...
const (
	ObjectDefTblName = "ves.io.schema.global_config.Object.default"
	ObjectType       = "ves.io.schema.global_config.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.global_config.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.global_config.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
