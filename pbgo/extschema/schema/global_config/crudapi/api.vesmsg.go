...
import (
	...
	ves_io_schema_global_config "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/global_config"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_global_config.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_global_config.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_global_config.DBObject)
	}
	_ = f
