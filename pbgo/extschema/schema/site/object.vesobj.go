...
const (
	ObjectDefTblName = "ves.io.schema.site.Object.default"
	ObjectType       = "ves.io.schema.site.Object"

	StatusObjectDefTblName = "ves.io.schema.site.StatusObject.default"
	StatusObjectType       = "ves.io.schema.site.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.site.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.site.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.site.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.site.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetVerStatusDRefInfo(); err != nil {
		return nil, errors.Wrap(err, "GetVerStatusDRefInfo() FAILED")
	} else {
		for i := range fdrInfos {
			dri := &fdrInfos[i]
			// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "site.Object")
	if err != nil {
...
// GetDRefInfo for the field's type
func (e *DBStatusObject) GetVerStatusDRefInfo() ([]db.DRefInfo, error) {
