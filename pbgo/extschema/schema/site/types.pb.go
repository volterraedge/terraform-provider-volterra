...
type PublishVIPParamsPerAz struct {
	...
	InsideVipV6 []string `protobuf:"bytes,6,rep,name=inside_vip_v6,json=insideVipV6,proto3" json:"inside_vip_v6,omitempty"`
	// Outside IPv6 VIP(s)
	//
	// x-displayName: "Outside IPv6 VIP(s)"
	// x-example: "2001::1"
	// Optional list of Outside IPv6 VIPs for an AZ
	OutsideVipV6 []string `protobuf:"bytes,7,rep,name=outside_vip_v6,json=outsideVipV6,proto3" json:"outside_vip_v6,omitempty"`
	// Outside VIP CNAME
	//
...
func (m *PublishVIPParamsPerAz) GetInsideVipV6() []string {
	if m != nil {
...
func (m *PublishVIPParamsPerAz) GetOutsideVipV6() []string {
	if m != nil {
...
type GlobalSpecType struct {
	...
	InsideNameserverV6 string `protobuf:"bytes,165,opt,name=inside_nameserver_v6,json=insideNameserverV6,proto3" json:"inside_nameserver_v6,omitempty"`
	...
	OutsideNameserverV6 string `protobuf:"bytes,166,opt,name=outside_nameserver_v6,json=outsideNameserverV6,proto3" json:"outside_nameserver_v6,omitempty"`
	// desired_pool_count
	//
	...
	PrivateConnectivity *views.PrivateConnectivityType `protobuf:"bytes,167,opt,name=private_connectivity,json=privateConnectivity,proto3" json:"private_connectivity,omitempty"`
	// bgp_peer_addres_v6
	//
	...
	BgpPeerAddressV6 string `protobuf:"bytes,168,opt,name=bgp_peer_address_v6,json=bgpPeerAddressV6,proto3" json:"bgp_peer_address_v6,omitempty"`
	// Kubernetes Upgrade Drain
	//
	// x-displayName: "Kubernetes Upgrade Drain"
	// K8s Node drain during OS or SW upgrade
	KubernetesUpgradeDrain *views.KubernetesUpgradeDrain `protobuf:"bytes,169,opt,name=kubernetes_upgrade_drain,json=kubernetesUpgradeDrain,proto3" json:"kubernetes_upgrade_drain,omitempty"`
	// Regional Edge Selection
	//
	// x-displayName: "Regional Edge Selection"
	// Selection criteria for Regional Edge connectivity
	ReSelect *views.RegionalEdgeSelection `protobuf:"bytes,170,opt,name=re_select,json=reSelect,proto3" json:"re_select,omitempty"`
	// Admin User Credentials
	//
	// x-displayName: "Admin User Credentials"
	// Setup user credentials to manage access to nodes belonging to the site.
	AdminUserCredentials *views.AdminUserCredentialsType `protobuf:"bytes,171,opt,name=admin_user_credentials,json=adminUserCredentials,proto3" json:"admin_user_credentials,omitempty"`
	// Proactive Monitoring
	//
	// x-displayName: "Proactive Monitoring"
	// Proactive Monitoring
	ProactiveMonitoring *views.ProactiveMonitoringChoice `protobuf:"bytes,172,opt,name=proactive_monitoring,json=proactiveMonitoring,proto3" json:"proactive_monitoring,omitempty"`
}
...
func (m *GlobalSpecType) GetInsideNameserverV6() string {
	if m != nil {
...
func (m *GlobalSpecType) GetOutsideNameserverV6() string {
	if m != nil {
...
func (m *GlobalSpecType) GetPrivateConnectivity() *views.PrivateConnectivityType {
	if m != nil {
		return m.PrivateConnectivity
	}
	return nil
}

func (m *GlobalSpecType) GetBgpPeerAddressV6() string {
	if m != nil {
...
func (m *CreateSpecType) GetBgpPeerAddressV6() string {
	if m != nil {
		return m.BgpPeerAddressV6
	}
	return ""
...
func (m *CreateSpecType) GetInsideNameserverV6() string {
	if m != nil {
		return m.InsideNameserverV6
	}
	return ""
...
func (m *CreateSpecType) GetOutsideNameserverV6() string {
	if m != nil {
		return m.OutsideNameserverV6
	}
	return ""
...
func (m *ReplaceSpecType) GetBgpPeerAddressV6() string {
	if m != nil {
		return m.BgpPeerAddressV6
	}
	return ""
...
func (m *ReplaceSpecType) GetInsideNameserverV6() string {
	if m != nil {
		return m.InsideNameserverV6
	}
	return ""
...
func (m *ReplaceSpecType) GetOutsideNameserverV6() string {
	if m != nil {
		return m.OutsideNameserverV6
	}
	return ""
...
func (m *GetSpecType) GetBgpPeerAddressV6() string {
	if m != nil {
		return m.BgpPeerAddressV6
	}
	return ""
...
func (m *GetSpecType) GetInsideNameserverV6() string {
	if m != nil {
		return m.InsideNameserverV6
	}
	return ""
...
func (m *GetSpecType) GetOutsideNameserverV6() string {
	if m != nil {
		return m.OutsideNameserverV6
	}
	return ""
...
func (m *GetSpecType) GetMainNodes() []*Node {
	if m != nil {
		return m.MainNodes
	}
	return nil
...
func (m *GetSpecType) GetPrivateConnectivity() *views.PrivateConnectivityType {
	if m != nil {
		return m.PrivateConnectivity
	}
	return nil
...
type TunnelConnectionStatus struct {
	...
	// tunnel flap reason(ike)
	IkeTunnelFlapReason *TunnelFlapReason `protobuf:"bytes,9,opt,name=ike_tunnel_flap_reason,json=ikeTunnelFlapReason,proto3" json:"ike_tunnel_flap_reason,omitempty"`
	// ssl_tunnel_flap_reason
	//
	// x-displayName: "Ssl tunnel flap reason"
	// tunnel flap reason(Ssl)
	SslTunnelFlapReason *TunnelFlapReason `protobuf:"bytes,10,opt,name=ssl_tunnel_flap_reason,json=sslTunnelFlapReason,proto3" json:"ssl_tunnel_flap_reason,omitempty"`
	// verNodeIP
	//
	// x-displayName: "VER Node IP"
	// The VER node IP in the local site from which the connection is setup
	VerNodeIp string `protobuf:"bytes,11,opt,name=verNodeIp,proto3" json:"verNodeIp,omitempty"`
}
...
func (m *TunnelConnectionStatus) GetIkeTunnelFlapReason() *TunnelFlapReason {
	if m != nil {
		return m.IkeTunnelFlapReason
	}
	return nil
}

func (m *TunnelConnectionStatus) GetSslTunnelFlapReason() *TunnelFlapReason {
	if m != nil {
		return m.SslTunnelFlapReason
	}
	return nil
}

func (m *TunnelConnectionStatus) GetVerNodeIp() string {
	if m != nil {
		return m.VerNodeIp
	}
	return ""
...
type OsInfo struct {
	...
	NumaNodes int32 `protobuf:"varint,13,opt,name=numa_nodes,json=numaNodes,proto3" json:"numa_nodes,omitempty"`
}
...
func (m *OsInfo) GetNumaNodes() int32 {
	if m != nil {
		return m.NumaNodes
	}
	return 0
...
func (m *SiteStatusMetricsData) GetUnit() schema.UnitType {
	if m != nil {
		return m.Unit
	}
...
type TunnelFlapReason struct {
	// Flap Reason
	//
	// x-displayName: "Flap Reason"
	// flap reason for tunnel
	FlapReason string `protobuf:"bytes,1,opt,name=flap_reason,json=flapReason,proto3" json:"flap_reason,omitempty"`
	// Flap time
	//
...
func (m *TunnelFlapReason) Reset()      { *m = TunnelFlapReason{} }
func (*TunnelFlapReason) ProtoMessage() {}
func (*TunnelFlapReason) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b1b2598d34ae46b, []int{65}
}
func (m *TunnelFlapReason) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TunnelFlapReason) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *TunnelFlapReason) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TunnelFlapReason.Merge(m, src)
}
func (m *TunnelFlapReason) XXX_Size() int {
	return m.Size()
}
func (m *TunnelFlapReason) XXX_DiscardUnknown() {
	xxx_messageInfo_TunnelFlapReason.DiscardUnknown(m)
}

var xxx_messageInfo_TunnelFlapReason proto.InternalMessageInfo

func (m *TunnelFlapReason) GetFlapReason() string {
	if m != nil {
		return m.FlapReason
	}
	return ""
...
func (m *TunnelFlapReason) GetTime() *types.Timestamp {
	if m != nil {
		return m.Time
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TunnelFlapReason)(nil), "ves.io.schema.site.TunnelFlapReason")
	golang_proto.RegisterType((*TunnelFlapReason)(nil), "ves.io.schema.site.TunnelFlapReason")
}
...
var fileDescriptor_3b1b2598d34ae46b = []byte{
	...
	,
}
...
func (this *PublishVIPParamsPerAz) Equal(that interface{}) bool {
	...
	if len(this.InsideVipV6) != len(that1.InsideVipV6) {
		return false
	}
	for i := range this.InsideVipV6 {
		if this.InsideVipV6[i] != that1.InsideVipV6[i] {
			return false
		}
	}
	if len(this.OutsideVipV6) != len(that1.OutsideVipV6) {
		return false
	}
	for i := range this.OutsideVipV6 {
		if this.OutsideVipV6[i] != that1.OutsideVipV6[i] {
			return false
		}
	}
...
func (this *TunnelConnectionStatus) Equal(that interface{}) bool {
	...
	if !this.IkeTunnelFlapReason.Equal(that1.IkeTunnelFlapReason) {
		return false
	}
	if !this.SslTunnelFlapReason.Equal(that1.SslTunnelFlapReason) {
		return false
	}
	if this.VerNodeIp != that1.VerNodeIp {
		return false
	}
	return true
}
...
func (this *TunnelFlapReason) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TunnelFlapReason)
	if !ok {
		that2, ok := that.(TunnelFlapReason)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.FlapReason != that1.FlapReason {
		return false
	}
...
func (this *GlobalSpecType) GoString() string {
	...
	if this.PrivateConnectivity != nil {
		s = append(s, "PrivateConnectivity: "+fmt.Sprintf("%#v", this.PrivateConnectivity)+",\n")
	}
...
func (this *TunnelConnectionStatus) GoString() string {
	...
	if this.IkeTunnelFlapReason != nil {
		s = append(s, "IkeTunnelFlapReason: "+fmt.Sprintf("%#v", this.IkeTunnelFlapReason)+",\n")
	}
	if this.SslTunnelFlapReason != nil {
		s = append(s, "SslTunnelFlapReason: "+fmt.Sprintf("%#v", this.SslTunnelFlapReason)+",\n")
	}
...
func (this *TunnelFlapReason) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&site.TunnelFlapReason{")
	s = append(s, "FlapReason: "+fmt.Sprintf("%#v", this.FlapReason)+",\n")
	if this.Time != nil {
...
func (m *PublishVIPParamsPerAz) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OutsideVipV6) > 0 {
		for iNdEx := len(m.OutsideVipV6) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.OutsideVipV6[iNdEx])
			copy(dAtA[i:], m.OutsideVipV6[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.OutsideVipV6[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
	if len(m.InsideVipV6) > 0 {
		for iNdEx := len(m.InsideVipV6) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.InsideVipV6[iNdEx])
			copy(dAtA[i:], m.InsideVipV6[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.InsideVipV6[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
...
func (m *TunnelConnectionStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VerNodeIp) > 0 {
		i -= len(m.VerNodeIp)
		copy(dAtA[i:], m.VerNodeIp)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.VerNodeIp)))
		i--
		dAtA[i] = 0x5a
	}
	if m.SslTunnelFlapReason != nil {
		{
			size, err := m.SslTunnelFlapReason.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.IkeTunnelFlapReason != nil {
		{
			size, err := m.IkeTunnelFlapReason.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TunnelFlapReason) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TunnelFlapReason) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TunnelFlapReason) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.FlapReason) > 0 {
		i -= len(m.FlapReason)
		copy(dAtA[i:], m.FlapReason)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FlapReason)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PublishVIPParamsPerAz) Size() (n int) {
	...
	if len(m.InsideVipV6) > 0 {
		for _, s := range m.InsideVipV6 {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
	if len(m.OutsideVipV6) > 0 {
		for _, s := range m.OutsideVipV6 {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *TunnelConnectionStatus) Size() (n int) {
	...
	if m.IkeTunnelFlapReason != nil {
		l = m.IkeTunnelFlapReason.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.SslTunnelFlapReason != nil {
		l = m.SslTunnelFlapReason.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.VerNodeIp)
	if l > 0 {
...
func (m *TunnelFlapReason) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`PrivateConnectivity:` + strings.Replace(fmt.Sprintf("%v", this.PrivateConnectivity), "PrivateConnectivityType", "views.PrivateConnectivityType", 1) + `,`,
...
func (this *TunnelConnectionStatus) String() string {
	...
	s := strings.Join([]string{`&TunnelConnectionStatus{`,
		...
		`IkeTunnelFlapReason:` + strings.Replace(this.IkeTunnelFlapReason.String(), "TunnelFlapReason", "TunnelFlapReason", 1) + `,`,
		`SslTunnelFlapReason:` + strings.Replace(this.SslTunnelFlapReason.String(), "TunnelFlapReason", "TunnelFlapReason", 1) + `,`,
		`VerNodeIp:` + fmt.Sprintf("%v", this.VerNodeIp) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TunnelFlapReason) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TunnelFlapReason{`,
		`FlapReason:` + fmt.Sprintf("%v", this.FlapReason) + `,`,
...
func (m *PublishVIPParamsPerAz) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.InsideVipV6 = append(m.InsideVipV6, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			m.OutsideVipV6 = append(m.OutsideVipV6, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 167:
			...
			if m.PrivateConnectivity == nil {
				m.PrivateConnectivity = &views.PrivateConnectivityType{}
			}
			if err := m.PrivateConnectivity.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 168:
...
func (m *TunnelConnectionStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IkeTunnelFlapReason", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IkeTunnelFlapReason == nil {
				m.IkeTunnelFlapReason = &TunnelFlapReason{}
			}
			if err := m.IkeTunnelFlapReason.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SslTunnelFlapReason", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SslTunnelFlapReason == nil {
				m.SslTunnelFlapReason = &TunnelFlapReason{}
			}
			if err := m.SslTunnelFlapReason.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VerNodeIp", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VerNodeIp = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *TunnelFlapReason) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TunnelFlapReason: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TunnelFlapReason: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlapReason", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FlapReason = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
