...
// Get Kube Config Request
//
// x-displayName: "Get Kube Config Request"
// Get kubeconfig request parameters
...
func (m *GetKubeConfigReq) Reset()                    { *m = GetKubeConfigReq{} }
func (*GetKubeConfigReq) ProtoMessage()               {}
func (*GetKubeConfigReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }

func (m *GetKubeConfigReq) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *GetKubeConfigReq) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (*ListKubeConfigReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func (*ListKubeConfigRspItem) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{33} }
...
func (*ListKubeConfigRsp) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func init() {
	...
	proto.RegisterType((*GetKubeConfigReq)(nil), "ves.io.schema.site.GetKubeConfigReq")
	golang_proto.RegisterType((*GetKubeConfigReq)(nil), "ves.io.schema.site.GetKubeConfigReq")
...
func (this *GetKubeConfigReq) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetKubeConfigReq)
	if !ok {
		that2, ok := that.(GetKubeConfigReq)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetKubeConfigReq) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&site.GetKubeConfigReq{")
...
func (m *GetKubeConfigReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetKubeConfigReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ListKubeConfigRspItem) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CreateTimestamp != nil {
		...
		n22, err := m.CreateTimestamp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.ExpiryTimestamp != nil {
		...
		n23, err := m.ExpiryTimestamp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func NewPopulatedGlobalSpecType(r randyTypes, easy bool) *GlobalSpecType {
	...
	this.NoTenantInVk8SNs = bool(bool(r.Intn(2) == 0))
	this.LocalK8SAccessEnabled = bool(bool(r.Intn(2) == 0))
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.K8SClusterApiGw = make([]*ves_io_schema4.ObjectRefType, v10)
		for i := 0; i < v10; i++ {
			this.K8SClusterApiGw[i] = ves_io_schema4.NewPopulatedObjectRefType(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedGetSpecType(r randyTypes, easy bool) *GetSpecType {
	...
	if r.Intn(10) != 0 {
		v11 := r.Intn(5)
		this.ConnectedRe = make([]*ves_io_schema4.ObjectRefType, v11)
		for i := 0; i < v11; i++ {
			this.ConnectedRe[i] = ves_io_schema4.NewPopulatedObjectRefType(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v12 := r.Intn(5)
		this.ConnectedReForConfig = make([]*ves_io_schema4.ObjectRefType, v12)
		for i := 0; i < v12; i++ {
			this.ConnectedReForConfig[i] = ves_io_schema4.NewPopulatedObjectRefType(r, easy)
		}
	}
...
func NewPopulatedVerStatusType(r randyTypes, easy bool) *VerStatusType {
	...
	if r.Intn(10) != 0 {
		v13 := r.Intn(5)
		this.IpsecStatus = make([]*IpsecConnectionStatus, v13)
		for i := 0; i < v13; i++ {
	...
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.AresStatus = make([]*AresConnectionStatus, v14)
		for i := 0; i < v14; i++ {
	...
	if r.Intn(10) != 0 {
		v15 := r.Intn(5)
		this.IntfStatus = make([]*InterfaceStatus, v15)
		for i := 0; i < v15; i++ {
	...
	if r.Intn(10) != 0 {
		v16 := r.Intn(5)
		this.ConfiguredTunnelStatus = make([]*TunnelConnectionStatus, v16)
		for i := 0; i < v16; i++ {
	...
	if r.Intn(10) != 0 {
		v17 := r.Intn(5)
		this.SiteTunnelStatus = make([]*TunnelConnectionStatus, v17)
		for i := 0; i < v17; i++ {
...
func NewPopulatedInterfaceStatus(r randyTypes, easy bool) *InterfaceStatus {
	...
	this.LinkType = LinkType([]int32{0, 1, 2, 3, 4, 5, 6}[r.Intn(7)])
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedOsInfo(r randyTypes, easy bool) *OsInfo {
	...
	if r.Intn(10) != 0 {
		v19 := r.Intn(5)
		this.Storage = make([]*StorageDevice, v19)
		for i := 0; i < v19; i++ {
	...
	if r.Intn(10) != 0 {
		v20 := r.Intn(5)
		this.Network = make([]*NetworkDevice, v20)
		for i := 0; i < v20; i++ {
...
func NewPopulatedNetworkDevice(r randyTypes, easy bool) *NetworkDevice {
	...
	this.Driver = string(randStringTypes(r))
	v22 := r.Intn(10)
	this.IpAddress = make([]string, v22)
	for i := 0; i < v22; i++ {
...
func NewPopulatedSiteStatusMetricsFieldData(r randyTypes, easy bool) *SiteStatusMetricsFieldData {
	...
	if r.Intn(10) != 0 {
		v24 := r.Intn(5)
		this.Value = make([]*ves_io_schema4.MetricValue, v24)
		for i := 0; i < v24; i++ {
...
func NewPopulatedSiteStatusMetricsData(r randyTypes, easy bool) *SiteStatusMetricsData {
	...
	if r.Intn(10) != 0 {
		v25 := r.Intn(5)
		this.Data = make([]*SiteStatusMetricsFieldData, v25)
		for i := 0; i < v25; i++ {
...
func NewPopulatedGetKubeConfigReq(r randyTypes, easy bool) *GetKubeConfigReq {
	this := &GetKubeConfigReq{}
...
func NewPopulatedListKubeConfigReq(r randyTypes, easy bool) *ListKubeConfigReq {
	this := &ListKubeConfigReq{}
	this.Namespace = string(randStringTypes(r))
	this.Name = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedListKubeConfigRspItem(r randyTypes, easy bool) *ListKubeConfigRspItem {
	this := &ListKubeConfigRspItem{}
	this.Uid = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.CreateTimestamp = google_protobuf1.NewPopulatedTimestamp(r, easy)
	}
	if r.Intn(10) != 0 {
		this.ExpiryTimestamp = google_protobuf1.NewPopulatedTimestamp(r, easy)
	}
	this.UserEmail = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedListKubeConfigRsp(r randyTypes, easy bool) *ListKubeConfigRsp {
	this := &ListKubeConfigRsp{}
	if r.Intn(10) != 0 {
		v26 := r.Intn(5)
		this.Items = make([]*ListKubeConfigRspItem, v26)
		for i := 0; i < v26; i++ {
			this.Items[i] = NewPopulatedListKubeConfigRspItem(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func randFieldTypes(dAtA []byte, r randyTypes, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateTypes(dAtA, uint64(v28))
	case 1:
		dAtA = encodeVarintPopulateTypes(dAtA, uint64(key))
...
func (m *GetKubeConfigReq) Size() (n int) {
	var l int
	_ = l
	l = len(m.Namespace)
	if l > 0 {
...
func (this *GetKubeConfigReq) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetKubeConfigReq{`,
...
func (m *GetKubeConfigReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetKubeConfigReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetKubeConfigReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
