...
type StatusObject struct {
	...
	FleetStatus *FleetStatus `protobuf:"bytes,14,opt,name=fleet_status,json=fleetStatus" json:"fleet_status,omitempty"`
}
...
func (m *StatusObject) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FleetStatus != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintObject(dAtA, i, uint64(m.FleetStatus.Size()))
		n13, err := m.FleetStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
var fileDescriptorObject = []byte{
	...
	,
}
