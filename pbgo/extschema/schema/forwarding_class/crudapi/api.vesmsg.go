...
import (
	...
	ves_io_schema_forwarding_class "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/forwarding_class"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_forwarding_class.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_forwarding_class.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_forwarding_class.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_forwarding_class.DBObject)
	}
	_ = f
