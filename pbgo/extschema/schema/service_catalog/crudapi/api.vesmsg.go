...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_service_catalog.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_service_catalog.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_service_catalog.DBObject)
	}
	_ = f
