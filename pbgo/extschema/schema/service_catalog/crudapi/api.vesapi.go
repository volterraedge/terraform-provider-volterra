...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/service_catalog"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.service_catalog.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.service_catalog.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.service_catalog.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_catalog.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_catalog.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_catalog.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_catalog.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_catalog.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.service_catalog.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.service_catalog.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_catalog.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_catalog.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_catalog.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_catalog.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_catalog.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_catalog.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_catalog.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_catalog.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/service_catalog/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.service_catalog/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "service_catalog",
            "x-ves-object-type": "ves.io.schema.service_catalog.Object",
            "x-ves-proto-service": "ves.io.schema.service_catalog.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.service_catalog/Objects": {
            "get": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "service_catalog",
            "x-ves-object-type": "ves.io.schema.service_catalog.Object",
        ...
        "/ves.io.schema.service_catalog/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-service_catalog-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_catalog.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "service_catalog",
            "x-ves-object-type": "ves.io.schema.service_catalog.Object",
        ...
        "/ves.io.schema.service_catalog/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_catalog/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_catalog/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_catalog/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.service_catalog.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/service_catalogSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/service_catalogcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/service_catalogcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/service_catalogcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/service_catalogcrudapiErrorCode"
                },
        ...
        "schemaservice_catalogGlobalSpecType": {
            "type": "object",
            "description": "Desired state of the Service Catalog record",
            "title": "Service Catalog Record",
            "x-displayname": "Service Catalog Record",
            "x-ves-oneof-field-service_type": "[\"http_load_balancer\"]",
            "x-ves-proto-message": "ves.io.schema.service_catalog.GlobalSpecType",
            "properties": {
                "http_load_balancer": {
                    "description": "Exclusive with []\n HTTP load balancer probe is constructed to monitor.",
                    "title": "http_load_balancer",
                    "$ref": "#/definitions/service_catalogHTTPLoadBalancer",
        ...
        "service_catalogHTTPLoadBalancer": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_catalog.HTTPLoadBalancer",
            "properties": {
                "http_load_balancer": {
                    "description": " Owner object of virtual host.",
                    "title": "http_load_balancer",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "HTTP Load Balancer"
                },
                "virtual_host": {
                    "description": " Virtual host fields for monitoring.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "virtual_host",
                    "$ref": "#/definitions/service_catalogVirtualHost",
        ...
        "service_catalogSpecType": {
            "type": "object",
            "description": "Shape of the Service Catalog Record specification",
            "title": "Service Catalog Record specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.service_catalog.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemaservice_catalogGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "service_catalogVirtualHost": {
            "type": "object",
            "x-ves-oneof-field-port_choice": "[\"port\",\"port_ranges\"]",
            "x-ves-proto-message": "ves.io.schema.service_catalog.VirtualHost",
            "properties": {
                "domains": {
                    "type": "array",
                    "description": " List of domains matched with the load balancer.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_len: 256\n  ves.io.schema.rules.repeated.items.string.min_len: 1\n  ves.io.schema.rules.repeated.items.string.vh_domain: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "domains",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                ...
                "host_name": {
                    "type": "string",
                    "description": " Host name to monitored.\n\nExample: - \"ves-io-f73a29d2-2d64-4095-a6f7-57fd3639d56e.ac.vh.ves.io\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "host_name",
                    "x-displayname": "Host Name",
                    "x-ves-example": "ves-io-f73a29d2-2d64-4095-a6f7-57fd3639d56e.ac.vh.ves.io",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                ...
                "virtual_ips": {
                    "type": "array",
                    "description": " List of virtual IPs to monitor.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.string.ip: true\n",
                    "title": "virtual_ips",
                    "minItems": 1,
                    "items": {
                        "type": "string"
        ...
        "service_catalogcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.service_catalog.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/service_catalog/crudapi/api.proto"
}`
