...
import (
	...
	ves_io_schema_contact "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/contact"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_contact.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_contact.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_contact.DBObject)
	}
	_ = f
