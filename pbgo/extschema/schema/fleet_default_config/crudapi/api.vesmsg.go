...
import (
	...
	ves_io_schema_fleet_default_config "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/fleet_default_config"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_fleet_default_config.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_fleet_default_config.DBObject)
	}
	_ = f
