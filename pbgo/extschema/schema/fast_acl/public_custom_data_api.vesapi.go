...
func (c *CustomDataAPIInprocClient) FastACLHits(ctx context.Context, in *FastACLHitsRequest, opts ...grpc.CallOption) (*FastACLHitsResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.fast_acl.CustomDataAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.fast_acl.FastACLHitsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, c.svc, "ves.io.schema.fast_acl.FastACLHitsResponse", rsp)...)
        ...
        "/public/namespaces/{namespace}/fast_acl/hits": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-fast_acl-CustomDataAPI-FastACLHits"
                },
