...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/fast_acl_sets", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/fast_acl_sets/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/fast_acl_sets/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/fast_acl_sets", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/fast_acl_sets/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.fast_acl_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.fast_acl_set")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.fast_acl_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.fast_acl_set")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.fast_acl_set")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.fast_acl_set.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.fast_acl_set.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.fast_acl_set.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.fast_acl_set.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.fast_acl_set.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.fast_acl_set.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.fast_acl_set.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.fast_acl_set.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.fast_acl_set.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.fast_acl_set.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Fast ACL Set Object",
        "description": "Fast ACL set maintains list of Fast ACL to be applied\n\nFast ACL specifies rules to protect the site from denial of service attacks.\nTypical Usecase(s) are:\n  Rate-limiting traffic to destination\n  Accepting traffic from certain source IPs to destination\n  Ratelimiting or dropping traffic from source IPs to destination\n\nFast ACL Set on CE\n\nFast ACL Set is selected on CE Site based on Fleet Configuration. Fast ACL set matching following condition are applied on a CE site\n- Fast ACL is referred to by a Network Firewall\n- Network Firewall is referred to by a Fleet\n- CE site is member of the Fleet\n- Only tenant can configure this set\n\nSelection of Destination\n- Tenant can choose public VIP or interface IP(configured as VIP) via Fast ACL\n\nFor more details on types of destination and selection of rules on CE, refer to Fast ACL description\n\n Fast ACL Set on RE\n\n- RE sets can be defined by both tenant and ves.io tenant\n- Its mandatory to keep the name of Fast ACL set to be \"fast-acl-set-regional-edge\". Sets with this name will only be picked for application\n- Sets from all tenants will be applied however in case of overlap between ves.io and non ves.io tenant, action of ves.io will be applied\n- Network type supported for RE is Public. Sets with Fast ACL with any other network type will be rejected\n\nSelection of public VIP destination\n- ves.io tenant ACL can pick all VIP across tenant in the RE\n- Non ves.io tenant ACL can pick VIP corresponding to tenant only\nSelection of shared VIP destination\n- ves.io tenant ACL can configure the rule for same\n- Non ves.io tenant CANNOT use this option on RE. In other words its ineffective and is not applied\nCustom prefixes destination\n- ves.io tenant can specify custom prefixes for destination\n- Non ves.io tennat CANNOT use this option. In other words its ineffective and is not applied\n\nFor more details on types of destination and selection of rules on RE, refer to Fast ACL description",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-fast_acl_set-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.API.Create"
            },
            "x-displayname": "Fast ACL Set",
            "x-ves-proto-service": "ves.io.schema.fast_acl_set.API",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-fast_acl_set-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.API.Replace"
            },
            "x-displayname": "Fast ACL Set",
            "x-ves-proto-service": "ves.io.schema.fast_acl_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/fast_acl_sets": {
            "get": {
                "summary": "List",
                "description": "List the set of fast_acl_set in a namespace",
                "operationId": "ves.io.schema.fast_acl_set.API.List",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-fast_acl_set-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.API.List"
            },
            "x-displayname": "Fast ACL Set",
            "x-ves-proto-service": "ves.io.schema.fast_acl_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-fast_acl_set-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.API.Get"
            },
            "delete": {
                "summary": "Delete",
                "description": "Delete the specified fast_acl_set",
                "operationId": "ves.io.schema.fast_acl_set.API.Delete",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/fast_acl_setDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-fast_acl_set-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.API.Delete"
            },
            "x-displayname": "Fast ACL Set",
            "x-ves-proto-service": "ves.io.schema.fast_acl_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "fast_acl_setCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of fast_acl_set",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.CreateRequest",
            "properties": {
                "metadata": {
        ...
        "fast_acl_setCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "fast_acl_setDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a fast_acl_set",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "fast_acl_setGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read fast_acl_set",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.GetResponse",
            "properties": {
                "create_form": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/fast_acl_setObject",
        ...
        "fast_acl_setGetResponseFormatCode": {
            "type": "string",
        ...
        "fast_acl_setListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of fast_acl_set",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.ListResponse",
            "properties": {
                "items": {
                    "type": "array",
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/fast_acl_setListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "fast_acl_setListResponseItem": {
            "type": "object",
            "description": "By default a summary of fast_acl_set is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of fast_acl_set",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this fast_acl_set",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this fast_acl_set",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates fast_acl_set is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this fast_acl_set",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this fast_acl_set\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this fast_acl_set\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "fast_acl_setObject": {
            "type": "object",
            "description": "Fast ACL Set object",
            "title": "Fast ACL Set",
            "x-displayname": "Fast ACL Set",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "fast_acl_setReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a fast_acl_set",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "fast_acl_setReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.ReplaceResponse"
        },
    ...
    "x-displayname": "Fast ACL Set",
    "x-ves-proto-file": "ves.io/schema/fast_acl_set/public_crudapi.proto"
}`
