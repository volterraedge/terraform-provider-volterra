...
// source: ves.io/schema/fast_acl_set/public_crudapi.proto
...
// CreateRequest is used to create an instance of fast_acl_set
//
...
// ReplaceRequest is used to replace contents of a fast_acl_set
//
...
// GetRequest is used to get different forms of a fast_acl_set
//
...
// creating new instance of fast_acl_set) etc. can be fetched
type GetRequest struct {
	...
	ResponseFormat GetResponseFormatCode `protobuf:"varint,3,opt,name=response_format,json=responseFormat,proto3,enum=ves.io.schema.fast_acl_set.GetResponseFormatCode" json:"response_format,omitempty"`
}
...
// GetResponse is the shape of a read fast_acl_set
//
...
// ListRequest is used to get a collection of fast_acl_set
//
...
type ListRequest struct {
	...
	// x-displayName: "Namespace"
	// x-example: "ns1"
	// Namespace to scope the listing of fast_acl_set
	Namespace string `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	// label_filter
	//
...
// ListResponseItem is an individual item in a collection of fast_acl_set
//
// x-displayName: "List Item"
// By default a summary of fast_acl_set is returned in 'List'. By setting
...
type ListResponseItem struct {
	...
	// x-displayName: "Name"
	// x-example: "name"
	// The name of this fast_acl_set
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// uid
	//
	// x-displayName: "UID"
	// x-example: "d27938ba-967e-40a7-9709-57b8627f9f75"
	// The unique uid of this fast_acl_set
	Uid string `protobuf:"bytes,3,opt,name=uid,proto3" json:"uid,omitempty"`
	// description
	//
	// x-displayName: "Description"
	// The description set for this fast_acl_set
	Description string `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`
	// disabled
	//
	// x-displayName: "Disabled"
	// A value of true indicates fast_acl_set is administratively disabled
	Disabled bool `protobuf:"varint,12,opt,name=disabled,proto3" json:"disabled,omitempty"`
	// labels
	//
	// x-displayName: "Labels"
	// The set of labels present on this fast_acl_set
	...
	// The set of annotations present on this fast_acl_set
...
// ListResponse is the collection of fast_acl_set
//
...
// DeleteRequest is used to delete a fast_acl_set
//
...
func init() {
	proto.RegisterType((*CreateRequest)(nil), "ves.io.schema.fast_acl_set.CreateRequest")
	golang_proto.RegisterType((*CreateRequest)(nil), "ves.io.schema.fast_acl_set.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "ves.io.schema.fast_acl_set.CreateResponse")
	golang_proto.RegisterType((*CreateResponse)(nil), "ves.io.schema.fast_acl_set.CreateResponse")
	proto.RegisterType((*ReplaceRequest)(nil), "ves.io.schema.fast_acl_set.ReplaceRequest")
	golang_proto.RegisterType((*ReplaceRequest)(nil), "ves.io.schema.fast_acl_set.ReplaceRequest")
	proto.RegisterType((*ReplaceResponse)(nil), "ves.io.schema.fast_acl_set.ReplaceResponse")
	golang_proto.RegisterType((*ReplaceResponse)(nil), "ves.io.schema.fast_acl_set.ReplaceResponse")
	proto.RegisterType((*GetRequest)(nil), "ves.io.schema.fast_acl_set.GetRequest")
	golang_proto.RegisterType((*GetRequest)(nil), "ves.io.schema.fast_acl_set.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "ves.io.schema.fast_acl_set.GetResponse")
	golang_proto.RegisterType((*GetResponse)(nil), "ves.io.schema.fast_acl_set.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "ves.io.schema.fast_acl_set.ListRequest")
	golang_proto.RegisterType((*ListRequest)(nil), "ves.io.schema.fast_acl_set.ListRequest")
	proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.fast_acl_set.ListResponseItem")
	golang_proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.fast_acl_set.ListResponseItem")
	proto.RegisterType((*ListResponse)(nil), "ves.io.schema.fast_acl_set.ListResponse")
	golang_proto.RegisterType((*ListResponse)(nil), "ves.io.schema.fast_acl_set.ListResponse")
	proto.RegisterType((*DeleteRequest)(nil), "ves.io.schema.fast_acl_set.DeleteRequest")
	golang_proto.RegisterType((*DeleteRequest)(nil), "ves.io.schema.fast_acl_set.DeleteRequest")
	proto.RegisterEnum("ves.io.schema.fast_acl_set.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	golang_proto.RegisterEnum("ves.io.schema.fast_acl_set.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
}
...
func (this *CreateRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&fast_acl_set.CreateRequest{")
...
func (this *CreateResponse) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&fast_acl_set.CreateResponse{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
...
func (this *ReplaceRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&fast_acl_set.ReplaceRequest{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
	if this.Spec != nil {
...
func (this *ReplaceResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&fast_acl_set.ReplaceResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&fast_acl_set.GetRequest{")
...
func (this *GetResponse) GoString() string {
	...
	s := make([]string, 0, 13)
	s = append(s, "&fast_acl_set.GetResponse{")
	if this.Object != nil {
...
func (this *ListRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&fast_acl_set.ListRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
...
func (this *ListResponseItem) GoString() string {
	...
	s := make([]string, 0, 18)
	s = append(s, "&fast_acl_set.ListResponseItem{")
...
func (this *ListResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&fast_acl_set.ListResponse{")
	if this.Items != nil {
...
func (this *DeleteRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&fast_acl_set.DeleteRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
...
type APIClient interface {
	...
	// List
	//
	// x-displayName: "List Fast ACL Set"
	// List the set of fast_acl_set in a namespace
	...
	// Delete
	//
	// x-displayName: "Delete Fast ACL Set"
	// Delete the specified fast_acl_set
...
func (c *aPIClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.API/Create", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.API/Get", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.API/List", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Replace(ctx context.Context, in *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.API/Replace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf3.Empty, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.API/Delete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.fast_acl_set.API/Create",
	}
...
func _API_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.fast_acl_set.API/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.fast_acl_set.API/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Replace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.fast_acl_set.API/Replace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.fast_acl_set.API/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _API_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ves.io.schema.fast_acl_set.API",
	...
	Metadata: "ves.io/schema/fast_acl_set/public_crudapi.proto",
}
...
func init() {
	proto.RegisterFile("ves.io/schema/fast_acl_set/public_crudapi.proto", fileDescriptorPublicCrudapi)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/fast_acl_set/public_crudapi.proto", fileDescriptorPublicCrudapi)
}

var fileDescriptorPublicCrudapi = []byte{
	// 1508 bytes of a gzipped FileDescriptorProto
	,
}
