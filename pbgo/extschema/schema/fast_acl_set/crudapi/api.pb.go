...
/*
	...
	It is generated from these files:
		ves.io/schema/fast_acl_set/crudapi/api.proto
...
import ves_io_schema_fast_acl_set1 "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/fast_acl_set"
import _ "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/fast_acl_set"
...
type ObjectCreateReq struct {
	...
	Spec           *ves_io_schema_fast_acl_set1.SpecType `protobuf:"bytes,3,opt,name=spec" json:"spec,omitempty"`
}
...
func (m *ObjectCreateReq) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *ObjectCreateRsp) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *ObjectReplaceReq) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *ObjectReplaceRsp) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
type ObjectGetRsp struct {
	...
	SystemMetadata  *ves_io_schema4.SystemObjectMetaType        `protobuf:"bytes,2,opt,name=system_metadata,json=systemMetadata" json:"system_metadata,omitempty"`
	Spec            *ves_io_schema_fast_acl_set1.SpecType       `protobuf:"bytes,3,opt,name=spec" json:"spec,omitempty"`
	Status          []*ves_io_schema_fast_acl_set1.StatusObject `protobuf:"bytes,20000,rep,name=status" json:"status,omitempty"`
}
...
func (m *ObjectGetRsp) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *ObjectGetRsp) GetStatus() []*ves_io_schema_fast_acl_set1.StatusObject {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *ObjectListRspItem) GetSpec() *ves_io_schema_fast_acl_set1.SpecType {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *ObjectListRspItem) GetStatus() []*ves_io_schema_fast_acl_set1.StatusObject {
	if m != nil {
		return m.Status
	}
	return nil
...
func (c *aPIClient) Create(ctx context.Context, in *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.crudapi.API/Create", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Replace(ctx context.Context, in *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.crudapi.API/Replace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Get(ctx context.Context, in *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.crudapi.API/Get", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) List(ctx context.Context, in *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.crudapi.API/List", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListStream(ctx context.Context, in *ObjectListReq, opts ...grpc.CallOption) (API_ListStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_API_serviceDesc.Streams[0], c.cc, "/ves.io.schema.fast_acl_set.crudapi.API/ListStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) Delete(ctx context.Context, in *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	err := grpc.Invoke(ctx, "/ves.io.schema.fast_acl_set.crudapi.API/Delete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (this *ObjectCreateReq) String() string {
	...
	s := strings.Join([]string{`&ObjectCreateReq{`,
		...
		`Spec:` + strings.Replace(fmt.Sprintf("%v", this.Spec), "SpecType", "ves_io_schema_fast_acl_set1.SpecType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ObjectGetRsp) String() string {
	...
	s := strings.Join([]string{`&ObjectGetRsp{`,
		...
		`ResourceVersion:` + fmt.Sprintf("%v", this.ResourceVersion) + `,`,
		`Status:` + strings.Replace(fmt.Sprintf("%v", this.Status), "StatusObject", "ves_io_schema_fast_acl_set1.StatusObject", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ObjectCreateReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Spec == nil {
				m.Spec = &ves_io_schema_fast_acl_set1.SpecType{}
			}
...
func (m *ObjectGetRsp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20000:
			...
			m.Status = append(m.Status, &ves_io_schema_fast_acl_set1.StatusObject{})
...
func init() { proto.RegisterFile("ves.io/schema/fast_acl_set/crudapi/api.proto", fileDescriptorApi) }
func init() {
	golang_proto.RegisterFile("ves.io/schema/fast_acl_set/crudapi/api.proto", fileDescriptorApi)
}
...
var fileDescriptorApi = []byte{
	...
	,
}
