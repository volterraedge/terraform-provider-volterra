...
import (
	...
	ves_io_schema_ocsp_response "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/ocsp_response"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_ocsp_response.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ocsp_response.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ocsp_response.DBObject)
	}
	_ = f
