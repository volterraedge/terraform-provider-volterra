...
import (
	...
	ves_io_schema_virtual_k8s1 "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s"

	_ "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s"
