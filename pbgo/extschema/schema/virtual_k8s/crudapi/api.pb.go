...
import (
	...
	ves_io_schema_virtual_k8s1 "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s"

	_ "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s"
