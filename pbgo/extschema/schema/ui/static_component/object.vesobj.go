...
const (
	ObjectDefTblName = "ves.io.schema.ui.static_component.Object.default"
	ObjectType       = "ves.io.schema.ui.static_component.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.ui.static_component.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.ui.static_component.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
