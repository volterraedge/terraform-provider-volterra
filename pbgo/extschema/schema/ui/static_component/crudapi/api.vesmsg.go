...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_ui_static_component.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ui_static_component.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ui_static_component.DBObject)
	}
	_ = f
