...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/static_components/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/static_components", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ui.static_component.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.ui.static_component")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.ui.static_component.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.ui.static_component.API.List", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.ui.static_component.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.ui.static_component.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ui.static_component.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.ui.static_component.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ui.static_component.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.ui.static_component.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/static_components": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/static_componentListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.ui.static_component.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/static_components/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/static_componentGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        ...
        "static_componentGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read static_component",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.GetResponse",
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/static_componentObject",
                ...
                "spec": {
                    "description": " Specification of the ui component",
                    "title": "spec",
                    "$ref": "#/definitions/static_componentGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "static_componentGetResponseFormatCode": {
            "type": "string",
        ...
        "static_componentGetSpecType": {
            "type": "object",
            "description": "Get Ui static component.",
            "title": "Get Ui static component",
            "x-displayname": "Get Ui static component",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.GetSpecType",
            "properties": {
                "value": {
                    "type": "object",
                    "description": " information of the UI component\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "x-displayname": "value",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
        ...
        "static_componentGlobalSpecType": {
            "type": "object",
            "description": "used to store the information about the UI component",
            "title": "GlobalSpecType",
            "x-displayname": "GlobalSpecType",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.GlobalSpecType",
            "properties": {
                "value": {
                    "type": "object",
                    "description": " information of the UI component\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "static_componentListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of static_component",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/static_componentListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "static_componentListResponseItem": {
            "type": "object",
            "description": "By default a summary of static_component is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of static_component",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates static_component is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this static_component\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this static_component\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "static_componentObject": {
            "type": "object",
            "description": "UI static component object",
            "title": "Ui static component",
            "x-displayname": "UI static component",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the ui component",
                    "title": "spec",
                    "$ref": "#/definitions/static_componentSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
                    "description": " System generated object's metadata",
        ...
        "static_componentSpecType": {
            "type": "object",
            "description": "Ui Component specification",
            "title": "SpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.ui.static_component.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " Ui Component specification",
                    "title": "gc_spec",
                    "$ref": "#/definitions/static_componentGlobalSpecType",
    ...
    "x-displayname": "Ui Static Component",
    "x-ves-proto-file": "ves.io/schema/ui/static_component/public_crudapi.proto"
}`
