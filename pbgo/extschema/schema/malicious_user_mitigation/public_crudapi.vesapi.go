...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.malicious_user_mitigation.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.malicious_user_mitigation.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.malicious_user_mitigation.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.malicious_user_mitigation.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.malicious_user_mitigation.API.Delete", nil)
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "malicious_user_mitigationObject": {
            "type": "object",
            "description": "Malicious User Mitigation object",
            "title": "Malicious User Mitigation object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.malicious_user_mitigation.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
