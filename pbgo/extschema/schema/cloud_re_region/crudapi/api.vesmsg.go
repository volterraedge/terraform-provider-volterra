...
import (
	...
	ves_io_schema_cloud_re_region "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/cloud_re_region"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_cloud_re_region.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_cloud_re_region.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_cloud_re_region.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_cloud_re_region.DBObject)
	}
	_ = f
