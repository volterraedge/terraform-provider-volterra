...
// source: ves.io/schema/dns_lb_health_check/object.proto
...
// DNS Load Balancer Health Check object
type Object struct {
	// metadata
	//
	...
	//
	// x-displayName: "Spec"
	// Specification of the desired behavior of the DNS Load Balancer Zone
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_426bea6345c5e4bf, []int{0}
}
...
// DNS Load Balancer Zone specification
//
// x-displayName: "Specification"
// Shape of the DNS Load Balancer Zone specification
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_426bea6345c5e4bf, []int{1}
}
...
// DNS Load Balancer Health Check Status Object
//
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_426bea6345c5e4bf, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.dns_lb_health_check.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.dns_lb_health_check.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.dns_lb_health_check.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.dns_lb_health_check.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.dns_lb_health_check.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.dns_lb_health_check.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/dns_lb_health_check/object.proto", fileDescriptor_426bea6345c5e4bf)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/dns_lb_health_check/object.proto", fileDescriptor_426bea6345c5e4bf)
}

var fileDescriptor_426bea6345c5e4bf = []byte{
	// 631 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&dns_lb_health_check.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&dns_lb_health_check.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&dns_lb_health_check.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
