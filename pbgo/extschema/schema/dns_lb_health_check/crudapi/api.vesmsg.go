...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_dns_lb_health_check.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_dns_lb_health_check.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_dns_lb_health_check.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_dns_lb_health_check.DBObject)
	}
	_ = f
