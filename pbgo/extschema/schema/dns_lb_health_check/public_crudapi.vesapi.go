...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_health_check.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_health_check.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_health_check.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_health_check.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_health_check.API.Delete", nil)
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_lb_health_checks": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_health_check-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/dns_lb_health_checks/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_health_check-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/dns_lb_health_checks": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_health_check-api-list"
                },
        ...
        "/public/namespaces/{namespace}/dns_lb_health_checks/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_health_check-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_health_check-api-delete"
                },
    ...
    "definitions": {
        ...
        "dns_lb_health_checkGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/dns_lb_health_checkObject",
        ...
        "dns_lb_health_checkObject": {
            "type": "object",
            "description": "DNS Load Balancer Health Check object",
            "title": "DNS Load Balancer Health Check",
            "x-displayname": "DNS Load Balancer Health Check",
            "x-ves-proto-message": "ves.io.schema.dns_lb_health_check.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
