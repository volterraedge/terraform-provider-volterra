...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/usb_policys", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
    ...
    "definitions": {
        ...
        "usb_policyGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/usb_policyObject",
        ...
        "usb_policyObject": {
            "type": "object",
            "description": "USB policy Object to configure allowed USB devices",
            "title": "USB policy Object",
            "x-displayname": "USB policy Object",
            "x-ves-proto-message": "ves.io.schema.usb_policy.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
