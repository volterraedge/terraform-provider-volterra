...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/advertise_policys", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.advertise_policy.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.advertise_policy")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.advertise_policy")
	}
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/advertise_policys": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-advertise_policy-API-Create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/advertise_policys/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-advertise_policy-API-Replace"
                },
        ...
        "/public/namespaces/{namespace}/advertise_policys": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-advertise_policy-API-List"
                },
        ...
        "/public/namespaces/{namespace}/advertise_policys/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-advertise_policy-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-advertise_policy-API-Delete"
                },
    ...
    "definitions": {
        ...
        "advertise_policyGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/advertise_policyObject",
        ...
        "advertise_policyObject": {
            "type": "object",
            "description": "Advertise policy object",
            "title": "Advertise Policy object",
            "x-displayname": "Advertise Policy",
            "x-ves-displayorder": "1,2,3",
            "x-ves-proto-message": "ves.io.schema.advertise_policy.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
