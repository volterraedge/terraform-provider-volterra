...
func (m *DNSComplianceChecksStatus) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *DNSComplianceChecksStatus) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *DNSComplianceChecksStatus) DeepCopy() *DNSComplianceChecksStatus {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *DNSComplianceChecksStatus) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *DNSComplianceChecksStatus) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return DNSComplianceChecksStatusValidator().Validate(ctx, m, opts...)
}

type ValidateDNSComplianceChecksStatus struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateDNSComplianceChecksStatus) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*DNSComplianceChecksStatus)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *DNSComplianceChecksStatus got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultDNSComplianceChecksStatusValidator = func() *ValidateDNSComplianceChecksStatus {
	v := &ValidateDNSComplianceChecksStatus{FldValidators: map[string]db.ValidatorFunc{}}

	return v
}()

func DNSComplianceChecksStatusValidator() db.Validator {
	return DefaultDNSComplianceChecksStatusValidator
}
