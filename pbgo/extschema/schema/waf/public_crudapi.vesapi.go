...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/wafs", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/wafs/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/wafs/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/wafs", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/wafs/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.waf.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.waf")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.waf.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.waf")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.waf.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.waf.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.waf.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.waf.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.waf.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.waf.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.waf.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.waf.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.waf.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.waf.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "WAF object",
        "description": "This object allows user to create a high level configuration for a WAF instance without\nhaving to go into the details of configuring on a rule by rule basis.\nFor every WAF object, Volterra WAF Rules processor automatically generates a WAF-Rules object\nwhich has all the detailed WAF configurations along with information about exactly which WAF Rules \nare included or excluded.",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{metadata.namespace}/wafs": {
            "post": {
                "summary": "Create WAF",
                ...
                "operationId": "ves.io.schema.waf.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/wafCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wafCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf.API.Create"
            },
            "x-displayname": "WAF",
            "x-ves-proto-service": "ves.io.schema.waf.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/wafs/{metadata.name}": {
            "put": {
                "summary": "Replace WAF",
                "description": "Update the configuration by replacing the existing spec with the provided one. \nFor read-then-write operations a resourceVersion mismatch will occur if the object was modified between the read and write.",
                "operationId": "ves.io.schema.waf.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/wafReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wafReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf.API.Replace"
            },
            "x-displayname": "WAF",
            "x-ves-proto-service": "ves.io.schema.waf.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/wafs": {
            "get": {
                "summary": "List",
                "description": "List the set of waf in a namespace",
                "operationId": "ves.io.schema.waf.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/wafListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of waf",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf.API.List"
            },
            "x-displayname": "WAF",
            "x-ves-proto-service": "ves.io.schema.waf.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/wafs/{name}": {
            "get": {
                "summary": "Get WAF",
                "description": "Get WAF will read the configuration from namespace metadata.namespace",
                "operationId": "ves.io.schema.waf.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/wafGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf.API.Get"
            },
            "delete": {
                "summary": "Delete",
                "description": "Delete the specified waf",
                "operationId": "ves.io.schema.waf.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wafDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf.API.Delete"
            },
            "x-displayname": "WAF",
            "x-ves-proto-service": "ves.io.schema.waf.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "schemawafCreateSpecType": {
            "type": "object",
            "description": "WAF object is used to create a WAF instance associated with a VHOST or ROUTE\nA WAF instance can be shared by multiple \"virtual_host\" or \"route\"\nA \"virtual_host\" or \"route\" shall refer to one WAF instance",
            "title": "Create WAF",
            "x-displayname": "Create WAF",
            "x-ves-proto-message": "ves.io.schema.waf.CreateSpecType",
            "properties": {
                "app_profile": {
                    "description": " Details of the apps which are going through this WAF instance.",
                    "$ref": "#/definitions/wafAppProfile",
                    "x-displayname": "App Profile"
                },
                "disabled_detection_tags": {
                    "description": " DisabledDetectionTags will allow user to selectively disable the Security Rules associated with Tags",
                    "$ref": "#/definitions/wafDisabledDetectionTags",
                    "x-displayname": "Disabled Detections"
                },
                "mode": {
                    "description": " Mode of this WAF instance , will be either in blocked or alert mode.",
                    "$ref": "#/definitions/schemaWafModeType",
                    "x-displayname": "Mode"
                }
            }
        },
        "schemawafGetSpecType": {
            "type": "object",
            "description": "Get WAF will read the configuration from namespace metadata.namespace",
            "title": "Get WAF",
            "x-displayname": "Get WAF",
            "x-ves-proto-message": "ves.io.schema.waf.GetSpecType",
            "properties": {
                "app_profile": {
                    "description": " Details of the apps which are going through this WAF instance.",
                    "$ref": "#/definitions/wafAppProfile",
        ...
        "schemawafGlobalSpecType": {
            "type": "object",
            "title": "GlobalSpecType",
            "x-displayname": "WAF Specification",
            "x-ves-proto-message": "ves.io.schema.waf.GlobalSpecType",
            "properties": {
                "app_profile": {
                    "description": " Details of the apps which are going through this WAF instance.",
                    "title": "app_profile",
        ...
        "schemawafObject": {
            ...
            "title": "WAF Object",
            "x-displayname": "WAF Object",
            "x-ves-proto-message": "ves.io.schema.waf.Object",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/schemawafSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "schemawafReplaceSpecType": {
            "type": "object",
            "description": "Update the configuration by replacing the existing spec with the provided one. \nFor read-then-write operations a resourceVersion mismatch will occur if the object was modified between the read and write.",
            "title": "Replace WAF",
            "x-displayname": "Replace WAF",
            "x-ves-proto-message": "ves.io.schema.waf.ReplaceSpecType",
            "properties": {
                "app_profile": {
                    "description": " Details of the apps which are going through this WAF instance.",
                    "$ref": "#/definitions/wafAppProfile",
        ...
        "schemawafSpecType": {
            ...
            "title": "WAF Object Specification",
            "x-displayname": "WAF Object Specification",
            "x-ves-proto-message": "ves.io.schema.waf.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemawafGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "schemawafStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "WAF Status Object",
            "x-displayname": "WAF Status Object",
            "x-ves-proto-message": "ves.io.schema.waf.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "wafAppProfile": {
            ...
            "properties": {
                "cms": {
                    "type": "array",
                    "description": " The content management system used to build the target application.",
                    "title": "Content Management System Type",
                    "items": {
                        "$ref": "#/definitions/wafContentManagementSystemType"
                    },
                    "x-displayname": "Content Management System Type"
                },
                "language": {
                    "type": "array",
                    "description": " The languages used to build the target application.",
                    "title": "Languages",
                    "items": {
                        "$ref": "#/definitions/wafLanguageType"
                    },
                    "x-displayname": "Languages"
                },
                "webserver": {
                    "type": "array",
                    "description": " The Web Server used to build the target application.",
                    "title": "Web Server Type",
                    "items": {
                        "$ref": "#/definitions/wafWebServerType"
                    },
                    "x-displayname": "Web Server Type"
                }
            }
        },
        "wafContentManagementSystemType": {
            "type": "string",
            "description": "The content management system used to build the target application.\n\nDrupal CMS\nWordpress CMS\nNextcloud CMS\nDokuwiki CMS\nCPanel CMS",
            "title": "CMS Type",
            "enum": [
            ...
            "default": "DRUPAL",
            "x-displayname": "Content Management System Type",
            "x-ves-proto-enum": "ves.io.schema.waf.ContentManagementSystemType"
        },
        "wafCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of waf",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.waf.CreateRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the WAF instance",
                    "title": "spec",
                    "$ref": "#/definitions/schemawafCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "wafCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the WAF instance",
                    "title": "spec",
                    "$ref": "#/definitions/schemawafGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
                    "description": " System generated object's metadata",
        ...
        "wafDeleteRequest": {
            ...
            "title": "DeleteRequest is used to delete a waf",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.waf.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "wafDetectionTagType": {
            ...
            "x-ves-proto-enum": "ves.io.schema.waf.DetectionTagType"
        },
        "wafDisabledDetectionTags": {
            "type": "object",
            "description": "To optimize WAF performance by having only relevant rules configured for a WAF instance, WAF can be configured to explicitly disable certain types of attacks.\nThis can be done by configuring this list of attacks types for which the user wants to disable detection.",
            "title": "Disabled Detection Tags",
            "x-displayname": "Disabled Detection Tags",
            "x-ves-proto-message": "ves.io.schema.waf.DisabledDetectionTags",
            "properties": {
                "detection_tag_type": {
                    "type": "array",
                    "description": " List of detection tags to be disabled",
                    "title": "detection_tag_type",
                    "items": {
                        "$ref": "#/definitions/wafDetectionTagType"
                    },
        ...
        "wafGetResponse": {
            ...
            "title": "GetResponse is the shape of a read waf",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.waf.GetResponse",
            "properties": {
                "create_form": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/schemawafObject",
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/schemawafStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "wafLanguageType": {
            "type": "string",
            "description": "languages used to build the target application.\n\nPHP language\nJava language",
            ...
            "x-ves-proto-enum": "ves.io.schema.waf.LanguageType"
        },
        "wafListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of waf",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.waf.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/wafListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "wafListResponseItem": {
            "type": "object",
            "description": "By default a summary of waf is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of waf",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.waf.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this waf",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this waf",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates waf is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this waf",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this waf\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
        ...
        "wafReplaceRequest": {
            ...
            "title": "ReplaceRequest is used to replace contents of a waf",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.waf.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the WAF instance",
                    "title": "spec",
                    "$ref": "#/definitions/schemawafReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "wafReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf.ReplaceResponse"
        },
        "wafWebServerType": {
            "type": "string",
            "description": "The Web Server used to build the target application.\n\nIIS Webserver",
            ...
            "default": "IIS",
            "x-displayname": "Web Server Type",
            "x-ves-proto-enum": "ves.io.schema.waf.WebServerType"
        }
    },
    "x-displayname": "WAF",
    "x-ves-proto-file": "ves.io/schema/waf/public_crudapi.proto"
}`
