...
const (
	ObjectDefTblName = "ves.io.schema.policer.Object.default"
	ObjectType       = "ves.io.schema.policer.Object"

	StatusObjectDefTblName = "ves.io.schema.policer.StatusObject.default"
	StatusObjectType       = "ves.io.schema.policer.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.policer.Object"
}
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.policer.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.policer.StatusObject"
}
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "policer.Object")
	if err != nil {
