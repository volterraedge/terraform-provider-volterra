...
func TestSingleRateTwoColorTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &SingleRateTwoColorType{}
...
func TestSingleRateTwoColorTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, false)
	size := p.Size()
...
func BenchmarkSingleRateTwoColorTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SingleRateTwoColorType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSingleRateTwoColorType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkSingleRateTwoColorTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedSingleRateTwoColorType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSingleRateTwoColorTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, true)
...
func TestSingleRateTwoColorTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, true)
...
func TestSingleRateTwoColorTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, true)
...
func TestSingleRateTwoColorTypeGoString(t *testing.T) {
...
func TestSingleRateTwoColorTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSingleRateTwoColorType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkSingleRateTwoColorTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SingleRateTwoColorType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSingleRateTwoColorType(popr, false)
	}
	b.ResetTimer()
...
func TestSingleRateTwoColorTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSingleRateTwoColorType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
