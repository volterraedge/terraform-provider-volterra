...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_observability_synthetic_monitor_v1_http_monitor.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["system_metadata"] = ves_io_schema.SystemObjectMetaTypeValidator().Validate
	v.FldValidators["spec"] = ves_io_schema_observability_synthetic_monitor_v1_http_monitor.SpecTypeValidator().Validate
	v.FldValidators["status"] = ves_io_schema_observability_synthetic_monitor_v1_http_monitor.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_observability_synthetic_monitor_v1_http_monitor.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_observability_synthetic_monitor_v1_http_monitor.DBObject)
	}
	_ = f
