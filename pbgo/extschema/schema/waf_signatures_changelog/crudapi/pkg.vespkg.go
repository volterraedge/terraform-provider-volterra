...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectCreateReq"] = ObjectCreateReqValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectCreateRsp"] = ObjectCreateRspValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectDeleteReq"] = ObjectDeleteReqValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectDeleteRsp"] = ObjectDeleteRspValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectGetReq"] = ObjectGetReqValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectGetRsp"] = ObjectGetRspValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectListReq"] = ObjectListReqValidator()
	vr["ves.io.schema.waf_signatures_changelog.crudapi.ObjectListRsp"] = ObjectListRspValidator()
...
func initializeCRUDServiceRegistry(mdr *svcfw.MDRegistry, isExternal bool) {
	...
	func() {
		...
		csr.CRUDGrpcClientRegistry["ves.io.schema.waf_signatures_changelog.Object"] = NewCRUDAPIGrpcClient
		csr.CRUDRestClientRegistry["ves.io.schema.waf_signatures_changelog.Object"] = NewCRUDAPIRestClient
		csr.CRUDInprocClientRegistry["ves.io.schema.waf_signatures_changelog.Object"] = NewCRUDAPIInprocClient
		if isExternal {
			return
		}
