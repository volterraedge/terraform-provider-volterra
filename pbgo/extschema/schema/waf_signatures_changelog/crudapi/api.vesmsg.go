...
import (
	...
	ves_io_schema_waf_signatures_changelog "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/waf_signatures_changelog"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_waf_signatures_changelog.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_waf_signatures_changelog.DBObject)
	}
	_ = f
