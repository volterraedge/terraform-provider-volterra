...
// source: ves.io/schema/waf_signatures_changelog/public_waf_signature_customapi.proto
...
func (*StagedSignaturesReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4ce05b0cfb2a73d, []int{0}
}
...
func (*StagedSignaturesRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4ce05b0cfb2a73d, []int{1}
}
...
func (*StagedSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4ce05b0cfb2a73d, []int{2}
}
...
func init() {
	proto.RegisterFile("ves.io/schema/waf_signatures_changelog/public_waf_signature_customapi.proto", fileDescriptor_f4ce05b0cfb2a73d)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/waf_signatures_changelog/public_waf_signature_customapi.proto", fileDescriptor_f4ce05b0cfb2a73d)
}

var fileDescriptor_f4ce05b0cfb2a73d = []byte{
	// 679 bytes of a gzipped FileDescriptorProto
	,
}
...
func valueToGoStringPublicWafSignatureCustomapi(v interface{}, typ string) string {
...
var _SignatureCustomApi_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "ves.io/schema/waf_signatures_changelog/public_waf_signature_customapi.proto",
}
...
func (m *StagedSignaturesReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EndTime) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.EndTime)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.StartTime) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.StartTime)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.VhName) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.VhName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Namespace) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.Namespace)))
		i--
		dAtA[i] = 0xa
	}
		...
		for iNdEx := len(m.StagedSignatures) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func (m *StagedSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Count != 0 {
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x48
	}
	if len(m.IdName) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.IdName)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.State) > 0 {
		i -= len(m.State)
		copy(dAtA[i:], m.State)
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.State)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Accuracy) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.Accuracy)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Context) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.Context)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MatchingInfo) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.MatchingInfo)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.AttackType) > 0 {
		...
		i = encodeVarintPublicWafSignatureCustomapi(dAtA, i, uint64(len(m.AttackType)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintPublicWafSignatureCustomapi(dAtA []byte, offset int, v uint64) int {
	offset -= sovPublicWafSignatureCustomapi(v)
	base := offset
	for v >= 1<<7 {
...
func (m *StagedSignaturesReq) Size() (n int) {
	...
	l = len(m.Namespace)
	if l > 0 {
		n += 1 + l + sovPublicWafSignatureCustomapi(uint64(l))
	}
	l = len(m.VhName)
	if l > 0 {
		n += 1 + l + sovPublicWafSignatureCustomapi(uint64(l))
...
func (m *StagedSignature) Size() (n int) {
	...
	if m.Count != 0 {
		n += 1 + sovPublicWafSignatureCustomapi(uint64(m.Count))
	}
	return n
}

func sovPublicWafSignatureCustomapi(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozPublicWafSignatureCustomapi(x uint64) (n int) {
	return sovPublicWafSignatureCustomapi(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringPublicWafSignatureCustomapi(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *StagedSignaturesReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowPublicWafSignatureCustomapi
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthPublicWafSignatureCustomapi
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipPublicWafSignatureCustomapi(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipPublicWafSignatureCustomapi(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowPublicWafSignatureCustomapi
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthPublicWafSignatureCustomapi
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupPublicWafSignatureCustomapi
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthPublicWafSignatureCustomapi        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowPublicWafSignatureCustomapi          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupPublicWafSignatureCustomapi = fmt.Errorf("proto: unexpected end of group")
)
