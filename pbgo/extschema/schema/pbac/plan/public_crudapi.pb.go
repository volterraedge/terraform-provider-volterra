...
// source: ves.io/schema/pbac/plan/public_crudapi.proto
...
func (GetResponseFormatCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_128bdb2a804422b6, []int{0}
}

// GetRequest is used to get different forms of a plan
//
...
// creating new instance of plan) etc. can be fetched
type GetRequest struct {
	...
	ResponseFormat GetResponseFormatCode `protobuf:"varint,3,opt,name=response_format,json=responseFormat,proto3,enum=ves.io.schema.pbac.plan.GetResponseFormatCode" json:"response_format,omitempty"`
}
...
// GetResponse is the shape of a read plan
//
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_128bdb2a804422b6, []int{1}
}
...
// ListRequest is used to get a collection of plan
//
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_128bdb2a804422b6, []int{2}
}
...
// ListResponseItem is an individual item in a collection of plan
//
// x-displayName: "List Item"
// By default a summary of plan is returned in 'List'. By setting
...
type ListResponseItem struct {
	...
	// The unique uid of this plan
	Uid string `protobuf:"bytes,3,opt,name=uid,proto3" json:"uid,omitempty"`
	// description
	//
	// x-displayName: "Description"
	// The description set for this plan
	Description string `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`
	// disabled
	//
	// x-displayName: "Disabled"
	// A value of true indicates plan is administratively disabled
	Disabled bool `protobuf:"varint,12,opt,name=disabled,proto3" json:"disabled,omitempty"`
	// labels
	//
	// x-displayName: "Labels"
	// The set of labels present on this plan
	Labels map[string]string `protobuf:"bytes,4,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// annotations
	//
	// x-displayName: "Annotations"
	// The set of annotations present on this plan
...
func (*ListResponseItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_128bdb2a804422b6, []int{3}
}
...
// ListResponse is the collection of plan
//
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_128bdb2a804422b6, []int{4}
}
...
func init() {
	proto.RegisterEnum("ves.io.schema.pbac.plan.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	golang_proto.RegisterEnum("ves.io.schema.pbac.plan.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	proto.RegisterType((*GetRequest)(nil), "ves.io.schema.pbac.plan.GetRequest")
	golang_proto.RegisterType((*GetRequest)(nil), "ves.io.schema.pbac.plan.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "ves.io.schema.pbac.plan.GetResponse")
	golang_proto.RegisterType((*GetResponse)(nil), "ves.io.schema.pbac.plan.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "ves.io.schema.pbac.plan.ListRequest")
	golang_proto.RegisterType((*ListRequest)(nil), "ves.io.schema.pbac.plan.ListRequest")
	proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.pbac.plan.ListResponseItem")
	golang_proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.pbac.plan.ListResponseItem")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.pbac.plan.ListResponseItem.AnnotationsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.pbac.plan.ListResponseItem.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.pbac.plan.ListResponseItem.LabelsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.pbac.plan.ListResponseItem.LabelsEntry")
	proto.RegisterType((*ListResponse)(nil), "ves.io.schema.pbac.plan.ListResponse")
	golang_proto.RegisterType((*ListResponse)(nil), "ves.io.schema.pbac.plan.ListResponse")
}

func init() {
	proto.RegisterFile("ves.io/schema/pbac/plan/public_crudapi.proto", fileDescriptor_128bdb2a804422b6)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/pbac/plan/public_crudapi.proto", fileDescriptor_128bdb2a804422b6)
}

var fileDescriptor_128bdb2a804422b6 = []byte{
	...
	,
}
...
func (this *ListResponseItem) GoString() string {
	...
	s := make([]string, 0, 18)
	s = append(s, "&plan.ListResponseItem{")
...
type APIClient interface {
	...
	// List
	//
	// x-displayName: "List Plan"
	// List the set of plan in a namespace
...
func (c *aPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ves.io.schema.pbac.plan.API/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.pbac.plan.API/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.pbac.plan.API/Get",
	}
...
func _API_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.pbac.plan.API/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _API_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ves.io.schema.pbac.plan.API",
	...
	Metadata: "ves.io/schema/pbac/plan/public_crudapi.proto",
}
