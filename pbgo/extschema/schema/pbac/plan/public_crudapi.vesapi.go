...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/plans/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/plans", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.pbac.plan.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.pbac.plan")
...
func (c *crudAPIInprocClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.pbac.plan.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.plan")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.pbac.plan.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.pbac.plan.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.plan.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.pbac.plan.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.plan.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.pbac.plan.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "plan object",
        "description": "\nRepresents collection of addon services that a tenant can subscribe or allowed to subscribe to.\nDuring signup, depending on the service requirements, user need to select a plan from pre-defined \nset of plans and tenant will be created with included addon services and will be allowed to subscribe\nnew addon services based on the allowed addon service list.",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{namespace}/plans": {
            "get": {
                "summary": "List",
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-plan-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.plan.API.List"
            },
            "x-displayname": "Plan",
            "x-ves-proto-service": "ves.io.schema.pbac.plan.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/plans/{name}": {
            "get": {
                "summary": "Get plan",
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/planGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-plan-API-Get"
                },
    ...
    "definitions": {
        "planGetResponse": {
            ...
            "title": "GetResponse is the shape of a read plan",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.GetResponse",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the plan",
                    "title": "spec",
                    "$ref": "#/definitions/planGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "planGetSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.pbac.plan.GetSpecType",
            "properties": {
                "allowed_services": {
                    "type": "array",
                    "description": " List of pre-defined addon services that can be subscribed part this plan.",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "included_services": {
                    "type": "array",
                    "description": " List of pre-defined addon services that are by default included part this plan.\n tenant will be auto subscribed to all the addon services in this list.",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "planGlobalSpecType": {
            "type": "object",
            "description": "Shape of plan in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.GlobalSpecType",
            "properties": {
                "allowed_services": {
                    "type": "array",
                    "description": " List of pre-defined addon services that can be subscribed part this plan.",
                    "title": "allowed_services",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                    "x-displayname": "Allowed Addon Services"
                ...
                "subscription_policy": {
                    "type": "array",
                    "description": " Reference of subscription policy for this plan. This policy will include rules for allowed addon service subscription\n There will be one subscription policy per plan",
        ...
        "planListResponse": {
            ...
            "title": "ListResponse is the collection of plan",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/planListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "planListResponseItem": {
            "type": "object",
            "description": "By default a summary of plan is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of plan",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "description": {
                    "type": "string",
                    "description": " The description set for this plan",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates plan is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
        ...
        "planObject": {
            ...
            "title": "Plan Object",
            "x-displayname": "Plan",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "planSpecType": {
            "type": "object",
            "description": "Shape of the plan specification",
            "title": "Specification for Plan",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/planGlobalSpecType",
        ...
        "planStatusObject": {
            ...
            "title": "Status for Plan",
            "x-displayname": "Plan",
            "x-ves-proto-message": "ves.io.schema.pbac.plan.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "Plan",
    "x-ves-proto-file": "ves.io/schema/pbac/plan/public_crudapi.proto"
}`
