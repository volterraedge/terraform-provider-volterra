...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/pbac/navigation_tile"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.pbac.navigation_tile.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.pbac.navigation_tile.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.navigation_tile.crudapi")
	}
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.pbac.navigation_tile.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.navigation_tile.crudapi")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.pbac.navigation_tile.crudapi")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.pbac.navigation_tile.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.pbac.navigation_tile.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.navigation_tile.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.navigation_tile.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.navigation_tile.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/pbac/navigation_tile/crudapi/api.proto",
    ...
    "tags": null,
    "paths": {
        "/ves.io.schema.pbac.navigation_tile/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "navigation_tile",
            "x-ves-object-type": "ves.io.schema.pbac.navigation_tile.Object",
            "x-ves-proto-service": "ves.io.schema.pbac.navigation_tile.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.pbac.navigation_tile/Objects": {
            "get": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "navigation_tile",
            "x-ves-object-type": "ves.io.schema.pbac.navigation_tile.Object",
        ...
        "/ves.io.schema.pbac.navigation_tile/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-crudapi-API-ListStream"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "navigation_tile",
            "x-ves-object-type": "ves.io.schema.pbac.navigation_tile.Object",
        ...
        "/ves.io.schema.pbac.navigation_tile/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.navigation_tile/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.navigation_tile/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.navigation_tile/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.pbac.navigation_tile.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.pbac.navigation_tile.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/navigation_tileSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/navigation_tileStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
        ...
        "navigation_tileGlobalSpecType": {
            "type": "object",
            "description": "Shape of navigation_tile in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.GlobalSpecType",
            "properties": {
                "addon_services": {
                    "type": "array",
                    "description": " List of addon services linked to this navigation tile",
                ...
                "default_addon_service": {
                    "type": "string",
                    "description": " Default addon service landing page. Used as primary when multiple addon services are present.\n value should match the name of the addon service config object.",
                    "title": "default_addon_service",
                ...
                "roles": {
                    "type": "array",
                    "description": " List of pre-defined roles associated to this tile.",
                    "title": "roles",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "navigation_tileSpecType": {
            "type": "object",
            "description": "Shape of the navigation_tile specification",
            "title": "Specification for Navigation Tile",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/navigation_tileGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "navigation_tileStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Navigation Tile",
            "x-displayname": "Navigation Tile",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-ves-proto-file": "ves.io/schema/pbac/navigation_tile/crudapi/api.proto"
}`
