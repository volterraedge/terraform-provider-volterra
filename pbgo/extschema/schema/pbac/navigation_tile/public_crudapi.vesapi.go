...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/navigation_tiles/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/navigation_tiles", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.pbac.navigation_tile.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.pbac.navigation_tile")
...
func (c *crudAPIInprocClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.pbac.navigation_tile.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.navigation_tile")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.pbac.navigation_tile.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.pbac.navigation_tile.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.pbac.navigation_tile.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.navigation_tile.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.pbac.navigation_tile.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{namespace}/navigation_tiles": {
            "get": {
                "summary": "List",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/navigation_tileListResponse"
                        }
                    },
                    "401": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.navigation_tile.API.List"
            },
            "x-displayname": "Navigation Tile",
            "x-ves-proto-service": "ves.io.schema.pbac.navigation_tile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/navigation_tiles/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/navigation_tileGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-navigation_tile-API-Get"
                },
    ...
    "definitions": {
        "navigation_tileGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read navigation_tile",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.GetResponse",
            "properties": {
                "metadata": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/navigation_tileObject",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the navigation_tile",
                    "title": "spec",
                    "$ref": "#/definitions/navigation_tileGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "navigation_tileGetResponseFormatCode": {
            "type": "string",
        ...
        "navigation_tileGetSpecType": {
            "type": "object",
            "description": "Get navigation_tile reads a given object from storage backend for metadata.namespace.",
            "title": "Get navigation tile",
            "x-displayname": "Get Navigation Tile",
            "x-ves-displayorder": "1,2,3",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.GetSpecType",
            "properties": {
                "addon_services": {
                    "type": "array",
        ...
        "navigation_tileListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of navigation_tile",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/navigation_tileListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "navigation_tileListResponseItem": {
            "type": "object",
            "description": "By default a summary of navigation_tile is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of navigation_tile",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates navigation_tile is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this navigation_tile\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this navigation_tile\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "navigation_tileObject": {
            "type": "object",
            "description": "Navigation Tile object",
            "title": "Navigation Tile Object",
            "x-displayname": "Navigation Tile",
            "x-ves-proto-message": "ves.io.schema.pbac.navigation_tile.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
    ...
    "x-displayname": "Navigation Tile",
    "x-ves-proto-file": "ves.io/schema/pbac/navigation_tile/public_crudapi.proto"
}`
