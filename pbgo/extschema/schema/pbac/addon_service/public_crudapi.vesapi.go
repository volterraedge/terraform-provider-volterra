...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.pbac.addon_service.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.addon_service")
	}
    ...
    "paths": {
        "/public/namespaces/{namespace}/addon_services": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-addon_service-API-List"
                },
        ...
        "/public/namespaces/{namespace}/addon_services/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-pbac-addon_service-API-Get"
                },
    ...
    "definitions": {
        "addon_serviceGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/addon_serviceObject",
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/addon_serviceGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "addon_serviceObject": {
            "type": "object",
            "description": "Addon Service object",
            "title": "Addon Service Object",
            "x-displayname": "Addon Service",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
