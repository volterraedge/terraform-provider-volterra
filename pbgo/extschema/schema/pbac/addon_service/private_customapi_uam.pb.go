...
type CanSubscribeReq struct {
	...
	// x-example: "tenant-x893asj"
	// Name of the tenant obj or tenant ID this addon_service belongs to
...
func (m *CanSubscribeReq) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
// Request to set addon service subscription state for a tenant.
type SetSubscriptionReq struct {
	...
	// use action to transition state of an addon service.
	// actions can be one of type AddonServiceSubscribeAction for ex: AS_UNSUBSCRIBE to unsubscribe a subscription.
	Action schema.AddonServiceSubscribeAction `protobuf:"varint,3,opt,name=action,proto3,enum=ves.io.schema.AddonServiceSubscribeAction" json:"action,omitempty"`
}
...
func (m *SetSubscriptionReq) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
var fileDescriptor_118ce8901bedad9e = []byte{
	...
	,
}
...
type CustomPrivateAPIClient interface {
	...
	// Evaluate whether addon service is allowed to subscribe or not based on current plan of the tenant.
	...
	// SetSubscription
	//
	// x-displayName: "Set Subscription"
	// Set subscription state for an addon service of a tenant.
	...
	// SetSubscriptionRestricted
	//
	// x-displayName: "Set Subscription Restricted"
	// Set subscription state for an addon service of a tenant.
	// This API is restricted and can only be invoked by respective services or via SIA
	// request context should have tenant set to ves-io and tenant in payload should be set to the
	// requesting addon service's tenant.
	SetSubscriptionRestricted(ctx context.Context, in *SetSubscriptionReq, opts ...grpc.CallOption) (*SetSubscriptionResp, error)
}
...
func (c *customPrivateAPIClient) SetSubscriptionRestricted(ctx context.Context, in *SetSubscriptionReq, opts ...grpc.CallOption) (*SetSubscriptionResp, error) {
	out := new(SetSubscriptionResp)
	err := c.cc.Invoke(ctx, "/ves.io.schema.pbac.addon_service.CustomPrivateAPI/SetSubscriptionRestricted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomPrivateAPIServer interface {
	...
	// request context should have tenant set to ves-io and tenant in payload should be set to the
	// requesting addon service's tenant.
	SetSubscriptionRestricted(context.Context, *SetSubscriptionReq) (*SetSubscriptionResp, error)
}
...
func (*UnimplementedCustomPrivateAPIServer) SetSubscriptionRestricted(ctx context.Context, req *SetSubscriptionReq) (*SetSubscriptionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSubscriptionRestricted not implemented")
}
...
func _CustomPrivateAPI_SetSubscriptionRestricted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetSubscriptionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomPrivateAPIServer).SetSubscriptionRestricted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.pbac.addon_service.CustomPrivateAPI/SetSubscriptionRestricted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomPrivateAPIServer).SetSubscriptionRestricted(ctx, req.(*SetSubscriptionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CustomPrivateAPI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetSubscriptionRestricted",
			Handler:    _CustomPrivateAPI_SetSubscriptionRestricted_Handler,
		},
	},
...
func (m *CanSubscribeReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tenant) > 0 {
		...
		i = encodeVarintPrivateCustomapiUam(dAtA, i, uint64(len(m.Tenant)))
		i--
		dAtA[i] = 0x12
	}
