...
import (
	...
	ves_io_schema_api_sec_code_base_integration "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/api_sec/code_base_integration"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_api_sec_code_base_integration.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_api_sec_code_base_integration.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_api_sec_code_base_integration.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_api_sec_code_base_integration.DBObject)
	}
	_ = f
