...
import (
	...
	ves_io_schema_api_sec_api_crawler "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/api_sec/api_crawler"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_api_sec_api_crawler.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_api_sec_api_crawler.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_api_sec_api_crawler.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_api_sec_api_crawler.DBObject)
	}
	_ = f
