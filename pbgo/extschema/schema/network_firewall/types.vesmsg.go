...
func (m *CreateSpecType) GetNetworkPolicyChoiceDRefInfo() ([]db.DRefInfo, error) {
	...
	case *CreateSpecType_EnhancedFirewallPolicies:
...
func (v *ValidateCreateSpecType) NetworkPolicyChoiceEnhancedFirewallPoliciesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	return ActiveEnhancedFirewallPoliciesTypeValidator().Validate, nil
}
...
func (v *ValidateCreateSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *CreateSpecType_EnhancedFirewallPolicies:
		if fv, exists := v.FldValidators["network_policy_choice.enhanced_firewall_policies"]; exists {
			val := m.GetNetworkPolicyChoice().(*CreateSpecType_EnhancedFirewallPolicies).EnhancedFirewallPolicies
			vOpts := append(opts,
				db.WithValidateField("network_policy_choice"),
				db.WithValidateField("enhanced_firewall_policies"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
...
var DefaultCreateSpecTypeValidator = func() *ValidateCreateSpecType {
	...
	vrhNetworkPolicyChoiceEnhancedFirewallPolicies := v.NetworkPolicyChoiceEnhancedFirewallPoliciesValidationRuleHandler
	rulesNetworkPolicyChoiceEnhancedFirewallPolicies := map[string]string{
		"ves.io.schema.rules.repeated.max_items": "128",
	}
	vFnMap["network_policy_choice.enhanced_firewall_policies"], err = vrhNetworkPolicyChoiceEnhancedFirewallPolicies(rulesNetworkPolicyChoiceEnhancedFirewallPolicies)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for oneof field CreateSpecType.network_policy_choice_enhanced_firewall_policies: %s", err)
		panic(errMsg)
	}

	v.FldValidators["network_policy_choice.network_policy_set"] = vFnMap["network_policy_choice.network_policy_set"]
	v.FldValidators["network_policy_choice.enhanced_firewall_policies"] = vFnMap["network_policy_choice.enhanced_firewall_policies"]
...
func (m *GetSpecType) GetNetworkPolicyChoiceDRefInfo() ([]db.DRefInfo, error) {
	...
	case *GetSpecType_EnhancedFirewallPolicies:
...
func (v *ValidateGetSpecType) NetworkPolicyChoiceEnhancedFirewallPoliciesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	return ActiveEnhancedFirewallPoliciesTypeValidator().Validate, nil
}
...
func (v *ValidateGetSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *GetSpecType_EnhancedFirewallPolicies:
		if fv, exists := v.FldValidators["network_policy_choice.enhanced_firewall_policies"]; exists {
			val := m.GetNetworkPolicyChoice().(*GetSpecType_EnhancedFirewallPolicies).EnhancedFirewallPolicies
			vOpts := append(opts,
				db.WithValidateField("network_policy_choice"),
				db.WithValidateField("enhanced_firewall_policies"),
			)
...
var DefaultGetSpecTypeValidator = func() *ValidateGetSpecType {
	...
	vFnMap["network_policy_choice.enhanced_firewall_policies"], err = vrhNetworkPolicyChoiceEnhancedFirewallPolicies(rulesNetworkPolicyChoiceEnhancedFirewallPolicies)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for oneof field GetSpecType.network_policy_choice_enhanced_firewall_policies: %s", err)
		panic(errMsg)
	}
...
func (m *ReplaceSpecType) GetNetworkPolicyChoiceDRefInfo() ([]db.DRefInfo, error) {
	...
	case *ReplaceSpecType_EnhancedFirewallPolicies:
...
func (v *ValidateReplaceSpecType) NetworkPolicyChoiceEnhancedFirewallPoliciesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	return ActiveEnhancedFirewallPoliciesTypeValidator().Validate, nil
}
...
func (v *ValidateReplaceSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *ReplaceSpecType_EnhancedFirewallPolicies:
		if fv, exists := v.FldValidators["network_policy_choice.enhanced_firewall_policies"]; exists {
			val := m.GetNetworkPolicyChoice().(*ReplaceSpecType_EnhancedFirewallPolicies).EnhancedFirewallPolicies
			vOpts := append(opts,
				db.WithValidateField("network_policy_choice"),
				db.WithValidateField("enhanced_firewall_policies"),
			)
...
var DefaultReplaceSpecTypeValidator = func() *ValidateReplaceSpecType {
	...
	vFnMap["network_policy_choice.enhanced_firewall_policies"], err = vrhNetworkPolicyChoiceEnhancedFirewallPolicies(rulesNetworkPolicyChoiceEnhancedFirewallPolicies)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for oneof field ReplaceSpecType.network_policy_choice_enhanced_firewall_policies: %s", err)
		panic(errMsg)
	}
