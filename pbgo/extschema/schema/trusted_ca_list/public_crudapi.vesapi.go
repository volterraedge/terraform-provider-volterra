...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/trusted_ca_lists", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/trusted_ca_lists/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/trusted_ca_lists/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/trusted_ca_lists", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/trusted_ca_lists/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.trusted_ca_list.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.trusted_ca_list")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.trusted_ca_list.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.trusted_ca_list.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.trusted_ca_list.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.trusted_ca_list.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.trusted_ca_list.API.Delete", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.trusted_ca_list.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.trusted_ca_list.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.trusted_ca_list.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.trusted_ca_list.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.trusted_ca_list.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.trusted_ca_list.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.trusted_ca_list.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.trusted_ca_list.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.trusted_ca_list.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.trusted_ca_list.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "A Trusted CA List represents list of trusted root CAs",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/trusted_ca_lists": {
            "post": {
                "summary": "Create Trusted CA List",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-trusted_ca_list-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.API.Create"
            },
            "x-displayname": "Trusted CA List",
            "x-ves-proto-service": "ves.io.schema.trusted_ca_list.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/trusted_ca_lists/{metadata.name}": {
            "put": {
                "summary": "Replace Trusted CA List",
                "description": "Shape of the Trusted CA List specification",
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-trusted_ca_list-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/trusted_ca_lists": {
            "get": {
                "summary": "List Trusted CA List",
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-trusted_ca_list-api-list"
                },
        ...
        "/public/namespaces/{namespace}/trusted_ca_lists/{name}": {
            "get": {
                "summary": "Get Trusted CA List",
                "description": "Shape of the Trusted CA List specification",
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-trusted_ca_list-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.API.Get"
            },
            "delete": {
                "summary": "Delete Trusted CA List",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trusted_ca_listDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-trusted_ca_list-api-delete"
                },
    ...
    "definitions": {
        ...
        "trusted_ca_listCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of trusted_ca_list",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Trusted CA List",
                    "title": "spec",
                    "$ref": "#/definitions/trusted_ca_listCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "trusted_ca_listCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Trusted CA List",
                    "title": "spec",
                    "$ref": "#/definitions/trusted_ca_listGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "trusted_ca_listCreateSpecType": {
            "type": "object",
            "description": "Shape of the Trusted CA List specification",
            "title": "Create Trusted CA List",
            "x-displayname": "Create Trusted CA List",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.CreateSpecType",
            "properties": {
                "trusted_ca_url": {
                    "type": "string",
        ...
        "trusted_ca_listDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a trusted_ca_list",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "trusted_ca_listGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read trusted_ca_list",
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/trusted_ca_listObject",
        ...
        "trusted_ca_listGetResponseFormatCode": {
            "type": "string",
        ...
        "trusted_ca_listGetSpecType": {
            "type": "object",
            "description": "Shape of the Trusted CA List specification",
            "title": "Get Trusted CA List",
            "x-displayname": "Get Trusted CA List",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.GetSpecType",
            "properties": {
                "infos": {
                    "type": "array",
        ...
        "trusted_ca_listGlobalSpecType": {
            "type": "object",
            "description": "Trusted CA List specification",
        ...
        "trusted_ca_listListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of trusted_ca_list",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/trusted_ca_listListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "trusted_ca_listListResponseItem": {
            "type": "object",
            "description": "By default a summary of trusted_ca_list is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of trusted_ca_list",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates trusted_ca_list is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this trusted_ca_list\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this trusted_ca_list\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "trusted_ca_listObject": {
            "type": "object",
            "description": "Trusted CA List object",
            "title": "Trusted CA List",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "trusted_ca_listReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a trusted_ca_list",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Trusted CA List",
                    "title": "spec",
                    "$ref": "#/definitions/trusted_ca_listReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "trusted_ca_listReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.ReplaceResponse"
        },
        "trusted_ca_listReplaceSpecType": {
            "type": "object",
            "description": "Shape of the Trusted CA List specification",
            "title": "Replace Trusted CA List",
            "x-displayname": "Replace Trusted CA List",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.ReplaceSpecType",
            "properties": {
                "trusted_ca_url": {
                    "type": "string",
                    "description": " Trusted CA certificates for validating certificates\n\nExample: - \"cert\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 512000\n  ves.io.schema.rules.string.truststore_url: true\n",
    ...
    "x-displayname": "Trusted CA List",
    "x-ves-proto-file": "ves.io/schema/trusted_ca_list/public_crudapi.proto"
}`
