...
import (
	...
	ves_io_schema_trusted_ca_list "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/trusted_ca_list"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_trusted_ca_list.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_trusted_ca_list.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_trusted_ca_list.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_trusted_ca_list.DBObject)
	}
	_ = f
