...
import (
	...
	ves_io_schema_nginx_one_nginx_server "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/nginx/one/nginx_server"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_nginx_one_nginx_server.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_nginx_one_nginx_server.DBObject)
	}
	_ = f
