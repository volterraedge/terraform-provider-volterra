...
func (c *CustomAPIGrpcClient) doRPCSubscribe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.nginx.one.subscription.SubscribeRequest", yamlReq)
	}
...
func (c *CustomAPIGrpcClient) doRPCUnsubscribe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.nginx.one.subscription.UnsubscribeRequest", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCSubscribe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &SubscribeRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.nginx.one.subscription.SubscribeRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.nginx.one.subscription.SubscribeResponse", body)
...
func (c *CustomAPIRestClient) doRPCUnsubscribe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &UnsubscribeRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.nginx.one.subscription.UnsubscribeRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.nginx.one.subscription.UnsubscribeResponse", body)
...
func (s *customAPISrv) Subscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.nginx.one.subscription.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.nginx.one.subscription.SubscribeRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.nginx.one.subscription.CustomAPI.Subscribe"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.nginx.one.subscription.SubscribeResponse", rsp)...)
...
func (s *customAPISrv) Unsubscribe(ctx context.Context, in *UnsubscribeRequest) (*UnsubscribeResponse, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.nginx.one.subscription.UnsubscribeRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.nginx.one.subscription.CustomAPI.Unsubscribe"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.nginx.one.subscription.UnsubscribeResponse", rsp)...)
...
var CustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "NGINX One Subscription API",
        "description": "Use this API to subscribe to NGINX One",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/system/n1/subscribe": {
            "post": {
            ...
            "x-ves-proto-service": "ves.io.schema.nginx.one.subscription.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/system/n1/unsubscribe": {
            "post": {
    ...
    "definitions": {
        "subscriptionSubscribeRequest": {
            "type": "object",
            "description": "Request to subscribe to NGINX One",
            "title": "SubscribeRequest",
            "x-displayname": "Subscribe Request",
            "x-ves-proto-message": "ves.io.schema.nginx.one.subscription.SubscribeRequest"
        },
        "subscriptionSubscribeResponse": {
            "type": "object",
            "description": "Response of subscribe to NGINX One",
            "title": "SubscribeResponse",
            "x-displayname": "Subscribe Response",
            "x-ves-proto-message": "ves.io.schema.nginx.one.subscription.SubscribeResponse"
        },
        "subscriptionUnsubscribeRequest": {
            "type": "object",
            "description": "Request to unsubscribe to NGINX One",
            "title": "UnsubscribeRequest",
            "x-displayname": "Unsubscribe Request",
            "x-ves-proto-message": "ves.io.schema.nginx.one.subscription.UnsubscribeRequest"
        },
        "subscriptionUnsubscribeResponse": {
            "type": "object",
            "description": "Response of unsubscribe to NGINX One",
            "title": "UnsubscribeResponse",
            "x-displayname": "Unsubscribe Response",
            "x-ves-proto-message": "ves.io.schema.nginx.one.subscription.UnsubscribeResponse"
        }
    },
    "x-displayname": "NGINX One Subscription API",
    "x-ves-proto-file": "ves.io/schema/nginx/one/subscription/public_customapi.proto"
}`
