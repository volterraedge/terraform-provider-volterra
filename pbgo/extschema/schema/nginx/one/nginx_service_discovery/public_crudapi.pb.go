...
// source: ves.io/schema/nginx/one/nginx_service_discovery/public_crudapi.proto
...
func (GetResponseFormatCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{0}
}

// CreateRequest is used to create an instance of nginx_service_discovery
//
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{1}
}
...
// ReplaceRequest is used to replace contents of a nginx_service_discovery
//
...
func (*ReplaceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{2}
}
...
func (*ReplaceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{3}
}
...
// GetRequest is used to get different forms of a nginx_service_discovery
//
...
// creating new instance of nginx_service_discovery) etc. can be fetched
type GetRequest struct {
	...
	ResponseFormat GetResponseFormatCode `protobuf:"varint,3,opt,name=response_format,json=responseFormat,proto3,enum=ves.io.schema.nginx.one.nginx_service_discovery.GetResponseFormatCode" json:"response_format,omitempty"`
}

func (m *GetRequest) Reset()      { *m = GetRequest{} }
func (*GetRequest) ProtoMessage() {}
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{4}
}
...
// GetResponse is the shape of a read nginx_service_discovery
//
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{5}
}
...
// ListRequest is used to get a collection of nginx_service_discovery
//
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{6}
}
...
// ListResponseItem is an individual item in a collection of nginx_service_discovery
//
// x-displayName: "List Item"
// By default a summary of nginx_service_discovery is returned in 'List'. By setting
...
type ListResponseItem struct {
	...
	// x-displayName: "Name"
	// x-example: "name"
	// The name of this nginx_service_discovery
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// uid
	//
	// x-displayName: "UID"
	// x-example: "d27938ba-967e-40a7-9709-57b8627f9f75"
	// The unique uid of this nginx_service_discovery
	Uid string `protobuf:"bytes,3,opt,name=uid,proto3" json:"uid,omitempty"`
	// description
	//
	// x-displayName: "Description"
	// The description set for this nginx_service_discovery
	Description string `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`
	// disabled
	//
	// x-displayName: "Disabled"
	// A value of true indicates nginx_service_discovery is administratively disabled
	Disabled bool `protobuf:"varint,12,opt,name=disabled,proto3" json:"disabled,omitempty"`
	// labels
	//
	// x-displayName: "Labels"
	// The set of labels present on this nginx_service_discovery
	Labels map[string]string `protobuf:"bytes,4,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// annotations
	//
	// x-displayName: "Annotations"
	// The set of annotations present on this nginx_service_discovery
...
func (*ListResponseItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{7}
}
...
// ListResponse is the collection of nginx_service_discovery
//
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{8}
}
...
// DeleteRequest is used to delete a nginx_service_discovery
//
...
func (*DeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6218f1ce3de95f8f, []int{9}
}
...
func init() {
	proto.RegisterEnum("ves.io.schema.nginx.one.nginx_service_discovery.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	golang_proto.RegisterEnum("ves.io.schema.nginx.one.nginx_service_discovery.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	proto.RegisterType((*CreateRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.CreateRequest")
	golang_proto.RegisterType((*CreateRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.CreateResponse")
	golang_proto.RegisterType((*CreateResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.CreateResponse")
	proto.RegisterType((*ReplaceRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceRequest")
	golang_proto.RegisterType((*ReplaceRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceRequest")
	proto.RegisterType((*ReplaceResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceResponse")
	golang_proto.RegisterType((*ReplaceResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceResponse")
	proto.RegisterType((*GetRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.GetRequest")
	golang_proto.RegisterType((*GetRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.GetResponse")
	golang_proto.RegisterType((*GetResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListRequest")
	golang_proto.RegisterType((*ListRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListRequest")
	proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem")
	golang_proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem.AnnotationsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem.LabelsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem.LabelsEntry")
	proto.RegisterType((*ListResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponse")
	golang_proto.RegisterType((*ListResponse)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.ListResponse")
	proto.RegisterType((*DeleteRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.DeleteRequest")
	golang_proto.RegisterType((*DeleteRequest)(nil), "ves.io.schema.nginx.one.nginx_service_discovery.DeleteRequest")
}

func init() {
	proto.RegisterFile("ves.io/schema/nginx/one/nginx_service_discovery/public_crudapi.proto", fileDescriptor_6218f1ce3de95f8f)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/nginx/one/nginx_service_discovery/public_crudapi.proto", fileDescriptor_6218f1ce3de95f8f)
}

<<<<<<< HEAD:pbgo/extschema/schema/nginx/one/nginx_service_discovery/public_crudapi.pb.go
var fileDescriptor_6218f1ce3de95f8f = []byte{
	...
	,
=======
var fileDescriptor_013a3b31830526f4 = []byte{
	// 1635 bytes of a gzipped FileDescriptorProto
	,
>>>>>>> main:pbgo/extschema/schema/infraprotect_firewall_rule/public_crudapi.pb.go
}
...
func (this *CreateRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&nginx_service_discovery.CreateRequest{")
...
func (this *CreateResponse) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&nginx_service_discovery.CreateResponse{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
...
func (this *ReplaceRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&nginx_service_discovery.ReplaceRequest{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
	if this.Spec != nil {
...
func (this *ReplaceResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&nginx_service_discovery.ReplaceResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&nginx_service_discovery.GetRequest{")
...
func (this *GetResponse) GoString() string {
	...
	s := make([]string, 0, 14)
	s = append(s, "&nginx_service_discovery.GetResponse{")
...
func (this *ListRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&nginx_service_discovery.ListRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
...
func (this *ListResponseItem) GoString() string {
	...
	s := make([]string, 0, 17)
	s = append(s, "&nginx_service_discovery.ListResponseItem{")
...
func (this *ListResponse) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&nginx_service_discovery.ListResponse{")
	if this.Items != nil {
...
func (this *DeleteRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&nginx_service_discovery.DeleteRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
...
type APIClient interface {
	...
	// List
	//
	// x-displayName: "List NGINX Service Discovery"
	...
	// Delete
	//
	// x-displayName: "Delete NGINX Service Discovery"
...
func (c *aPIClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_service_discovery.API/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_service_discovery.API/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_service_discovery.API/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Replace(ctx context.Context, in *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_service_discovery.API/Replace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_service_discovery.API/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_service_discovery.API/Create",
	}
...
func _API_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_service_discovery.API/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_service_discovery.API/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Replace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_service_discovery.API/Replace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_service_discovery.API/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _API_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ves.io.schema.nginx.one.nginx_service_discovery.API",
	...
	Metadata: "ves.io/schema/nginx/one/nginx_service_discovery/public_crudapi.proto",
}
