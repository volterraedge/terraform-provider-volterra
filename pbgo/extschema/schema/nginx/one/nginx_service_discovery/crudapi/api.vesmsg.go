...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_nginx_one_nginx_service_discovery.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_nginx_one_nginx_service_discovery.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_nginx_one_nginx_service_discovery.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_nginx_one_nginx_service_discovery.DBObject)
	}
	_ = f
