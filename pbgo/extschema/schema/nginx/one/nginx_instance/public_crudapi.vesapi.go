...
const (
	...
	CreateRequestFQN = "ves.io.schema.nginx.one.nginx_instance.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.nginx.one.nginx_instance.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.nginx.one.nginx_instance.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.nginx.one.nginx_instance.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.nginx.one.nginx_instance.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.nginx.one.nginx_instance.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.nginx.one.nginx_instance.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.nginx.one.nginx_instance.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.nginx.one.nginx_instance.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.nginx.one.nginx_instance.DeleteResponse"
)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_instances/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_instances", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.nginx.one.nginx_instance.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.nginx.one.nginx_instance")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_instance.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_instance.API.List")
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_instance.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.nginx.one.nginx_instance.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_instance.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.nginx.one.nginx_instance.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "NGINX One Instance Object configuration",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/nginx_instances": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/nginx_instanceListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.nginx.one.nginx_instance.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/nginx_instances/{name}": {
            "get": {
                "summary": "Get Request",
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nginx_instanceGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        ...
        "nginx_instanceGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read nginx_instance",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_instance.GetResponse",
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the NGINX Instance",
                    "title": "spec",
                    "$ref": "#/definitions/nginx_instanceGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "nginx_instanceGetResponseFormatCode": {
            "type": "string",
        ...
        "nginx_instanceGetSpecType": {
            "type": "object",
            "description": "Get NGINX instance configuration",
            "title": "Get NGINX instance configuration",
        ...
        "nginx_instanceListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of nginx_instance",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_instance.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/nginx_instanceListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "nginx_instanceListResponseItem": {
            "type": "object",
            "description": "By default a summary of nginx_instance is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of nginx_instance",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_instance.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates nginx_instance is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this nginx_instance\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this nginx_instance\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
    ...
    "x-displayname": "NGINX One Instance Object configuration",
    "x-ves-proto-file": "ves.io/schema/nginx/one/nginx_instance/public_crudapi.proto"
}`
