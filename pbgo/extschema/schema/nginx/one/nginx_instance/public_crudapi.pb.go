...
// source: ves.io/schema/nginx/one/nginx_instance/public_crudapi.proto
...
func (GetResponseFormatCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f62325acd4e9a827, []int{0}
}

// GetRequest is used to get different forms of a nginx_instance
//
...
// creating new instance of nginx_instance) etc. can be fetched
type GetRequest struct {
	...
	ResponseFormat GetResponseFormatCode `protobuf:"varint,3,opt,name=response_format,json=responseFormat,proto3,enum=ves.io.schema.nginx.one.nginx_instance.GetResponseFormatCode" json:"response_format,omitempty"`
}
...
// GetResponse is the shape of a read nginx_instance
//
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f62325acd4e9a827, []int{1}
}
...
// ListRequest is used to get a collection of nginx_instance
//
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f62325acd4e9a827, []int{2}
}
...
// ListResponseItem is an individual item in a collection of nginx_instance
//
...
type ListResponseItem struct {
	...
	// x-displayName: "Name"
	// x-example: "name"
	// The name of this nginx_instance
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// uid
	//
	// x-displayName: "UID"
	// x-example: "d27938ba-967e-40a7-9709-57b8627f9f75"
	// The unique uid of this nginx_instance
	Uid string `protobuf:"bytes,3,opt,name=uid,proto3" json:"uid,omitempty"`
	// description
	//
	// x-displayName: "Description"
	// The description set for this nginx_instance
	Description string `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`
	// disabled
	//
	// x-displayName: "Disabled"
	// A value of true indicates nginx_instance is administratively disabled
	Disabled bool `protobuf:"varint,12,opt,name=disabled,proto3" json:"disabled,omitempty"`
	// labels
	//
	// x-displayName: "Labels"
	// The set of labels present on this nginx_instance
	Labels map[string]string `protobuf:"bytes,4,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// annotations
	//
	// x-displayName: "Annotations"
	// The set of annotations present on this nginx_instance
...
func (*ListResponseItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_f62325acd4e9a827, []int{3}
}
...
// ListResponse is the collection of nginx_instance
//
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f62325acd4e9a827, []int{4}
}
...
func init() {
	proto.RegisterEnum("ves.io.schema.nginx.one.nginx_instance.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	golang_proto.RegisterEnum("ves.io.schema.nginx.one.nginx_instance.GetResponseFormatCode", GetResponseFormatCode_name, GetResponseFormatCode_value)
	proto.RegisterType((*GetRequest)(nil), "ves.io.schema.nginx.one.nginx_instance.GetRequest")
	golang_proto.RegisterType((*GetRequest)(nil), "ves.io.schema.nginx.one.nginx_instance.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "ves.io.schema.nginx.one.nginx_instance.GetResponse")
	golang_proto.RegisterType((*GetResponse)(nil), "ves.io.schema.nginx.one.nginx_instance.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "ves.io.schema.nginx.one.nginx_instance.ListRequest")
	golang_proto.RegisterType((*ListRequest)(nil), "ves.io.schema.nginx.one.nginx_instance.ListRequest")
	proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem")
	golang_proto.RegisterType((*ListResponseItem)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem.AnnotationsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem.LabelsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponseItem.LabelsEntry")
	proto.RegisterType((*ListResponse)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponse")
	golang_proto.RegisterType((*ListResponse)(nil), "ves.io.schema.nginx.one.nginx_instance.ListResponse")
}

func init() {
	proto.RegisterFile("ves.io/schema/nginx/one/nginx_instance/public_crudapi.proto", fileDescriptor_f62325acd4e9a827)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/nginx/one/nginx_instance/public_crudapi.proto", fileDescriptor_f62325acd4e9a827)
}

var fileDescriptor_f62325acd4e9a827 = []byte{
	...
	,
}
...
func (this *GetRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&nginx_instance.GetRequest{")
...
func (this *GetResponse) GoString() string {
	...
	s := make([]string, 0, 11)
	s = append(s, "&nginx_instance.GetResponse{")
...
func (this *ListRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&nginx_instance.ListRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
...
func (this *ListResponseItem) GoString() string {
	...
	s := make([]string, 0, 16)
	s = append(s, "&nginx_instance.ListResponseItem{")
...
func (this *ListResponse) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&nginx_instance.ListResponse{")
	if this.Items != nil {
...
type APIClient interface {
	...
	// List
	//
	// x-displayName: "List NGINX One Instance Object configuration"
...
func (c *aPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_instance.API/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.nginx.one.nginx_instance.API/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_instance.API/Get",
	}
...
func _API_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.nginx.one.nginx_instance.API/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _API_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ves.io.schema.nginx.one.nginx_instance.API",
	...
	Metadata: "ves.io/schema/nginx/one/nginx_instance/public_crudapi.proto",
}
