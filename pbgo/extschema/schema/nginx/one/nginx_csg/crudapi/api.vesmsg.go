...
import (
	...
	ves_io_schema_nginx_one_nginx_csg "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/nginx/one/nginx_csg"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_nginx_one_nginx_csg.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_nginx_one_nginx_csg.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_nginx_one_nginx_csg.DBObject)
	}
	_ = f
