...
const (
	ObjectDefTblName = "ves.io.schema.nginx.one.nginx_csg.Object.default"
	ObjectType       = "ves.io.schema.nginx.one.nginx_csg.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.nginx.one.nginx_csg.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.nginx.one.nginx_csg.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
