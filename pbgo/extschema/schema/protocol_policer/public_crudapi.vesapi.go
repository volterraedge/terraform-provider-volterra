...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protocol_policers", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protocol_policers/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protocol_policers/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/protocol_policers", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protocol_policers/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.protocol_policer.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.protocol_policer")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_policer.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_policer.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.protocol_policer.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.protocol_policer.API.Create' operation on 'protocol_policer'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.protocol_policer.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.protocol_policer.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_policer.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_policer.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.protocol_policer.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.protocol_policer.API.Replace' operation on 'protocol_policer'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.protocol_policer.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	rspMsgFQN := "ves.io.schema.protocol_policer.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_policer.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_policer.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.protocol_policer.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.protocol_policer.API.Delete' operation on 'protocol_policer'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/protocol_policers": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/protocol_policerCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol_policerCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.protocol_policer.API",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/protocol_policerReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol_policerReplaceRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/protocol_policerListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/protocol_policerGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol_policerDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "protocol_policerCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of protocol_policer",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Protocol policer",
                    "title": "spec",
                    "$ref": "#/definitions/protocol_policerCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "protocol_policerCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Protocol policer",
                    "title": "spec",
                    "$ref": "#/definitions/protocol_policerGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "protocol_policerCreateSpecType": {
            "type": "object",
            "description": "Create a protocol_policer object, protocol_policer object contains list\nof L4 protocol match condition and corresponding traffic rate limits",
            "title": "Create a Protocol policer object",
            "x-displayname": "Create Protocol Policer",
            "x-ves-displayorder": "1",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.CreateSpecType",
            "properties": {
                "protocol_policer": {
                    "type": "array",
        ...
        "protocol_policerDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a protocol_policer",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "protocol_policerGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read protocol_policer",
        ...
        "protocol_policerGetResponseFormatCode": {
            "type": "string",
        ...
        "protocol_policerGetSpecType": {
            "type": "object",
            "description": "Get specification of a protocol_policer object with L4 protocol match condition and\ncorresponding traffic rate limits",
            "title": "Get a Protocol policer object",
            "x-displayname": "Get Protocol Policer",
            "x-ves-displayorder": "1",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.GetSpecType",
            "properties": {
                "protocol_policer": {
                    "type": "array",
                    "description": " List of L4 protocol match condition and associated traffic rate limits\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 64\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "protocol_policerListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of protocol_policer",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/protocol_policerListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "protocol_policerListResponseItem": {
            "type": "object",
            "description": "By default a summary of protocol_policer is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of protocol_policer",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates protocol_policer is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this protocol_policer\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "protocol_policerReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a protocol_policer",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Protocol policer",
                    "title": "spec",
                    "$ref": "#/definitions/protocol_policerReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "protocol_policerReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.ReplaceResponse"
        },
        "protocol_policerReplaceSpecType": {
            "type": "object",
            "description": "Replace a protocol_policer object with new L4 protocol match condition and\ncorresponding traffic rate limits",
            "title": "Replace a Protocol policer object",
            "x-displayname": "Replace Protocol Policer",
            "x-ves-displayorder": "1",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.ReplaceSpecType",
            "properties": {
                "protocol_policer": {
                    "type": "array",
                    "description": " List of L4 protocol match condition and associated traffic rate limits\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 64\n  ves.io.schema.rules.repeated.unique: true\n",
    ...
    "x-displayname": "Protocol Policer",
    "x-ves-proto-file": "ves.io/schema/protocol_policer/public_crudapi.proto"
}`
