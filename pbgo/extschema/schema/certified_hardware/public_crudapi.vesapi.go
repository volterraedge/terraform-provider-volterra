...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.certified_hardware.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.certified_hardware.API.List", nil)
    ...
    "definitions": {
        ...
        "certified_hardwareGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/certified_hardwareObject",
        ...
        "certified_hardwareObject": {
            "type": "object",
            "description": "Certified Hardware Object",
            "title": "Certified Hardware",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
