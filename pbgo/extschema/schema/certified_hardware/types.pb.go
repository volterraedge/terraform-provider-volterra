...
type ImageType struct {
	...
	//	*ImageType_Aws
	//	*ImageType_Gcp
	CloudProvider isImageType_CloudProvider `protobuf_oneof:"CloudProvider"`
}
...
func NewPopulatedGetSpecType(r randyTypes, easy bool) *GetSpecType {
	...
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.VendorModelList = make([]*HardwareVendorModel, v6)
		for i := 0; i < v6; i++ {
			this.VendorModelList[i] = NewPopulatedHardwareVendorModel(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v7 := r.Intn(5)
		this.Devices = make([]*DeviceType, v7)
		for i := 0; i < v7; i++ {
			this.Devices[i] = NewPopulatedDeviceType(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v8 := r.Intn(5)
		this.ImageList = make([]*ImageType, v8)
		for i := 0; i < v8; i++ {
			this.ImageList[i] = NewPopulatedImageType(r, easy)
		}
	}
...
var fileDescriptorTypes = []byte{
	...
	,
}
