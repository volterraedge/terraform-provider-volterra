...
const (
	ObjectDefTblName = "ves.io.schema.certified_hardware.Object.default"
	ObjectType       = "ves.io.schema.certified_hardware.Object"

	StatusObjectDefTblName = "ves.io.schema.certified_hardware.StatusObject.default"
	StatusObjectType       = "ves.io.schema.certified_hardware.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.certified_hardware.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		...
		dri.DRField = "ves.io.schema.certified_hardware.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.certified_hardware.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.certified_hardware.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.certified_hardware.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range e.GetObjectRefs() {
		...
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "certified_hardware.Object",
			RefdUID:    ref.Uid,
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "certified_hardware.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: certified_hardware")
	}
