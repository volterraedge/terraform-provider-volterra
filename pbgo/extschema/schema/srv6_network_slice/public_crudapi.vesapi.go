...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/srv6_network_slices", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/srv6_network_slices/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/srv6_network_slices/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/srv6_network_slices", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/srv6_network_slices/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.srv6_network_slice.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.srv6_network_slice")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.srv6_network_slice.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.srv6_network_slice.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.srv6_network_slice.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.srv6_network_slice.API.Create' operation on 'srv6_network_slice'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.srv6_network_slice.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.srv6_network_slice.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.srv6_network_slice.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.srv6_network_slice.API.Replace' operation on 'srv6_network_slice'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.srv6_network_slice.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.srv6_network_slice.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.srv6_network_slice.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.srv6_network_slice.API.Delete' operation on 'srv6_network_slice'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.srv6_network_slice.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "SRv6 Network Slice Object",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/srv6_network_slices": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.srv6_network_slice.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/srv6_network_slices/{metadata.name}": {
            "put": {
                "summary": "Replace SRv6 Network Slice",
                "description": "Replace srv6_network_slice replaces an existing object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.srv6_network_slice.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/srv6_network_slices": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/srv6_network_slices/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/srv6_network_sliceDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "schemasrv6_network_sliceCreateSpecType": {
            "type": "object",
            "description": "Create srv6_network_slice creates a new object in the storage backend for metadata.namespace.",
            "title": "Create srv6_network_slice",
            "x-displayname": "Create SRv6 Network Slice",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.CreateSpecType",
            "properties": {
        ...
        "schemasrv6_network_sliceGetSpecType": {
            "type": "object",
            "description": "Get srv6_network_slice reads a given object from storage backend for metadata.namespace.",
            "title": "Get srv6_network_slice",
            "x-displayname": "Get SRv6 Network Slice",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.GetSpecType",
            "properties": {
                "connect_to_access_networks": {
                    "type": "boolean",
                    "description": " Connect all SRv6 Virtual Networks in this slice to their corresponding access networks by importing route\n targets specified in the virtual network.",
        ...
        "schemasrv6_network_sliceReplaceSpecType": {
            "type": "object",
            "description": "Replace srv6_network_slice replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace srv6_network_slice",
            "x-displayname": "Replace SRv6 Network Slice",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.ReplaceSpecType",
            "properties": {
                "connect_to_access_networks": {
                    "type": "boolean",
                    "description": " Connect all SRv6 Virtual Networks in this slice to their corresponding access networks by importing route\n targets specified in the virtual network.",
        ...
        "srv6_network_sliceCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of srv6_network_slice",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the srv6_network_slice",
                    "title": "spec",
                    "$ref": "#/definitions/schemasrv6_network_sliceCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "srv6_network_sliceCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the srv6_network_slice",
                    "title": "spec",
                    "$ref": "#/definitions/schemasrv6_network_sliceGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "srv6_network_sliceDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a srv6_network_slice",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "srv6_network_sliceGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read srv6_network_slice",
        ...
        "srv6_network_sliceGetResponseFormatCode": {
            "type": "string",
        ...
        "srv6_network_sliceListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of srv6_network_slice",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/srv6_network_sliceListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "srv6_network_sliceListResponseItem": {
            "type": "object",
            "description": "By default a summary of srv6_network_slice is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of srv6_network_slice",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this srv6_network_slice",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this srv6_network_slice",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates srv6_network_slice is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this srv6_network_slice",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this srv6_network_slice\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this srv6_network_slice\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "srv6_network_sliceReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a srv6_network_slice",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the srv6_network_slice",
                    "title": "spec",
                    "$ref": "#/definitions/schemasrv6_network_sliceReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "srv6_network_sliceReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.ReplaceResponse"
        },
    ...
    "x-displayname": "SRv6 Network Slice",
    "x-ves-proto-file": "ves.io/schema/srv6_network_slice/public_crudapi.proto"
}`
