...
import (
	...
	ves_io_schema_srv6_network_slice "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/srv6_network_slice"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_srv6_network_slice.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_srv6_network_slice.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_srv6_network_slice.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_srv6_network_slice.DBObject)
	}
	_ = f
