...
func TestRateLimitValueProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, false)
...
func TestRateLimitValueMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, false)
	size := p.Size()
...
func BenchmarkRateLimitValueProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*RateLimitValue, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedRateLimitValue(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkRateLimitValueProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedRateLimitValue(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRateLimitValueJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, true)
...
func TestRateLimitValueProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, true)
...
func TestRateLimitValueProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, true)
...
func TestRateLimitValueGoString(t *testing.T) {
...
func TestRateLimitValueSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRateLimitValue(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkRateLimitValueSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*RateLimitValue, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedRateLimitValue(popr, false)
	}
	b.ResetTimer()
...
func TestRateLimitValueStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRateLimitValue(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
