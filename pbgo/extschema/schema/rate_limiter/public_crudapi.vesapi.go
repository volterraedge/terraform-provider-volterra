...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/rate_limiters", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/rate_limiters/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/rate_limiters/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/rate_limiters", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.rate_limiter.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.rate_limiter")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.rate_limiter.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.rate_limiter")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.rate_limiter")
	}
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.rate_limiter.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.rate_limiter.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.rate_limiter.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.rate_limiter.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.rate_limiter.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.rate_limiter.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.rate_limiter.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.rate_limiter.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.rate_limiter.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.rate_limiter.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.rate_limiter.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.rate_limiter.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.rate_limiter.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.rate_limiter.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.rate_limiter.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.rate_limiter.GetResponse"
...
var APISwaggerJSON string = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/rate_limiterCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/rate_limiterCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-rate_limiter-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.rate_limiter.API.Create"
            },
            "x-displayname": "Rate Limiter",
            "x-ves-proto-service": "ves.io.schema.rate_limiter.API",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/rate_limiterReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/rate_limiterReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-rate_limiter-API-Replace"
                },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/rate_limiterListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-rate_limiter-API-List"
                },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/rate_limiterGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-rate_limiter-API-Get"
                },
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/rate_limiterDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-rate_limiter-API-Delete"
                },
    ...
    "definitions": {
        ...
        "rate_limiterCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of rate_limiter",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the rate_limiter",
                    "title": "spec",
                    "$ref": "#/definitions/rate_limiterCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "rate_limiterCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the rate_limiter",
                    "title": "spec",
                    "$ref": "#/definitions/rate_limiterGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "rate_limiterCreateSpecType": {
            "type": "object",
            "description": "Create rate_limiter creates a new object in the storage backend for metadata.namespace.",
            "title": "Create rate limiter",
            "x-displayname": "Create Rate Limiter",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.CreateSpecType",
            "properties": {
                "limits": {
                    "type": "array",
        ...
        "rate_limiterDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a rate_limiter",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "rate_limiterGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read rate_limiter",
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/rate_limiterObject",
        ...
        "rate_limiterGetResponseFormatCode": {
            "type": "string",
        ...
        "rate_limiterGetSpecType": {
            "type": "object",
            "description": "Get rate_limiter reads a given object from storage backend for metadata.namespace.",
            "title": "Get rate limiter",
            "x-displayname": "Get Rate Limiter",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.GetSpecType",
            "properties": {
                "limits": {
                    "type": "array",
                    "description": " A list of RateLimitValues that specifies the total number of allowed requests for each specified period.\nRequired: YES",
        ...
        "rate_limiterGlobalSpecType": {
            ...
            "properties": {
                ...
                "mode": {
                    "description": " Specifies if the request limits are shared across all references to this rate limiter or unique rate limits are allotted for each reference.",
                    "title": "mode",
        ...
        "rate_limiterListResponse": {
            ...
            "title": "ListResponse is the collection of rate_limiter",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/rate_limiterListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "rate_limiterListResponseItem": {
            "type": "object",
            "description": "By default a summary of rate_limiter is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of rate_limiter",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates rate_limiter is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this rate_limiter\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this rate_limiter\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "rate_limiterObject": {
            ...
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "rate_limiterRateLimiterMode": {
            ...
            "x-displayname": "Rate Limiter Mode",
            "x-ves-proto-enum": "ves.io.schema.rate_limiter.RateLimiterMode"
        },
        "rate_limiterReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a rate_limiter",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the rate_limiter",
                    "title": "spec",
                    "$ref": "#/definitions/rate_limiterReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "rate_limiterReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.ReplaceResponse"
        },
        "rate_limiterReplaceSpecType": {
            "type": "object",
            "description": "Replace rate_limiter replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace rate limiter",
            "x-displayname": "Replace Rate Limiter",
            "x-ves-proto-message": "ves.io.schema.rate_limiter.ReplaceSpecType",
            "properties": {
                "limits": {
                    "type": "array",
                    "description": " A list of RateLimitValues that specifies the total number of allowed requests for each specified period.\nRequired: YES",
    ...
    "x-displayname": "Rate Limiter",
    "x-ves-proto-file": "ves.io/schema/rate_limiter/public_crudapi.proto"
}`
