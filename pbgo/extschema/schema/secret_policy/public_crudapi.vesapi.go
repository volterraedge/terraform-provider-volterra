    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/secret_policys": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-secret_policy-API-Create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/secret_policys/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-secret_policy-API-Replace"
                },
        ...
        "/public/namespaces/{namespace}/secret_policys": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-secret_policy-API-List"
                },
        ...
        "/public/namespaces/{namespace}/secret_policys/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-secret_policy-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-secret_policy-API-Delete"
                },
    ...
    "definitions": {
        ...
        "schemasecret_policyCreateSpecType": {
            ...
            "properties": {
                ...
                "allow_volterra": {
                    "type": "boolean",
                    "description": " if allow_volterra is set to true, it allows relevent volterra infrastructure services to decrypt the secret encrypted using this policy.\n\nExample: - \"true\"-",
                    "format": "boolean",
