...
var (
	pattern_CustomAPI_DeletePolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"public", "namespaces", "namespace", "secret_policys", "name", "softdelete"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_RecoverPolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"public", "namespaces", "namespace", "secret_policys", "name", "recover"}, "", runtime.AssumeColonVerbOpt(false)))
)
