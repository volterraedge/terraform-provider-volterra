...
import (
	...
	ves_io_schema_workload_flavor "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/workload_flavor"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_workload_flavor.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_workload_flavor.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_workload_flavor.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_workload_flavor.DBObject)
	}
	_ = f
