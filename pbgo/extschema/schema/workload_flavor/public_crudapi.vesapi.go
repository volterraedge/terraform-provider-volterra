...
const (
	...
	CreateRequestFQN = "ves.io.schema.uztna.application.uztna_snat_pool.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.uztna.application.uztna_snat_pool.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.uztna.application.uztna_snat_pool.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.uztna.application.uztna_snat_pool.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.uztna.application.uztna_snat_pool.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.uztna.application.uztna_snat_pool.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.uztna.application.uztna_snat_pool.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.uztna.application.uztna_snat_pool.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.uztna.application.uztna_snat_pool.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.uztna.application.uztna_snat_pool.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_snat_pools", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_snat_pools/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_snat_pools/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_snat_pools", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_snat_pools/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.uztna_snat_pool.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.uztna_snat_pool")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.uztna_snat_pool.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.uztna_snat_pool.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.uztna.application.uztna_snat_pool.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.uztna.application.uztna_snat_pool.API.Create' operation on 'uztna_snat_pool'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.uztna.application.uztna_snat_pool.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_snat_pool.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_snat_pool.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.application.uztna_snat_pool.API.Replace' operation on 'uztna_snat_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_snat_pool.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.uztna.application.uztna_snat_pool.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_snat_pool.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.application.uztna_snat_pool.API.Delete' operation on 'uztna_snat_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.uztna.application.uztna_snat_pool.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/uztna_snat_pools": {
            "post": {
                "summary": "Create Specification",
                "description": "\nShape of the UZTNA SNAT Pool",
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.API.Create"
            },
            "x-displayname": "SNAT Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_snat_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/uztna_snat_pools/{metadata.name}": {
            "put": {
                "summary": "Replace Specification",
                "description": "\nShape of the UZTNA SNAT Pool",
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.API.Replace"
            },
            "x-displayname": "SNAT Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_snat_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_snat_pools": {
            "get": {
                "summary": "List SNAT Pool",
                "description": "List the set of uztna_snat_pool in a namespace",
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.API.List"
            },
            "x-displayname": "SNAT Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_snat_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_snat_pools/{name}": {
            "get": {
                "summary": "Get SNAT Pool schema",
                "description": "\nGet a SNAT Pool object.",
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.API.Get"
            },
            "delete": {
                "summary": "Delete SNAT Pool",
                "description": "Delete the specified uztna_snat_pool",
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_snat_poolDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.API.Delete"
            },
            "x-displayname": "SNAT Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_snat_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "applicationuztna_snat_poolCreateSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA SNAT Pool",
            "title": "CreateSpecType",
            "x-displayname": "Create Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.CreateSpecType",
            "properties": {
                "ip_addresses": {
                    "type": "array",
        ...
        "applicationuztna_snat_poolGetSpecType": {
            "type": "object",
            "description": "\nGet a SNAT Pool object.",
            "title": "Get SNAT Pool Schema",
            "x-displayname": "Get SNAT Pool schema",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.GetSpecType",
            "properties": {
                "ip_addresses": {
                    "type": "array",
                    "description": "\n Each IP Address could be IPV4 or IPV6, \n Combination of IPV4 and IPV6 can exist in the list.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.min_items: 1\n",
        ...
        "applicationuztna_snat_poolReplaceSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA SNAT Pool",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.ReplaceSpecType",
            "properties": {
                "ip_addresses": {
                    "type": "array",
                    "description": "\n Each IP Address could be IPV4 or IPV6, \n Combination of IPV4 and IPV6 can exist in the list.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.min_items: 1\n",
        ...
        "uztna_snat_poolCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of uztna_snat_pool",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna snat pool",
                    "title": "spec",
                    "$ref": "#/definitions/applicationuztna_snat_poolCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_snat_poolCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna snat pool",
                    "title": "spec",
                    "$ref": "#/definitions/applicationuztna_snat_poolGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "uztna_snat_poolDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a uztna_snat_pool",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "uztna_snat_poolGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read uztna_snat_pool",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.GetResponse",
            "properties": {
                "create_form": {
        ...
        "uztna_snat_poolGetResponseFormatCode": {
            "type": "string",
        ...
        "uztna_snat_poolListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of uztna_snat_pool",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/uztna_snat_poolListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "uztna_snat_poolListResponseItem": {
            "type": "object",
            "description": "By default a summary of uztna_snat_pool is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of uztna_snat_pool",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this uztna_snat_pool",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this uztna_snat_pool",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates uztna_snat_pool is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this uztna_snat_pool",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this uztna_snat_pool\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this uztna_snat_pool\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "uztna_snat_poolReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a uztna_snat_pool",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna snat pool",
                    "title": "spec",
                    "$ref": "#/definitions/applicationuztna_snat_poolReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_snat_poolReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.ReplaceResponse"
        },
    ...
    "x-displayname": "SNAT Pool",
    "x-ves-proto-file": "ves.io/schema/uztna/application/uztna_snat_pool/public_crudapi.proto"
}`
