...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_discovered_service.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_discovered_service.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_discovered_service.DBObject)
	}
	_ = f
