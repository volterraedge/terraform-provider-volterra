...
const (
	ObjectDefTblName = "ves.io.schema.discovered_service.Object.default"
	ObjectType       = "ves.io.schema.discovered_service.Object"

	StatusObjectDefTblName = "ves.io.schema.discovered_service.StatusObject.default"
	StatusObjectType       = "ves.io.schema.discovered_service.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.discovered_service.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.discovered_service.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.discovered_service.StatusObject"
}
