...
import (
	...
	ves_io_schema_l7_acl "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/l7_acl"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_l7_acl.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_l7_acl.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_l7_acl.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_l7_acl.DBObject)
	}
	_ = f
