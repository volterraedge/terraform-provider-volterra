...
type Passport struct {
	...
	// x-example: "192.168.33.1"
	PrivateDefaultGw string `protobuf:"bytes,4,opt,name=private_default_gw,json=privateDefaultGw,proto3" json:"private_default_gw,omitempty"`
	// Private VN prefix
	//
	// x-displayName: "Private VN Prefix"
	// x-example: "192.168.33.1"
	PrivateVnPrefix string `protobuf:"bytes,5,opt,name=private_vn_prefix,json=privateVnPrefix,proto3" json:"private_vn_prefix,omitempty"`
	// Customer route
	//
	// x-displayName: "Customer Route"
	// x-example: "192.168.36.0/24"
	CustomerRoute string `protobuf:"bytes,6,opt,name=customer_route,json=customerRoute,proto3" json:"customer_route,omitempty"`
	// Latitude
	//
...
func (m *Passport) GetPrivateDefaultGw() string {
	if m != nil {
		return m.PrivateDefaultGw
	}
	return ""
}

func (m *Passport) GetPrivateVnPrefix() string {
	if m != nil {
		return m.PrivateVnPrefix
	}
	return ""
}

func (m *Passport) GetCustomerRoute() string {
	if m != nil {
		return m.CustomerRoute
	}
	return ""
}
...
func (this *Passport) Equal(that interface{}) bool {
	...
	if this.PrivateDefaultGw != that1.PrivateDefaultGw {
		return false
	}
	if this.PrivateVnPrefix != that1.PrivateVnPrefix {
		return false
	}
	if this.CustomerRoute != that1.CustomerRoute {
		return false
	}
...
func (this *Passport) GoString() string {
	...
	s = append(s, "PrivateDefaultGw: "+fmt.Sprintf("%#v", this.PrivateDefaultGw)+",\n")
	s = append(s, "PrivateVnPrefix: "+fmt.Sprintf("%#v", this.PrivateVnPrefix)+",\n")
	s = append(s, "CustomerRoute: "+fmt.Sprintf("%#v", this.CustomerRoute)+",\n")
...
func (m *Passport) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PrivateDefaultGw) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PrivateDefaultGw)))
		i += copy(dAtA[i:], m.PrivateDefaultGw)
	}
	if len(m.PrivateVnPrefix) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PrivateVnPrefix)))
		i += copy(dAtA[i:], m.PrivateVnPrefix)
	}
	if len(m.CustomerRoute) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.CustomerRoute)))
		i += copy(dAtA[i:], m.CustomerRoute)
	}
	if m.Latitude != 0 {
		dAtA[i] = 0x3d
		i++
...
func NewPopulatedPassport(r randyTypes, easy bool) *Passport {
	...
	this.PrivateDefaultGw = string(randStringTypes(r))
	this.PrivateVnPrefix = string(randStringTypes(r))
	this.CustomerRoute = string(randStringTypes(r))
...
func (m *Passport) Size() (n int) {
	...
	l = len(m.PrivateDefaultGw)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.PrivateVnPrefix)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.CustomerRoute)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.Latitude != 0 {
...
func (this *Passport) String() string {
	...
	s := strings.Join([]string{`&Passport{`,
		...
		`PrivateDefaultGw:` + fmt.Sprintf("%v", this.PrivateDefaultGw) + `,`,
		`PrivateVnPrefix:` + fmt.Sprintf("%v", this.PrivateVnPrefix) + `,`,
		`CustomerRoute:` + fmt.Sprintf("%v", this.CustomerRoute) + `,`,
...
func (m *Passport) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrivateDefaultGw", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrivateDefaultGw = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrivateVnPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrivateVnPrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomerRoute", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CustomerRoute = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 5 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
