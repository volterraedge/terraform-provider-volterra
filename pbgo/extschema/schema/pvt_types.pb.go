...
//
// x-displayName: "StatusServerParamsType"
// StatusServerParamsType specifies all status server params.
type StatusServerParamsType struct {
	// Status Server Service Params
	//
	// x-displayName: "Status Server List"
	// x-required
	StatusServerList []*ServiceParameters `protobuf:"bytes,1,rep,name=status_server_list,json=statusServerList" json:"status_server_list,omitempty"`
}

func (m *StatusServerParamsType) Reset()                    { *m = StatusServerParamsType{} }
func (*StatusServerParamsType) ProtoMessage()               {}
func (*StatusServerParamsType) Descriptor() ([]byte, []int) { return fileDescriptorPvtTypes, []int{7} }

func (m *StatusServerParamsType) GetStatusServerList() []*ServiceParameters {
	if m != nil {
		return m.StatusServerList
	}
	return nil
}
...
type SyncServerParamsType struct {
	...
	// x-required
	SyncServerList []*ServiceParameters `protobuf:"bytes,1,rep,name=sync_server_list,json=syncServerList" json:"sync_server_list,omitempty"`
}

func (m *SyncServerParamsType) Reset()                    { *m = SyncServerParamsType{} }
func (*SyncServerParamsType) ProtoMessage()               {}
func (*SyncServerParamsType) Descriptor() ([]byte, []int) { return fileDescriptorPvtTypes, []int{8} }
...
func init() {
	...
	proto.RegisterType((*StatusServerParamsType)(nil), "ves.io.schema.StatusServerParamsType")
	golang_proto.RegisterType((*StatusServerParamsType)(nil), "ves.io.schema.StatusServerParamsType")
...
func (this *StatusServerParamsType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StatusServerParamsType)
	if !ok {
		that2, ok := that.(StatusServerParamsType)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.StatusServerList) != len(that1.StatusServerList) {
		return false
	}
	for i := range this.StatusServerList {
		if !this.StatusServerList[i].Equal(that1.StatusServerList[i]) {
			return false
		}
	}
	return true
...
func (this *StatusServerParamsType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&schema.StatusServerParamsType{")
	if this.StatusServerList != nil {
		s = append(s, "StatusServerList: "+fmt.Sprintf("%#v", this.StatusServerList)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *StatusServerParamsType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StatusServerParamsType) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.StatusServerList) > 0 {
		for _, msg := range m.StatusServerList {
			dAtA[i] = 0xa
			i++
			i = encodeVarintPvtTypes(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *SyncServerParamsType) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SyncServerList) > 0 {
		for _, msg := range m.SyncServerList {
			dAtA[i] = 0xa
			i++
			i = encodeVarintPvtTypes(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *StatusServerParamsType) Size() (n int) {
	var l int
	_ = l
	if len(m.StatusServerList) > 0 {
		for _, e := range m.StatusServerList {
			l = e.Size()
			n += 1 + l + sovPvtTypes(uint64(l))
		}
	}
...
func (this *StatusServerParamsType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StatusServerParamsType{`,
		`StatusServerList:` + strings.Replace(fmt.Sprintf("%v", this.StatusServerList), "ServiceParameters", "ServiceParameters", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SyncServerParamsType) String() string {
	...
	s := strings.Join([]string{`&SyncServerParamsType{`,
		`SyncServerList:` + strings.Replace(fmt.Sprintf("%v", this.SyncServerList), "ServiceParameters", "ServiceParameters", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StatusServerParamsType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StatusServerParamsType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatusServerParamsType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatusServerList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatusServerList = append(m.StatusServerList, &ServiceParameters{})
			if err := m.StatusServerList[len(m.StatusServerList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorPvtTypes = []byte{
	...
	,
}
