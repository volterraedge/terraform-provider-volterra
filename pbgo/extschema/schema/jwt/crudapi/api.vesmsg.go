...
import (
	...
	ves_io_schema_jwt "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/jwt"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_jwt.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_jwt.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_jwt.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_jwt.DBObject)
	}
	_ = f
