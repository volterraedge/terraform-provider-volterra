...
const (
	...
	CreateRequestFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.shape.client_side_defense.allowed_domain.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_domains", c.baseURL, namespace)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_domains/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_domains", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_domains/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.client_side_defense.allowed_domain.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.shape.client_side_defense.allowed_domain")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.allowed_domain.API.Create")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.allowed_domain.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.allowed_domain.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.allowed_domain.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.client_side_defense.allowed_domain.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.client_side_defense.allowed_domain.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.allowed_domain.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.client_side_defense.allowed_domain.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.shape.client_side_defense.allowed_domain.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.shape.client_side_defense.allowed_domain.API.Create' operation on 'allowed_domain'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.shape.client_side_defense.allowed_domain.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.client_side_defense.allowed_domain.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.allowed_domain.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.shape.client_side_defense.allowed_domain.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.allowed_domain.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.allowed_domain.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.client_side_defense.allowed_domain.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.client_side_defense.allowed_domain.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.client_side_defense.allowed_domain.API.Delete' operation on 'allowed_domain'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.shape.client_side_defense.allowed_domain.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Client-Side Defense Allowed Domain",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/allowed_domains": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/allowed_domainCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/allowed_domainCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-allowed_domain-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.allowed_domain.API.Create"
            },
            "x-displayname": "Client-Side Defense Allowed Domain",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.allowed_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/allowed_domains": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/allowed_domainListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-allowed_domain-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.allowed_domain.API.List"
            },
            "x-displayname": "Client-Side Defense Allowed Domain",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.allowed_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/allowed_domains/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/allowed_domainGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-allowed_domain-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.allowed_domain.API.Get"
            },
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/allowed_domainDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-allowed_domain-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.allowed_domain.API.Delete"
            },
            "x-displayname": "Client-Side Defense Allowed Domain",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.allowed_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "allowed_domainCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of allowed_domain",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/allowed_domainCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "allowed_domainCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the client_side_defense",
                    "title": "spec",
                    "$ref": "#/definitions/allowed_domainGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "allowed_domainCreateSpecType": {
            "type": "object",
            "description": "Create allowed domain",
            "title": "Create Allowed Domain",
            "x-displayname": "Create Allowed Domain",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.CreateSpecType",
            "properties": {
                "allowed_domain": {
                    "type": "string",
        ...
        "allowed_domainDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a allowed_domain",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "allowed_domainGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read allowed_domain",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.GetResponse",
            "properties": {
                "create_form": {
        ...
        "allowed_domainGetResponseFormatCode": {
            "type": "string",
        ...
        "allowed_domainGetSpecType": {
            "type": "object",
            "description": "Get allowed domain",
            "title": "Get Allowed Domain",
            "x-displayname": "Get Allowed Domain",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.GetSpecType",
            "properties": {
                "allowed_domain": {
                    "type": "string",
                    "description": " Enter root domain or domain to be entered to allow list below.\n Domains can be entered only one at a time. In case of conflicting entries, the domain entry takes precedence over the root domain entry.\n Example: if you are adding Client-Side Defense JS on checkout.example.com, you should enter example.com here.\n\nExample: - \"news.abc.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.not_empty: true\n",
        ...
        "allowed_domainListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of allowed_domain",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/allowed_domainListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "allowed_domainListResponseItem": {
            "type": "object",
            "description": "By default a summary of allowed_domain is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of allowed_domain",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.allowed_domain.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this allowed_domain",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this allowed_domain",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates allowed_domain is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this allowed_domain",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this allowed_domain\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this allowed_domain\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
    ...
    "x-displayname": "Client-Side Defense Allowed Domain",
    "x-ves-proto-file": "ves.io/schema/shape/client_side_defense/allowed_domain/public_crudapi.proto"
}`
