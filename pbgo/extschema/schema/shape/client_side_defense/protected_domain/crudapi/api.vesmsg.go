...
import (
	...
	ves_io_schema_shape_client_side_defense_protected_domain "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/shape/client_side_defense/protected_domain"
)
