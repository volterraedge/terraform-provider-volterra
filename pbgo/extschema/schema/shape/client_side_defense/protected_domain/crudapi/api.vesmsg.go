...
import (
	...
	ves_io_schema_shape_client_side_defense_protected_domain "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/client_side_defense/protected_domain"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_shape_client_side_defense_protected_domain.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_shape_client_side_defense_protected_domain.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_shape_client_side_defense_protected_domain.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_shape_client_side_defense_protected_domain.DBObject)
	}
	_ = f
