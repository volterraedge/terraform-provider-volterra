...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.shape.client_side_defense.protected_domain.GetRequest"] = GetRequestValidator()
	vr["ves.io.schema.shape.client_side_defense.protected_domain.GetResponse"] = GetResponseValidator()
...
func initializeEntryRegistry(mdr *svcfw.MDRegistry) {
	mdr.EntryFactory["ves.io.schema.shape.client_side_defense.protected_domain.Object"] = NewEntryObject
	mdr.EntryStoreMap["ves.io.schema.shape.client_side_defense.protected_domain.Object"] = store.InMemory
	mdr.EntryRegistry["ves.io.schema.shape.client_side_defense.protected_domain.Object"] = reflect.TypeOf(&DBObject{})
	mdr.EntryIndexers["ves.io.schema.shape.client_side_defense.protected_domain.Object"] = GetObjectIndexers
	mdr.EntryFactory["ves.io.schema.shape.client_side_defense.protected_domain.StatusObject"] = NewEntryStatusObject
