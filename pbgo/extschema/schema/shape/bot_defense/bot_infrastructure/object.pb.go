...
// source: ves.io/schema/shape/bot_defense/bot_infrastructure/object.proto
...
// Bot Defense Bot Infrastructure  Object
//
// x-displayName: "Object"
// Bot Infrastructure object
type Object struct {
	// metadata
	//
	...
	//
	// x-displayName: "Spec"
	// Specification of the desired behavior of the Bot Infrastructure
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_46d3e57c79e361bf, []int{0}
}
...
// Specification of Bot Infrastructure
//
// x-displayName: "Specification of Bot Infrastructure "
// Shape of Bot Infrastructure specification
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_46d3e57c79e361bf, []int{1}
}
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_46d3e57c79e361bf, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/shape/bot_defense/bot_infrastructure/object.proto", fileDescriptor_46d3e57c79e361bf)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/shape/bot_defense/bot_infrastructure/object.proto", fileDescriptor_46d3e57c79e361bf)
}

var fileDescriptor_46d3e57c79e361bf = []byte{
	// 601 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&bot_infrastructure.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&bot_infrastructure.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&bot_infrastructure.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
