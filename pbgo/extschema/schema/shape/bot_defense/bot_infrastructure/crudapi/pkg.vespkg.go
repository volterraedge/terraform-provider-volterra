...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectCreateReq"] = ObjectCreateReqValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectCreateRsp"] = ObjectCreateRspValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectDeleteReq"] = ObjectDeleteReqValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectDeleteRsp"] = ObjectDeleteRspValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectGetReq"] = ObjectGetReqValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectGetRsp"] = ObjectGetRspValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectListReq"] = ObjectListReqValidator()
	vr["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectListRsp"] = ObjectListRspValidator()
...
func initializeRPCRegistry(mdr *svcfw.MDRegistry) {
	...
	mdr.RPCDeprecatedRequestFieldsRegistry["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create"] = []string{
		...
		"spec.gc_spec.infra_host_name",
		"spec.gc_spec.infra_region.#",
		"spec.gc_spec.infra_type",
	...
	mdr.RPCDeprecatedResponseFieldsRegistry["ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List"] = []string{
		...
		"items.#.spec.gc_spec.infra_host_name",
		"items.#.spec.gc_spec.infra_region.#",
		"items.#.spec.gc_spec.infra_type",
