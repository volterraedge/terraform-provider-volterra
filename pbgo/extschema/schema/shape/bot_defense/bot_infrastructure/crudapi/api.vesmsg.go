...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_shape_bot_defense_bot_infrastructure.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_shape_bot_defense_bot_infrastructure.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_shape_bot_defense_bot_infrastructure.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_shape_bot_defense_bot_infrastructure.DBObject)
	}
	_ = f
