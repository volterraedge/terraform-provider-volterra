...
import (
	...
	ves_io_schema_shape_bot_defense_bot_allowlist_policy "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_allowlist_policy"
)
