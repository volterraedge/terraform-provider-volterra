...
import (
	...
	ves_io_schema_shape_bot_defense_bot_allowlist_policy "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_allowlist_policy"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_shape_bot_defense_bot_allowlist_policy.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_shape_bot_defense_bot_allowlist_policy.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_shape_bot_defense_bot_allowlist_policy.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_shape_bot_defense_bot_allowlist_policy.DBObject)
	}
	_ = f
