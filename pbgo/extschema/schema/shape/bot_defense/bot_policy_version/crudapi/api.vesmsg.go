...
import (
	...
	ves_io_schema_shape_bot_defense_bot_policy_version "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_policy_version"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_shape_bot_defense_bot_policy_version.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_shape_bot_defense_bot_policy_version.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_shape_bot_defense_bot_policy_version.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_shape_bot_defense_bot_policy_version.DBObject)
	}
	_ = f
