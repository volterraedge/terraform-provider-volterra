...
import (
	...
	ves_io_schema_shape_bot_defense_bot_policy_version "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_policy_version"
)
