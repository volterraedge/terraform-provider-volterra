...
const (
	ObjectDefTblName = "ves.io.schema.shape.bot_defense.bot_policy_version.Object.default"
	ObjectType       = "ves.io.schema.shape.bot_defense.bot_policy_version.Object"

	StatusObjectDefTblName = "ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject.default"
	StatusObjectType       = "ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.shape.bot_defense.bot_policy_version.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.shape.bot_defense.bot_policy_version.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "bot_policy_version.Object")
	if err != nil {
