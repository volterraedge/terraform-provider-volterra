...
const (
	ObjectDefTblName = "ves.io.schema.shape.bot_defense.mobile_base_config.Object.default"
	ObjectType       = "ves.io.schema.shape.bot_defense.mobile_base_config.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.shape.bot_defense.mobile_base_config.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.shape.bot_defense.mobile_base_config.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
