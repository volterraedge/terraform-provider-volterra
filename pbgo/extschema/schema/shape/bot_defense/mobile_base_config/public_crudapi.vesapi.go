...
const (
	...
	CreateRequestFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.shape.bot_defense.mobile_base_config.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/mobile_base_configs", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/mobile_base_configs/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/mobile_base_configs/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/mobile_base_configs", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/mobile_base_configs/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.mobile_base_config.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.mobile_base_config")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.mobile_base_config.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.mobile_base_config.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.mobile_base_config.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.mobile_base_config.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.mobile_base_config.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.mobile_base_config.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.mobile_base_config.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.mobile_base_config.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.mobile_base_config.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.shape.bot_defense.mobile_base_config.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.shape.bot_defense.mobile_base_config.API.Create' operation on 'mobile_base_config'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.shape.bot_defense.mobile_base_config.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.mobile_base_config.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.mobile_base_config.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.mobile_base_config.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.mobile_base_config.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.bot_defense.mobile_base_config.API.Replace' operation on 'mobile_base_config'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.mobile_base_config.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.mobile_base_config.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.shape.bot_defense.mobile_base_config.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.mobile_base_config.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.mobile_base_config.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.mobile_base_config.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.mobile_base_config.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.bot_defense.mobile_base_config.API.Delete' operation on 'mobile_base_config'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.shape.bot_defense.mobile_base_config.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Mobile SDK Base Configuration",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/mobile_base_configs": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-mobile_base_config-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.mobile_base_config.API.Create"
            },
            "x-displayname": "Mobile SDK Base Configuration",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.mobile_base_config.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/mobile_base_configs/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-mobile_base_config-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.mobile_base_config.API.Replace"
            },
            "x-displayname": "Mobile SDK Base Configuration",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.mobile_base_config.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/mobile_base_configs": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-mobile_base_config-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.mobile_base_config.API.List"
            },
            "x-displayname": "Mobile SDK Base Configuration",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.mobile_base_config.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/mobile_base_configs/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-mobile_base_config-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.mobile_base_config.API.Get"
            },
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mobile_base_configDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-mobile_base_config-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.mobile_base_config.API.Delete"
            },
            "x-displayname": "Mobile SDK Base Configuration",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.mobile_base_config.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "mobile_base_configCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of mobile_base_config",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the mobile_base_config",
                    "title": "spec",
                    "$ref": "#/definitions/mobile_base_configCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "mobile_base_configCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the mobile_base_config",
                    "title": "spec",
                    "$ref": "#/definitions/mobile_base_configGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "mobile_base_configCreateSpecType": {
            "type": "object",
            "description": "Create Mobile SDK Base Configuration",
            "title": "Create Mobile SDK Base Configuration",
            "x-displayname": "Create Mobile SDK Base Configuration",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.CreateSpecType",
            "properties": {
                "fqdn": {
                    "type": "string",
        ...
        "mobile_base_configDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a mobile_base_config",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "mobile_base_configGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read mobile_base_config",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.GetResponse",
            "properties": {
                "create_form": {
        ...
        "mobile_base_configGetResponseFormatCode": {
            "type": "string",
        ...
        "mobile_base_configGetSpecType": {
            "type": "object",
            "description": "Get Mobile SDK Base Configuration",
            "title": "Get Mobile SDK Base Configuration",
            "x-displayname": "Get Mobile SDK Base Configuration",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.GetSpecType",
            "properties": {
                "fqdn": {
                    "type": "string",
                    "description": " Fully qualified domain name (FQDN)\n\nExample: - \"mobile.example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n",
        ...
        "mobile_base_configListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of mobile_base_config",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/mobile_base_configListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "mobile_base_configListResponseItem": {
            "type": "object",
            "description": "By default a summary of mobile_base_config is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of mobile_base_config",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this mobile_base_config",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this mobile_base_config",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates mobile_base_config is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this mobile_base_config",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this mobile_base_config\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this mobile_base_config\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "mobile_base_configReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a mobile_base_config",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the mobile_base_config",
                    "title": "spec",
                    "$ref": "#/definitions/mobile_base_configReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "mobile_base_configReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.ReplaceResponse"
        },
        "mobile_base_configReplaceSpecType": {
            "type": "object",
            "description": "Replace Mobile SDK Base Configuration",
            "title": "Replace Mobile SDK Base Configuration",
            "x-displayname": "Replace Mobile SDK Base Configuration",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.mobile_base_config.ReplaceSpecType",
            "properties": {
                "fqdn": {
                    "type": "string",
                    "description": " Fully qualified domain name (FQDN)\n\nExample: - \"mobile.example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n",
    ...
    "x-displayname": "Mobile SDK Base Configuration",
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/mobile_base_config/public_crudapi.proto"
}`
