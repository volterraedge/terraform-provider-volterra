...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_shape_bot_defense_protected_application.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_shape_bot_defense_protected_application.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_shape_bot_defense_protected_application.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_shape_bot_defense_protected_application.DBObject)
	}
	_ = f
