...
func (m *CloudfrontType) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *CloudfrontType) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *CloudfrontType) DeepCopy() *CloudfrontType {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *CloudfrontType) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *CloudfrontType) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return CloudfrontTypeValidator().Validate(ctx, m, opts...)
}

type ValidateCloudfrontType struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateCloudfrontType) AwsConfigurationTypeChoiceValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	validatorFn, err := db.NewMessageValidationRuleHandler(rules)
	if err != nil {
		return nil, errors.Wrap(err, "ValidationRuleHandler for aws_configuration_type_choice")
	}
	return validatorFn, nil
}

func (v *ValidateCloudfrontType) JavaScriptChoiceValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	validatorFn, err := db.NewMessageValidationRuleHandler(rules)
	if err != nil {
...
func (v *ValidateCloudfrontType) MobileSdkChoiceValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	validatorFn, err := db.NewMessageValidationRuleHandler(rules)
	if err != nil {
...
func (v *ValidateCloudfrontType) ProtectedEndpointsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateCloudfrontType) TrustedClientsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateCloudfrontType) TimeoutValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateCloudfrontType) DataSampleValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {

	validatorFn, err := db.NewUint32ValidationRuleHandler(rules)
	if err != nil {
		return nil, errors.Wrap(err, "ValidationRuleHandler for data_sample")
	}

	return validatorFn, nil
}

func (v *ValidateCloudfrontType) ContinueMitigationActionHdrValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateCloudfrontType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*CloudfrontType)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *CloudfrontType got type %s", t)
		}
	}
	if m == nil {
		return nil
	...
	if fv, exists := v.FldValidators["aws_account_no"]; exists {

		vOpts := append(opts, db.WithValidateField("aws_account_no"))
		if err := fv(ctx, m.GetAwsAccountNo(), vOpts...); err != nil {
			return err
		}

	}

	if fv, exists := v.FldValidators["aws_configuration_type_choice"]; exists {
		val := m.GetAwsConfigurationTypeChoice()
		vOpts := append(opts,
			db.WithValidateField("aws_configuration_type_choice"),
		)
		if err := fv(ctx, val, vOpts...); err != nil {
			return err
		}
	...
	switch m.GetAwsConfigurationTypeChoice().(type) {
	case *CloudfrontType_DisableAwsConfiguration:
		if fv, exists := v.FldValidators["aws_configuration_type_choice.disable_aws_configuration"]; exists {
			val := m.GetAwsConfigurationTypeChoice().(*CloudfrontType_DisableAwsConfiguration).DisableAwsConfiguration
			vOpts := append(opts,
				db.WithValidateField("aws_configuration_type_choice"),
				db.WithValidateField("disable_aws_configuration"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
		}
	case *CloudfrontType_AwsConfigurationIdSelector:
		if fv, exists := v.FldValidators["aws_configuration_type_choice.aws_configuration_id_selector"]; exists {
			val := m.GetAwsConfigurationTypeChoice().(*CloudfrontType_AwsConfigurationIdSelector).AwsConfigurationIdSelector
			vOpts := append(opts,
				db.WithValidateField("aws_configuration_type_choice"),
				db.WithValidateField("aws_configuration_id_selector"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
		}
	case *CloudfrontType_AwsConfigurationTagSelector:
		if fv, exists := v.FldValidators["aws_configuration_type_choice.aws_configuration_tag_selector"]; exists {
			val := m.GetAwsConfigurationTypeChoice().(*CloudfrontType_AwsConfigurationTagSelector).AwsConfigurationTagSelector
			vOpts := append(opts,
				db.WithValidateField("aws_configuration_type_choice"),
				db.WithValidateField("aws_configuration_tag_selector"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
	...
	if fv, exists := v.FldValidators["data_sample"]; exists {

		vOpts := append(opts, db.WithValidateField("data_sample"))
		if err := fv(ctx, m.GetDataSample(), vOpts...); err != nil {
			return err
		}
	...
	case *CloudfrontType_DisableJsInsert:
		if fv, exists := v.FldValidators["java_script_choice.disable_js_insert"]; exists {
			val := m.GetJavaScriptChoice().(*CloudfrontType_DisableJsInsert).DisableJsInsert
			vOpts := append(opts,
				db.WithValidateField("java_script_choice"),
	...
	case *CloudfrontType_JsInsertAllPages:
		if fv, exists := v.FldValidators["java_script_choice.js_insert_all_pages"]; exists {
			val := m.GetJavaScriptChoice().(*CloudfrontType_JsInsertAllPages).JsInsertAllPages
			vOpts := append(opts,
				db.WithValidateField("java_script_choice"),
	...
	case *CloudfrontType_JsInsertAllPagesExcept:
		if fv, exists := v.FldValidators["java_script_choice.js_insert_all_pages_except"]; exists {
			val := m.GetJavaScriptChoice().(*CloudfrontType_JsInsertAllPagesExcept).JsInsertAllPagesExcept
			vOpts := append(opts,
				db.WithValidateField("java_script_choice"),
	...
	case *CloudfrontType_JsInsertionRules:
		if fv, exists := v.FldValidators["java_script_choice.js_insertion_rules"]; exists {
			val := m.GetJavaScriptChoice().(*CloudfrontType_JsInsertionRules).JsInsertionRules
			vOpts := append(opts,
				db.WithValidateField("java_script_choice"),
	...
	case *CloudfrontType_ManualJsInsert:
		if fv, exists := v.FldValidators["java_script_choice.manual_js_insert"]; exists {
			val := m.GetJavaScriptChoice().(*CloudfrontType_ManualJsInsert).ManualJsInsert
			vOpts := append(opts,
				db.WithValidateField("java_script_choice"),
	...
	case *CloudfrontType_DisableMobileSdk:
		if fv, exists := v.FldValidators["mobile_sdk_choice.disable_mobile_sdk"]; exists {
			val := m.GetMobileSdkChoice().(*CloudfrontType_DisableMobileSdk).DisableMobileSdk
			vOpts := append(opts,
				db.WithValidateField("mobile_sdk_choice"),
	...
	case *CloudfrontType_MobileSdkConfig:
		if fv, exists := v.FldValidators["mobile_sdk_choice.mobile_sdk_config"]; exists {
			val := m.GetMobileSdkChoice().(*CloudfrontType_MobileSdkConfig).MobileSdkConfig
			vOpts := append(opts,
				db.WithValidateField("mobile_sdk_choice"),
...
// Well-known symbol for default validator implementation
var DefaultCloudfrontTypeValidator = func() *ValidateCloudfrontType {
	v := &ValidateCloudfrontType{FldValidators: map[string]db.ValidatorFunc{}}
	...
	vrhAwsConfigurationTypeChoice := v.AwsConfigurationTypeChoiceValidationRuleHandler
	rulesAwsConfigurationTypeChoice := map[string]string{
		"ves.io.schema.rules.message.required_oneof": "true",
	}
	vFn, err = vrhAwsConfigurationTypeChoice(rulesAwsConfigurationTypeChoice)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.aws_configuration_type_choice: %s", err)
		panic(errMsg)
	}
	v.FldValidators["aws_configuration_type_choice"] = vFn
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.java_script_choice: %s", err)
		panic(errMsg)
	}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.mobile_sdk_choice: %s", err)
		panic(errMsg)
	}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.protected_endpoints: %s", err)
		panic(errMsg)
	}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.trusted_clients: %s", err)
		panic(errMsg)
	}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.timeout: %s", err)
		panic(errMsg)
	}
	v.FldValidators["timeout"] = vFn

	vrhDataSample := v.DataSampleValidationRuleHandler
	rulesDataSample := map[string]string{
		"ves.io.schema.rules.uint32.gte": "0",
		"ves.io.schema.rules.uint32.lte": "1048576",
	}
	vFn, err = vrhDataSample(rulesDataSample)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.data_sample: %s", err)
		panic(errMsg)
	}
	v.FldValidators["data_sample"] = vFn
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for CloudfrontType.continue_mitigation_action_hdr: %s", err)
		panic(errMsg)
	}
	v.FldValidators["continue_mitigation_action_hdr"] = vFn

	v.FldValidators["aws_configuration_type_choice.aws_configuration_id_selector"] = DistributionIDListValidator().Validate
	v.FldValidators["aws_configuration_type_choice.aws_configuration_tag_selector"] = DistributionTagListValidator().Validate
...
func CloudfrontTypeValidator() db.Validator {
	return DefaultCloudfrontTypeValidator
}
...
func (m *DistributionIDList) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *DistributionIDList) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *DistributionIDList) DeepCopy() *DistributionIDList {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *DistributionIDList) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *DistributionIDList) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return DistributionIDListValidator().Validate(ctx, m, opts...)
}

type ValidateDistributionIDList struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateDistributionIDList) IdsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateDistributionIDList) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*DistributionIDList)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *DistributionIDList got type %s", t)
		}
	}
	if m == nil {
		return nil
...
// Well-known symbol for default validator implementation
var DefaultDistributionIDListValidator = func() *ValidateDistributionIDList {
	v := &ValidateDistributionIDList{FldValidators: map[string]db.ValidatorFunc{}}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for DistributionIDList.ids: %s", err)
		panic(errMsg)
	}
...
func DistributionIDListValidator() db.Validator {
	return DefaultDistributionIDListValidator
}

// augmented methods on protoc/std generated struct

func (m *DistributionTagList) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *DistributionTagList) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *DistributionTagList) DeepCopy() *DistributionTagList {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *DistributionTagList) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *DistributionTagList) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return DistributionTagListValidator().Validate(ctx, m, opts...)
}

type ValidateDistributionTagList struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateDistributionTagList) TagsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateDistributionTagList) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*DistributionTagList)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *DistributionTagList got type %s", t)
		}
	}
	if m == nil {
		return nil
...
// Well-known symbol for default validator implementation
var DefaultDistributionTagListValidator = func() *ValidateDistributionTagList {
	v := &ValidateDistributionTagList{FldValidators: map[string]db.ValidatorFunc{}}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for DistributionTagList.tags: %s", err)
		panic(errMsg)
	}
...
func DistributionTagListValidator() db.Validator {
	return DefaultDistributionTagListValidator
}
...
func (v *ValidateJavaScriptInsertType) JavascriptLocationValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateJavaScriptInsertType) JavascriptModeValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
var DefaultJavaScriptInsertTypeValidator = func() *ValidateJavaScriptInsertType {
	...
	vFn, err = vrhJavascriptLocation(rulesJavascriptLocation)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for JavaScriptInsertType.javascript_location: %s", err)
		panic(errMsg)
	}
	v.FldValidators["javascript_location"] = vFn
	...
	vFn, err = vrhJavascriptMode(rulesJavascriptMode)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for JavaScriptInsertType.javascript_mode: %s", err)
		panic(errMsg)
	}
	v.FldValidators["javascript_mode"] = vFn
...
func (v *ValidateProtectedEndpointType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *ProtectedEndpointType_UndefinedFlowLabel:
		if fv, exists := v.FldValidators["flow_label_choice.undefined_flow_label"]; exists {
			val := m.GetFlowLabelChoice().(*ProtectedEndpointType_UndefinedFlowLabel).UndefinedFlowLabel
			vOpts := append(opts,
	...
	case *ProtectedEndpointType_FlowLabel:
		if fv, exists := v.FldValidators["flow_label_choice.flow_label"]; exists {
			val := m.GetFlowLabelChoice().(*ProtectedEndpointType_FlowLabel).FlowLabel
			vOpts := append(opts,
				db.WithValidateField("flow_label_choice"),
