...
import (
	...
	ves_io_schema_shape_bot_defense_bot_endpoint_policy "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_endpoint_policy"
)
