...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nfv_services", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nfv_services/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nfv_services/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/nfv_services", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nfv_services/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.nfv_service.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.nfv_service.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.nfv_service.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nfv_service.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nfv_service.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.nfv_service.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.nfv_service.API.Create' operation on 'nfv_service'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.nfv_service.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.nfv_service.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nfv_service.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nfv_service.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.nfv_service.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.nfv_service.API.Replace' operation on 'nfv_service'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.nfv_service.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nfv_service.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.nfv_service.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nfv_service.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nfv_service.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nfv_service.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.nfv_service.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.nfv_service.API.Delete' operation on 'nfv_service'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.nfv_service.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/nfv_services": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.nfv_service.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/nfv_services/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/nfv_services": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/nfv_services/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nfv_serviceDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "nfv_serviceCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of nfv_service",
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/schemanfv_serviceCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "nfv_serviceCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the NFV service",
                    "title": "spec",
                    "$ref": "#/definitions/schemanfv_serviceGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "nfv_serviceDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a nfv_service",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.nfv_service.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "nfv_serviceEndpointServiceReplaceType": {
            "type": "object",
        ...
        "nfv_serviceF5BigIpAWSReplaceType": {
            "type": "object",
            ...
            "properties": {
                "endpoint_service": {
                    ...
                    "title": "Endpoint Service",
                    "$ref": "#/definitions/nfv_serviceEndpointServiceReplaceType",
                    "x-displayname": "Endpoint Service"
                },
                "tags": {
                    "type": "object",
        ...
        "nfv_serviceGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read nfv_service",
        ...
        "nfv_serviceGetResponseFormatCode": {
            "type": "string",
        ...
        "nfv_serviceListResponse": {
            ...
            "title": "ListResponse is the collection of nfv_service",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.nfv_service.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/nfv_serviceListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "nfv_serviceListResponseItem": {
            "type": "object",
            "description": "By default a summary of nfv_service is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of nfv_service",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.nfv_service.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this nfv_service",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this nfv_service",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates nfv_service is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this nfv_service",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this nfv_service\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this nfv_service\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "nfv_servicePaloAltoFWAWSReplaceType": {
            "type": "object",
            "description": "Virtual PaloAlto Firewall specification",
            "title": "Virtual PaloAlto Firewall",
            "x-displayname": "Virtual PaloAlto Firewall",
            "x-ves-proto-message": "ves.io.schema.nfv_service.PaloAltoFWAWSReplaceType",
            "properties": {
                "tags": {
                    "type": "object",
                    "description": " AWS Tags is a label consisting of a user-defined key and value.\n It helps to manage, identify, organize, search for, and filter resources in AWS console.\n\nExample: - \"devstaging\"-\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.max_len: 127\n  ves.io.schema.rules.map.max_pairs: 40\n  ves.io.schema.rules.map.values.string.max_len: 255\n",
        ...
        "nfv_serviceReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a nfv_service",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the NFV service",
                    "title": "spec",
                    "$ref": "#/definitions/schemanfv_serviceReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "nfv_serviceReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.nfv_service.ReplaceResponse"
        },
        ...
        "schemanfv_serviceCreateSpecType": {
            "type": "object",
            "description": "Creates a new NFV service with configured parameters",
            "title": "Create NFV Service",
        ...
        "schemanfv_serviceGetSpecType": {
            "type": "object",
            "description": "Gets NFV Service parameters",
            "title": "Get NFV Service",
        ...
        "schemanfv_serviceReplaceSpecType": {
            "type": "object",
            "description": "Replaces configured NFV Service with new set of parameters",
            "title": "Replace NFV Service",
            ...
            "properties": {
                ...
                "f5_big_ip_aws_service": {
                    "description": "Exclusive with [palo_alto_fw_service]\n Virtual BIG-IP service to be deployed on AWS",
                    "$ref": "#/definitions/nfv_serviceF5BigIpAWSReplaceType",
                    "x-displayname": "Virtual BIG-IP on AWS"
                },
                "https_management": {
                    "description": "Exclusive with [disable_https_management]\n Enable HTTPS based management",
                ...
                "palo_alto_fw_service": {
                    "description": "Exclusive with [f5_big_ip_aws_service]\n Palo Alto Networks VM-Series Firewall to be deployed on AWS Cloud",
                    "$ref": "#/definitions/nfv_servicePaloAltoFWAWSReplaceType",
                    "x-displayname": "Palo Alto Networks VM-Series Firewall on AWS"
                }
            }
        },
    ...
    "x-displayname": "NFV Service",
    "x-ves-proto-file": "ves.io/schema/nfv_service/public_crudapi.proto"
}`
