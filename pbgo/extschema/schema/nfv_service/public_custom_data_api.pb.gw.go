...
func request_CustomDataAPI_Metrics_0(ctx context.Context, marshaler runtime.Marshaler, client CustomDataAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_CustomDataAPI_Metrics_0(ctx context.Context, marshaler runtime.Marshaler, server CustomDataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MetricsRequest
	var metadata runtime.ServerMetadata
...
func RegisterCustomDataAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomDataAPIServer) error {
	...
	mux.Handle("POST", pattern_CustomDataAPI_Metrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomDataAPI_Metrics_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CustomDataAPI_Metrics_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCustomDataAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomDataAPIClient) error {
	...
	mux.Handle("POST", pattern_CustomDataAPI_Metrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CustomDataAPI_Metrics_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CustomDataAPI_Metrics_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"public", "namespaces", "namespace", "nfv_services", "metrics"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_CustomDataAPI_Metrics_0 = runtime.ForwardResponseMessage
)
