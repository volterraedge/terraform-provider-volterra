...
const (
	ObjectDefTblName = "ves.io.schema.nfv_service.Object.default"
	ObjectType       = "ves.io.schema.nfv_service.Object"

	StatusObjectDefTblName = "ves.io.schema.nfv_service.StatusObject.default"
	StatusObjectType       = "ves.io.schema.nfv_service.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.nfv_service.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.nfv_service.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.nfv_service.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.nfv_service.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.nfv_service.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "nfv_service.Object")
	if err != nil {
...
func (v *ValidateStatusObject) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	if fv, exists := v.FldValidators["external_cname"]; exists {

		vOpts := append(opts, db.WithValidateField("external_cname"))
		if err := fv(ctx, e.GetExternalCname(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["software_version"]; exists {
		...
		if err := fv(ctx, e.GetSoftwareVersion(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["vip"]; exists {
		...
		if err := fv(ctx, e.GetVip(), vOpts...); err != nil {
			return err
		}
