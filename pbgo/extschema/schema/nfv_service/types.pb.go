...
type ServiceNodesAWSType struct {
	...
	// BigIp Mgmt Subnet Choices
	//
	// x-displayName: "Subnet for BigIp Mgmt Interface"
	// x-required
	// Subnet for the BigIp Mgmt Interface of the node
	//
...
// F5 BigIP AWS TGW Site
//
// x-displayName: "F5 BigIP AWS TGW Site"
// F5 BigIP AWS TGW site specification
...
// F5 BigIP AWS VPC Site
//
// x-displayName: "F5 BigIP AWS VPC Site"
...
// F5 BigIP AWS BYOL Image
//
// x-displayName: "F5 BigIP AWS BYOL Image"
// F5 BigIP AWS VPC site specification
type F5BigIpAWSBYOLImageType struct {
	// BigIp AWS Image
	//
	// x-displayName: "BigIp AWS Image"
	// x-required
	// x-example: "image1"
...
// Virtual F5 BigIP AWS
//
// x-displayName: "Virtual F5 BigIP AWS"
// Virtual F5 BigIP specification for AWS
...
type PaloAltoServiceNodesAWSType struct {
	...
	// Mgmt Subnet Choices
	//
	// x-displayName: "Subnet for Mgmt Interface"
	// x-required
	// Subnet for the Mgmt Interface of the node
	//
	// Types that are valid to be assigned to MgmtSubnetChoice:
...
var fileDescriptor_a04d33a158d31df9 = []byte{
	...
	,
}
...
func (m *SSHManagementType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SshPorts) > 0 {
		dAtA42 := make([]byte, len(m.SshPorts)*10)
		var j41 int
