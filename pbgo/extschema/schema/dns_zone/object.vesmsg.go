...
func (m *DNSZoneStatus) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *DNSZoneStatus) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *DNSZoneStatus) DeepCopy() *DNSZoneStatus {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *DNSZoneStatus) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *DNSZoneStatus) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return DNSZoneStatusValidator().Validate(ctx, m, opts...)
}

type ValidateDNSZoneStatus struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateDNSZoneStatus) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*DNSZoneStatus)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *DNSZoneStatus got type %s", t)
		}
	}
	if m == nil {
		return nil
	...
	if fv, exists := v.FldValidators["dnssec"]; exists {

		vOpts := append(opts, db.WithValidateField("dnssec"))
		if err := fv(ctx, m.GetDnssec(), vOpts...); err != nil {
			return err
		}
...
var DefaultDNSZoneStatusValidator = func() *ValidateDNSZoneStatus {
	v := &ValidateDNSZoneStatus{FldValidators: map[string]db.ValidatorFunc{}}

	v.FldValidators["dnssec"] = DNSSECStatusValidator().Validate

	return v
}()

func DNSZoneStatusValidator() db.Validator {
	return DefaultDNSZoneStatusValidator
}
