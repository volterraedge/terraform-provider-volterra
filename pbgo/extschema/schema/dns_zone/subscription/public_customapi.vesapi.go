...
func (c *CustomAPIGrpcClient) doRPCSubscribe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.dns_zone.subscription.SubscribeRequest", yamlReq)
	}
...
func (c *CustomAPIGrpcClient) doRPCUnsubscribe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.dns_zone.subscription.UnsubscribeRequest", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCSubscribe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &SubscribeRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.dns_zone.subscription.SubscribeRequest: %s", yamlReq, err)
	}
...
func (c *CustomAPIRestClient) doRPCUnsubscribe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &UnsubscribeRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.dns_zone.subscription.UnsubscribeRequest: %s", yamlReq, err)
	}
...
func (c *customAPIInprocClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*SubscribeResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_zone.subscription.CustomAPI.Subscribe")
...
func (c *customAPIInprocClient) Unsubscribe(ctx context.Context, in *UnsubscribeRequest, opts ...grpc.CallOption) (*UnsubscribeResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_zone.subscription.CustomAPI.Unsubscribe")
...
func (s *customAPISrv) Subscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.dns_zone.subscription.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.dns_zone.subscription.SubscribeRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.dns_zone.subscription.CustomAPI.Subscribe"); rvFn != nil {
...
func (s *customAPISrv) Unsubscribe(ctx context.Context, in *UnsubscribeRequest) (*UnsubscribeResponse, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.dns_zone.subscription.UnsubscribeRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.dns_zone.subscription.CustomAPI.Unsubscribe"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
var CustomAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Use this API to subscribe to F5XC DNS Management",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/system/dns_management/addon/subscribe": {
            "post": {
            ...
            "x-ves-proto-service": "ves.io.schema.dns_zone.subscription.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/system/dns_management/addon/unsubscribe": {
            "post": {
    ...
    "definitions": {
        "subscriptionSubscribeRequest": {
            "type": "object",
            "description": "Request to subscribe to DNS Management",
            "title": "SubscribeRequest",
            "x-displayname": "Subscribe Request",
            "x-ves-proto-message": "ves.io.schema.dns_zone.subscription.SubscribeRequest"
        },
        "subscriptionSubscribeResponse": {
            "type": "object",
            "description": "Response of subscribe to DNS Management",
            "title": "SubscribeResponse",
            "x-displayname": "Subscribe Response",
            "x-ves-proto-message": "ves.io.schema.dns_zone.subscription.SubscribeResponse"
        },
        "subscriptionUnsubscribeRequest": {
            "type": "object",
            "description": "Request to unsubscribe to DNS Management",
            "title": "UnsubscribeRequest",
            "x-displayname": "Unsubscribe Request",
            "x-ves-proto-message": "ves.io.schema.dns_zone.subscription.UnsubscribeRequest"
        },
        "subscriptionUnsubscribeResponse": {
            "type": "object",
            "description": "Response of unsubscribe to DNS Management",
            "title": "UnsubscribeResponse",
            "x-displayname": "Unsubscribe Response",
            "x-ves-proto-message": "ves.io.schema.dns_zone.subscription.UnsubscribeResponse"
        }
    },
    "x-displayname": "F5XC DNS Management Subscription API",
    "x-ves-proto-file": "ves.io/schema/dns_zone/subscription/public_customapi.proto"
}`
