...
var (
	pattern_CustomAPI_Subscribe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"public", "namespaces", "system", "dns_management", "addon", "subscribe"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Unsubscribe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"public", "namespaces", "system", "dns_management", "addon", "unsubscribe"}, "", runtime.AssumeColonVerbOpt(false)))
)
