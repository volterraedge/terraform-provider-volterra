...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.dns_zone.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.dns_zone")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.dns_zone")
	}
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_zones": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_zone-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/dns_zones/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_zone-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/dns_zones": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_zone-api-list"
                },
        ...
        "/public/namespaces/{namespace}/dns_zones/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_zone-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_zone-api-delete"
                },
    ...
    "definitions": {
        ...
        "dns_zoneDNSLBResourceRecord": {
            "type": "object",
            "description": "x-displayName: \"DNS LB Record\"\nDNS Load Balancer Record",
        ...
        "dns_zoneDNSSRVResourceRecord": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description": "\nExample: - \"www or mail or * or corp.web or *.b\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.pattern: ^([*]|_[a-zA-Z0-9]{1,62})\\\\._[a-zA-Z0-9]{1,62}$\n",
                    "title": "Record Name",
                    "x-displayname": "Record Name",
                    "x-ves-example": "www or mail or * or corp.web or *.b",
                    "x-ves-required": "true",
        ...
        "dns_zoneGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/dns_zoneObject",
        ...
        "dns_zoneObject": {
            ...
            "title": "DNS Zone",
            "x-displayname": "DNS Zone",
            "x-ves-proto-message": "ves.io.schema.dns_zone.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "dns_zoneRRSet": {
            ...
            "x-ves-oneof-field-type_record_set": "[\"a_record\",\"aaaa_record\",\"alias_record\",\"caa_record\",\"cname_record\",\"mx_record\",\"ns_record\",\"ptr_record\",\"srv_record\",\"txt_record\"]",
            "x-ves-proto-message": "ves.io.schema.dns_zone.RRSet",
            "properties": {
                "a_record": {
                    "description": "Exclusive with [aaaa_record alias_record caa_record cname_record mx_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "A Record",
                    "$ref": "#/definitions/dns_zoneDNSAResourceRecord",
                    "x-displayname": "A"
                },
                "aaaa_record": {
                    "description": "Exclusive with [a_record alias_record caa_record cname_record mx_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "AAAA Record",
                    "$ref": "#/definitions/dns_zoneDNSAAAAResourceRecord",
                    "x-displayname": "AAAA"
                },
                "alias_record": {
                    "description": "Exclusive with [a_record aaaa_record caa_record cname_record mx_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "ALIAS Record",
                    "$ref": "#/definitions/dns_zoneDNSAliasResourceRecord",
                    "x-displayname": "ALIAS"
                },
                "caa_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record cname_record mx_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "CAA Record",
                    "$ref": "#/definitions/dns_zoneDNSCAAResourceRecord",
                    "x-displayname": "CAA"
                },
                "cname_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record mx_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "CNAME Record",
                    "$ref": "#/definitions/dns_zoneDNSCNAMEResourceRecord",
                    "x-displayname": "CNAME"
                },
                "mx_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record cname_record ns_record ptr_record srv_record txt_record]\n",
                    "title": "MX Record",
                    "$ref": "#/definitions/dns_zoneDNSMXResourceRecord",
                    "x-displayname": "MX"
                },
                "ns_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record cname_record mx_record ptr_record srv_record txt_record]\n",
                    "title": "NS Record",
                    "$ref": "#/definitions/dns_zoneDNSNSResourceRecord",
                    "x-displayname": "NS"
                },
                "ptr_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record cname_record mx_record ns_record srv_record txt_record]\n",
                    "title": "PTR Record",
                    "$ref": "#/definitions/dns_zoneDNSPTRResourceRecord",
                    "x-displayname": "PTR"
                },
                "srv_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record cname_record mx_record ns_record ptr_record txt_record]\n",
                    "title": "SRV Record",
                ...
                "txt_record": {
                    "description": "Exclusive with [a_record aaaa_record alias_record caa_record cname_record mx_record ns_record ptr_record srv_record]\n",
                    "title": "TXT Record",
