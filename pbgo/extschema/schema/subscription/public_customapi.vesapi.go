...
var CustomAPISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/system/addon/subscribe": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-subscription-customapi-subscribe"
                },
        ...
        "/public/namespaces/system/addon/unsubscribe": {
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-subscription-customapi-unsubscribe"
                },
    ...
    "definitions": {
        ...
        "subscriptionSubscribeRequest": {
            ...
            "x-ves-oneof-field-addon_choice": "[\"f5xc_appstack_standard\",\"f5xc_securemesh_advanced\",\"f5xc_securemesh_standard\",\"f5xc_site_management_standard\",\"f5xc_waap_advanced\",\"f5xc_waap_standard\",\"f5xc_web_app_scanning_standard\"]",
            "x-ves-proto-message": "ves.io.schema.subscription.SubscribeRequest",
            "properties": {
                "f5xc_appstack_standard": {
                    "description": "Exclusive with [f5xc_securemesh_advanced f5xc_securemesh_standard f5xc_site_management_standard f5xc_waap_advanced f5xc_waap_standard f5xc_web_app_scanning_standard]\n addon-Appstack tier-standard",
                    "title": "addon-Appstack tier-standard",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "appstack standard"
                },
                "f5xc_securemesh_advanced": {
                    "description": "Exclusive with [f5xc_appstack_standard f5xc_securemesh_standard f5xc_site_management_standard f5xc_waap_advanced f5xc_waap_standard f5xc_web_app_scanning_standard]\n addon-Securemesh tier-advanced",
                    "title": "addon-Securemesh tier-advanced",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "secure mesh advance"
                },
                "f5xc_securemesh_standard": {
                    "description": "Exclusive with [f5xc_appstack_standard f5xc_securemesh_advanced f5xc_site_management_standard f5xc_waap_advanced f5xc_waap_standard f5xc_web_app_scanning_standard]\n addon-Securemesh tier-standard",
                    "title": "addon-Securemesh tier-standard",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "secure mesh standard"
                },
                "f5xc_site_management_standard": {
                    "description": "Exclusive with [f5xc_appstack_standard f5xc_securemesh_advanced f5xc_securemesh_standard f5xc_waap_advanced f5xc_waap_standard f5xc_web_app_scanning_standard]\n addon-Sitemanagement tier-standard ",
                    "title": "addon-Sitemanagement tier-standard",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Site management standard"
                },
                "f5xc_waap_advanced": {
                    "description": "Exclusive with [f5xc_appstack_standard f5xc_securemesh_advanced f5xc_securemesh_standard f5xc_site_management_standard f5xc_waap_standard f5xc_web_app_scanning_standard]\n addon-WAAP tier-advanced",
                    "title": "addon-WAAP tier-advanced",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "WAAP advance"
                },
                "f5xc_waap_standard": {
                    "description": "Exclusive with [f5xc_appstack_standard f5xc_securemesh_advanced f5xc_securemesh_standard f5xc_site_management_standard f5xc_waap_advanced f5xc_web_app_scanning_standard]\n addon-WAAP tier-standard",
