...
const (
	ObjectDefTblName = "ves.io.schema.subscription.Object.default"
	ObjectType       = "ves.io.schema.subscription.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.subscription.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.subscription.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
