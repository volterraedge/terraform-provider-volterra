...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/subscription"
)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*ObjectGetRsp, error) {
	...
	sl := strings.Split("ves.io.schema.subscription.crudapi", ".")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.subscription.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.subscription.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subscription.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subscription.crudapi.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.subscription.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.subscription.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subscription.crudapi.API.Get"); rvFn != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subscription.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/subscription/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.subscription/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.subscription.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "subscription",
            "x-ves-object-type": "ves.io.schema.subscription.Object",
            "x-ves-proto-service": "ves.io.schema.subscription.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.subscription/Objects": {
            "get": {
                "operationId": "ves.io.schema.subscription.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.subscription/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.subscription.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.subscription/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.subscription.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.subscription/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.subscription.crudapi.API.List",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subscription.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "err": {
                    "$ref": "#/definitions/subscriptioncrudapiErrorCode"
                },
                "metadata": {
                ...
                "spec": {
                    "$ref": "#/definitions/subscriptionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subscription.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/subscriptioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subscription.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/subscription/crudapi/api.proto"
}`
