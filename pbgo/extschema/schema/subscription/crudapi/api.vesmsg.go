...
import (
	...
	ves_io_schema_subscription "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/subscription"
)
...
func (m *ObjectGetRsp) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_subscription.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_subscription.DBObject)
	}
	_ = f
