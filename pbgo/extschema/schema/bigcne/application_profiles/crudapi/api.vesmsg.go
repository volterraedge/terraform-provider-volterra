...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_bigcne_application_profiles.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_bigcne_application_profiles.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_bigcne_application_profiles.DBObject)
	}
	_ = f
