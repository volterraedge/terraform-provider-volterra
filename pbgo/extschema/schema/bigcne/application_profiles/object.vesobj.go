...
const (
	ObjectDefTblName = "ves.io.schema.bigcne.application_profiles.Object.default"
	ObjectType       = "ves.io.schema.bigcne.application_profiles.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.bigcne.application_profiles.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.bigcne.application_profiles.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
