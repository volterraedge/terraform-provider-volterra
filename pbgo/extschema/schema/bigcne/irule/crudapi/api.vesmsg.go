...
import (
	...
	ves_io_schema_bigcne_irule "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/bigcne/irule"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_bigcne_irule.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_bigcne_irule.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_bigcne_irule.DBObject)
	}
	_ = f
