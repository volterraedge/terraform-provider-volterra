...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/application/discovered"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.application.discovered.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.discovered.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.discovered.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.discovered.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.discovered.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.discovered.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.discovered.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.discovered.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.discovered.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.discovered.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.discovered.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.discovered.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.discovered.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/application/discovered/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.application.discovered/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "discovered",
            "x-ves-object-type": "ves.io.schema.uztna.application.discovered.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.application.discovered.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.application.discovered/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "discovered",
            "x-ves-object-type": "ves.io.schema.uztna.application.discovered.Object",
        ...
        "/ves.io.schema.uztna.application.discovered/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-discovered-crudapi-api-liststream"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.discovered.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "discovered",
            "x-ves-object-type": "ves.io.schema.uztna.application.discovered.Object",
        ...
        "/ves.io.schema.uztna.application.discovered/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.discovered/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.discovered/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.discovered/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.application.discovered.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/discoveredSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/discoveredcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/discoveredcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/discoveredcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/discoveredcrudapiErrorCode"
                },
        ...
        "discoveredApplicationLocation": {
            "type": "object",
            "description": "Defines BIG-IP Next Instance Details",
            "title": "ApplicationLocation",
            "x-displayname": "Application Location",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.ApplicationLocation",
            "properties": {
                "hostname": {
                    "type": "string",
                    "description": " FQDN of Instance\n\nExample: - \"bigip-next.asia.com\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.hostname: true\n",
                    "title": "hostname",
                ...
                "ip_address": {
                    "type": "string",
                    "description": " Management IP of the BIG-IP Next Instance\n\nExample: - \"202.14.23.121\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ip: true\n",
                    "title": "ip_address",
                    "x-displayname": "IP Address",
                    "x-ves-example": "202.14.23.121",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.ip": "true"
                    }
                },
                "site_name": {
                    "type": "string",
                    "description": " BIG-IP Next CE Site on which this Instance is running\n\nExample: - \"CE-Mumbai\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.not_empty: true\n",
                    "title": "site_name",
                ...
                "virtual_servers": {
                    "type": "array",
                    "description": " List of Virtual Servers deployed on this Instance\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 10\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "virtual_servers",
                    "maxItems": 10,
                    "items": {
                        "$ref": "#/definitions/discoveredVirtualServer"
                    },
        ...
        "discoveredGlobalSpecType": {
            "type": "object",
            "description": "Defines actual Discovered CM Application shape in DB",
            "title": "GlobalSpecType",
            "x-displayname": "GlobalSpecType",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.GlobalSpecType",
            "properties": {
                "cm_site_name": {
                    "type": "string",
                    "description": " Name of the Central Manager site\n\nExample: - \"cm01-eastern-us\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.not_empty: true\n",
                    "title": "cm site name",
                ...
                "locations": {
                    "type": "array",
                    "description": " Locations of the BIG-IP Next Instances\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 50\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "locations",
                    "maxItems": 50,
                    "items": {
                        "$ref": "#/definitions/discoveredApplicationLocation"
                    },
        ...
        "discoveredSpecType": {
            "type": "object",
            "title": "Shape of Discovered CM Application",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/discoveredGlobalSpecType",
        ...
        "discoveredVirtualServer": {
            "type": "object",
            "description": "Defines Virtual Server Details",
            "title": "VirtualServer",
            "x-displayname": "Virtual Server",
            "x-ves-proto-message": "ves.io.schema.uztna.application.discovered.VirtualServer",
            "properties": {
                "ip_address": {
                    "type": "string",
                    "description": " VIP serving the Discovered App on the corresponding BIG-IP Next Instance\n\nExample: - \"192.168.1.2\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ip: true\n",
                    "title": "ip_address",
                    "x-displayname": "IP Address",
        ...
        "discoveredcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.application.discovered.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/application/discovered/crudapi/api.proto"
}`
