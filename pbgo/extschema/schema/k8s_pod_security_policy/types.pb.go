...
func NewPopulatedCapabilityListType(r randyTypes, easy bool) *CapabilityListType {
	this := &CapabilityListType{}
	v1 := r.Intn(10)
	this.Capabilities = make([]string, v1)
	for i := 0; i < v1; i++ {
		this.Capabilities[i] = string(randStringTypes(r))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedHostPathType(r randyTypes, easy bool) *HostPathType {
	this := &HostPathType{}
...
func NewPopulatedIDRangeType(r randyTypes, easy bool) *IDRangeType {
	this := &IDRangeType{}
	this.MinId = uint32(r.Uint32())
	this.MaxId = uint32(r.Uint32())
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedIDStrategyOptionsType(r randyTypes, easy bool) *IDStrategyOptionsType {
	this := &IDStrategyOptionsType{}
	if r.Intn(10) != 0 {
		v2 := r.Intn(5)
		this.IdRanges = make([]*IDRangeType, v2)
		for i := 0; i < v2; i++ {
			this.IdRanges[i] = NewPopulatedIDRangeType(r, easy)
		}
	}
	this.Rule = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedRuntimeClassStrategyOptions(r randyTypes, easy bool) *RuntimeClassStrategyOptions {
	this := &RuntimeClassStrategyOptions{}
	v3 := r.Intn(10)
	this.AllowedRuntimeClassNames = make([]string, v3)
	for i := 0; i < v3; i++ {
		this.AllowedRuntimeClassNames[i] = string(randStringTypes(r))
	}
	this.DefaultRuntimeClassName = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedSELinuxStrategyOptions(r randyTypes, easy bool) *SELinuxStrategyOptions {
	this := &SELinuxStrategyOptions{}
	this.Rule = string(randStringTypes(r))
	this.Level = string(randStringTypes(r))
	this.Role = string(randStringTypes(r))
...
func NewPopulatedPodSecurityPolicySpecType(r randyTypes, easy bool) *PodSecurityPolicySpecType {
	this := &PodSecurityPolicySpecType{}
	this.Privileged = bool(bool(r.Intn(2) == 0))
	this.AllowPrivilegeEscalation = bool(bool(r.Intn(2) == 0))
	this.DefaultAllowPrivilegeEscalation = bool(bool(r.Intn(2) == 0))
	oneofNumber_DefaultCapabilitiesChoice := []int32{5, 6}[r.Intn(2)]
	switch oneofNumber_DefaultCapabilitiesChoice {
	case 5:
		this.DefaultCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_NoDefaultCapabilities(r, easy)
	case 6:
		this.DefaultCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_DefaultCapabilities(r, easy)
	}
	oneofNumber_AllowedCapabilitiesChoice := []int32{8, 9}[r.Intn(2)]
	switch oneofNumber_AllowedCapabilitiesChoice {
	case 8:
		this.AllowedCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_NoAllowedCapabilities(r, easy)
	case 9:
		this.AllowedCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_AllowedCapabilities(r, easy)
	}
	oneofNumber_DropCapabilitiesChoice := []int32{11, 12}[r.Intn(2)]
	switch oneofNumber_DropCapabilitiesChoice {
	case 11:
		this.DropCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_NoDropCapabilities(r, easy)
	case 12:
		this.DropCapabilitiesChoice = NewPopulatedPodSecurityPolicySpecType_DropCapabilities(r, easy)
	}
	v4 := r.Intn(10)
	this.Volumes = make([]string, v4)
	for i := 0; i < v4; i++ {
		this.Volumes[i] = string(randStringTypes(r))
	}
	v5 := r.Intn(10)
	this.AllowedFlexVolumes = make([]string, v5)
	for i := 0; i < v5; i++ {
		this.AllowedFlexVolumes[i] = string(randStringTypes(r))
	}
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.AllowedHostPaths = make([]*HostPathType, v6)
		for i := 0; i < v6; i++ {
			this.AllowedHostPaths[i] = NewPopulatedHostPathType(r, easy)
		}
	}
	v7 := r.Intn(10)
	this.AllowedProcMounts = make([]string, v7)
	for i := 0; i < v7; i++ {
		this.AllowedProcMounts[i] = string(randStringTypes(r))
	}
	this.ReadOnlyRootFilesystem = bool(bool(r.Intn(2) == 0))
	v8 := r.Intn(10)
	this.AllowedCsiDrivers = make([]string, v8)
	for i := 0; i < v8; i++ {
		this.AllowedCsiDrivers[i] = string(randStringTypes(r))
	}
	this.HostNetwork = bool(bool(r.Intn(2) == 0))
	this.HostPortRanges = string(randStringTypes(r))
	this.HostIpc = bool(bool(r.Intn(2) == 0))
	this.HostPid = bool(bool(r.Intn(2) == 0))
	v9 := r.Intn(10)
	this.AllowedUnsafeSysctls = make([]string, v9)
	for i := 0; i < v9; i++ {
		this.AllowedUnsafeSysctls[i] = string(randStringTypes(r))
	}
	v10 := r.Intn(10)
	this.ForbiddenSysctls = make([]string, v10)
	for i := 0; i < v10; i++ {
		this.ForbiddenSysctls[i] = string(randStringTypes(r))
	}
	oneofNumber_UserChoice := []int32{26, 27}[r.Intn(2)]
	switch oneofNumber_UserChoice {
	case 26:
		this.UserChoice = NewPopulatedPodSecurityPolicySpecType_NoRunAsUser(r, easy)
	case 27:
		this.UserChoice = NewPopulatedPodSecurityPolicySpecType_RunAsUser(r, easy)
	}
	oneofNumber_GroupChoice := []int32{29, 30}[r.Intn(2)]
	switch oneofNumber_GroupChoice {
	case 29:
		this.GroupChoice = NewPopulatedPodSecurityPolicySpecType_NoRunAsGroup(r, easy)
	case 30:
		this.GroupChoice = NewPopulatedPodSecurityPolicySpecType_RunAsGroup(r, easy)
	}
	oneofNumber_SupplementalGroupChoice := []int32{32, 33}[r.Intn(2)]
	switch oneofNumber_SupplementalGroupChoice {
	case 32:
		this.SupplementalGroupChoice = NewPopulatedPodSecurityPolicySpecType_NoSupplementalGroups(r, easy)
	case 33:
		this.SupplementalGroupChoice = NewPopulatedPodSecurityPolicySpecType_SupplementalGroups(r, easy)
	}
	oneofNumber_FsGroupChoice := []int32{35, 36}[r.Intn(2)]
	switch oneofNumber_FsGroupChoice {
	case 35:
		this.FsGroupChoice = NewPopulatedPodSecurityPolicySpecType_NoFsGroups(r, easy)
	case 36:
		this.FsGroupChoice = NewPopulatedPodSecurityPolicySpecType_FsGroupStrategyOptions(r, easy)
	}
	oneofNumber_SeLinuxChoice := []int32{38, 39}[r.Intn(2)]
	switch oneofNumber_SeLinuxChoice {
	case 38:
		this.SeLinuxChoice = NewPopulatedPodSecurityPolicySpecType_NoSeLinuxOptions(r, easy)
	case 39:
		this.SeLinuxChoice = NewPopulatedPodSecurityPolicySpecType_SeLinuxOptions(r, easy)
	}
	oneofNumber_RuntimeClassChoice := []int32{41, 42}[r.Intn(2)]
	switch oneofNumber_RuntimeClassChoice {
	case 41:
		this.RuntimeClassChoice = NewPopulatedPodSecurityPolicySpecType_NoRuntimeClass(r, easy)
	case 42:
		this.RuntimeClassChoice = NewPopulatedPodSecurityPolicySpecType_RuntimeClass(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedPodSecurityPolicySpecType_NoDefaultCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoDefaultCapabilities {
	this := &PodSecurityPolicySpecType_NoDefaultCapabilities{}
	this.NoDefaultCapabilities = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_DefaultCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_DefaultCapabilities {
	this := &PodSecurityPolicySpecType_DefaultCapabilities{}
	this.DefaultCapabilities = NewPopulatedCapabilityListType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoAllowedCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoAllowedCapabilities {
	this := &PodSecurityPolicySpecType_NoAllowedCapabilities{}
	this.NoAllowedCapabilities = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_AllowedCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_AllowedCapabilities {
	this := &PodSecurityPolicySpecType_AllowedCapabilities{}
	this.AllowedCapabilities = NewPopulatedCapabilityListType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoDropCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoDropCapabilities {
	this := &PodSecurityPolicySpecType_NoDropCapabilities{}
	this.NoDropCapabilities = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_DropCapabilities(r randyTypes, easy bool) *PodSecurityPolicySpecType_DropCapabilities {
	this := &PodSecurityPolicySpecType_DropCapabilities{}
	this.DropCapabilities = NewPopulatedCapabilityListType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoRunAsUser(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoRunAsUser {
	this := &PodSecurityPolicySpecType_NoRunAsUser{}
	this.NoRunAsUser = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_RunAsUser(r randyTypes, easy bool) *PodSecurityPolicySpecType_RunAsUser {
	this := &PodSecurityPolicySpecType_RunAsUser{}
	this.RunAsUser = NewPopulatedIDStrategyOptionsType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoRunAsGroup(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoRunAsGroup {
	this := &PodSecurityPolicySpecType_NoRunAsGroup{}
	this.NoRunAsGroup = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_RunAsGroup(r randyTypes, easy bool) *PodSecurityPolicySpecType_RunAsGroup {
	this := &PodSecurityPolicySpecType_RunAsGroup{}
	this.RunAsGroup = NewPopulatedIDStrategyOptionsType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoSupplementalGroups(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoSupplementalGroups {
	this := &PodSecurityPolicySpecType_NoSupplementalGroups{}
	this.NoSupplementalGroups = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_SupplementalGroups(r randyTypes, easy bool) *PodSecurityPolicySpecType_SupplementalGroups {
	this := &PodSecurityPolicySpecType_SupplementalGroups{}
	this.SupplementalGroups = NewPopulatedIDStrategyOptionsType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoFsGroups(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoFsGroups {
	this := &PodSecurityPolicySpecType_NoFsGroups{}
	this.NoFsGroups = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_FsGroupStrategyOptions(r randyTypes, easy bool) *PodSecurityPolicySpecType_FsGroupStrategyOptions {
	this := &PodSecurityPolicySpecType_FsGroupStrategyOptions{}
	this.FsGroupStrategyOptions = NewPopulatedIDStrategyOptionsType(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoSeLinuxOptions(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoSeLinuxOptions {
	this := &PodSecurityPolicySpecType_NoSeLinuxOptions{}
	this.NoSeLinuxOptions = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_SeLinuxOptions(r randyTypes, easy bool) *PodSecurityPolicySpecType_SeLinuxOptions {
	this := &PodSecurityPolicySpecType_SeLinuxOptions{}
	this.SeLinuxOptions = NewPopulatedSELinuxStrategyOptions(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_NoRuntimeClass(r randyTypes, easy bool) *PodSecurityPolicySpecType_NoRuntimeClass {
	this := &PodSecurityPolicySpecType_NoRuntimeClass{}
	this.NoRuntimeClass = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedPodSecurityPolicySpecType_RuntimeClass(r randyTypes, easy bool) *PodSecurityPolicySpecType_RuntimeClass {
	this := &PodSecurityPolicySpecType_RuntimeClass{}
	this.RuntimeClass = NewPopulatedRuntimeClassStrategyOptions(r, easy)
	return this
}
func NewPopulatedGlobalSpecType(r randyTypes, easy bool) *GlobalSpecType {
	this := &GlobalSpecType{}
	oneofNumber_ConfigMethodChoice := []int32{2, 3}[r.Intn(2)]
	switch oneofNumber_ConfigMethodChoice {
	case 2:
		this.ConfigMethodChoice = NewPopulatedGlobalSpecType_PspSpec(r, easy)
	case 3:
		this.ConfigMethodChoice = NewPopulatedGlobalSpecType_Yaml(r, easy)
	}
...
func NewPopulatedGlobalSpecType_PspSpec(r randyTypes, easy bool) *GlobalSpecType_PspSpec {
	this := &GlobalSpecType_PspSpec{}
	this.PspSpec = NewPopulatedPodSecurityPolicySpecType(r, easy)
	return this
}
...
func NewPopulatedCreateSpecType(r randyTypes, easy bool) *CreateSpecType {
	...
	switch oneofNumber_ConfigMethodChoice {
	case 2:
		this.ConfigMethodChoice = NewPopulatedCreateSpecType_PspSpec(r, easy)
	case 3:
		this.ConfigMethodChoice = NewPopulatedCreateSpecType_Yaml(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedCreateSpecType_PspSpec(r randyTypes, easy bool) *CreateSpecType_PspSpec {
	this := &CreateSpecType_PspSpec{}
	this.PspSpec = NewPopulatedPodSecurityPolicySpecType(r, easy)
	return this
}
...
func NewPopulatedReplaceSpecType(r randyTypes, easy bool) *ReplaceSpecType {
	...
	switch oneofNumber_ConfigMethodChoice {
	case 2:
		this.ConfigMethodChoice = NewPopulatedReplaceSpecType_PspSpec(r, easy)
	case 3:
		this.ConfigMethodChoice = NewPopulatedReplaceSpecType_Yaml(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedReplaceSpecType_PspSpec(r randyTypes, easy bool) *ReplaceSpecType_PspSpec {
	this := &ReplaceSpecType_PspSpec{}
	this.PspSpec = NewPopulatedPodSecurityPolicySpecType(r, easy)
	return this
}
...
func NewPopulatedGetSpecType(r randyTypes, easy bool) *GetSpecType {
	...
	switch oneofNumber_ConfigMethodChoice {
	case 2:
		this.ConfigMethodChoice = NewPopulatedGetSpecType_PspSpec(r, easy)
	case 3:
		this.ConfigMethodChoice = NewPopulatedGetSpecType_Yaml(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGetSpecType_PspSpec(r randyTypes, easy bool) *GetSpecType_PspSpec {
	this := &GetSpecType_PspSpec{}
	this.PspSpec = NewPopulatedPodSecurityPolicySpecType(r, easy)
	return this
}
...
var fileDescriptorTypes = []byte{
	...
	,
}
