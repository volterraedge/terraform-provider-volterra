...
type Destination struct {
	...
	// x-required
	// Object on which mitigation is to occur
	//
	// Types that are valid to be assigned to Destination:
	//	*Destination_VirtualHost
...
type Destination_VirtualHost struct {
	VirtualHost *views.ObjectRefType `protobuf:"bytes,2,opt,name=virtual_host,json=virtualHost,proto3,oneof" json:"virtual_host,omitempty"`
}

func (*Destination_VirtualHost) isDestination_Destination() {}
...
func (m *Destination) GetVirtualHost() *views.ObjectRefType {
	if x, ok := m.GetDestination().(*Destination_VirtualHost); ok {
...
var fileDescriptor_a812e8894b362209 = []byte{
	...
	,
}
...
func (this *Destination_VirtualHost) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Destination_VirtualHost)
	if !ok {
		that2, ok := that.(Destination_VirtualHost)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Destination_VirtualHost) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dos_mitigation.Destination_VirtualHost{` +
...
func (m *Destination_VirtualHost) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Destination_VirtualHost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *Destination_VirtualHost) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *Destination_VirtualHost) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Destination_VirtualHost{`,
		`VirtualHost:` + strings.Replace(fmt.Sprintf("%v", this.VirtualHost), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Destination) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Destination = &Destination_VirtualHost{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
