...
func (c *customAPIInprocClient) GetSelectees(ctx context.Context, in *SelecteeRequest, opts ...grpc.CallOption) (*SelecteeResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_site.CustomAPI.GetSelectees")
        ...
        "/public/namespaces/{namespace}/virtual_sites/{name}/selectees": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_site-customapi-getselectees"
                },
