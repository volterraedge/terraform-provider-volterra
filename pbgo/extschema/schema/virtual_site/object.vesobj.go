...
const (
	ObjectDefTblName = "ves.io.schema.virtual_site.Object.default"
	ObjectType       = "ves.io.schema.virtual_site.Object"

	StatusObjectDefTblName = "ves.io.schema.virtual_site.StatusObject.default"
	StatusObjectType       = "ves.io.schema.virtual_site.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.virtual_site.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		...
		dri.DRField = "ves.io.schema.virtual_site.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBObject) GetSRefInfo() ([]db.SelrFldInfo, error) {
	var (
		err               error
		srInfos, fsrInfos []db.SelrFldInfo
	)
	fsrInfos, err = e.GetSpecSRefInfo()
	if err != nil {
		return nil, errors.Wrap(err, "Getting object field selector info")
	}
	for _, sri := range fsrInfos {
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		sri.Name = "ves.io.schema.virtual_site.Object." + sri.Name
...
func (e *DBObject) GetSpecSRefInfo() ([]db.SelrFldInfo, error) {
	...
	srInfos, err = e.Spec.GetSRefInfo()
	if err != nil {
		return nil, errors.Wrap(err, "HasSref object field")
	}
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.virtual_site.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.virtual_site.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.virtual_site.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "virtual_site.Object")
	if err != nil {
...
func (o *DBObject) GetSiteType() string {
	return o.GetSpec().GetGcSpec().GetSiteType().String()
}
