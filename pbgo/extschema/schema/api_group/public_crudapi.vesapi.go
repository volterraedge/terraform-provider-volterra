...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/api_groups/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/api_groups", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_group.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.api_group")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_group.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_group.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.api_group.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.api_group.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/api_groups": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api_groupListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.api_group.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/api_groups/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/api_groupGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        "api_groupGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read api_group",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.api_group.GetResponse",
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the api_group",
                    "title": "spec",
                    "$ref": "#/definitions/schemaapi_groupGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "api_groupGetResponseFormatCode": {
            "type": "string",
        ...
        "api_groupListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of api_group",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.api_group.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/api_groupListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "api_groupListResponseItem": {
            "type": "object",
            "description": "By default a summary of api_group is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of api_group",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.api_group.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this api_group",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this api_group",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates api_group is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this api_group",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this api_group\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this api_group\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "schemaapi_groupGetSpecType": {
            "type": "object",
            "description": "Get api_group reads a given object from storage backend for metadata.namespace.",
            "title": "Get api group",
            "x-displayname": "Get API Group",
            "x-ves-proto-message": "ves.io.schema.api_group.GetSpecType",
            "properties": {
                "element_specs": {
                    "type": "array",
    ...
    "x-displayname": "API Group",
    "x-ves-proto-file": "ves.io/schema/api_group/public_crudapi.proto"
}`
