...
func (m *DNSProxyStatus) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *DNSProxyStatus) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *DNSProxyStatus) DeepCopy() *DNSProxyStatus {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *DNSProxyStatus) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *DNSProxyStatus) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return DNSProxyStatusValidator().Validate(ctx, m, opts...)
}

type ValidateDNSProxyStatus struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateDNSProxyStatus) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*DNSProxyStatus)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *DNSProxyStatus got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultDNSProxyStatusValidator = func() *ValidateDNSProxyStatus {
	v := &ValidateDNSProxyStatus{FldValidators: map[string]db.ValidatorFunc{}}

	return v
}()

func DNSProxyStatusValidator() db.Validator {
	return DefaultDNSProxyStatusValidator
}
