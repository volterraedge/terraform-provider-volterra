...
import (
	...
	ves_io_schema_api_credential_credential_validation "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_credential/credential_validation"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_api_credential_credential_validation.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_api_credential_credential_validation.DBObject)
	}
	_ = f
