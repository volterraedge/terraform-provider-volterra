...
const (
	ObjectDefTblName = "ves.io.schema.api_credential.credential_validation.Object.default"
	ObjectType       = "ves.io.schema.api_credential.credential_validation.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.api_credential.credential_validation.Object"
}
...
func GetObjectIndexers() store.Indexers {
	indexers := store.Indexers{
		"spec.gc_spec.digest": store.NewIndexInfo(store.WithSecondaryIndex(func(e store.Entry) ([]string, error) {
			obj, ok := e.(*Object)
			if !ok {
				return nil, fmt.Errorf("Index spec.gc_spec.digest expected *ves.io.schema.api_credential.credential_validation.Object, got %T: %#v", e, e)
			}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.api_credential.credential_validation.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
