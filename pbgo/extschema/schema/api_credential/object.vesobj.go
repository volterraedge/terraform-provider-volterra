...
const (
	ObjectDefTblName = "ves.io.schema.api_credential.Object.default"
	ObjectType       = "ves.io.schema.api_credential.Object"

	StatusObjectDefTblName = "ves.io.schema.api_credential.StatusObject.default"
	StatusObjectType       = "ves.io.schema.api_credential.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.api_credential.Object"
}
...
func GetObjectIndexers() store.Indexers {
	indexers := store.Indexers{
		"spec.gc_spec.digest": store.NewIndexInfo(store.WithSecondaryIndex(func(e store.Entry) ([]string, error) {
			obj, ok := e.(*Object)
			if !ok {
				return nil, fmt.Errorf("Index spec.gc_spec.digest expected *ves.io.schema.api_credential.Object, got %T: %#v", e, e)
			}
			return []string{obj.GetSpec().GetGcSpec().GetDigest()}, nil
		})),
	}
	return indexers
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		...
		dri.DRField = "ves.io.schema.api_credential.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.api_credential.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.api_credential.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.api_credential.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range e.GetObjectRefs() {
		...
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "api_credential.Object",
			RefdUID:    ref.Uid,
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "api_credential.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: api_credential")
	}
