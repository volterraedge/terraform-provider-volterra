...
const (
	ObjectDefTblName = "ves.io.schema.ticket_management.ticket_tracking_system.Object.default"
	ObjectType       = "ves.io.schema.ticket_management.ticket_tracking_system.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.ticket_management.ticket_tracking_system.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.ticket_management.ticket_tracking_system.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
