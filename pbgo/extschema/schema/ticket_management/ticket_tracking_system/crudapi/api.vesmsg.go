...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_ticket_management_ticket_tracking_system.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ticket_management_ticket_tracking_system.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ticket_management_ticket_tracking_system.DBObject)
	}
	_ = f
