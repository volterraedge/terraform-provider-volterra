...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_ticket_management_ticket.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ticket_management_ticket.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ticket_management_ticket.DBObject)
	}
	_ = f
