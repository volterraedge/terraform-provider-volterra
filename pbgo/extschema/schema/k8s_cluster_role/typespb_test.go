...
func TestNonResourceURLListTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &NonResourceURLListType{}
...
func TestNonResourceURLListTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, false)
	size := p.Size()
...
func BenchmarkNonResourceURLListTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NonResourceURLListType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedNonResourceURLListType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkNonResourceURLListTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedNonResourceURLListType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestResourceListTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &ResourceListType{}
	if err := proto.Unmarshal(dAtA, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(dAtA))
...
func TestResourceListTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, false)
	size := p.Size()
...
func BenchmarkResourceListTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*ResourceListType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedResourceListType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkResourceListTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedResourceListType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestPolicyRuleTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestPolicyRuleTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, false)
	size := p.Size()
...
func TestPolicyRuleListTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &PolicyRuleListType{}
	if err := proto.Unmarshal(dAtA, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(dAtA))
...
func TestPolicyRuleListTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, false)
	size := p.Size()
...
func BenchmarkPolicyRuleListTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*PolicyRuleListType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedPolicyRuleListType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkPolicyRuleListTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedPolicyRuleListType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestNonResourceURLListTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, true)
...
func TestResourceListTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestPolicyRuleTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestPolicyRuleListTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestNonResourceURLListTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, true)
...
func TestNonResourceURLListTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, true)
...
func TestResourceListTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestResourceListTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestPolicyRuleTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestPolicyRuleTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestPolicyRuleListTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestPolicyRuleListTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestNonResourceURLListTypeGoString(t *testing.T) {
...
func TestResourceListTypeGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedResourceListType(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestPolicyRuleTypeGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedPolicyRuleType(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestPolicyRuleListTypeGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedPolicyRuleListType(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestNonResourceURLListTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNonResourceURLListType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkNonResourceURLListTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NonResourceURLListType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedNonResourceURLListType(popr, false)
	}
	b.ResetTimer()
...
func TestResourceListTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedResourceListType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkResourceListTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*ResourceListType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedResourceListType(popr, false)
	}
	b.ResetTimer()
...
func TestPolicyRuleTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleType(popr, true)
	size2 := proto.Size(p)
...
func TestPolicyRuleListTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedPolicyRuleListType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkPolicyRuleListTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*PolicyRuleListType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedPolicyRuleListType(popr, false)
	}
	b.ResetTimer()
...
func TestNonResourceURLListTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNonResourceURLListType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestResourceListTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedResourceListType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestPolicyRuleTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedPolicyRuleType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestPolicyRuleListTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedPolicyRuleListType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
