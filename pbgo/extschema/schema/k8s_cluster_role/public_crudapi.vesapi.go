...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_roles", c.baseURL, req.Metadata.GetNamespace())
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.k8s_cluster_role.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role")
	}
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/k8s_cluster_roles": {
            "post": {
                "summary": "Create k8s_cluster_role",
        ...
        "/public/namespaces/{metadata.namespace}/k8s_cluster_roles/{metadata.name}": {
            "put": {
                "summary": "Replace k8s_cluster_role",
