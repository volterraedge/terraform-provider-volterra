...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	vr["ves.io.schema.virtual_host.crudapi.ObjectCreateReq"] = ObjectCreateReqValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectCreateRsp"] = ObjectCreateRspValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectDeleteReq"] = ObjectDeleteReqValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectDeleteRsp"] = ObjectDeleteRspValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectGetReq"] = ObjectGetReqValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectGetRsp"] = ObjectGetRspValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectListReq"] = ObjectListReqValidator()
	vr["ves.io.schema.virtual_host.crudapi.ObjectListRsp"] = ObjectListRspValidator()
