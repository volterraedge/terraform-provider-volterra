...
// RegisterApiepCustomAPIHandler registers the http handlers for service ApiepCustomAPI to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "ApiepCustomAPIClient".
...
var (
	pattern_ApiepCustomAPI_GetAPIEndpoints_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"public", "namespaces", "namespace", "virtual_hosts", "name", "api_endpoints"}, ""))

	pattern_ApiepCustomAPI_GetAPIEndpointPDF_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"public", "namespaces", "namespace", "virtual_hosts", "name", "api_endpoint", "pdf"}, ""))

	pattern_ApiepCustomAPI_GetAPIEndpointLearntSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"public", "namespaces", "namespace", "virtual_hosts", "name", "api_endpoint", "learnt_schema"}, ""))

	pattern_ApiepCustomAPI_GetSwaggerSpec_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"public", "namespaces", "namespace", "virtual_hosts", "name", "api_endpoints", "swagger_spec"}, ""))
)
