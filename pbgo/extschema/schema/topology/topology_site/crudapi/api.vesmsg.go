...
import (
	...
	ves_io_schema_topology_topology_site "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_site"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_topology_topology_site.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_topology_topology_site.DBObject)
	}
	_ = f
