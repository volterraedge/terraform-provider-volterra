...
import (
	...
	ves_io_schema_topology_topology_tunnel "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_tunnel"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_topology_topology_tunnel.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_topology_topology_tunnel.DBObject)
	}
	_ = f
