...
import (
	...
	ves_io_schema_topology_topology_network_peer "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_network_peer"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_topology_topology_network_peer.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_topology_topology_network_peer.DBObject)
	}
	_ = f
