...
import (
	...
	ves_io_schema_topology_topology_instance "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_instance"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_topology_topology_instance.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_topology_topology_instance.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_topology_topology_instance.DBObject)
	}
	_ = f
