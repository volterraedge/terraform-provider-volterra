...
import (
	...
	ves_io_schema_topology_topology_cloud_policy "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_cloud_policy"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_topology_topology_cloud_policy.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_topology_topology_cloud_policy.DBObject)
	}
	_ = f
