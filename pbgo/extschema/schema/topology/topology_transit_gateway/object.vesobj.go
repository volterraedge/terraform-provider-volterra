...
const (
	ObjectDefTblName = "ves.io.schema.topology.topology_transit_gateway.Object.default"
	ObjectType       = "ves.io.schema.topology.topology_transit_gateway.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.topology.topology_transit_gateway.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.topology.topology_transit_gateway.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
