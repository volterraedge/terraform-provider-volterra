...
import (
	...
	ves_io_schema_segment_connection "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/segment_connection"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_segment_connection.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_segment_connection.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_segment_connection.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_segment_connection.DBObject)
	}
	_ = f
