...
const (
	ObjectDefTblName = "ves.io.schema.alert_policy_set.Object.default"
	ObjectType       = "ves.io.schema.alert_policy_set.Object"

	StatusObjectDefTblName = "ves.io.schema.alert_policy_set.StatusObject.default"
	StatusObjectType       = "ves.io.schema.alert_policy_set.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.alert_policy_set.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.alert_policy_set.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.alert_policy_set.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.alert_policy_set.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetObjectRefsDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			dri := &fdrInfos[i]
			// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
			dri.DRField = "ves.io.schema.alert_policy_set.StatusObject." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
	...
	if fdrInfos, err := e.GetPolicyStatusDRefInfo(); err != nil {
		return nil, errors.Wrap(err, "GetPolicyStatusDRefInfo() FAILED")
	} else {
		for i := range fdrInfos {
			dri := &fdrInfos[i]
			// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
...
func (e *DBStatusObject) GetObjectRefsDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		...
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "alert_policy_set.Object",
			RefdUID:    ref.Uid,
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "alert_policy_set.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: alert_policy_set")
	}
...
// GetDRefInfo for the field's type
func (e *DBStatusObject) GetPolicyStatusDRefInfo() ([]db.DRefInfo, error) {
	if e.GetPolicyStatus() == nil {
		return nil, nil
	}

	var drInfos []db.DRefInfo
	for idx, i := range e.GetPolicyStatus() {
		driSet, err := i.GetDRefInfo()
		if err != nil {
			return nil, errors.Wrap(err, "GetPolicyStatus() GetDRefInfo() FAILED")
		}
		for i := range driSet {
			dri := &driSet[i]
			dri.DRField = fmt.Sprintf("policy_status[%v].%s", idx, dri.DRField)
		}
...
func (v *ValidateStatusObject) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	if fv, exists := v.FldValidators["policy_status"]; exists {
		...
		for idx, item := range e.GetPolicyStatus() {
			vOpts := append(vOpts, db.WithValidateRepItem(idx), db.WithValidateIsRepItem(true))
			if err := fv(ctx, item, vOpts...); err != nil {
				return err
			}
...
var DefaultStatusObjectValidator = func() *ValidateStatusObject {
	...
	v.FldValidators["policy_status"] = AlertPolicyStatusValidator().Validate
