...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_policy_sets", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_policy_sets/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_policy_sets/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_policy_sets", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_policy_sets/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.alert_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.alert_policy_set")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.alert_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.alert_policy_set")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.alert_policy_set")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.alert_policy_set.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.alert_policy_set.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_policy_set.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_policy_set.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.alert_policy_set.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.alert_policy_set.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.alert_policy_set.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_policy_set.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_policy_set.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.alert_policy_set.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.alert_policy_set.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_policy_set.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.alert_policy_set.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_policy_set.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_policy_set.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_policy_set.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.alert_policy_set.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.alert_policy_set.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Alert Policy Set",
        "description": "Alert Policy Set is a singleton object in a namespace that consists of a list of references to one or more alert policy objects.\nAll the alert policies in the policy set are evaluated irrespective of the order and the alert notifications are sent based on the\naction defined in the matching route of the alert policy. Therefore, the receiver list in the alert policies referenced in the policy set\nshould not overlap.",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{metadata.namespace}/alert_policy_sets": {
            "post": {
                "summary": "Create Alert Policy Set",
                "description": "Creates a new Alert Policy Set Object",
                "operationId": "ves.io.schema.alert_policy_set.API.Create",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-alert_policy_set-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_policy_set.API.Create"
            },
            "x-displayname": "Alert Policy Set",
            "x-ves-proto-service": "ves.io.schema.alert_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/alert_policy_sets/{metadata.name}": {
            "put": {
                "summary": "Replace Alert Policy Set",
                "description": "Replaces the content of the Alert Policy Set Object",
                "operationId": "ves.io.schema.alert_policy_set.API.Replace",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-alert_policy_set-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_policy_set.API.Replace"
            },
            "x-displayname": "Alert Policy Set",
            "x-ves-proto-service": "ves.io.schema.alert_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/alert_policy_sets": {
            "get": {
                "summary": "List",
                "description": "List the set of alert_policy_set in a namespace",
                "operationId": "ves.io.schema.alert_policy_set.API.List",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-alert_policy_set-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_policy_set.API.List"
            },
            "x-displayname": "Alert Policy Set",
            "x-ves-proto-service": "ves.io.schema.alert_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/alert_policy_sets/{name}": {
            "get": {
                "summary": "Get Alert Policy Set",
                "description": "Get the Alert Policy Set Object",
                "operationId": "ves.io.schema.alert_policy_set.API.Get",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-alert_policy_set-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_policy_set.API.Get"
            },
            "delete": {
                "summary": "Delete",
                "description": "Delete the specified alert_policy_set",
                "operationId": "ves.io.schema.alert_policy_set.API.Delete",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/alert_policy_setDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-alert_policy_set-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_policy_set.API.Delete"
            },
            "x-displayname": "Alert Policy Set",
            "x-ves-proto-service": "ves.io.schema.alert_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "alert_policy_setCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of alert_policy_set",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the alert policy set",
                    "title": "spec",
                    "$ref": "#/definitions/alert_policy_setCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "alert_policy_setCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the alert policy set",
                    "title": "spec",
                    "$ref": "#/definitions/alert_policy_setGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "alert_policy_setCreateSpecType": {
            "type": "object",
            "description": "Creates a new Alert Policy Set Object",
            "title": "Create Alert Policy Set",
            "x-displayname": "Create Alert Policy Set",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.CreateSpecType",
            "properties": {
                "policies": {
                    "type": "array",
        ...
        "alert_policy_setDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a alert_policy_set",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "alert_policy_setGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read alert_policy_set",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.GetResponse",
            "properties": {
                "create_form": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/alert_policy_setObject",
        ...
        "alert_policy_setGetResponseFormatCode": {
            "type": "string",
        ...
        "alert_policy_setGetSpecType": {
            "type": "object",
            "description": "Get the Alert Policy Set Object",
            "title": "Get Alert Policy Set",
            "x-displayname": "Get Alert Policy Set",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.GetSpecType",
            "properties": {
                "policies": {
                    "type": "array",
                    "description": " Reference to a list of Alert Policy objects to send the alert.\nRequired: YES",
        ...
        "alert_policy_setListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of alert_policy_set",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.ListResponse",
            "properties": {
                "items": {
                    "type": "array",
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/alert_policy_setListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "alert_policy_setListResponseItem": {
            "type": "object",
            "description": "By default a summary of alert_policy_set is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of alert_policy_set",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this alert_policy_set",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this alert_policy_set",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates alert_policy_set is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this alert_policy_set",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this alert_policy_set\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this alert_policy_set\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "alert_policy_setObject": {
            "type": "object",
            "description": "Alert Policy Set Object",
            "title": "Alert Policy Set Object",
            "x-displayname": "Alert Policy Set Object",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "alert_policy_setReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a alert_policy_set",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the alert policy set",
                    "title": "spec",
                    "$ref": "#/definitions/alert_policy_setReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "alert_policy_setReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.ReplaceResponse"
        },
        "alert_policy_setReplaceSpecType": {
            "type": "object",
            "description": "Replaces the content of the Alert Policy Set Object",
            "title": "Replace Alert Policy Set",
            "x-displayname": "Replace Alert Policy Set",
            "x-ves-proto-message": "ves.io.schema.alert_policy_set.ReplaceSpecType",
            "properties": {
                "policies": {
                    "type": "array",
                    "description": " Reference to a list of Alert Policy objects to send the alert.\nRequired: YES",
    ...
    "x-displayname": "Alert Policy Set",
    "x-ves-proto-file": "ves.io/schema/alert_policy_set/public_crudapi.proto"
}`
