...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.sensitive_data_policy.GetRequest"] = GetRequestValidator()
	vr["ves.io.schema.sensitive_data_policy.GetResponse"] = GetResponseValidator()
	vr["ves.io.schema.sensitive_data_policy.ListRequest"] = ListRequestValidator()
	vr["ves.io.schema.sensitive_data_policy.ListResponse"] = ListResponseValidator()
...
func initializeEntryRegistry(mdr *svcfw.MDRegistry) {
	mdr.EntryFactory["ves.io.schema.sensitive_data_policy.Object"] = NewEntryObject
	mdr.EntryStoreMap["ves.io.schema.sensitive_data_policy.Object"] = store.InMemory
	mdr.EntryRegistry["ves.io.schema.sensitive_data_policy.Object"] = reflect.TypeOf(&DBObject{})
	mdr.EntryIndexers["ves.io.schema.sensitive_data_policy.Object"] = GetObjectIndexers
	mdr.EntryFactory["ves.io.schema.sensitive_data_policy.StatusObject"] = NewEntryStatusObject
