...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_sensitive_data_policy.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_sensitive_data_policy.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_sensitive_data_policy.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_sensitive_data_policy.DBObject)
	}
	_ = f
