...
const (
	ObjectDefTblName = "ves.io.schema.shape_bot_defense_instance.Object.default"
	ObjectType       = "ves.io.schema.shape_bot_defense_instance.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.shape_bot_defense_instance.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.shape_bot_defense_instance.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
