...
import (
	...
	ves_io_schema_cloud_link "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/cloud_link"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_cloud_link.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_cloud_link.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_cloud_link.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_cloud_link.DBObject)
	}
	_ = f
