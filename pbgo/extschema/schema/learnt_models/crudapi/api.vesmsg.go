...
import (
	...
	ves_io_schema_learnt_models "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/learnt_models"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_learnt_models.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_learnt_models.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_learnt_models.DBObject)
	}
	_ = f
