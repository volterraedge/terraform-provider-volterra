...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.fast_acl_rule.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.fast_acl_rule.crudapi")
	}
    ...
    "paths": {
        "/ves.io.schema.fast_acl_rule/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-Delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-Replace"
                },
        ...
        "/ves.io.schema.fast_acl_rule/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-List"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-Create"
                },
        ...
        "/ves.io.schema.fast_acl_rule/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-fast_acl_rule-crudapi-API-ListStream"
                },
