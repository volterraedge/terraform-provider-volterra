...
func TestFastAclRuleActionProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &FastAclRuleAction{}
...
func TestFastAclRuleActionMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, false)
	size := p.Size()
...
func BenchmarkFastAclRuleActionProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*FastAclRuleAction, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedFastAclRuleAction(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkFastAclRuleActionProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedFastAclRuleAction(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestFastAclRuleActionJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, true)
...
func TestFastAclRuleActionProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, true)
...
func TestFastAclRuleActionProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, true)
...
func TestFastAclRuleActionGoString(t *testing.T) {
...
func TestFastAclRuleActionSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedFastAclRuleAction(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkFastAclRuleActionSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*FastAclRuleAction, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedFastAclRuleAction(popr, false)
	}
	b.ResetTimer()
...
func TestFastAclRuleActionStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedFastAclRuleAction(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
