...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fd82bc50c1cfb1a, []int{0}
}
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fd82bc50c1cfb1a, []int{1}
}
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fd82bc50c1cfb1a, []int{2}
}
...
func init() {
	proto.RegisterFile("ves.io/schema/views/rate_limiter_policy/object.proto", fileDescriptor_6fd82bc50c1cfb1a)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/views/rate_limiter_policy/object.proto", fileDescriptor_6fd82bc50c1cfb1a)
}

var fileDescriptor_6fd82bc50c1cfb1a = []byte{
	// 646 bytes of a gzipped FileDescriptorProto
	,
}
