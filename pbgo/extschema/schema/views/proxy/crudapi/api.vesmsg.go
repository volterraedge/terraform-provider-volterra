...
import (
	...
	ves_io_schema_views_proxy "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/proxy"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_proxy.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_proxy.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_proxy.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_proxy.DBObject)
	}
	_ = f
