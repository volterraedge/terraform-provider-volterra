...
const (
	ObjectDefTblName = "ves.io.schema.views.cdn_loadbalancer.Object.default"
	ObjectType       = "ves.io.schema.views.cdn_loadbalancer.Object"

	StatusObjectDefTblName = "ves.io.schema.views.cdn_loadbalancer.StatusObject.default"
	StatusObjectType       = "ves.io.schema.views.cdn_loadbalancer.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.views.cdn_loadbalancer.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.views.cdn_loadbalancer.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.views.cdn_loadbalancer.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.views.cdn_loadbalancer.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.views.cdn_loadbalancer.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "cdn_loadbalancer.Object")
	if err != nil {
...
func (v *ValidateStatusObject) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	if fv, exists := v.FldValidators["site_status"]; exists {

		vOpts := append(opts, db.WithValidateField("site_status"))
		if err := fv(ctx, e.GetSiteStatus(), vOpts...); err != nil {
			return err
		}
