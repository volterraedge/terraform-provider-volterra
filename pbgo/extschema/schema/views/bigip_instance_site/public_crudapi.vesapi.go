...
const (
	...
	CreateRequestFQN = "ves.io.schema.views.bigip_instance_site.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.views.bigip_instance_site.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.views.bigip_instance_site.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.views.bigip_instance_site.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.views.bigip_instance_site.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.views.bigip_instance_site.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.views.bigip_instance_site.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.views.bigip_instance_site.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.views.bigip_instance_site.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.views.bigip_instance_site.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_instance_sites", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_instance_sites/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_instance_sites/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_instance_sites", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.bigip_instance_site.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.views.bigip_instance_site")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.bigip_instance_site.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.bigip_instance_site.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.API.Create"), zap.Error(err))
			}
		}
	}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.bigip_instance_site.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.views.bigip_instance_site.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.API.Delete"), zap.Error(err))
			}
		}
	}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.views.bigip_instance_site.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "BIG-IP Instance defines a required parameters that can be\nused in CRUD, to create and manage an BIG-IP Instance site.",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/bigip_instance_sites": {
            "post": {
                "summary": "Create BIG-IP Instance",
                "description": "Shape of the BIG-IP Instance specification",
                "operationId": "ves.io.schema.views.bigip_instance_site.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.API.Create"
            },
            "x-displayname": "BIG-IP Instance",
            "x-ves-proto-service": "ves.io.schema.views.bigip_instance_site.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/bigip_instance_sites/{metadata.name}": {
            "put": {
                "summary": "Replace BIG-IP Instance",
                "description": "Shape of the BIG-IP Instance site specification",
                "operationId": "ves.io.schema.views.bigip_instance_site.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.API.Replace"
            },
            "x-displayname": "BIG-IP Instance",
            "x-ves-proto-service": "ves.io.schema.views.bigip_instance_site.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bigip_instance_sites": {
            "get": {
                "summary": "List BIG-IP Instance",
                "description": "List the set of bigip_instance_site in a namespace",
                "operationId": "ves.io.schema.views.bigip_instance_site.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.API.List"
            },
            "x-displayname": "BIG-IP Instance",
            "x-ves-proto-service": "ves.io.schema.views.bigip_instance_site.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bigip_instance_sites/{name}": {
            "get": {
                "summary": "Get BIG-IP Instance",
                "description": "Shape of the BIG-IP Instance specification",
                "operationId": "ves.io.schema.views.bigip_instance_site.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.API.Get"
            },
            "delete": {
                "summary": "Delete BIG-IP Instance",
                "description": "Delete the specified bigip_instance_site",
                "operationId": "ves.io.schema.views.bigip_instance_site.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_instance_siteDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.API.Delete"
            },
            "x-displayname": "BIG-IP Instance",
            "x-ves-proto-service": "ves.io.schema.views.bigip_instance_site.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "bigip_instance_siteCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of bigip_instance_site",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_instance_siteCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bigip_instance_siteCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_instance_siteGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "bigip_instance_siteDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a bigip_instance_site",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "bigip_instance_siteGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read bigip_instance_site",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.GetResponse",
            "properties": {
                "create_form": {
        ...
        "bigip_instance_siteGetResponseFormatCode": {
            "type": "string",
        ...
        "bigip_instance_siteListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of bigip_instance_site",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/bigip_instance_siteListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "bigip_instance_siteListResponseItem": {
            "type": "object",
            "description": "By default a summary of bigip_instance_site is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of bigip_instance_site",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this bigip_instance_site",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this bigip_instance_site",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates bigip_instance_site is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this bigip_instance_site",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this bigip_instance_site\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this bigip_instance_site\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "bigip_instance_siteReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a bigip_instance_site",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_instance_siteReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bigip_instance_siteReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.ReplaceResponse"
        },
        ...
        "viewsbigip_instance_siteCreateSpecType": {
            "type": "object",
            "description": "Shape of the BIG-IP Instance specification",
            "title": "CreateSpecType",
            "x-displayname": "Create BIG-IP Instance",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.CreateSpecType",
            "properties": {
                "central_manager": {
                    "description": " BIG-IP Central manager site managing this BIG-IP instance\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "viewsbigip_instance_siteGetSpecType": {
            "type": "object",
            "description": "Shape of the BIG-IP Instance specification",
            "title": "GetSpecType",
            "x-displayname": "Get BIG-IP Instance",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.GetSpecType",
            "properties": {
                "central_manager": {
                    "description": " BIG-IP Central manager site managing this BIG-IP instance\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/bigip_instance_siteCentralManagerList",
        ...
        "viewsbigip_instance_siteReplaceSpecType": {
            "type": "object",
            "description": "Shape of the BIG-IP Instance site specification",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace BIG-IP Instance",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.ReplaceSpecType",
            "properties": {
                "central_manager": {
                    "description": " BIG-IP Central manager site managing this BIG-IP instance\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/bigip_instance_siteCentralManagerList",
    ...
    "x-displayname": "BIG-IP Instance",
    "x-ves-proto-file": "ves.io/schema/views/bigip_instance_site/public_crudapi.proto"
}`
