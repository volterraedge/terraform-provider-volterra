...
type ContainerType struct {
	...
	// Flavor
	//
	// Types that are valid to be assigned to FlavorChoice:
	//	*ContainerType_Flavor
	//	*ContainerType_CustomFlavor
	//	*ContainerType_DefaultFlavor
	FlavorChoice isContainerType_FlavorChoice `protobuf_oneof:"flavor_choice"`
	// LivenessCheck
	//
...
type isContainerType_FlavorChoice interface {
	isContainerType_FlavorChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type ContainerType_Flavor struct {
	Flavor ContainerFlavorType `protobuf:"varint,4,opt,name=flavor,proto3,enum=ves.io.schema.views.workload.ContainerFlavorType,oneof" json:"flavor,omitempty"`
}
type ContainerType_CustomFlavor struct {
	CustomFlavor *views.ObjectRefType `protobuf:"bytes,10,opt,name=custom_flavor,json=customFlavor,proto3,oneof" json:"custom_flavor,omitempty"`
}
type ContainerType_DefaultFlavor struct {
	DefaultFlavor *schema.Empty `protobuf:"bytes,11,opt,name=default_flavor,json=defaultFlavor,proto3,oneof" json:"default_flavor,omitempty"`
}

func (*ContainerType_Flavor) isContainerType_FlavorChoice()        {}
func (*ContainerType_CustomFlavor) isContainerType_FlavorChoice()  {}
func (*ContainerType_DefaultFlavor) isContainerType_FlavorChoice() {}

func (m *ContainerType) GetFlavorChoice() isContainerType_FlavorChoice {
	if m != nil {
		return m.FlavorChoice
	}
	return nil
}
...
func (m *ContainerType) GetFlavor() ContainerFlavorType {
	if x, ok := m.GetFlavorChoice().(*ContainerType_Flavor); ok {
		return x.Flavor
	}
	return CONTAINER_FLAVOR_TYPE_TINY
}

func (m *ContainerType) GetCustomFlavor() *views.ObjectRefType {
	if x, ok := m.GetFlavorChoice().(*ContainerType_CustomFlavor); ok {
		return x.CustomFlavor
	}
	return nil
}

func (m *ContainerType) GetDefaultFlavor() *schema.Empty {
	if x, ok := m.GetFlavorChoice().(*ContainerType_DefaultFlavor); ok {
		return x.DefaultFlavor
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ContainerType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ContainerType_Flavor)(nil),
		(*ContainerType_CustomFlavor)(nil),
		(*ContainerType_DefaultFlavor)(nil),
	}
}
...
type IPFamilyType struct {
	// IP Family Choice
	//
	// x-displayName: "Select IP Family"
	// x-required
	// Select IP Family
	//
	// Types that are valid to be assigned to IpFamilyChoice:
	//	*IPFamilyType_V4
	//	*IPFamilyType_V6
	//	*IPFamilyType_DualV4Preferred
	//	*IPFamilyType_DualV6Preferred
	IpFamilyChoice isIPFamilyType_IpFamilyChoice `protobuf_oneof:"ip_family_choice"`
}

func (m *IPFamilyType) Reset()      { *m = IPFamilyType{} }
func (*IPFamilyType) ProtoMessage() {}
func (*IPFamilyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_9adbda8cf19677b4, []int{43}
}
func (m *IPFamilyType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IPFamilyType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *IPFamilyType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPFamilyType.Merge(m, src)
}
func (m *IPFamilyType) XXX_Size() int {
	return m.Size()
}
func (m *IPFamilyType) XXX_DiscardUnknown() {
	xxx_messageInfo_IPFamilyType.DiscardUnknown(m)
}

var xxx_messageInfo_IPFamilyType proto.InternalMessageInfo

type isIPFamilyType_IpFamilyChoice interface {
	isIPFamilyType_IpFamilyChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type IPFamilyType_V4 struct {
	V4 *schema.Empty `protobuf:"bytes,2,opt,name=v4,proto3,oneof" json:"v4,omitempty"`
}
type IPFamilyType_V6 struct {
	V6 *schema.Empty `protobuf:"bytes,3,opt,name=v6,proto3,oneof" json:"v6,omitempty"`
}
type IPFamilyType_DualV4Preferred struct {
	DualV4Preferred *schema.Empty `protobuf:"bytes,4,opt,name=dual_v4_preferred,json=dualV4Preferred,proto3,oneof" json:"dual_v4_preferred,omitempty"`
}
type IPFamilyType_DualV6Preferred struct {
	DualV6Preferred *schema.Empty `protobuf:"bytes,5,opt,name=dual_v6_preferred,json=dualV6Preferred,proto3,oneof" json:"dual_v6_preferred,omitempty"`
}

func (*IPFamilyType_V4) isIPFamilyType_IpFamilyChoice()              {}
func (*IPFamilyType_V6) isIPFamilyType_IpFamilyChoice()              {}
func (*IPFamilyType_DualV4Preferred) isIPFamilyType_IpFamilyChoice() {}
func (*IPFamilyType_DualV6Preferred) isIPFamilyType_IpFamilyChoice() {}

func (m *IPFamilyType) GetIpFamilyChoice() isIPFamilyType_IpFamilyChoice {
	if m != nil {
		return m.IpFamilyChoice
	}
	return nil
}

func (m *IPFamilyType) GetV4() *schema.Empty {
	if x, ok := m.GetIpFamilyChoice().(*IPFamilyType_V4); ok {
		return x.V4
	}
	return nil
}

func (m *IPFamilyType) GetV6() *schema.Empty {
	if x, ok := m.GetIpFamilyChoice().(*IPFamilyType_V6); ok {
		return x.V6
	}
	return nil
}

func (m *IPFamilyType) GetDualV4Preferred() *schema.Empty {
	if x, ok := m.GetIpFamilyChoice().(*IPFamilyType_DualV4Preferred); ok {
		return x.DualV4Preferred
	}
	return nil
}

func (m *IPFamilyType) GetDualV6Preferred() *schema.Empty {
	if x, ok := m.GetIpFamilyChoice().(*IPFamilyType_DualV6Preferred); ok {
		return x.DualV6Preferred
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*IPFamilyType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*IPFamilyType_V4)(nil),
		(*IPFamilyType_V6)(nil),
		(*IPFamilyType_DualV4Preferred)(nil),
		(*IPFamilyType_DualV6Preferred)(nil),
	}
}
...
type ServiceType struct {
	...
	Family *IPFamilyType `protobuf:"bytes,10,opt,name=family,proto3" json:"family,omitempty"`
}
...
func (m *ServiceType) GetFamily() *IPFamilyType {
	if m != nil {
		return m.Family
	}
	return nil
...
func (m *StatefulServiceType) GetFamily() *IPFamilyType {
	if m != nil {
		return m.Family
	}
	return nil
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_9adbda8cf19677b4, []int{50}
}
...
func init() {
	...
	proto.RegisterType((*IPFamilyType)(nil), "ves.io.schema.views.workload.IPFamilyType")
	golang_proto.RegisterType((*IPFamilyType)(nil), "ves.io.schema.views.workload.IPFamilyType")
...
var fileDescriptor_9adbda8cf19677b4 = []byte{
	...
	,
}
...
func (this *ContainerType) Equal(that interface{}) bool {
	...
	if that1.FlavorChoice == nil {
		if this.FlavorChoice != nil {
			return false
		}
	} else if this.FlavorChoice == nil {
		return false
	} else if !this.FlavorChoice.Equal(that1.FlavorChoice) {
		return false
	}
...
func (this *ContainerType_Flavor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ContainerType_Flavor)
	if !ok {
		that2, ok := that.(ContainerType_Flavor)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ContainerType_CustomFlavor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ContainerType_CustomFlavor)
	if !ok {
		that2, ok := that.(ContainerType_CustomFlavor)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.CustomFlavor.Equal(that1.CustomFlavor) {
		return false
	}
	return true
}
func (this *ContainerType_DefaultFlavor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ContainerType_DefaultFlavor)
	if !ok {
		that2, ok := that.(ContainerType_DefaultFlavor)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultFlavor.Equal(that1.DefaultFlavor) {
		return false
	}
	return true
}
...
func (this *IPFamilyType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IPFamilyType)
	if !ok {
		that2, ok := that.(IPFamilyType)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.IpFamilyChoice == nil {
		if this.IpFamilyChoice != nil {
			return false
		}
	} else if this.IpFamilyChoice == nil {
		return false
	} else if !this.IpFamilyChoice.Equal(that1.IpFamilyChoice) {
		return false
	}
	return true
}
func (this *IPFamilyType_V4) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IPFamilyType_V4)
	if !ok {
		that2, ok := that.(IPFamilyType_V4)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.V4.Equal(that1.V4) {
		return false
	}
	return true
}
func (this *IPFamilyType_V6) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IPFamilyType_V6)
	if !ok {
		that2, ok := that.(IPFamilyType_V6)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.V6.Equal(that1.V6) {
		return false
	}
	return true
}
func (this *IPFamilyType_DualV4Preferred) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IPFamilyType_DualV4Preferred)
	if !ok {
		that2, ok := that.(IPFamilyType_DualV4Preferred)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DualV4Preferred.Equal(that1.DualV4Preferred) {
		return false
	}
	return true
}
func (this *IPFamilyType_DualV6Preferred) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IPFamilyType_DualV6Preferred)
	if !ok {
		that2, ok := that.(IPFamilyType_DualV6Preferred)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DualV6Preferred.Equal(that1.DualV6Preferred) {
		return false
	}
	return true
}
...
func (this *ContainerType) GoString() string {
	...
	if this.FlavorChoice != nil {
		s = append(s, "FlavorChoice: "+fmt.Sprintf("%#v", this.FlavorChoice)+",\n")
	}
...
func (this *ContainerType_Flavor) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.ContainerType_Flavor{` +
		`Flavor:` + fmt.Sprintf("%#v", this.Flavor) + `}`}, ", ")
	return s
}
func (this *ContainerType_CustomFlavor) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.ContainerType_CustomFlavor{` +
		`CustomFlavor:` + fmt.Sprintf("%#v", this.CustomFlavor) + `}`}, ", ")
	return s
}
func (this *ContainerType_DefaultFlavor) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.ContainerType_DefaultFlavor{` +
		`DefaultFlavor:` + fmt.Sprintf("%#v", this.DefaultFlavor) + `}`}, ", ")
	return s
}
...
func (this *IPFamilyType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&workload.IPFamilyType{")
	if this.IpFamilyChoice != nil {
		s = append(s, "IpFamilyChoice: "+fmt.Sprintf("%#v", this.IpFamilyChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *IPFamilyType_V4) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.IPFamilyType_V4{` +
		`V4:` + fmt.Sprintf("%#v", this.V4) + `}`}, ", ")
	return s
}
func (this *IPFamilyType_V6) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.IPFamilyType_V6{` +
		`V6:` + fmt.Sprintf("%#v", this.V6) + `}`}, ", ")
	return s
}
func (this *IPFamilyType_DualV4Preferred) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.IPFamilyType_DualV4Preferred{` +
		`DualV4Preferred:` + fmt.Sprintf("%#v", this.DualV4Preferred) + `}`}, ", ")
	return s
}
func (this *IPFamilyType_DualV6Preferred) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&workload.IPFamilyType_DualV6Preferred{` +
		`DualV6Preferred:` + fmt.Sprintf("%#v", this.DualV6Preferred) + `}`}, ", ")
	return s
}
...
func (m *ContainerType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FlavorChoice != nil {
		{
			size := m.FlavorChoice.Size()
			i -= size
			if _, err := m.FlavorChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *ContainerType_Flavor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ContainerType_Flavor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ContainerType_CustomFlavor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ContainerType_CustomFlavor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomFlavor != nil {
		{
			size, err := m.CustomFlavor.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ContainerType_DefaultFlavor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ContainerType_DefaultFlavor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultFlavor != nil {
		{
...
func (m *IPFamilyType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IPFamilyType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPFamilyType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.IpFamilyChoice != nil {
		{
			size := m.IpFamilyChoice.Size()
			i -= size
			if _, err := m.IpFamilyChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *IPFamilyType_V4) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPFamilyType_V4) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.V4 != nil {
		{
...
func (m *IPFamilyType_V6) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPFamilyType_V6) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.V6 != nil {
		{
...
func (m *IPFamilyType_DualV4Preferred) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPFamilyType_DualV4Preferred) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DualV4Preferred != nil {
		{
			size, err := m.DualV4Preferred.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *IPFamilyType_DualV6Preferred) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPFamilyType_DualV6Preferred) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DualV6Preferred != nil {
		{
			size, err := m.DualV6Preferred.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ContainerType_Flavor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ContainerType_CustomFlavor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CustomFlavor != nil {
		l = m.CustomFlavor.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *ContainerType_DefaultFlavor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IPFamilyType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.IpFamilyChoice != nil {
		n += m.IpFamilyChoice.Size()
	}
	return n
}

func (m *IPFamilyType_V4) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IPFamilyType_V6) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IPFamilyType_DualV4Preferred) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DualV4Preferred != nil {
		l = m.DualV4Preferred.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *IPFamilyType_DualV6Preferred) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ContainerType) String() string {
	...
	s := strings.Join([]string{`&ContainerType{`,
		...
		`FlavorChoice:` + fmt.Sprintf("%v", this.FlavorChoice) + `,`,
...
func (this *ContainerType_Flavor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerType_Flavor{`,
		`Flavor:` + fmt.Sprintf("%v", this.Flavor) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerType_CustomFlavor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerType_CustomFlavor{`,
		`CustomFlavor:` + strings.Replace(fmt.Sprintf("%v", this.CustomFlavor), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerType_DefaultFlavor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerType_DefaultFlavor{`,
		`DefaultFlavor:` + strings.Replace(fmt.Sprintf("%v", this.DefaultFlavor), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *IPFamilyType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPFamilyType{`,
		`IpFamilyChoice:` + fmt.Sprintf("%v", this.IpFamilyChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IPFamilyType_V4) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPFamilyType_V4{`,
		`V4:` + strings.Replace(fmt.Sprintf("%v", this.V4), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IPFamilyType_V6) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPFamilyType_V6{`,
		`V6:` + strings.Replace(fmt.Sprintf("%v", this.V6), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IPFamilyType_DualV4Preferred) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPFamilyType_DualV4Preferred{`,
		`DualV4Preferred:` + strings.Replace(fmt.Sprintf("%v", this.DualV4Preferred), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IPFamilyType_DualV6Preferred) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPFamilyType_DualV6Preferred{`,
		`DualV6Preferred:` + strings.Replace(fmt.Sprintf("%v", this.DualV6Preferred), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ServiceType) String() string {
	...
	s := strings.Join([]string{`&ServiceType{`,
		...
		`Family:` + strings.Replace(this.Family.String(), "IPFamilyType", "IPFamilyType", 1) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= ContainerFlavorType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
			m.FlavorChoice = &ContainerType_Flavor{v}
		case 5:
			if wireType != 2 {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomFlavor", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FlavorChoice = &ContainerType_CustomFlavor{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
			...
			m.FlavorChoice = &ContainerType_DefaultFlavor{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *IPFamilyType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IPFamilyType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IPFamilyType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
			...
			m.IpFamilyChoice = &IPFamilyType_V4{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.IpFamilyChoice = &IPFamilyType_V6{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DualV4Preferred", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IpFamilyChoice = &IPFamilyType_DualV4Preferred{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DualV6Preferred", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IpFamilyChoice = &IPFamilyType_DualV6Preferred{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
