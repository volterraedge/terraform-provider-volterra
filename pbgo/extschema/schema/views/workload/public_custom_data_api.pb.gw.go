...
func request_CustomDataAPI_Usage_0(ctx context.Context, marshaler runtime.Marshaler, client CustomDataAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.Usage(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_CustomDataAPI_Usage_0(ctx context.Context, marshaler runtime.Marshaler, server CustomDataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UsageRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.Usage(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCustomDataAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomDataAPIServer) error {
	...
	mux.Handle("POST", pattern_CustomDataAPI_Usage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomDataAPI_Usage_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CustomDataAPI_Usage_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCustomDataAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomDataAPIClient) error {
	...
	mux.Handle("POST", pattern_CustomDataAPI_Usage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CustomDataAPI_Usage_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CustomDataAPI_Usage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"public", "namespaces", "namespace", "workloads", "usage"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_CustomDataAPI_Usage_0 = runtime.ForwardResponseMessage
)
