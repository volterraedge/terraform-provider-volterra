...
import (
	...
	ves_io_schema_views_workload "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/workload"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_workload.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_workload.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_workload.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_workload.DBObject)
	}
	_ = f
