...
import (
	...
	ves_io_schema_views_policy_based_routing "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/policy_based_routing"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_policy_based_routing.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_policy_based_routing.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_policy_based_routing.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_policy_based_routing.DBObject)
	}
	_ = f
