...
func (c *CustomDataAPIGrpcClient) doRPCNetworkPolicyHits(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &NetworkPolicyHitsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.network_policy_view.NetworkPolicyHitsRequest", yamlReq)
	}
	rsp, err := c.grpcClient.NetworkPolicyHits(ctx, req, opts...)
	return rsp, err
}
...
func NewCustomDataAPIGrpcClient(cc *grpc.ClientConn) server.CustomClient {
	...
	rpcFns["NetworkPolicyHits"] = ccl.doRPCNetworkPolicyHits
...
func (c *CustomDataAPIRestClient) doRPCNetworkPolicyHits(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
	...
	req := &NetworkPolicyHitsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.network_policy_view.NetworkPolicyHitsRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.views.network_policy_view.NetworkPolicyHitsResponse", body)
...
func (c *customDataAPIInprocClient) NetworkPolicyHits(ctx context.Context, in *NetworkPolicyHitsRequest, opts ...grpc.CallOption) (*NetworkPolicyHitsResponse, error) {
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.network_policy_view.CustomDataAPI.NetworkPolicyHits", nil)
...
func (s *customDataAPISrv) NetworkPolicyHits(ctx context.Context, in *NetworkPolicyHitsRequest) (*NetworkPolicyHitsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.views.network_policy_view.CustomDataAPI")
	...
	var (
		rsp *NetworkPolicyHitsResponse
		err error
	)

	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.views.network_policy_view.NetworkPolicyHitsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomDataAPI.NetworkPolicyHits' operation on 'network_policy_view'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.network_policy_view.CustomDataAPI.NetworkPolicyHits"); rvFn != nil {
	...
	rsp, err = cah.NetworkPolicyHits(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.views.network_policy_view.NetworkPolicyHitsResponse", rsp)...)
...
var CustomDataAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Monitoring APIs for Network Policy View",
    ...
    "paths": {
        "/public/namespaces/{namespace}/network_policy_view/hits": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/network_policy_viewNetworkPolicyHitsResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/network_policy_viewNetworkPolicyHitsRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Network Policy View Monitoring APIs",
    ...
    "definitions": {
        "network_policy_viewNetworkPolicyHits": {
            ...
            "properties": {
                "id": {
                    ...
                    "title": "ID",
                    "$ref": "#/definitions/network_policy_viewNetworkPolicyHitsId",
                    "x-displayname": "ID"
                },
                "metric": {
                    "type": "array",
        ...
        "network_policy_viewNetworkPolicyHitsRequest": {
            ...
            "properties": {
                ...
                "group_by": {
                    ...
                    "title": "Group by",
                    "items": {
                        "$ref": "#/definitions/network_policy_viewNetworkPolicyMetricLabel"
                    },
                ...
                "label_filter": {
                    ...
                    "title": "Label Filter",
                    "items": {
                        "$ref": "#/definitions/network_policy_viewNetworkPolicyMetricLabelFilter"
                    },
        ...
        "network_policy_viewNetworkPolicyHitsResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "title": "Network policy Hits",
                    "items": {
                        "$ref": "#/definitions/network_policy_viewNetworkPolicyHits"
                    },
                    "x-displayname": "Network Policy Hits"
                },
                "step": {
        ...
        "network_policy_viewNetworkPolicyMetricLabelFilter": {
            ...
            "properties": {
                "label": {
                    "description": " Label associated with Network policy hits",
                    "title": "Label",
                    "$ref": "#/definitions/network_policy_viewNetworkPolicyMetricLabel",
                    "x-displayname": "Label"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/views/network_policy_view/public_custom_data_api.proto"
}`
