...
func (c *CustomAPIInprocClient) GetDnsInfo(ctx context.Context, in *GetDnsInfoRequest, opts ...grpc.CallOption) (*GetDnsInfoResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.http_loadbalancer.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.views.http_loadbalancer.GetDnsInfoRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	if c.svc.Config().EnableAPIValidation {
		if rvFn := c.svc.GetRPCValidator("ves.io.schema.views.http_loadbalancer.CustomAPI.GetDnsInfo"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, c.svc, "ves.io.schema.views.http_loadbalancer.GetDnsInfoResponse", rsp)...)
