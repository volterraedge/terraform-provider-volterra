...
// source: ves.io/schema/views/bigip_virtual_server/object.proto
...
// BIG-IP virtual server view object
type Object struct {
	// metadata
	//
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28352bc345415c3, []int{0}
}
...
// BIG-IP virtual server specification
//
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28352bc345415c3, []int{1}
}
...
type StatusObject struct {
	...
	// BIG-IP virtual_server view object direct reference
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28352bc345415c3, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.views.bigip_virtual_server.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.views.bigip_virtual_server.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.views.bigip_virtual_server.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.views.bigip_virtual_server.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.views.bigip_virtual_server.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.views.bigip_virtual_server.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/views/bigip_virtual_server/object.proto", fileDescriptor_c28352bc345415c3)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/views/bigip_virtual_server/object.proto", fileDescriptor_c28352bc345415c3)
}

var fileDescriptor_c28352bc345415c3 = []byte{
	// 627 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&bigip_virtual_server.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&bigip_virtual_server.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&bigip_virtual_server.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
