...
const (
	ObjectDefTblName = "ves.io.schema.views.third_party_application.Object.default"
	ObjectType       = "ves.io.schema.views.third_party_application.Object"

	StatusObjectDefTblName = "ves.io.schema.views.third_party_application.StatusObject.default"
	StatusObjectType       = "ves.io.schema.views.third_party_application.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.views.third_party_application.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.views.third_party_application.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.views.third_party_application.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.views.third_party_application.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.views.third_party_application.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		...
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "third_party_application.Object",
			RefdUID:    ref.Uid,
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "third_party_application.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: third_party_application")
	}
