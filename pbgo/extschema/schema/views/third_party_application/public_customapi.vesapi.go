...
func (c *CustomAPIGrpcClient) doRPCGenerateToken(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &GenerateTokenRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.third_party_application.GenerateTokenRequest", yamlReq)
	}
...
func (c *CustomAPIGrpcClient) doRPCGetSecurityConfig(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.third_party_application.GetSecurityConfigReq", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCGenerateToken(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
	...
	req := &GenerateTokenRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.third_party_application.GenerateTokenRequest: %s", yamlReq, err)
	}
...
func (c *CustomAPIRestClient) doRPCGetSecurityConfig(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &GetSecurityConfigReq{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.third_party_application.GetSecurityConfigReq: %s", yamlReq, err)
	}
	...
	case "get":
		...
		_ = q
		q.Add("namespace", fmt.Sprintf("%v", req.Namespace))
		q.Add("third_party_choice", fmt.Sprintf("%v", req.ThirdPartyChoice))
...
func (c *customAPIInprocClient) GenerateToken(ctx context.Context, in *GenerateTokenRequest, opts ...grpc.CallOption) (*GenerateTokenResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.third_party_application.CustomAPI.GenerateToken")
	return c.CustomAPIServer.GenerateToken(ctx, in)
}
func (c *customAPIInprocClient) GetSecurityConfig(ctx context.Context, in *GetSecurityConfigReq, opts ...grpc.CallOption) (*ves_io_schema_views_common_security.GetSecurityConfigRsp, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.third_party_application.CustomAPI.GetSecurityConfig")
...
func (s *customAPISrv) GenerateToken(ctx context.Context, in *GenerateTokenRequest) (*GenerateTokenResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.views.third_party_application.CustomAPI")
	...
	var (
		rsp *GenerateTokenResponse
		err error
	)

	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.views.third_party_application.GenerateTokenRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.GenerateToken' operation on 'third_party_application'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.third_party_application.CustomAPI.GenerateToken"); rvFn != nil {
	...
	rsp, err = cah.GenerateToken(ctx, in)
	if err != nil {
...
func (s *customAPISrv) GetSecurityConfig(ctx context.Context, in *GetSecurityConfigReq) (*ves_io_schema_views_common_security.GetSecurityConfigRsp, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.views.third_party_application.GetSecurityConfigReq", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.GetSecurityConfig' operation on 'third_party_application'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.third_party_application.CustomAPI.GetSecurityConfig"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
var CustomAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Custom API's for Third Party Application",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/third_party_application/get_security_config": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/third_party_applicationGetSecurityConfigReq"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Third Party Application Custom API",
            "x-ves-proto-service": "ves.io.schema.views.third_party_application.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/{namespace}/third_party_applications/{name}/generate_token": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/third_party_applicationGenerateTokenResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        ...
        "third_party_applicationGenerateTokenResponse": {
            "type": "object",
            "description": "Response to the Generate Token Request\ntoken - a base64 encoding of AuthToken struct\nwill be used in accesslog request header",
            "title": "GenerateTokenResponse",
            "x-displayname": "Generate Token Response",
            "x-ves-proto-message": "ves.io.schema.views.third_party_application.GenerateTokenResponse",
            "properties": {
                "token": {
                    "type": "string",
                    "title": "Token",
        ...
        "third_party_applicationGetSecurityConfigReq": {
            "type": "object",
            ...
            "x-ves-oneof-field-third_party_choice": "[\"all_third_party_applications\",\"third_party_applications_list\"]",
            "x-ves-proto-message": "ves.io.schema.views.third_party_application.GetSecurityConfigReq",
            "properties": {
                "all_third_party_applications": {
                    "description": "Exclusive with [third_party_applications_list]\n",
                    "title": "all third party applications",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All Third Party Applications"
                },
                "namespace": {
                    "type": "string",
                    "description": " Namespace of the Third Party Application for current request\n\nExample: - \"shared\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Namespace",
                    "x-displayname": "Namespace",
                ...
                "third_party_applications_list": {
                    "description": "Exclusive with [all_third_party_applications]\n",
                    "title": "List of third party applications",
                    "$ref": "#/definitions/third_party_applicationThirdPartyApplicationList",
                    "x-displayname": "List of third party applications"
                }
            }
        },
        "third_party_applicationThirdPartyApplicationList": {
            "type": "object",
            "title": "List of third party applications",
            "x-displayname": "List of third party applications",
            "x-ves-proto-message": "ves.io.schema.views.third_party_application.ThirdPartyApplicationList",
            "properties": {
    ...
    "x-ves-proto-file": "ves.io/schema/views/third_party_application/public_customapi.proto"
}`
