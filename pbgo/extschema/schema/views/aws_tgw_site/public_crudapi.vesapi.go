...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/aws_tgw_sites", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.views.aws_tgw_site.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.aws_tgw_site")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.views.aws_tgw_site")
	}
    ...
    "definitions": {
        ...
        "aws_tgw_siteExistingTGWType": {
            ...
            "properties": {
                ...
                "volterra_site_asn": {
                    "type": "integer",
                    "description": " Volterra Site ASN.\n\nExample: - \"64501\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gt: 0\n  ves.io.schema.rules.uint32.lte: 65535\n",
                    "title": "Volterra Site ASN",
                    "format": "int64",
        ...
        "aws_tgw_siteObject": {
            "type": "object",
            "description": "AWS TGW view object",
            "title": "Object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.views.aws_tgw_site.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "viewsCustomPorts": {
            "type": "object",
            "description": "x-displayName: \"Custom Ports\"\nList of Custom port",
            "title": "Custom Ports",
            "properties": {
                "port_ranges": {
                    "type": "string",
        ...
        "viewsaws_tgw_siteGlobalSpecType": {
            ...
            "properties": {
                ...
                "vn_config": {
                    "description": " Virtual Network Configuration for transit gateway",
                    "title": "TGW Virtual Network Configuration",
                    "$ref": "#/definitions/aws_tgw_siteVnConfiguration",
                    "x-displayname": "TGW Virtual Network Configuration"
                },
                "vpc_attachments": {
