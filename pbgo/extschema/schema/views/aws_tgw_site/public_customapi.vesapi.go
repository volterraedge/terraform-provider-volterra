...
func (c *customAPIInprocClient) SetTGWInfo(ctx context.Context, in *SetTGWInfoRequest, opts ...grpc.CallOption) (*SetTGWInfoResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.aws_tgw_site.CustomAPI.SetTGWInfo")
...
func (c *customAPIInprocClient) SetVIPInfo(ctx context.Context, in *SetVIPInfoRequest, opts ...grpc.CallOption) (*SetVIPInfoResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.aws_tgw_site.CustomAPI.SetVIPInfo")
...
func (c *customAPIInprocClient) SetVPCIpPrefixes(ctx context.Context, in *SetVPCIpPrefixesRequest, opts ...grpc.CallOption) (*SetVPCIpPrefixesResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.aws_tgw_site.CustomAPI.SetVPCIpPrefixes")
...
func (c *customAPIInprocClient) SetVPNTunnels(ctx context.Context, in *SetVPNTunnelsRequest, opts ...grpc.CallOption) (*SetVPNTunnelsResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.aws_tgw_site.CustomAPI.SetVPNTunnels")
...
func (c *customAPIInprocClient) ValidateConfig(ctx context.Context, in *ves_io_schema_views.ValidateConfigRequest, opts ...grpc.CallOption) (*ves_io_schema_views.ValidateConfigResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.aws_tgw_site.CustomAPI.ValidateConfig")
...
func (s *customAPISrv) ValidateConfig(ctx context.Context, in *ves_io_schema_views.ValidateConfigRequest) (*ves_io_schema_views.ValidateConfigResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'CustomAPI.ValidateConfig' operation on 'aws_tgw_site'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.aws_tgw_site.CustomAPI.ValidateConfig"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
var CustomAPISwaggerJSON string = `{
    ...
    "paths": {
        ...
        "/public/namespaces/{namespace}/aws_tgw_site/{name}/validate_config": {
            "post": {
