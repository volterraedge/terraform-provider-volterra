...
type VnConfiguration struct {
	...
	//
	// Types that are valid to be assigned to InternetVipChoice:
	//	*VnConfiguration_DisableInternetVip
	//	*VnConfiguration_EnableInternetVip
	InternetVipChoice isVnConfiguration_InternetVipChoice `protobuf_oneof:"internet_vip_choice"`
}
...
type isVnConfiguration_InternetVipChoice interface {
	isVnConfiguration_InternetVipChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type VnConfiguration_DisableInternetVip struct {
	DisableInternetVip *schema.Empty `protobuf:"bytes,20,opt,name=disable_internet_vip,json=disableInternetVip,proto3,oneof" json:"disable_internet_vip,omitempty"`
}
type VnConfiguration_EnableInternetVip struct {
	EnableInternetVip *schema.Empty `protobuf:"bytes,21,opt,name=enable_internet_vip,json=enableInternetVip,proto3,oneof" json:"enable_internet_vip,omitempty"`
}
...
func (*VnConfiguration_DisableInternetVip) isVnConfiguration_InternetVipChoice()           {}
func (*VnConfiguration_EnableInternetVip) isVnConfiguration_InternetVipChoice()            {}
...
func (m *VnConfiguration) GetInternetVipChoice() isVnConfiguration_InternetVipChoice {
	if m != nil {
		return m.InternetVipChoice
	}
	return nil
...
func (m *VnConfiguration) GetDisableInternetVip() *schema.Empty {
	if x, ok := m.GetInternetVipChoice().(*VnConfiguration_DisableInternetVip); ok {
		return x.DisableInternetVip
	}
	return nil
}

func (m *VnConfiguration) GetEnableInternetVip() *schema.Empty {
	if x, ok := m.GetInternetVipChoice().(*VnConfiguration_EnableInternetVip); ok {
		return x.EnableInternetVip
	}
	return nil
}
...
func (*VnConfiguration) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*VnConfiguration_DisableInternetVip)(nil),
		(*VnConfiguration_EnableInternetVip)(nil),
	}
}
...
type AWSTGWSpokeAttachmentType struct {
	...
	// x-required
	// Choose cloud credentials to attach VPCs to this site. By default, the cloud credential used to provision this site will be used.
	//
	...
	// Choose a network segment. All attached VPCs will be placed in this network segment
	Segment *views.ObjectRefType `protobuf:"bytes,9,opt,name=segment,proto3" json:"segment,omitempty"`
	// Spoke VPCs
	//
...
func (m *AWSTGWSpokeAttachmentType) GetSegment() *views.ObjectRefType {
	if m != nil {
		return m.Segment
	}
	return nil
...
type AWSTGWResourceShareType struct {
	...
	// Resource Share Receiver Account
	//
	// x-displayName: "Resource Share Receiver Account"
	// Resource Share Receiver Account
	ReceiverAwsAccount string `protobuf:"bytes,5,opt,name=receiver_aws_account,json=receiverAwsAccount,proto3" json:"receiver_aws_account,omitempty"`
	// Resource Share Receiver ARN
	//
	// x-displayName: "Resource Share Receiver ARN"
	// Resource Share Receiver ARN
	ReceiverArn string `protobuf:"bytes,6,opt,name=receiver_arn,json=receiverArn,proto3" json:"receiver_arn,omitempty"`
	// Resource Share Acceptor Account ID
	//
	// x-displayName: "Resource Share Acceptor Account ID"
	// Resource Share Acceptor Account ID
	ReceiverAccountId string `protobuf:"bytes,7,opt,name=receiver_account_id,json=receiverAccountId,proto3" json:"receiver_account_id,omitempty"`
	...
	//
	// x-displayName "Feature Set"
	// Indicates what features are available for this Resource Share
	FeatureSet string `protobuf:"bytes,11,opt,name=feature_set,json=featureSet,proto3" json:"feature_set,omitempty"`
...
func (m *AWSTGWResourceShareType) GetReceiverAwsAccount() string {
	if m != nil {
		return m.ReceiverAwsAccount
	}
	return ""
}

func (m *AWSTGWResourceShareType) GetReceiverArn() string {
	if m != nil {
		return m.ReceiverArn
	}
	return ""
}
...
func (m *AWSTGWResourceShareType) GetFeatureSet() string {
	if m != nil {
		return m.FeatureSet
	}
	return ""
...
func (*ReplaceSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_69fc9b3c28dbc20f, []int{19}
}
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_69fc9b3c28dbc20f, []int{20}
}
...
var fileDescriptor_69fc9b3c28dbc20f = []byte{
	...
	,
}
...
func (this *VnConfiguration_DisableInternetVip) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VnConfiguration_DisableInternetVip)
	if !ok {
		that2, ok := that.(VnConfiguration_DisableInternetVip)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *VnConfiguration_EnableInternetVip) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VnConfiguration_EnableInternetVip)
	if !ok {
		that2, ok := that.(VnConfiguration_EnableInternetVip)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AWSTGWResourceShareType) Equal(that interface{}) bool {
	...
	if this.ReceiverAwsAccount != that1.ReceiverAwsAccount {
		return false
	}
	if this.ReceiverArn != that1.ReceiverArn {
		return false
	}
	if this.ReceiverAccountId != that1.ReceiverAccountId {
		return false
	}
	...
	if this.FeatureSet != that1.FeatureSet {
		return false
	}
...
func (this *VnConfiguration_DisableInternetVip) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_tgw_site.VnConfiguration_DisableInternetVip{` +
		`DisableInternetVip:` + fmt.Sprintf("%#v", this.DisableInternetVip) + `}`}, ", ")
	return s
}
func (this *VnConfiguration_EnableInternetVip) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_tgw_site.VnConfiguration_EnableInternetVip{` +
		`EnableInternetVip:` + fmt.Sprintf("%#v", this.EnableInternetVip) + `}`}, ", ")
	return s
}
...
func (this *AWSTGWResourceShareType) GoString() string {
	...
	s = append(s, "ReceiverAwsAccount: "+fmt.Sprintf("%#v", this.ReceiverAwsAccount)+",\n")
	s = append(s, "ReceiverArn: "+fmt.Sprintf("%#v", this.ReceiverArn)+",\n")
	...
	s = append(s, "FeatureSet: "+fmt.Sprintf("%#v", this.FeatureSet)+",\n")
...
func (m *VnConfiguration_DisableInternetVip) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VnConfiguration_DisableInternetVip) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableInternetVip != nil {
		{
			size, err := m.DisableInternetVip.MarshalToSizedBuffer(dAtA[:i])
...
func (m *VnConfiguration_EnableInternetVip) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VnConfiguration_EnableInternetVip) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableInternetVip != nil {
		{
			size, err := m.EnableInternetVip.MarshalToSizedBuffer(dAtA[:i])
...
func (m *AWSTGWResourceShareType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FeatureSet) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FeatureSet)))
		i--
		dAtA[i] = 0x5a
	}
	...
	if len(m.ReceiverAccountId) > 0 {
		i -= len(m.ReceiverAccountId)
		copy(dAtA[i:], m.ReceiverAccountId)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ReceiverAccountId)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ReceiverArn) > 0 {
		i -= len(m.ReceiverArn)
		copy(dAtA[i:], m.ReceiverArn)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ReceiverArn)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.ReceiverAwsAccount) > 0 {
		i -= len(m.ReceiverAwsAccount)
		copy(dAtA[i:], m.ReceiverAwsAccount)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ReceiverAwsAccount)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *VnConfiguration_DisableInternetVip) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VnConfiguration_EnableInternetVip) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *VnConfiguration_DisableInternetVip) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&VnConfiguration_DisableInternetVip{`,
		`DisableInternetVip:` + strings.Replace(fmt.Sprintf("%v", this.DisableInternetVip), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *VnConfiguration_EnableInternetVip) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&VnConfiguration_EnableInternetVip{`,
		`EnableInternetVip:` + strings.Replace(fmt.Sprintf("%v", this.EnableInternetVip), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *AWSTGWResourceShareType) String() string {
	...
	s := strings.Join([]string{`&AWSTGWResourceShareType{`,
		...
		`ReceiverAwsAccount:` + fmt.Sprintf("%v", this.ReceiverAwsAccount) + `,`,
		`ReceiverArn:` + fmt.Sprintf("%v", this.ReceiverArn) + `,`,
		...
		`FeatureSet:` + fmt.Sprintf("%v", this.FeatureSet) + `,`,
...
func (m *VnConfiguration) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			m.InternetVipChoice = &VnConfiguration_DisableInternetVip{v}
			iNdEx = postIndex
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableInternetVip", wireType)
			...
			m.InternetVipChoice = &VnConfiguration_EnableInternetVip{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *AWSTGWResourceShareType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceiverAwsAccount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReceiverAwsAccount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceiverArn", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReceiverArn = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			m.ReceiverAccountId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
