...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_virtual_address.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["system_metadata"] = ves_io_schema.SystemObjectMetaTypeValidator().Validate
	v.FldValidators["spec"] = ves_io_schema_views_virtual_address.SpecTypeValidator().Validate
	v.FldValidators["status"] = ves_io_schema_views_virtual_address.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_virtual_address.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_virtual_address.DBObject)
	}
	_ = f
