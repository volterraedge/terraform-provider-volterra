...
type AzureSubnetChoice struct {
	...
	ExistingSubnet *ves_io_schema_views1.AzureSubnetType `protobuf:"bytes,2,opt,name=existing_subnet,json=existingSubnet" json:"existing_subnet,omitempty"`
}

func (m *AzureSubnetChoice) Reset()                    { *m = AzureSubnetChoice{} }
func (*AzureSubnetChoice) ProtoMessage()               {}
func (*AzureSubnetChoice) Descriptor() ([]byte, []int) { return fileDescriptorAzureTypes, []int{2} }
...
func (m *AzureSubnetChoice) GetExistingSubnet() *ves_io_schema_views1.AzureSubnetType {
	if m != nil {
...
func (*AzureSubnetType) Descriptor() ([]byte, []int) { return fileDescriptorAzureTypes, []int{3} }
...
func (*AzureVnetParamsType) Descriptor() ([]byte, []int) { return fileDescriptorAzureTypes, []int{4} }
...
func (*AzureVnetInfoType) Descriptor() ([]byte, []int) { return fileDescriptorAzureTypes, []int{5} }
...
func (*AzureVnetSiteType) Descriptor() ([]byte, []int) { return fileDescriptorAzureTypes, []int{6} }
...
func NewPopulatedAzureInstanceType(r randyAzureTypes, easy bool) *AzureInstanceType {
	this := &AzureInstanceType{}
	this.VoltNodeId = string(randStringAzureTypes(r))
	this.VoltVnetId = string(randStringAzureTypes(r))
	this.PublicSubnetId = string(randStringAzureTypes(r))
	this.PrivateSubnetId = string(randStringAzureTypes(r))
	this.MachineType = string(randStringAzureTypes(r))
	this.DiskSize = string(randStringAzureTypes(r))
	if r.Intn(10) != 0 {
		this.Marketplace = ves_io_schema_certified_hardware.NewPopulatedMarketplace(r, easy)
	}
	this.Az = string(randStringAzureTypes(r))
...
func NewPopulatedAzureSubnetParamType(r randyAzureTypes, easy bool) *AzureSubnetParamType {
	this := &AzureSubnetParamType{}
	this.ResourceGroup = string(randStringAzureTypes(r))
	this.Ipv4 = string(randStringAzureTypes(r))
	this.Ipv6 = string(randStringAzureTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedAzureSubnetChoice(r randyAzureTypes, easy bool) *AzureSubnetChoice {
	this := &AzureSubnetChoice{}
	if r.Intn(10) != 0 {
		this.SubnetParam = NewPopulatedAzureSubnetParamType(r, easy)
	}
	if r.Intn(10) != 0 {
		this.ExistingSubnet = ves_io_schema_views1.NewPopulatedAzureSubnetType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedAzureSubnetType(r randyAzureTypes, easy bool) *AzureSubnetType {
	this := &AzureSubnetType{}
	this.VoltSubnetId = string(randStringAzureTypes(r))
	this.VoltVnetId = string(randStringAzureTypes(r))
	if r.Intn(10) != 0 {
...
func NewPopulatedAzureVnetParamsType(r randyAzureTypes, easy bool) *AzureVnetParamsType {
	this := &AzureVnetParamsType{}
	this.ResourceGroup = string(randStringAzureTypes(r))
	this.Name = string(randStringAzureTypes(r))
	this.PrimaryIpv4 = string(randStringAzureTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedAzureVnetInfoType(r randyAzureTypes, easy bool) *AzureVnetInfoType {
	this := &AzureVnetInfoType{}
	if r.Intn(10) != 0 {
		this.NewVnet = ves_io_schema_views1.NewPopulatedAzureVnetParamsType(r, easy)
	}
	if r.Intn(10) != 0 {
		this.Vnet = ves_io_schema_views1.NewPopulatedAzureVnetType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedAzureVnetSiteType(r randyAzureTypes, easy bool) *AzureVnetSiteType {
	this := &AzureVnetSiteType{}
	this.SiteName = string(randStringAzureTypes(r))
	this.VoltVnetId = string(randStringAzureTypes(r))
	this.FleetLabel = string(randStringAzureTypes(r))
	this.CertifiedHw = string(randStringAzureTypes(r))
	this.AzureRegion = string(randStringAzureTypes(r))
	this.AzureResourceGrp = string(randStringAzureTypes(r))
	if r.Intn(10) != 0 {
		this.Vnet = NewPopulatedAzureVnetInfoType(r, easy)
	}
	if r.Intn(10) != 0 {
		v1 := r.Intn(5)
		this.Subnets = make([]*AzureSubnetType, v1)
		for i := 0; i < v1; i++ {
			this.Subnets[i] = NewPopulatedAzureSubnetType(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v2 := r.Intn(5)
		this.MasterNodes = make([]*AzureInstanceType, v2)
		for i := 0; i < v2; i++ {
			this.MasterNodes[i] = NewPopulatedAzureInstanceType(r, easy)
		}
	}
	this.GatewayType = CloudGatewayType([]int32{0, 1}[r.Intn(2)])
	this.SshKey = string(randStringAzureTypes(r))
	this.WorkerNodes = uint32(r.Uint32())
	this.AzureName = string(randStringAzureTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

type randyAzureTypes interface {
	Float32() float32
	Float64() float64
	Int63() int64
	Int31() int32
...
func randUTF8RuneAzureTypes(r randyAzureTypes) rune {
	ru := r.Intn(62)
	if ru < 10 {
		return rune(ru + 48)
	} else if ru < 36 {
...
func randStringAzureTypes(r randyAzureTypes) string {
	v3 := r.Intn(100)
	tmps := make([]rune, v3)
	for i := 0; i < v3; i++ {
		tmps[i] = randUTF8RuneAzureTypes(r)
	}
	return string(tmps)
}
func randUnrecognizedAzureTypes(r randyAzureTypes, maxFieldNumber int) (dAtA []byte) {
	l := r.Intn(5)
	for i := 0; i < l; i++ {
		wire := r.Intn(4)
		if wire == 3 {
		...
		dAtA = randFieldAzureTypes(dAtA, r, fieldNumber, wire)
	}
	return dAtA
}
func randFieldAzureTypes(dAtA []byte, r randyAzureTypes, fieldNumber int, wire int) []byte {
	key := uint32(fieldNumber)<<3 | uint32(wire)
	switch wire {
	case 0:
		dAtA = encodeVarintPopulateAzureTypes(dAtA, uint64(key))
		v4 := r.Int63()
		if r.Intn(2) == 0 {
			v4 *= -1
		}
		dAtA = encodeVarintPopulateAzureTypes(dAtA, uint64(v4))
	case 1:
		dAtA = encodeVarintPopulateAzureTypes(dAtA, uint64(key))
	...
	case 2:
		dAtA = encodeVarintPopulateAzureTypes(dAtA, uint64(key))
		ll := r.Intn(100)
		dAtA = encodeVarintPopulateAzureTypes(dAtA, uint64(ll))
		for j := 0; j < ll; j++ {
...
func encodeVarintPopulateAzureTypes(dAtA []byte, v uint64) []byte {
	for v >= 1<<7 {
...
func (this *AzureSubnetChoice) String() string {
	...
	s := strings.Join([]string{`&AzureSubnetChoice{`,
		...
		`ExistingSubnet:` + strings.Replace(fmt.Sprintf("%v", this.ExistingSubnet), "AzureSubnetType", "ves_io_schema_views1.AzureSubnetType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *AzureSubnetChoice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ExistingSubnet == nil {
				m.ExistingSubnet = &ves_io_schema_views1.AzureSubnetType{}
			}
...
var fileDescriptorAzureTypes = []byte{
	...
	,
}
