...
// Azure Disk Type
//
// x-displayName: "Azure Disk Type"
// Azure Disk Type
type AzureDiskType int32

const (
	// x-displayName: "Standard HDD"
	// Backup, non-critical, infrequent access
	Standard_HDD AzureDiskType = 0
	// x-displayName: "Standard SSD"
	// Web servers, lightly used enterprise applications and dev/test
	Standard_SSD AzureDiskType = 1
	// x-displayName: "Premium SSD"
	// Production and performance sensitive workloads
	Premium_SSD AzureDiskType = 2
	// x-displayName: "Premium SSD v2"
	// Production and performance-sensitive workloads that consistently require low latency and high IOPS and throughput
	Premium_SSD_v2 AzureDiskType = 3
)

var AzureDiskType_name = map[int32]string{
	0: "Standard_HDD",
	1: "Standard_SSD",
	2: "Premium_SSD",
	3: "Premium_SSD_v2",
...
var AzureDiskType_value = map[string]int32{
	"Standard_HDD":   0,
	"Standard_SSD":   1,
	"Premium_SSD":    2,
	"Premium_SSD_v2": 3,
...
func (AzureDiskType) EnumDescriptor() ([]byte, []int) {
...
type AzureInstanceType struct {
	...
	// Managed Disk Type
	//
	// x-displayName: "Azure Managed Disk Type for Node"
	// Select Instance disk type based on performance needed.
	// The default setting will be Premium_LRS
	DiskType AzureDiskType `protobuf:"varint,12,opt,name=disk_type,json=diskType,proto3,enum=ves.io.schema.views.terraform_parameters.AzureDiskType" json:"disk_type,omitempty"`
	// Disk Encryption
	//
	...
	// If encryption is enabled, DES to be used
	DiskEncryptionSet string `protobuf:"bytes,14,opt,name=disk_encryption_set,json=diskEncryptionSet,proto3" json:"disk_encryption_set,omitempty"`
	// Resource group
	//
...
func (m *AzureInstanceType) GetDiskType() AzureDiskType {
	if m != nil {
		return m.DiskType
	}
	return Standard_HDD
...
func (m *AzureInstanceType) GetEncryption() bool {
	if m != nil {
		return m.Encryption
	}
	return false
...
func (m *AzureInstanceType) GetDiskEncryptionSet() string {
	if m != nil {
...
func (m *AzureInstanceType) GetResourceGroup() string {
	if m != nil {
...
type AzureVnetSiteType struct {
	...
	//
	// x-displayName: "F5XC Vnet ID"
	// F5XC vnet ID will be used to refer to this vnet in other TF parameters
	VoltVnetId string `protobuf:"bytes,2,opt,name=volt_vnet_id,json=voltVnetId,proto3" json:"volt_vnet_id,omitempty"`
	// Certified Hardware
	//
	...
	DisableInternetConnectivityViaIgw bool `protobuf:"varint,23,opt,name=disable_internet_connectivity_via_igw,json=disableInternetConnectivityViaIgw,proto3" json:"disable_internet_connectivity_via_igw,omitempty"`
	// enable_accelerated_networking
	//
	// x-displayName: "Enable Accelerated Networking"
	//
	EnableAcceleratedNetworking bool `protobuf:"varint,24,opt,name=enable_accelerated_networking,json=enableAcceleratedNetworking,proto3" json:"enable_accelerated_networking,omitempty"`
	// manual_routing
	//
	// x-displayName: "Enable F5 Based Routing or Manual Routing"
	//
	ManualRouting bool `protobuf:"varint,25,opt,name=manual_routing,json=manualRouting,proto3" json:"manual_routing,omitempty"`
}
...
func (m *AzureVnetSiteType) GetAdminPassword() string {
	if m != nil {
...
func (m *AzureVnetSiteType) GetAdminPasswordClearB64() string {
	if m != nil {
...
func (m *AzureVnetSiteType) GetAdminPasswordBlindfolded() string {
	if m != nil {
...
func (m *AzureVnetSiteType) GetDisableInternetConnectivityViaIgw() bool {
	if m != nil {
...
func (m *AzureVnetSiteType) GetEnableAcceleratedNetworking() bool {
	if m != nil {
		return m.EnableAcceleratedNetworking
	}
	return false
}

func (m *AzureVnetSiteType) GetManualRouting() bool {
	if m != nil {
...
type AzureExpressRouteType struct {
	...
	PrivateNetworkName string `protobuf:"bytes,9,opt,name=private_network_name,json=privateNetworkName,proto3" json:"private_network_name,omitempty"`
	// Cloud Link ADN DNS IP
	//
	// x-displayName: "Cloud Link DNS IP"
	// x-example: "10.0.0.1"
	// Cloud Link ADN DNS IP, which will be used to resolve domains
	AdnDnsIp string `protobuf:"bytes,10,opt,name=adn_dns_ip,json=adnDnsIp,proto3" json:"adn_dns_ip,omitempty"`
}
...
func (m *AzureExpressRouteType) GetPrivateNetworkName() string {
	if m != nil {
...
func (m *AzureExpressRouteType) GetAdnDnsIp() string {
	if m != nil {
		return m.AdnDnsIp
	}
	return ""
...
func init() {
	proto.RegisterEnum("ves.io.schema.views.terraform_parameters.AzureDiskType", AzureDiskType_name, AzureDiskType_value)
	golang_proto.RegisterEnum("ves.io.schema.views.terraform_parameters.AzureDiskType", AzureDiskType_name, AzureDiskType_value)
...
var fileDescriptor_cfa180cd722a5ccd = []byte{
	...
	,
}

func (x AzureDiskType) String() string {
	s, ok := AzureDiskType_name[int32(x)]
	if ok {
		return s
	}
...
func (this *AzureInstanceType) Equal(that interface{}) bool {
	...
	if this.DiskType != that1.DiskType {
		return false
	}
	if this.Encryption != that1.Encryption {
		return false
	}
	if this.DiskEncryptionSet != that1.DiskEncryptionSet {
		return false
	}
...
func (this *AzureVnetSiteType) Equal(that interface{}) bool {
	...
	if this.EnableAcceleratedNetworking != that1.EnableAcceleratedNetworking {
		return false
	}
...
func (this *AzureInstanceType) GoString() string {
	...
	s = append(s, "DiskType: "+fmt.Sprintf("%#v", this.DiskType)+",\n")
	s = append(s, "Encryption: "+fmt.Sprintf("%#v", this.Encryption)+",\n")
	s = append(s, "DiskEncryptionSet: "+fmt.Sprintf("%#v", this.DiskEncryptionSet)+",\n")
...
func (this *AzureVnetSiteType) goString() string {
	...
	s = append(s, "EnableAcceleratedNetworking: "+fmt.Sprintf("%#v", this.EnableAcceleratedNetworking)+",\n")
...
func (m *AzureInstanceType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DiskEncryptionSet) > 0 {
		i -= len(m.DiskEncryptionSet)
		copy(dAtA[i:], m.DiskEncryptionSet)
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.DiskEncryptionSet)))
		i--
		dAtA[i] = 0x72
	}
	if m.Encryption {
	...
	if m.DiskType != 0 {
		i = encodeVarintAzureTypes(dAtA, i, uint64(m.DiskType))
		i--
		dAtA[i] = 0x60
	}
	if m.NodeCount != 0 {
...
func (m *AzureVnetSiteType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AdminPasswordBlindfolded) > 0 {
		...
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.AdminPasswordBlindfolded)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xa2
	...
	if len(m.AdminPasswordClearB64) > 0 {
		...
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.AdminPasswordClearB64)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x9a
	...
	if len(m.AdminPassword) > 0 {
		...
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.AdminPassword)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x92
	...
	if m.EnableAcceleratedNetworking {
		i--
		if m.EnableAcceleratedNetworking {
			dAtA[i] = 1
		} else {
...
func (m *AzureExpressRouteType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AdnDnsIp) > 0 {
		...
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.AdnDnsIp)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.PrivateNetworkName) > 0 {
		...
		i = encodeVarintAzureTypes(dAtA, i, uint64(len(m.PrivateNetworkName)))
		i--
		dAtA[i] = 0x4a
	}
	if m.SiteAsn != 0 {
...
func (m *AzureInstanceType) Size() (n int) {
	...
	if m.DiskType != 0 {
		n += 1 + sovAzureTypes(uint64(m.DiskType))
	}
	if m.Encryption {
		n += 2
	}
	l = len(m.DiskEncryptionSet)
	if l > 0 {
		n += 1 + l + sovAzureTypes(uint64(l))
	}
...
func (this *AzureInstanceType) String() string {
	...
	s := strings.Join([]string{`&AzureInstanceType{`,
		...
		`DiskEncryptionSet:` + fmt.Sprintf("%v", this.DiskEncryptionSet) + `,`,
...
func (this *AzureVnetSiteType) string() string {
	...
	s := strings.Join([]string{`&AzureVnetSiteType{`,
		...
		`EnableAcceleratedNetworking:` + fmt.Sprintf("%v", this.EnableAcceleratedNetworking) + `,`,
	...
	for iNdEx < l {
		...
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DiskType |= AzureDiskType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 14:
			...
			m.DiskEncryptionSet = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
...
func (m *AzureVnetSiteType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableAcceleratedNetworking", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableAcceleratedNetworking = bool(v != 0)
		case 25:
			if wireType != 0 {
