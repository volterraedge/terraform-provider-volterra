...
import (
	...
	ves_io_schema_views_k8s_manifest_params "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/k8s_manifest_params"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_k8s_manifest_params.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_k8s_manifest_params.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_k8s_manifest_params.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_k8s_manifest_params.DBObject)
	}
	_ = f
