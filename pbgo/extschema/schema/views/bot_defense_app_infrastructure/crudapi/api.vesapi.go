...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.bot_defense_app_infrastructure.crudapi.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.bot_defense_app_infrastructure.crudapi.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.bot_defense_app_infrastructure.crudapi.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.bot_defense_app_infrastructure.crudapi.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.views.bot_defense_app_infrastructure.crudapi.API.Delete", nil)
    ...
    "paths": {
        "/ves.io.schema.views.bot_defense_app_infrastructure/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-replace"
                },
        ...
        "/ves.io.schema.views.bot_defense_app_infrastructure/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-list"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-create"
                },
        ...
        "/ves.io.schema.views.bot_defense_app_infrastructure/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-views-bot_defense_app_infrastructure-crudapi-api-liststream"
                },
