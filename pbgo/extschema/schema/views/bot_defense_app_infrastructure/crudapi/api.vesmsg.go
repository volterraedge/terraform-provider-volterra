...
import (
	...
	ves_io_schema_views_bot_defense_app_infrastructure "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/bot_defense_app_infrastructure"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_bot_defense_app_infrastructure.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_bot_defense_app_infrastructure.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_bot_defense_app_infrastructure.DBObject)
	}
	_ = f
