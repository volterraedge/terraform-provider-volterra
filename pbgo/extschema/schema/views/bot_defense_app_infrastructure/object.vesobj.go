...
const (
	ObjectDefTblName = "ves.io.schema.views.bot_defense_app_infrastructure.Object.default"
	ObjectType       = "ves.io.schema.views.bot_defense_app_infrastructure.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.views.bot_defense_app_infrastructure.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.views.bot_defense_app_infrastructure.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
