...
func (c *CustomAPIRestClient) doRPCSetCloudSiteInfo(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, fmt.Errorf("JSON Response %s is not of type *ves.io.schema.views.azure_vnet_site.SetCloudSiteInfoResponse", body)
...
func (c *CustomAPIInprocClient) SetCloudSiteInfo(ctx context.Context, in *SetCloudSiteInfoRequest, opts ...grpc.CallOption) (*SetCloudSiteInfoResponse, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.views.azure_vnet_site.SetCloudSiteInfoRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	if c.svc.Config().EnableAPIValidation {
		if rvFn := c.svc.GetRPCValidator("ves.io.schema.views.azure_vnet_site.CustomAPI.SetCloudSiteInfo"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, c.svc, "ves.io.schema.views.azure_vnet_site.SetCloudSiteInfoResponse", rsp)...)
