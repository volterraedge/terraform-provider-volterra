...
import (
	...
	ves_io_schema_views_view_internal "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/view_internal"
)
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_view_internal.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_view_internal.DBObject)
	}
	_ = f
