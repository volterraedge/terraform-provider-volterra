...
/*
Package view_internal is a reverse proxy.
...
var (
	pattern_CustomAPI_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"public", "namespaces", "namespace", "view_internal", "view_kind", "view_name"}, "", runtime.AssumeColonVerbOpt(false)))
)
