...
const (
	ObjectDefTblName = "ves.io.schema.views.view_internal.Object.default"
	ObjectType       = "ves.io.schema.views.view_internal.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.views.view_internal.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.views.view_internal.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
