...
import (
	...
	ves_io_schema_views_securemesh_site_v2 "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/securemesh_site_v2"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_securemesh_site_v2.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_securemesh_site_v2.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_securemesh_site_v2.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_securemesh_site_v2.DBObject)
	}
	_ = f
