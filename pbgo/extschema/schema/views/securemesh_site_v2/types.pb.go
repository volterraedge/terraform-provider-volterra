...
type GlobalSpecType struct {
	...
	ProactiveMonitoring *views.ProactiveMonitoringChoice `protobuf:"bytes,56,opt,name=proactive_monitoring,json=proactiveMonitoring,proto3" json:"proactive_monitoring,omitempty"` // Deprecated: Do not use.
	// Enterprise Proxy
	//
	...
	// Proxy Bypass
	//
	// x-displayName: "Proxy Bypass Settings"
	// Proxy Bypass can be used for any domains that need to bypass the forward proxy. By default, all domains will go through the F5 Enterprise Proxy or the Custom Enterprise Proxy if configured. Note: The F5 Enterprise Proxy is configured to only allow domains required for Customer Edge bootstrap and upgrades. This setting is especially useful for use-cases such as virtual kubernetes (vk8s) to pull images from custom container registries.
	//
	// Types that are valid to be assigned to ProxyBypassChoice:
	//	*GlobalSpecType_NoProxyBypass
	//	*GlobalSpecType_CustomProxyBypass
	ProxyBypassChoice isGlobalSpecType_ProxyBypassChoice `protobuf_oneof:"proxy_bypass_choice"`
	// DNS & NTP Servers
	//
	...
	SiteErrors []*views.SiteError `protobuf:"bytes,64,rep,name=site_errors,json=siteErrors,proto3" json:"site_errors,omitempty"`
}
...
type isGlobalSpecType_ProxyBypassChoice interface {
	isGlobalSpecType_ProxyBypassChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GlobalSpecType_Equinix struct {
	Equinix *EquinixProviderType `protobuf:"bytes,57,opt,name=equinix,proto3,oneof" json:"equinix,omitempty"`
}
...
type GlobalSpecType_NoProxyBypass struct {
	NoProxyBypass *schema.Empty `protobuf:"bytes,66,opt,name=no_proxy_bypass,json=noProxyBypass,proto3,oneof" json:"no_proxy_bypass,omitempty"`
}
type GlobalSpecType_CustomProxyBypass struct {
	CustomProxyBypass *CustomProxyBypassSettings `protobuf:"bytes,67,opt,name=custom_proxy_bypass,json=customProxyBypass,proto3,oneof" json:"custom_proxy_bypass,omitempty"`
}
...
func (*GlobalSpecType_Equinix) isGlobalSpecType_ProviderChoice()                             {}
...
func (*GlobalSpecType_NoProxyBypass) isGlobalSpecType_ProxyBypassChoice()                    {}
func (*GlobalSpecType_CustomProxyBypass) isGlobalSpecType_ProxyBypassChoice()                {}
...
func (m *GlobalSpecType) GetProxyBypassChoice() isGlobalSpecType_ProxyBypassChoice {
	if m != nil {
		return m.ProxyBypassChoice
	}
	return nil
}
...
func (m *GlobalSpecType) GetEquinix() *EquinixProviderType {
	if x, ok := m.GetProviderChoice().(*GlobalSpecType_Equinix); ok {
		return x.Equinix
	}
	return nil
}
...
func (m *GlobalSpecType) GetNoProxyBypass() *schema.Empty {
	if x, ok := m.GetProxyBypassChoice().(*GlobalSpecType_NoProxyBypass); ok {
		return x.NoProxyBypass
	}
	return nil
}

func (m *GlobalSpecType) GetCustomProxyBypass() *CustomProxyBypassSettings {
	if x, ok := m.GetProxyBypassChoice().(*GlobalSpecType_CustomProxyBypass); ok {
		return x.CustomProxyBypass
	}
	return nil
}
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_NoProxyBypass)(nil),
		(*GlobalSpecType_CustomProxyBypass)(nil),
	}
}
...
type CustomProxyBypassSettings struct {
	// Proxy Bypass
	//
	// x-displayName: "Proxy Bypass"
	// List of domains to bypass the proxy
	ProxyBypass []string `protobuf:"bytes,1,rep,name=proxy_bypass,json=proxyBypass,proto3" json:"proxy_bypass,omitempty"`
}

func (m *CustomProxyBypassSettings) Reset()      { *m = CustomProxyBypassSettings{} }
func (*CustomProxyBypassSettings) ProtoMessage() {}
func (*CustomProxyBypassSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_6acf9f1f49f4d0ae, []int{4}
}
func (m *CustomProxyBypassSettings) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CustomProxyBypassSettings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *CustomProxyBypassSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CustomProxyBypassSettings.Merge(m, src)
}
func (m *CustomProxyBypassSettings) XXX_Size() int {
	return m.Size()
}
func (m *CustomProxyBypassSettings) XXX_DiscardUnknown() {
	xxx_messageInfo_CustomProxyBypassSettings.DiscardUnknown(m)
}

var xxx_messageInfo_CustomProxyBypassSettings proto.InternalMessageInfo

func (m *CustomProxyBypassSettings) GetProxyBypass() []string {
	if m != nil {
		return m.ProxyBypass
	}
	return nil
}
...
type AzureProviderType_Managed struct {
	Managed *AzureManagedMode `protobuf:"bytes,3,opt,name=managed,proto3,oneof" json:"managed,omitempty"`
}

func (*AzureProviderType_NotManaged) isAzureProviderType_OrchestrationChoice() {}
func (*AzureProviderType_Managed) isAzureProviderType_OrchestrationChoice()    {}
...
func (m *AzureProviderType) GetManaged() *AzureManagedMode {
	if x, ok := m.GetOrchestrationChoice().(*AzureProviderType_Managed); ok {
		return x.Managed
	}
	return nil
}
...
type GCPProviderType_Managed struct {
	Managed *GCPManagedMode `protobuf:"bytes,4,opt,name=managed,proto3,oneof" json:"managed,omitempty"`
}

func (*GCPProviderType_NotManaged) isGCPProviderType_OrchestrationChoice() {}
func (*GCPProviderType_Managed) isGCPProviderType_OrchestrationChoice()    {}
...
func (m *GCPProviderType) GetManaged() *GCPManagedMode {
	if x, ok := m.GetOrchestrationChoice().(*GCPProviderType_Managed); ok {
		return x.Managed
	}
	return nil
}
...
// Equinix Provider Type
type EquinixProviderType struct {
	// Orchestration Mode
	//
	// x-displayName: "Orchestration Mode"
	// Select the orchestration mode for this site.
	...
	//
	// Types that are valid to be assigned to OrchestrationChoice:
	//	*EquinixProviderType_NotManaged
	OrchestrationChoice isEquinixProviderType_OrchestrationChoice `protobuf_oneof:"orchestration_choice"`
}

func (m *EquinixProviderType) Reset()      { *m = EquinixProviderType{} }
func (*EquinixProviderType) ProtoMessage() {}
func (*EquinixProviderType) Descriptor() ([]byte, []int) {
	return fileDescriptor_6acf9f1f49f4d0ae, []int{21}
}
func (m *EquinixProviderType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EquinixProviderType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *EquinixProviderType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EquinixProviderType.Merge(m, src)
}
func (m *EquinixProviderType) XXX_Size() int {
	return m.Size()
}
func (m *EquinixProviderType) XXX_DiscardUnknown() {
	xxx_messageInfo_EquinixProviderType.DiscardUnknown(m)
}

var xxx_messageInfo_EquinixProviderType proto.InternalMessageInfo

type isEquinixProviderType_OrchestrationChoice interface {
	isEquinixProviderType_OrchestrationChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type EquinixProviderType_NotManaged struct {
	NotManaged *NodeList `protobuf:"bytes,2,opt,name=not_managed,json=notManaged,proto3,oneof" json:"not_managed,omitempty"`
}

func (*EquinixProviderType_NotManaged) isEquinixProviderType_OrchestrationChoice() {}

func (m *EquinixProviderType) GetOrchestrationChoice() isEquinixProviderType_OrchestrationChoice {
	if m != nil {
		return m.OrchestrationChoice
	}
	return nil
...
func (m *EquinixProviderType) GetNotManaged() *NodeList {
	if x, ok := m.GetOrchestrationChoice().(*EquinixProviderType_NotManaged); ok {
		return x.NotManaged
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*EquinixProviderType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*EquinixProviderType_NotManaged)(nil),
	}
}
...
type CreateSpecType struct {
	...
	// Types that are valid to be assigned to ProxyBypassChoice:
	//	*CreateSpecType_NoProxyBypass
	//	*CreateSpecType_CustomProxyBypass
	ProxyBypassChoice isCreateSpecType_ProxyBypassChoice `protobuf_oneof:"proxy_bypass_choice"`
	DnsNtpConfig      *DNSNTPServerConfig                `protobuf:"bytes,62,opt,name=dns_ntp_config,json=dnsNtpConfig,proto3" json:"dns_ntp_config,omitempty"`
}
...
type isCreateSpecType_ProxyBypassChoice interface {
	isCreateSpecType_ProxyBypassChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type CreateSpecType_Equinix struct {
	Equinix *EquinixProviderType `protobuf:"bytes,57,opt,name=equinix,proto3,oneof" json:"equinix,omitempty"`
}
...
type CreateSpecType_NoProxyBypass struct {
	NoProxyBypass *schema.Empty `protobuf:"bytes,66,opt,name=no_proxy_bypass,json=noProxyBypass,proto3,oneof" json:"no_proxy_bypass,omitempty"`
}
type CreateSpecType_CustomProxyBypass struct {
	CustomProxyBypass *CustomProxyBypassSettings `protobuf:"bytes,67,opt,name=custom_proxy_bypass,json=customProxyBypass,proto3,oneof" json:"custom_proxy_bypass,omitempty"`
}
...
func (*CreateSpecType_Equinix) isCreateSpecType_ProviderChoice()                             {}
...
func (*CreateSpecType_NoProxyBypass) isCreateSpecType_ProxyBypassChoice()                    {}
func (*CreateSpecType_CustomProxyBypass) isCreateSpecType_ProxyBypassChoice()                {}
...
func (m *CreateSpecType) GetProxyBypassChoice() isCreateSpecType_ProxyBypassChoice {
	if m != nil {
		return m.ProxyBypassChoice
	}
	return nil
...
func (m *CreateSpecType) GetEquinix() *EquinixProviderType {
	if x, ok := m.GetProviderChoice().(*CreateSpecType_Equinix); ok {
		return x.Equinix
	}
	return nil
}
...
func (m *CreateSpecType) GetNoProxyBypass() *schema.Empty {
	if x, ok := m.GetProxyBypassChoice().(*CreateSpecType_NoProxyBypass); ok {
		return x.NoProxyBypass
	}
	return nil
}

func (m *CreateSpecType) GetCustomProxyBypass() *CustomProxyBypassSettings {
	if x, ok := m.GetProxyBypassChoice().(*CreateSpecType_CustomProxyBypass); ok {
		return x.CustomProxyBypass
	}
	return nil
}
...
func (*CreateSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*CreateSpecType_NoProxyBypass)(nil),
		(*CreateSpecType_CustomProxyBypass)(nil),
	}
}
...
type ReplaceSpecType struct {
	...
	// Types that are valid to be assigned to ProxyBypassChoice:
	//	*ReplaceSpecType_NoProxyBypass
	//	*ReplaceSpecType_CustomProxyBypass
	ProxyBypassChoice isReplaceSpecType_ProxyBypassChoice `protobuf_oneof:"proxy_bypass_choice"`
	DnsNtpConfig      *DNSNTPServerConfig                 `protobuf:"bytes,62,opt,name=dns_ntp_config,json=dnsNtpConfig,proto3" json:"dns_ntp_config,omitempty"`
}
...
type isReplaceSpecType_ProxyBypassChoice interface {
	isReplaceSpecType_ProxyBypassChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type ReplaceSpecType_Equinix struct {
	Equinix *EquinixProviderType `protobuf:"bytes,57,opt,name=equinix,proto3,oneof" json:"equinix,omitempty"`
}
...
type ReplaceSpecType_NoProxyBypass struct {
	NoProxyBypass *schema.Empty `protobuf:"bytes,66,opt,name=no_proxy_bypass,json=noProxyBypass,proto3,oneof" json:"no_proxy_bypass,omitempty"`
}
type ReplaceSpecType_CustomProxyBypass struct {
	CustomProxyBypass *CustomProxyBypassSettings `protobuf:"bytes,67,opt,name=custom_proxy_bypass,json=customProxyBypass,proto3,oneof" json:"custom_proxy_bypass,omitempty"`
}
...
func (*ReplaceSpecType_Equinix) isReplaceSpecType_ProviderChoice()                             {}
...
func (*ReplaceSpecType_NoProxyBypass) isReplaceSpecType_ProxyBypassChoice()                    {}
func (*ReplaceSpecType_CustomProxyBypass) isReplaceSpecType_ProxyBypassChoice()                {}
...
func (m *ReplaceSpecType) GetProxyBypassChoice() isReplaceSpecType_ProxyBypassChoice {
	if m != nil {
		return m.ProxyBypassChoice
	}
	return nil
...
func (m *ReplaceSpecType) GetEquinix() *EquinixProviderType {
	if x, ok := m.GetProviderChoice().(*ReplaceSpecType_Equinix); ok {
		return x.Equinix
	}
	return nil
}
...
func (m *ReplaceSpecType) GetNoProxyBypass() *schema.Empty {
	if x, ok := m.GetProxyBypassChoice().(*ReplaceSpecType_NoProxyBypass); ok {
		return x.NoProxyBypass
	}
	return nil
}

func (m *ReplaceSpecType) GetCustomProxyBypass() *CustomProxyBypassSettings {
	if x, ok := m.GetProxyBypassChoice().(*ReplaceSpecType_CustomProxyBypass); ok {
		return x.CustomProxyBypass
	}
	return nil
}
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_NoProxyBypass)(nil),
		(*ReplaceSpecType_CustomProxyBypass)(nil),
	}
}
...
type GetSpecType struct {
	...
	// Types that are valid to be assigned to ProxyBypassChoice:
	//	*GetSpecType_NoProxyBypass
	//	*GetSpecType_CustomProxyBypass
	ProxyBypassChoice isGetSpecType_ProxyBypassChoice `protobuf_oneof:"proxy_bypass_choice"`
	DnsNtpConfig      *DNSNTPServerConfig             `protobuf:"bytes,62,opt,name=dns_ntp_config,json=dnsNtpConfig,proto3" json:"dns_ntp_config,omitempty"`
	SiteErrors        []*views.SiteError              `protobuf:"bytes,64,rep,name=site_errors,json=siteErrors,proto3" json:"site_errors,omitempty"`
}
...
type isGetSpecType_ProxyBypassChoice interface {
	isGetSpecType_ProxyBypassChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GetSpecType_Equinix struct {
	Equinix *EquinixProviderType `protobuf:"bytes,57,opt,name=equinix,proto3,oneof" json:"equinix,omitempty"`
}
...
type GetSpecType_NoProxyBypass struct {
	NoProxyBypass *schema.Empty `protobuf:"bytes,66,opt,name=no_proxy_bypass,json=noProxyBypass,proto3,oneof" json:"no_proxy_bypass,omitempty"`
}
type GetSpecType_CustomProxyBypass struct {
	CustomProxyBypass *CustomProxyBypassSettings `protobuf:"bytes,67,opt,name=custom_proxy_bypass,json=customProxyBypass,proto3,oneof" json:"custom_proxy_bypass,omitempty"`
}
...
func (*GetSpecType_Equinix) isGetSpecType_ProviderChoice()                             {}
...
func (*GetSpecType_NoProxyBypass) isGetSpecType_ProxyBypassChoice()                    {}
func (*GetSpecType_CustomProxyBypass) isGetSpecType_ProxyBypassChoice()                {}
...
func (m *GetSpecType) GetProxyBypassChoice() isGetSpecType_ProxyBypassChoice {
	if m != nil {
		return m.ProxyBypassChoice
	}
	return nil
...
func (m *GetSpecType) GetEquinix() *EquinixProviderType {
	if x, ok := m.GetProviderChoice().(*GetSpecType_Equinix); ok {
		return x.Equinix
	}
	return nil
}
...
func (m *GetSpecType) GetNoProxyBypass() *schema.Empty {
	if x, ok := m.GetProxyBypassChoice().(*GetSpecType_NoProxyBypass); ok {
		return x.NoProxyBypass
	}
	return nil
}

func (m *GetSpecType) GetCustomProxyBypass() *CustomProxyBypassSettings {
	if x, ok := m.GetProxyBypassChoice().(*GetSpecType_CustomProxyBypass); ok {
		return x.CustomProxyBypass
	}
	return nil
}
...
func (*GetSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GetSpecType_NoProxyBypass)(nil),
		(*GetSpecType_CustomProxyBypass)(nil),
	}
}
...
func (*StaticRoutesListType) Descriptor() ([]byte, []int) {
	return fileDescriptor_6acf9f1f49f4d0ae, []int{30}
}
...
func (*LocalVRFSettingType) Descriptor() ([]byte, []int) {
	return fileDescriptor_6acf9f1f49f4d0ae, []int{31}
}
...
func init() {
	...
	proto.RegisterType((*CustomProxyBypassSettings)(nil), "ves.io.schema.views.securemesh_site_v2.CustomProxyBypassSettings")
	golang_proto.RegisterType((*CustomProxyBypassSettings)(nil), "ves.io.schema.views.securemesh_site_v2.CustomProxyBypassSettings")
	...
	proto.RegisterType((*EquinixProviderType)(nil), "ves.io.schema.views.securemesh_site_v2.EquinixProviderType")
	golang_proto.RegisterType((*EquinixProviderType)(nil), "ves.io.schema.views.securemesh_site_v2.EquinixProviderType")
...
var fileDescriptor_6acf9f1f49f4d0ae = []byte{
	...
	,
}
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if that1.ProxyBypassChoice == nil {
		if this.ProxyBypassChoice != nil {
			return false
		}
	} else if this.ProxyBypassChoice == nil {
		return false
	} else if !this.ProxyBypassChoice.Equal(that1.ProxyBypassChoice) {
		return false
	}
...
func (this *GlobalSpecType_Equinix) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_Equinix)
	if !ok {
		that2, ok := that.(GlobalSpecType_Equinix)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Equinix.Equal(that1.Equinix) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_NoProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_NoProxyBypass)
	if !ok {
		that2, ok := that.(GlobalSpecType_NoProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.NoProxyBypass.Equal(that1.NoProxyBypass) {
		return false
	}
	return true
}
func (this *GlobalSpecType_CustomProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_CustomProxyBypass)
	if !ok {
		that2, ok := that.(GlobalSpecType_CustomProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.CustomProxyBypass.Equal(that1.CustomProxyBypass) {
		return false
	}
	return true
}
...
func (this *CustomProxyBypassSettings) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CustomProxyBypassSettings)
	if !ok {
		that2, ok := that.(CustomProxyBypassSettings)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.ProxyBypass) != len(that1.ProxyBypass) {
		return false
	}
	for i := range this.ProxyBypass {
		if this.ProxyBypass[i] != that1.ProxyBypass[i] {
			return false
		}
	}
	return true
...
func (this *AzureProviderType_Managed) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AzureProviderType_Managed)
	if !ok {
		that2, ok := that.(AzureProviderType_Managed)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GCPProviderType_Managed) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GCPProviderType_Managed)
	if !ok {
		that2, ok := that.(GCPProviderType_Managed)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EquinixProviderType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EquinixProviderType)
	if !ok {
		that2, ok := that.(EquinixProviderType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EquinixProviderType_NotManaged) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EquinixProviderType_NotManaged)
	if !ok {
		that2, ok := that.(EquinixProviderType_NotManaged)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_Equinix) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_Equinix)
	if !ok {
		that2, ok := that.(CreateSpecType_Equinix)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_NoProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_NoProxyBypass)
	if !ok {
		that2, ok := that.(CreateSpecType_NoProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_CustomProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_CustomProxyBypass)
	if !ok {
		that2, ok := that.(CreateSpecType_CustomProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_Equinix) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_Equinix)
	if !ok {
		that2, ok := that.(ReplaceSpecType_Equinix)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_NoProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_NoProxyBypass)
	if !ok {
		that2, ok := that.(ReplaceSpecType_NoProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_CustomProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_CustomProxyBypass)
	if !ok {
		that2, ok := that.(ReplaceSpecType_CustomProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_Equinix) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_Equinix)
	if !ok {
		that2, ok := that.(GetSpecType_Equinix)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_NoProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_NoProxyBypass)
	if !ok {
		that2, ok := that.(GetSpecType_NoProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_CustomProxyBypass) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_CustomProxyBypass)
	if !ok {
		that2, ok := that.(GetSpecType_CustomProxyBypass)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType) GoString() string {
	...
	if this.ProxyBypassChoice != nil {
		s = append(s, "ProxyBypassChoice: "+fmt.Sprintf("%#v", this.ProxyBypassChoice)+",\n")
	}
...
func (this *GlobalSpecType_Equinix) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GlobalSpecType_Equinix{` +
		`Equinix:` + fmt.Sprintf("%#v", this.Equinix) + `}`}, ", ")
	return s
}
...
func (this *GlobalSpecType_NoProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GlobalSpecType_NoProxyBypass{` +
		`NoProxyBypass:` + fmt.Sprintf("%#v", this.NoProxyBypass) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_CustomProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GlobalSpecType_CustomProxyBypass{` +
		`CustomProxyBypass:` + fmt.Sprintf("%#v", this.CustomProxyBypass) + `}`}, ", ")
	return s
}
...
func (this *CustomProxyBypassSettings) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&securemesh_site_v2.CustomProxyBypassSettings{")
	s = append(s, "ProxyBypass: "+fmt.Sprintf("%#v", this.ProxyBypass)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *AzureProviderType_Managed) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.AzureProviderType_Managed{` +
		`Managed:` + fmt.Sprintf("%#v", this.Managed) + `}`}, ", ")
	return s
}
...
func (this *GCPProviderType_Managed) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GCPProviderType_Managed{` +
		`Managed:` + fmt.Sprintf("%#v", this.Managed) + `}`}, ", ")
	return s
}
...
func (this *EquinixProviderType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&securemesh_site_v2.EquinixProviderType{")
	if this.OrchestrationChoice != nil {
		s = append(s, "OrchestrationChoice: "+fmt.Sprintf("%#v", this.OrchestrationChoice)+",\n")
	}
	s = append(s, "}")
...
func (this *EquinixProviderType_NotManaged) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.EquinixProviderType_NotManaged{` +
		`NotManaged:` + fmt.Sprintf("%#v", this.NotManaged) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_Equinix) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.CreateSpecType_Equinix{` +
		`Equinix:` + fmt.Sprintf("%#v", this.Equinix) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_NoProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.CreateSpecType_NoProxyBypass{` +
		`NoProxyBypass:` + fmt.Sprintf("%#v", this.NoProxyBypass) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_CustomProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.CreateSpecType_CustomProxyBypass{` +
		`CustomProxyBypass:` + fmt.Sprintf("%#v", this.CustomProxyBypass) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_Equinix) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.ReplaceSpecType_Equinix{` +
		`Equinix:` + fmt.Sprintf("%#v", this.Equinix) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_NoProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.ReplaceSpecType_NoProxyBypass{` +
		`NoProxyBypass:` + fmt.Sprintf("%#v", this.NoProxyBypass) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_CustomProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.ReplaceSpecType_CustomProxyBypass{` +
		`CustomProxyBypass:` + fmt.Sprintf("%#v", this.CustomProxyBypass) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_Equinix) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GetSpecType_Equinix{` +
		`Equinix:` + fmt.Sprintf("%#v", this.Equinix) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_NoProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GetSpecType_NoProxyBypass{` +
		`NoProxyBypass:` + fmt.Sprintf("%#v", this.NoProxyBypass) + `}`}, ", ")
	return s
}
func (this *GetSpecType_CustomProxyBypass) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&securemesh_site_v2.GetSpecType_CustomProxyBypass{` +
		`CustomProxyBypass:` + fmt.Sprintf("%#v", this.CustomProxyBypass) + `}`}, ", ")
	return s
}
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProxyBypassChoice != nil {
		{
			size := m.ProxyBypassChoice.Size()
			i -= size
			if _, err := m.ProxyBypassChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *GlobalSpecType_Equinix) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_Equinix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Equinix != nil {
		{
			size, err := m.Equinix.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_NoProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_NoProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoProxyBypass != nil {
		{
			size, err := m.NoProxyBypass.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_CustomProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_CustomProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomProxyBypass != nil {
		{
			size, err := m.CustomProxyBypass.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CustomProxyBypassSettings) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CustomProxyBypassSettings) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CustomProxyBypassSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ProxyBypass) > 0 {
		for iNdEx := len(m.ProxyBypass) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ProxyBypass[iNdEx])
			copy(dAtA[i:], m.ProxyBypass[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.ProxyBypass[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *AzureProviderType_Managed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AzureProviderType_Managed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Managed != nil {
		{
			size, err := m.Managed.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GCPProviderType_Managed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GCPProviderType_Managed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Managed != nil {
		{
			size, err := m.Managed.MarshalToSizedBuffer(dAtA[:i])
...
func (m *EquinixProviderType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EquinixProviderType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EquinixProviderType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EquinixProviderType_NotManaged) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EquinixProviderType_NotManaged) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NotManaged != nil {
		{
			size, err := m.NotManaged.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_Equinix) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_Equinix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Equinix != nil {
		{
			size, err := m.Equinix.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_NoProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_NoProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoProxyBypass != nil {
		{
			size, err := m.NoProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_CustomProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_CustomProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomProxyBypass != nil {
		{
			size, err := m.CustomProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_Equinix) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_Equinix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Equinix != nil {
		{
			size, err := m.Equinix.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_NoProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_NoProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoProxyBypass != nil {
		{
			size, err := m.NoProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_CustomProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_CustomProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomProxyBypass != nil {
		{
			size, err := m.CustomProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_Equinix) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_Equinix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Equinix != nil {
		{
			size, err := m.Equinix.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_NoProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_NoProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoProxyBypass != nil {
		{
			size, err := m.NoProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_CustomProxyBypass) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_CustomProxyBypass) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomProxyBypass != nil {
		{
			size, err := m.CustomProxyBypass.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GlobalSpecType_Equinix) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GlobalSpecType_NoProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NoProxyBypass != nil {
		l = m.NoProxyBypass.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_CustomProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CustomProxyBypassSettings) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AzureProviderType_Managed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GCPProviderType_Managed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EquinixProviderType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EquinixProviderType_NotManaged) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_Equinix) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_NoProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_CustomProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_Equinix) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_NoProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_CustomProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_Equinix) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_NoProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_CustomProxyBypass) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`ProxyBypassChoice:` + fmt.Sprintf("%v", this.ProxyBypassChoice) + `,`,
...
func (this *GlobalSpecType_Equinix) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_Equinix{`,
		`Equinix:` + strings.Replace(fmt.Sprintf("%v", this.Equinix), "EquinixProviderType", "EquinixProviderType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_NoProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_NoProxyBypass{`,
		`NoProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.NoProxyBypass), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_CustomProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_CustomProxyBypass{`,
		`CustomProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.CustomProxyBypass), "CustomProxyBypassSettings", "CustomProxyBypassSettings", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CustomProxyBypassSettings) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CustomProxyBypassSettings{`,
		`ProxyBypass:` + fmt.Sprintf("%v", this.ProxyBypass) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AzureProviderType_Managed) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AzureProviderType_Managed{`,
		`Managed:` + strings.Replace(fmt.Sprintf("%v", this.Managed), "AzureManagedMode", "AzureManagedMode", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GCPProviderType_Managed) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GCPProviderType_Managed{`,
		`Managed:` + strings.Replace(fmt.Sprintf("%v", this.Managed), "GCPManagedMode", "GCPManagedMode", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *EquinixProviderType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EquinixProviderType{`,
		`OrchestrationChoice:` + fmt.Sprintf("%v", this.OrchestrationChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *EquinixProviderType_NotManaged) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EquinixProviderType_NotManaged{`,
		`NotManaged:` + strings.Replace(fmt.Sprintf("%v", this.NotManaged), "NodeList", "NodeList", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *CreateSpecType_Equinix) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_Equinix{`,
		`Equinix:` + strings.Replace(fmt.Sprintf("%v", this.Equinix), "EquinixProviderType", "EquinixProviderType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *CreateSpecType_NoProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_NoProxyBypass{`,
		`NoProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.NoProxyBypass), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_CustomProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_CustomProxyBypass{`,
		`CustomProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.CustomProxyBypass), "CustomProxyBypassSettings", "CustomProxyBypassSettings", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_Equinix) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_Equinix{`,
		`Equinix:` + strings.Replace(fmt.Sprintf("%v", this.Equinix), "EquinixProviderType", "EquinixProviderType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_NoProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_NoProxyBypass{`,
		`NoProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.NoProxyBypass), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_CustomProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_CustomProxyBypass{`,
		`CustomProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.CustomProxyBypass), "CustomProxyBypassSettings", "CustomProxyBypassSettings", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_Equinix) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_Equinix{`,
		`Equinix:` + strings.Replace(fmt.Sprintf("%v", this.Equinix), "EquinixProviderType", "EquinixProviderType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_NoProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_NoProxyBypass{`,
		`NoProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.NoProxyBypass), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_CustomProxyBypass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_CustomProxyBypass{`,
		`CustomProxyBypass:` + strings.Replace(fmt.Sprintf("%v", this.CustomProxyBypass), "CustomProxyBypassSettings", "CustomProxyBypassSettings", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Equinix", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &EquinixProviderType{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ProviderChoice = &GlobalSpecType_Equinix{v}
			iNdEx = postIndex
		case 60:
			if wireType != 2 {
		...
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoProxyBypass", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProxyBypassChoice = &GlobalSpecType_NoProxyBypass{v}
			iNdEx = postIndex
		case 67:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomProxyBypass", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &CustomProxyBypassSettings{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ProxyBypassChoice = &GlobalSpecType_CustomProxyBypass{v}
			iNdEx = postIndex
		case 998:
			if wireType != 2 {
...
func (m *CustomProxyBypassSettings) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CustomProxyBypassSettings: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CustomProxyBypassSettings: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProxyBypass", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProxyBypass = append(m.ProxyBypass, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *AzureProviderType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.OrchestrationChoice = &AzureProviderType_Managed{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GCPProviderType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.OrchestrationChoice = &GCPProviderType_Managed{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *EquinixProviderType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EquinixProviderType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EquinixProviderType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
			...
			m.OrchestrationChoice = &EquinixProviderType_NotManaged{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *CreateSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			...
			m.ProviderChoice = &CreateSpecType_Equinix{v}
			iNdEx = postIndex
		case 60:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F5Proxy", wireType)
		...
		case 66:
			...
			m.ProxyBypassChoice = &CreateSpecType_NoProxyBypass{v}
			iNdEx = postIndex
		case 67:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomProxyBypass", wireType)
			...
			m.ProxyBypassChoice = &CreateSpecType_CustomProxyBypass{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			...
			m.ProviderChoice = &ReplaceSpecType_Equinix{v}
			iNdEx = postIndex
		case 60:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F5Proxy", wireType)
		...
		case 66:
			...
			m.ProxyBypassChoice = &ReplaceSpecType_NoProxyBypass{v}
			iNdEx = postIndex
		case 67:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomProxyBypass", wireType)
			...
			m.ProxyBypassChoice = &ReplaceSpecType_CustomProxyBypass{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			...
			m.ProviderChoice = &GetSpecType_Equinix{v}
			iNdEx = postIndex
		case 60:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F5Proxy", wireType)
		...
		case 66:
			...
			m.ProxyBypassChoice = &GetSpecType_NoProxyBypass{v}
			iNdEx = postIndex
		case 67:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomProxyBypass", wireType)
			...
			m.ProxyBypassChoice = &GetSpecType_CustomProxyBypass{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
