...
import (
	...
	ves_io_schema_views_api_inventory "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/api_inventory"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_api_inventory.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_api_inventory.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_api_inventory.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_api_inventory.DBObject)
	}
	_ = f
