    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/gcp_vpc_sites": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-views-gcp_vpc_site-API-Create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/gcp_vpc_sites/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-views-gcp_vpc_site-API-Replace"
                },
        ...
        "/public/namespaces/{namespace}/gcp_vpc_sites": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-views-gcp_vpc_site-API-List"
                },
        ...
        "/public/namespaces/{namespace}/gcp_vpc_sites/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-views-gcp_vpc_site-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-views-gcp_vpc_site-API-Delete"
                },
    ...
    "definitions": {
        ...
        "gcp_vpc_siteGCPVPCIngressEgressGwType": {
            ...
            "properties": {
                ...
                "az_nodes": {
                    "type": "array",
                    "description": " Only Single zone or Three nodes are supported currently.",
                    "title": "Nodes",
                    "items": {
                        "$ref": "#/definitions/viewsGCPVPCTwoInterfaceNodeType"
                    },
        ...
        "gcp_vpc_siteGCPVPCIngressGwType": {
            ...
            "properties": {
                "az_nodes": {
                    ...
                    "title": "Nodes",
                    "items": {
                        "$ref": "#/definitions/viewsGCPVPCOneInterfaceNodeType"
                    },
        ...
        "gcp_vpc_siteGCPVPCVoltstackClusterType": {
            ...
            "properties": {
                ...
                "site_local_network": {
                    "description": " Network Subnets for the site local interface of the node",
                    "title": "Network",
                    "$ref": "#/definitions/viewsGCPVPCNetworkChoiceType",
        ...
        "viewsGCPSubnetParamsType": {
            ...
            "properties": {
                ...
                "subnet_name": {
                    "type": "string",
                    "description": " Name of new VPC Subnet\n\nExample: - \"subnet1-in-network1\"-\nRequired: YES",
        ...
        "viewsGCPVPCOneInterfaceNodeType": {
            "type": "object",
            "description": "Parameters for creating Single interface Node",
            "title": "Single Interface Node",
            "x-displayname": "Single Interface Node",
            "x-ves-displayorder": "1,2",
            "x-ves-proto-message": "ves.io.schema.views.GCPVPCOneInterfaceNodeType",
            "properties": {
                "gcp_zone_name": {
                    "type": "string",
        ...
        "viewsGCPVPCTwoInterfaceNodeType": {
            "type": "object",
            "description": "Parameters for creating two interface Node in different vpc networks",
            "title": "Two Interface Node",
            "x-displayname": "Two Interface Node",
            "x-ves-displayorder": "1,2,3",
            "x-ves-proto-message": "ves.io.schema.views.GCPVPCTwoInterfaceNodeType",
            "properties": {
                "gcp_zone_name": {
                    "type": "string",
                    "description": " x-required\n Name for GCP zone, should match with region selected.\n\nExample: - \"us-west-2a\"-\nRequired: YES",
