...
import (
	...
	ves_io_schema_views_external_connector "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/external_connector"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_external_connector.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_external_connector.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_external_connector.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_external_connector.DBObject)
	}
	_ = f
