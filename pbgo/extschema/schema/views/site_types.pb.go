...
// Azure Express Route Connection Type
//
// x-displayName: "Azure Express Route Connection Type"
// Azure Express Route Connection Type
type AzureExpressRouteConnectionType struct {
	// Resource Group
	//
	// x-displayName: "Resource Group"
	// x-required
	// x-example: "MyResourceGroup"
	// Resource group of connection
	ResourceGroup string `protobuf:"bytes,1,opt,name=resource_group,json=resourceGroup,proto3" json:"resource_group,omitempty"`
	// Name
	//
	// x-displayName: "Name"
	// x-required
	// x-example: "MyConnection"
	// Name of connection
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}

func (m *AzureExpressRouteConnectionType) Reset()      { *m = AzureExpressRouteConnectionType{} }
func (*AzureExpressRouteConnectionType) ProtoMessage() {}
func (*AzureExpressRouteConnectionType) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{9}
}
func (m *AzureExpressRouteConnectionType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AzureExpressRouteConnectionType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AzureExpressRouteConnectionType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AzureExpressRouteConnectionType.Merge(m, src)
}
func (m *AzureExpressRouteConnectionType) XXX_Size() int {
	return m.Size()
}
func (m *AzureExpressRouteConnectionType) XXX_DiscardUnknown() {
	xxx_messageInfo_AzureExpressRouteConnectionType.DiscardUnknown(m)
}

var xxx_messageInfo_AzureExpressRouteConnectionType proto.InternalMessageInfo

func (m *AzureExpressRouteConnectionType) GetResourceGroup() string {
	if m != nil {
		return m.ResourceGroup
	}
	return ""
...
func (m *AzureExpressRouteConnectionType) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type LocalControlPlaneType struct {
	...
	//	*LocalControlPlaneType_NoLocalControlPlane
	//	*LocalControlPlaneType_DefaultLocalControlPlane
	LocalControlPlaneChoice isLocalControlPlaneType_LocalControlPlaneChoice `protobuf_oneof:"local_control_plane_choice"`
}
...
type isLocalControlPlaneType_LocalControlPlaneChoice interface {
	isLocalControlPlaneType_LocalControlPlaneChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type LocalControlPlaneType_NoLocalControlPlane struct {
	NoLocalControlPlane *schema.Empty `protobuf:"bytes,2,opt,name=no_local_control_plane,json=noLocalControlPlane,proto3,oneof" json:"no_local_control_plane,omitempty"`
}
type LocalControlPlaneType_DefaultLocalControlPlane struct {
	DefaultLocalControlPlane *schema.Empty `protobuf:"bytes,3,opt,name=default_local_control_plane,json=defaultLocalControlPlane,proto3,oneof" json:"default_local_control_plane,omitempty"`
}

func (*LocalControlPlaneType_NoLocalControlPlane) isLocalControlPlaneType_LocalControlPlaneChoice() {}
func (*LocalControlPlaneType_DefaultLocalControlPlane) isLocalControlPlaneType_LocalControlPlaneChoice() {
}

func (m *LocalControlPlaneType) GetLocalControlPlaneChoice() isLocalControlPlaneType_LocalControlPlaneChoice {
	if m != nil {
...
func (m *LocalControlPlaneType) GetNoLocalControlPlane() *schema.Empty {
	if x, ok := m.GetLocalControlPlaneChoice().(*LocalControlPlaneType_NoLocalControlPlane); ok {
		return x.NoLocalControlPlane
	}
	return nil
}

func (m *LocalControlPlaneType) GetDefaultLocalControlPlane() *schema.Empty {
	if x, ok := m.GetLocalControlPlaneChoice().(*LocalControlPlaneType_DefaultLocalControlPlane); ok {
		return x.DefaultLocalControlPlane
	}
	return nil
}
...
func (*LocalControlPlaneType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*LocalControlPlaneType_NoLocalControlPlane)(nil),
		(*LocalControlPlaneType_DefaultLocalControlPlane)(nil),
	}
}
...
type HostedVIFConfigType struct {
	...
	// x-example: "value"
	// VIFs
	Vifs []string `protobuf:"bytes,1,rep,name=vifs,proto3" json:"vifs,omitempty"`
}
...
type DirectConnectConfigType struct {
	...
	// VIF Configuration
	//
	// x-displayName: "VIF Configuration"
	// x-required
	// VIF Configuration
	//
...
func init() {
	...
	proto.RegisterType((*AzureExpressRouteConnectionType)(nil), "ves.io.schema.views.AzureExpressRouteConnectionType")
	golang_proto.RegisterType((*AzureExpressRouteConnectionType)(nil), "ves.io.schema.views.AzureExpressRouteConnectionType")
	...
	proto.RegisterType((*LocalControlPlaneType)(nil), "ves.io.schema.views.LocalControlPlaneType")
	golang_proto.RegisterType((*LocalControlPlaneType)(nil), "ves.io.schema.views.LocalControlPlaneType")
...
var fileDescriptor_5debf32965df805e = []byte{
	...
	,
}
...
func (this *AzureExpressRouteConnectionType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AzureExpressRouteConnectionType)
	if !ok {
		that2, ok := that.(AzureExpressRouteConnectionType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LocalControlPlaneType_NoLocalControlPlane) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LocalControlPlaneType_NoLocalControlPlane)
	if !ok {
		that2, ok := that.(LocalControlPlaneType_NoLocalControlPlane)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LocalControlPlaneType_DefaultLocalControlPlane) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LocalControlPlaneType_DefaultLocalControlPlane)
	if !ok {
		that2, ok := that.(LocalControlPlaneType_DefaultLocalControlPlane)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultLocalControlPlane.Equal(that1.DefaultLocalControlPlane) {
		return false
	}
	return true
}
...
func (this *AzureExpressRouteConnectionType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&views.AzureExpressRouteConnectionType{")
	s = append(s, "ResourceGroup: "+fmt.Sprintf("%#v", this.ResourceGroup)+",\n")
...
func (this *LocalControlPlaneType) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&views.LocalControlPlaneType{")
	if this.LocalControlPlaneChoice != nil {
...
func (this *LocalControlPlaneType_NoLocalControlPlane) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.LocalControlPlaneType_NoLocalControlPlane{` +
		`NoLocalControlPlane:` + fmt.Sprintf("%#v", this.NoLocalControlPlane) + `}`}, ", ")
	return s
}
func (this *LocalControlPlaneType_DefaultLocalControlPlane) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.LocalControlPlaneType_DefaultLocalControlPlane{` +
		`DefaultLocalControlPlane:` + fmt.Sprintf("%#v", this.DefaultLocalControlPlane) + `}`}, ", ")
	return s
}
...
func (m *AzureExpressRouteConnectionType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AzureExpressRouteConnectionType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AzureExpressRouteConnectionType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LocalControlPlaneType_NoLocalControlPlane) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalControlPlaneType_NoLocalControlPlane) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *LocalControlPlaneType_DefaultLocalControlPlane) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalControlPlaneType_DefaultLocalControlPlane) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultLocalControlPlane != nil {
		{
			size, err := m.DefaultLocalControlPlane.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AzureExpressRouteConnectionType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalControlPlaneType_NoLocalControlPlane) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalControlPlaneType_DefaultLocalControlPlane) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DefaultLocalControlPlane != nil {
		l = m.DefaultLocalControlPlane.Size()
		n += 1 + l + sovSiteTypes(uint64(l))
	}
	return n
}
...
func (this *AzureExpressRouteConnectionType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AzureExpressRouteConnectionType{`,
		`ResourceGroup:` + fmt.Sprintf("%v", this.ResourceGroup) + `,`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`}`,
	}, "")
...
func (this *LocalControlPlaneType_NoLocalControlPlane) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LocalControlPlaneType_NoLocalControlPlane{`,
		`NoLocalControlPlane:` + strings.Replace(fmt.Sprintf("%v", this.NoLocalControlPlane), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *LocalControlPlaneType_DefaultLocalControlPlane) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LocalControlPlaneType_DefaultLocalControlPlane{`,
		`DefaultLocalControlPlane:` + strings.Replace(fmt.Sprintf("%v", this.DefaultLocalControlPlane), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *AzureExpressRouteConnectionType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AzureExpressRouteConnectionType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AzureExpressRouteConnectionType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LocalControlPlaneType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.LocalControlPlaneChoice = &LocalControlPlaneType_NoLocalControlPlane{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultLocalControlPlane", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LocalControlPlaneChoice = &LocalControlPlaneType_DefaultLocalControlPlane{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSiteTypes(dAtA[iNdEx:])
