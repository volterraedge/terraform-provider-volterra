...
// AWS Internet VIP Type
//
// x-displayName: "AWS Internet VIP Type"
// AWS Internet VIP Type
type AWSInternetVIPType struct {
	// Internet VIP Subnet
	//
	// x-displayName: "Internet VIP Subnet"
	// x-required
	// Subnet for the internet VIP Subnet
	//
	// Types that are valid to be assigned to InternetVipSubnetChoice:
	//	*AWSInternetVIPType_ReservedInternetNlbSubnet
	//	*AWSInternetVIPType_Subnet
	InternetVipSubnetChoice isAWSInternetVIPType_InternetVipSubnetChoice `protobuf_oneof:"internet_vip_subnet_choice"`
}

func (m *AWSInternetVIPType) Reset()      { *m = AWSInternetVIPType{} }
func (*AWSInternetVIPType) ProtoMessage() {}
func (*AWSInternetVIPType) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{37}
}
func (m *AWSInternetVIPType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AWSInternetVIPType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AWSInternetVIPType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AWSInternetVIPType.Merge(m, src)
}
func (m *AWSInternetVIPType) XXX_Size() int {
	return m.Size()
}
func (m *AWSInternetVIPType) XXX_DiscardUnknown() {
	xxx_messageInfo_AWSInternetVIPType.DiscardUnknown(m)
}

var xxx_messageInfo_AWSInternetVIPType proto.InternalMessageInfo

type isAWSInternetVIPType_InternetVipSubnetChoice interface {
	isAWSInternetVIPType_InternetVipSubnetChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type AWSInternetVIPType_ReservedInternetNlbSubnet struct {
	ReservedInternetNlbSubnet *schema.Empty `protobuf:"bytes,2,opt,name=reserved_internet_nlb_subnet,json=reservedInternetNlbSubnet,proto3,oneof" json:"reserved_internet_nlb_subnet,omitempty"`
}
type AWSInternetVIPType_Subnet struct {
	Subnet *CloudSubnetType `protobuf:"bytes,3,opt,name=subnet,proto3,oneof" json:"subnet,omitempty"`
}

func (*AWSInternetVIPType_ReservedInternetNlbSubnet) isAWSInternetVIPType_InternetVipSubnetChoice() {}
func (*AWSInternetVIPType_Subnet) isAWSInternetVIPType_InternetVipSubnetChoice()                    {}

func (m *AWSInternetVIPType) GetInternetVipSubnetChoice() isAWSInternetVIPType_InternetVipSubnetChoice {
	if m != nil {
		return m.InternetVipSubnetChoice
	}
	return nil
}

func (m *AWSInternetVIPType) GetReservedInternetNlbSubnet() *schema.Empty {
	if x, ok := m.GetInternetVipSubnetChoice().(*AWSInternetVIPType_ReservedInternetNlbSubnet); ok {
		return x.ReservedInternetNlbSubnet
	}
	return nil
}

func (m *AWSInternetVIPType) GetSubnet() *CloudSubnetType {
	if x, ok := m.GetInternetVipSubnetChoice().(*AWSInternetVIPType_Subnet); ok {
		return x.Subnet
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*AWSInternetVIPType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AWSInternetVIPType_ReservedInternetNlbSubnet)(nil),
		(*AWSInternetVIPType_Subnet)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*AWSInternetVIPType)(nil), "ves.io.schema.views.AWSInternetVIPType")
	golang_proto.RegisterType((*AWSInternetVIPType)(nil), "ves.io.schema.views.AWSInternetVIPType")
}
...
var fileDescriptor_5debf32965df805e = []byte{
	...
	,
}
...
func (this *AWSInternetVIPType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSInternetVIPType)
	if !ok {
		that2, ok := that.(AWSInternetVIPType)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.InternetVipSubnetChoice == nil {
		if this.InternetVipSubnetChoice != nil {
			return false
		}
	} else if this.InternetVipSubnetChoice == nil {
		return false
	} else if !this.InternetVipSubnetChoice.Equal(that1.InternetVipSubnetChoice) {
		return false
	}
	return true
}
func (this *AWSInternetVIPType_ReservedInternetNlbSubnet) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSInternetVIPType_ReservedInternetNlbSubnet)
	if !ok {
		that2, ok := that.(AWSInternetVIPType_ReservedInternetNlbSubnet)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.ReservedInternetNlbSubnet.Equal(that1.ReservedInternetNlbSubnet) {
		return false
	}
	return true
}
func (this *AWSInternetVIPType_Subnet) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSInternetVIPType_Subnet)
	if !ok {
		that2, ok := that.(AWSInternetVIPType_Subnet)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AWSInternetVIPType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&views.AWSInternetVIPType{")
	if this.InternetVipSubnetChoice != nil {
		s = append(s, "InternetVipSubnetChoice: "+fmt.Sprintf("%#v", this.InternetVipSubnetChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *AWSInternetVIPType_ReservedInternetNlbSubnet) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.AWSInternetVIPType_ReservedInternetNlbSubnet{` +
		`ReservedInternetNlbSubnet:` + fmt.Sprintf("%#v", this.ReservedInternetNlbSubnet) + `}`}, ", ")
	return s
}
func (this *AWSInternetVIPType_Subnet) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.AWSInternetVIPType_Subnet{` +
		`Subnet:` + fmt.Sprintf("%#v", this.Subnet) + `}`}, ", ")
	return s
}
...
func (m *AWSInternetVIPType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AWSInternetVIPType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSInternetVIPType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.InternetVipSubnetChoice != nil {
		{
			size := m.InternetVipSubnetChoice.Size()
			i -= size
			if _, err := m.InternetVipSubnetChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *AWSInternetVIPType_ReservedInternetNlbSubnet) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSInternetVIPType_ReservedInternetNlbSubnet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReservedInternetNlbSubnet != nil {
		{
			size, err := m.ReservedInternetNlbSubnet.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AWSInternetVIPType_Subnet) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSInternetVIPType_Subnet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Subnet != nil {
		{
			size, err := m.Subnet.MarshalToSizedBuffer(dAtA[:i])
...
func (m *AWSInternetVIPType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.InternetVipSubnetChoice != nil {
		n += m.InternetVipSubnetChoice.Size()
	}
	return n
}

func (m *AWSInternetVIPType_ReservedInternetNlbSubnet) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ReservedInternetNlbSubnet != nil {
		l = m.ReservedInternetNlbSubnet.Size()
		n += 1 + l + sovSiteTypes(uint64(l))
	}
	return n
}
func (m *AWSInternetVIPType_Subnet) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *AWSInternetVIPType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSInternetVIPType{`,
		`InternetVipSubnetChoice:` + fmt.Sprintf("%v", this.InternetVipSubnetChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AWSInternetVIPType_ReservedInternetNlbSubnet) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSInternetVIPType_ReservedInternetNlbSubnet{`,
		`ReservedInternetNlbSubnet:` + strings.Replace(fmt.Sprintf("%v", this.ReservedInternetNlbSubnet), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AWSInternetVIPType_Subnet) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSInternetVIPType_Subnet{`,
...
func (m *AWSInternetVIPType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AWSInternetVIPType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AWSInternetVIPType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReservedInternetNlbSubnet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InternetVipSubnetChoice = &AWSInternetVIPType_ReservedInternetNlbSubnet{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Subnet", wireType)
			...
			m.InternetVipSubnetChoice = &AWSInternetVIPType_Subnet{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSiteTypes(dAtA[iNdEx:])
