...
func (c *CustomAPIRestClient) doRPCGetDnsInfo(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, fmt.Errorf("JSON Response %s is not of type *ves.io.schema.views.tcp_loadbalancer.GetDnsInfoResponse", body)
...
func (c *CustomAPIInprocClient) GetDnsInfo(ctx context.Context, in *GetDnsInfoRequest, opts ...grpc.CallOption) (*GetDnsInfoResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.tcp_loadbalancer.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.views.tcp_loadbalancer.GetDnsInfoRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, c.svc, "ves.io.schema.views.tcp_loadbalancer.GetDnsInfoResponse", rsp)...)
