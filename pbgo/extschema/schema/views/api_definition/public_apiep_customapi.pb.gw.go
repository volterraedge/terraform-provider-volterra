...
// RegisterPublicApiepCustomAPIHandlerServer registers the http handlers for service PublicApiepCustomAPI to "mux".
// UnaryRPC     :call PublicApiepCustomAPIServer directly.
...
// RegisterPublicApiepCustomAPIHandlerFromEndpoint is same as RegisterPublicApiepCustomAPIHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterPublicApiepCustomAPIHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPublicApiepCustomAPIHandler(ctx, mux, conn)
}

// RegisterPublicApiepCustomAPIHandler registers the http handlers for service PublicApiepCustomAPI to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPublicApiepCustomAPIHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPublicApiepCustomAPIHandlerClient(ctx, mux, NewPublicApiepCustomAPIClient(conn))
}

// RegisterPublicApiepCustomAPIHandlerClient registers the http handlers for service PublicApiepCustomAPI
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PublicApiepCustomAPIClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PublicApiepCustomAPIClient"
