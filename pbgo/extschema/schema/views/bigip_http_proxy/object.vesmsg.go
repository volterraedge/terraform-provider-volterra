...
func (m *BigIPHTTPStatus) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *BigIPHTTPStatus) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *BigIPHTTPStatus) DeepCopy() *BigIPHTTPStatus {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *BigIPHTTPStatus) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *BigIPHTTPStatus) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return BigIPHTTPStatusValidator().Validate(ctx, m, opts...)
}

type ValidateBigIPHTTPStatus struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateBigIPHTTPStatus) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*BigIPHTTPStatus)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *BigIPHTTPStatus got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultBigIPHTTPStatusValidator = func() *ValidateBigIPHTTPStatus {
	v := &ValidateBigIPHTTPStatus{FldValidators: map[string]db.ValidatorFunc{}}

	return v
}()

func BigIPHTTPStatusValidator() db.Validator {
	return DefaultBigIPHTTPStatusValidator
}
