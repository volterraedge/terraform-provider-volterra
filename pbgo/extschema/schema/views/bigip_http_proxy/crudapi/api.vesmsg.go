...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_bigip_http_proxy.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["system_metadata"] = ves_io_schema.SystemObjectMetaTypeValidator().Validate
	v.FldValidators["spec"] = ves_io_schema_views_bigip_http_proxy.SpecTypeValidator().Validate
	v.FldValidators["status"] = ves_io_schema_views_bigip_http_proxy.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_bigip_http_proxy.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_bigip_http_proxy.DBObject)
	}
	_ = f
