...
type OriginServerVoltADNPrivateIP struct {
	// IP
	//
	// x-displayName: "IP"
	// x-required
	...
	// x-required
	// VoltADN Private Network where this IP will be present
...
func (m *OriginServerVoltADNPrivateIP) Reset()      { *m = OriginServerVoltADNPrivateIP{} }
func (*OriginServerVoltADNPrivateIP) ProtoMessage() {}
func (*OriginServerVoltADNPrivateIP) Descriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{4}
}

func (m *OriginServerVoltADNPrivateIP) GetIp() string {
	if m != nil {
		return m.Ip
	}
	return ""
...
func (m *OriginServerVoltADNPrivateIP) GetPrivateNetwork() *ves_io_schema_views.ObjectRefType {
	if m != nil {
...
type OriginServerVoltADNPrivateName struct {
	// DNS name
	//
	// x-displayName: "DNS Name"
	// x-required
	...
	// x-displayName: "VoltADN Private Network"
	// x-required
	// VoltADN Private Network where this Name will be present
	PrivateNetwork *ves_io_schema_views.ObjectRefType `protobuf:"bytes,2,opt,name=private_network,json=privateNetwork" json:"private_network,omitempty"`
}

func (m *OriginServerVoltADNPrivateName) Reset()      { *m = OriginServerVoltADNPrivateName{} }
func (*OriginServerVoltADNPrivateName) ProtoMessage() {}
func (*OriginServerVoltADNPrivateName) Descriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{5}
}

func (m *OriginServerVoltADNPrivateName) GetDnsName() string {
	if m != nil {
		return m.DnsName
	}
	return ""
...
func (m *OriginServerVoltADNPrivateName) GetPrivateNetwork() *ves_io_schema_views.ObjectRefType {
	if m != nil {
		return m.PrivateNetwork
	}
	return nil
...
type OriginServerType_VoltadnPrivateIp struct {
	VoltadnPrivateIp *OriginServerVoltADNPrivateIP `protobuf:"bytes,10,opt,name=voltadn_private_ip,json=voltadnPrivateIp,oneof"`
}
type OriginServerType_VoltadnPrivateName struct {
	VoltadnPrivateName *OriginServerVoltADNPrivateName `protobuf:"bytes,11,opt,name=voltadn_private_name,json=voltadnPrivateName,oneof"`
}
...
func (m *OriginServerType) GetVoltadnPrivateIp() *OriginServerVoltADNPrivateIP {
...
func (m *OriginServerType) GetVoltadnPrivateName() *OriginServerVoltADNPrivateName {
...
func _OriginServerType_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 10: // choice.voltadn_private_ip
		...
		msg := new(OriginServerVoltADNPrivateIP)
		err := b.DecodeMessage(msg)
	...
	case 11: // choice.voltadn_private_name
		...
		msg := new(OriginServerVoltADNPrivateName)
		err := b.DecodeMessage(msg)
...
func init() {
	...
	proto.RegisterType((*OriginServerVoltADNPrivateIP)(nil), "ves.io.schema.views.origin_pool.OriginServerVoltADNPrivateIP")
	golang_proto.RegisterType((*OriginServerVoltADNPrivateIP)(nil), "ves.io.schema.views.origin_pool.OriginServerVoltADNPrivateIP")
	proto.RegisterType((*OriginServerVoltADNPrivateName)(nil), "ves.io.schema.views.origin_pool.OriginServerVoltADNPrivateName")
	golang_proto.RegisterType((*OriginServerVoltADNPrivateName)(nil), "ves.io.schema.views.origin_pool.OriginServerVoltADNPrivateName")
...
func (this *OriginServerVoltADNPrivateIP) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginServerVoltADNPrivateIP)
	if !ok {
		that2, ok := that.(OriginServerVoltADNPrivateIP)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginServerVoltADNPrivateName) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginServerVoltADNPrivateName)
	if !ok {
		that2, ok := that.(OriginServerVoltADNPrivateName)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginServerVoltADNPrivateIP) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&origin_pool.OriginServerVoltADNPrivateIP{")
	s = append(s, "Ip: "+fmt.Sprintf("%#v", this.Ip)+",\n")
...
func (this *OriginServerVoltADNPrivateName) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&origin_pool.OriginServerVoltADNPrivateName{")
	s = append(s, "DnsName: "+fmt.Sprintf("%#v", this.DnsName)+",\n")
	if this.PrivateNetwork != nil {
		s = append(s, "PrivateNetwork: "+fmt.Sprintf("%#v", this.PrivateNetwork)+",\n")
	}
...
func (m *OriginServerVoltADNPrivateIP) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *OriginServerVoltADNPrivateIP) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.PrivateNetwork != nil {
		...
		n9, err := m.PrivateNetwork.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *OriginServerVoltADNPrivateName) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *OriginServerVoltADNPrivateName) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UpstreamTlsParameters) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.SniChoice != nil {
		nn31, err := m.SniChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn31
	...
	if m.TlsConfig != nil {
		...
		n32, err := m.TlsConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.ServerValidationChoice != nil {
		nn33, err := m.ServerValidationChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn33
	...
	if m.MtlsChoice != nil {
		nn34, err := m.MtlsChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn34
...
func (m *UpstreamTlsParameters_UseServerVerification) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseServerVerification != nil {
		...
		n35, err := m.UseServerVerification.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *UpstreamTlsParameters_SkipServerVerification) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SkipServerVerification != nil {
		...
		n36, err := m.SkipServerVerification.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *UpstreamTlsParameters_NoMtls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoMtls != nil {
		...
		n37, err := m.NoMtls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *UpstreamTlsParameters_UseMtls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseMtls != nil {
		...
		n38, err := m.UseMtls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *UpstreamTlsParameters_UseHostHeaderAsSni) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseHostHeaderAsSni != nil {
		...
		n39, err := m.UseHostHeaderAsSni.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *UpstreamTlsParameters_DisableSni) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DisableSni != nil {
		...
		n40, err := m.DisableSni.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *UpstreamTlsParameters_VolterraTrustedCa) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VolterraTrustedCa != nil {
		...
		n41, err := m.VolterraTrustedCa.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *OriginPoolSubsets) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FallbackPolicyChoice != nil {
		nn42, err := m.FallbackPolicyChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn42
...
func (m *OriginPoolSubsets_AnyEndpoint) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AnyEndpoint != nil {
		...
		n43, err := m.AnyEndpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *OriginPoolSubsets_DefaultSubset) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DefaultSubset != nil {
		...
		n44, err := m.DefaultSubset.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *OriginPoolSubsets_FailRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FailRequest != nil {
		...
		n45, err := m.FailRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *OriginPoolAdvancedOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CircuitBreakerChoice != nil {
		nn46, err := m.CircuitBreakerChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn46
	...
	if m.OutlierDetectionChoice != nil {
		nn47, err := m.OutlierDetectionChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn47
	...
	if m.PanicThresholdType != nil {
		nn48, err := m.PanicThresholdType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn48
	...
	if m.SubsetChoice != nil {
		nn49, err := m.SubsetChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn49
	...
	if m.Http2Options != nil {
		...
		n50, err := m.Http2Options.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *OriginPoolAdvancedOptions_DisableCircuitBreaker) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DisableCircuitBreaker != nil {
		...
		n51, err := m.DisableCircuitBreaker.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *OriginPoolAdvancedOptions_CircuitBreaker) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CircuitBreaker != nil {
		...
		n52, err := m.CircuitBreaker.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *OriginPoolAdvancedOptions_DisableOutlierDetection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DisableOutlierDetection != nil {
		...
		n53, err := m.DisableOutlierDetection.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *OriginPoolAdvancedOptions_OutlierDetection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OutlierDetection != nil {
		...
		n54, err := m.OutlierDetection.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *OriginPoolAdvancedOptions_NoPanicThreshold) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoPanicThreshold != nil {
		...
		n55, err := m.NoPanicThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
...
func (m *OriginPoolAdvancedOptions_DisableSubsets) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DisableSubsets != nil {
		...
		n56, err := m.DisableSubsets.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *OriginPoolAdvancedOptions_EnableSubsets) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnableSubsets != nil {
		...
		n57, err := m.EnableSubsets.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *GlobalSpecType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsChoice != nil {
		nn58, err := m.TlsChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn58
	...
	if m.HealthCheckPortChoice != nil {
		nn59, err := m.HealthCheckPortChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn59
	...
	if m.AdvancedOptions != nil {
		...
		n60, err := m.AdvancedOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n60
	...
	if m.ViewInternal != nil {
		...
		n61, err := m.ViewInternal.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n61
...
func (m *GlobalSpecType_NoTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoTls != nil {
		...
		n62, err := m.NoTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *GlobalSpecType_UseTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseTls != nil {
		...
		n63, err := m.UseTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *GlobalSpecType_SameAsEndpointPort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SameAsEndpointPort != nil {
		...
		n64, err := m.SameAsEndpointPort.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *CreateSpecType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsChoice != nil {
		nn65, err := m.TlsChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn65
	...
	if m.HealthCheckPortChoice != nil {
		nn66, err := m.HealthCheckPortChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn66
	...
	if m.AdvancedOptions != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.AdvancedOptions.Size()))
		n67, err := m.AdvancedOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n67
...
func (m *CreateSpecType_NoTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.NoTls.Size()))
		n68, err := m.NoTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n68
...
func (m *CreateSpecType_UseTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.UseTls.Size()))
		n69, err := m.UseTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n69
...
func (m *CreateSpecType_SameAsEndpointPort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SameAsEndpointPort != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.SameAsEndpointPort.Size()))
		n70, err := m.SameAsEndpointPort.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
func (m *ReplaceSpecType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsChoice != nil {
		nn71, err := m.TlsChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn71
	...
	if m.HealthCheckPortChoice != nil {
		nn72, err := m.HealthCheckPortChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn72
	...
	if m.AdvancedOptions != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.AdvancedOptions.Size()))
		n73, err := m.AdvancedOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n73
...
func (m *ReplaceSpecType_NoTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.NoTls.Size()))
		n74, err := m.NoTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n74
...
func (m *ReplaceSpecType_UseTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.UseTls.Size()))
		n75, err := m.UseTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n75
...
func (m *ReplaceSpecType_SameAsEndpointPort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SameAsEndpointPort != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.SameAsEndpointPort.Size()))
		n76, err := m.SameAsEndpointPort.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n76
...
func (m *GetSpecType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsChoice != nil {
		nn77, err := m.TlsChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn77
	...
	if m.HealthCheckPortChoice != nil {
		nn78, err := m.HealthCheckPortChoice.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn78
	...
	if m.AdvancedOptions != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.AdvancedOptions.Size()))
		n79, err := m.AdvancedOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n79
...
func (m *GetSpecType_NoTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NoTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.NoTls.Size()))
		n80, err := m.NoTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n80
...
func (m *GetSpecType_UseTls) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseTls != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.UseTls.Size()))
		n81, err := m.UseTls.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n81
...
func (m *GetSpecType_SameAsEndpointPort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SameAsEndpointPort != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.SameAsEndpointPort.Size()))
		n82, err := m.SameAsEndpointPort.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n82
...
func NewPopulatedOriginServerVoltADNPrivateIP(r randyTypes, easy bool) *OriginServerVoltADNPrivateIP {
	this := &OriginServerVoltADNPrivateIP{}
	this.Ip = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.PrivateNetwork = ves_io_schema_views.NewPopulatedObjectRefType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedOriginServerVoltADNPrivateName(r randyTypes, easy bool) *OriginServerVoltADNPrivateName {
	this := &OriginServerVoltADNPrivateName{}
	this.DnsName = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.PrivateNetwork = ves_io_schema_views.NewPopulatedObjectRefType(r, easy)
	}
...
func NewPopulatedOriginServerType(r randyTypes, easy bool) *OriginServerType {
	...
	oneofNumber_Choice := []int32{1, 2, 3, 4, 5, 6, 7, 10, 11}[r.Intn(9)]
	...
	case 10:
		this.Choice = NewPopulatedOriginServerType_VoltadnPrivateIp(r, easy)
	case 11:
		this.Choice = NewPopulatedOriginServerType_VoltadnPrivateName(r, easy)
	}
	if r.Intn(10) != 0 {
		v1 := r.Intn(10)
...
func NewPopulatedOriginServerType_VoltadnPrivateIp(r randyTypes, easy bool) *OriginServerType_VoltadnPrivateIp {
	this := &OriginServerType_VoltadnPrivateIp{}
	this.VoltadnPrivateIp = NewPopulatedOriginServerVoltADNPrivateIP(r, easy)
	return this
}
func NewPopulatedOriginServerType_VoltadnPrivateName(r randyTypes, easy bool) *OriginServerType_VoltadnPrivateName {
	this := &OriginServerType_VoltadnPrivateName{}
	this.VoltadnPrivateName = NewPopulatedOriginServerVoltADNPrivateName(r, easy)
	return this
}
...
func (m *OriginServerVoltADNPrivateIP) Size() (n int) {
	var l int
	_ = l
	l = len(m.Ip)
	if l > 0 {
...
func (m *OriginServerVoltADNPrivateName) Size() (n int) {
	var l int
	_ = l
	l = len(m.DnsName)
	if l > 0 {
...
func (this *OriginServerVoltADNPrivateIP) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginServerVoltADNPrivateIP{`,
		`Ip:` + fmt.Sprintf("%v", this.Ip) + `,`,
...
func (this *OriginServerVoltADNPrivateName) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginServerVoltADNPrivateName{`,
		`DnsName:` + fmt.Sprintf("%v", this.DnsName) + `,`,
		`PrivateNetwork:` + strings.Replace(fmt.Sprintf("%v", this.PrivateNetwork), "ObjectRefType", "ves_io_schema_views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
...
func (this *OriginServerType_VoltadnPrivateIp) String() string {
	...
	s := strings.Join([]string{`&OriginServerType_VoltadnPrivateIp{`,
		`VoltadnPrivateIp:` + strings.Replace(fmt.Sprintf("%v", this.VoltadnPrivateIp), "OriginServerVoltADNPrivateIP", "OriginServerVoltADNPrivateIP", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *OriginServerType_VoltadnPrivateName) String() string {
	...
	s := strings.Join([]string{`&OriginServerType_VoltadnPrivateName{`,
		`VoltadnPrivateName:` + strings.Replace(fmt.Sprintf("%v", this.VoltadnPrivateName), "OriginServerVoltADNPrivateName", "OriginServerVoltADNPrivateName", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *OriginServerVoltADNPrivateIP) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OriginServerVoltADNPrivateIP: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OriginServerVoltADNPrivateIP: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OriginServerVoltADNPrivateName) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OriginServerVoltADNPrivateName: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OriginServerVoltADNPrivateName: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OriginServerType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			v := &OriginServerVoltADNPrivateIP{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 11:
			...
			v := &OriginServerVoltADNPrivateName{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
