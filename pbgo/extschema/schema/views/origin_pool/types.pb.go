...
type OriginServerPrivateIP struct {
	...
	SnatPool *views.SnatPoolConfiguration `protobuf:"bytes,7,opt,name=snat_pool,json=snatPool,proto3" json:"snat_pool,omitempty"`
}
...
func (m *OriginServerPrivateIP) GetSnatPool() *views.SnatPoolConfiguration {
	if m != nil {
		return m.SnatPool
	}
	return nil
...
type OriginServerPrivateName struct {
	...
	//
	// x-displayName: "SNAT Pool Configuration"
	SnatPool *views.SnatPoolConfiguration `protobuf:"bytes,8,opt,name=snat_pool,json=snatPool,proto3" json:"snat_pool,omitempty"`
}
...
func (m *OriginServerPrivateName) GetSnatPool() *views.SnatPoolConfiguration {
	if m != nil {
		return m.SnatPool
	}
	return nil
...
type OriginServerK8SService struct {
	...
	// Protocol to be used in the discovery.
	Protocol ProtocolType `protobuf:"varint,12,opt,name=protocol,proto3,enum=ves.io.schema.views.origin_pool.ProtocolType" json:"protocol,omitempty"`
	// Site Locator
	//
	// x-displayName: "Site or Virtual Site"
	// x-required
...
func (m *OriginServerK8SService) GetProtocol() ProtocolType {
	if m != nil {
		return m.Protocol
	}
	return PROTOCOL_TCP
...
func (m *OriginServerK8SService) GetSnatPool() *views.SnatPoolConfiguration {
	if m != nil {
		return m.SnatPool
	}
	return nil
...
type OriginServerConsulService struct {
	...
	//
	// x-displayName: "SNAT Pool Configuration"
	SnatPool *views.SnatPoolConfiguration `protobuf:"bytes,6,opt,name=snat_pool,json=snatPool,proto3" json:"snat_pool,omitempty"`
}
...
func (m *OriginServerConsulService) GetSnatPool() *views.SnatPoolConfiguration {
	if m != nil {
		return m.SnatPool
	}
	return nil
...
type OriginServerCBIPService struct {
	// Service Name
	//
	// x-displayName: "Service Name"
...
func (m *OriginServerCBIPService) Reset()      { *m = OriginServerCBIPService{} }
func (*OriginServerCBIPService) ProtoMessage() {}
func (*OriginServerCBIPService) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ebf2c0bbcdcb0e6, []int{8}
}
func (m *OriginServerCBIPService) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OriginServerCBIPService) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *OriginServerCBIPService) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OriginServerCBIPService.Merge(m, src)
}
func (m *OriginServerCBIPService) XXX_Size() int {
	return m.Size()
}
func (m *OriginServerCBIPService) XXX_DiscardUnknown() {
	xxx_messageInfo_OriginServerCBIPService.DiscardUnknown(m)
}

var xxx_messageInfo_OriginServerCBIPService proto.InternalMessageInfo

func (m *OriginServerCBIPService) GetServiceName() string {
	if m != nil {
		return m.ServiceName
	}
	return ""
...
type OriginServerType_CbipService struct {
	CbipService *OriginServerCBIPService `protobuf:"bytes,16,opt,name=cbip_service,json=cbipService,proto3,oneof" json:"cbip_service,omitempty"`
}
...
func (*OriginServerType_CbipService) isOriginServerType_Choice()          {}
...
func (m *OriginServerType) GetCbipService() *OriginServerCBIPService {
	if x, ok := m.GetChoice().(*OriginServerType_CbipService); ok {
...
func (*OriginServerType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*OriginServerType_CbipService)(nil),
	}
}
...
type OriginPoolAdvancedOptions struct {
	...
	//	*OriginPoolAdvancedOptions_NoRequestLimitPerConnection
	//	*OriginPoolAdvancedOptions_MaxRequestsPerConnection
	MaxRequestsPerConnectionChoice isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice `protobuf_oneof:"max_requests_per_connection_choice"`
}
...
type isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice interface {
	isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type OriginPoolAdvancedOptions_NoRequestLimitPerConnection struct {
	NoRequestLimitPerConnection *schema.Empty `protobuf:"bytes,30,opt,name=no_request_limit_per_connection,json=noRequestLimitPerConnection,proto3,oneof" json:"no_request_limit_per_connection,omitempty"`
}
type OriginPoolAdvancedOptions_MaxRequestsPerConnection struct {
	MaxRequestsPerConnection uint32 `protobuf:"varint,28,opt,name=max_requests_per_connection,json=maxRequestsPerConnection,proto3,oneof" json:"max_requests_per_connection,omitempty"`
}
...
func (*OriginPoolAdvancedOptions_NoRequestLimitPerConnection) isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice() {
}
func (*OriginPoolAdvancedOptions_MaxRequestsPerConnection) isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice() {
}
...
func (m *OriginPoolAdvancedOptions) GetMaxRequestsPerConnectionChoice() isOriginPoolAdvancedOptions_MaxRequestsPerConnectionChoice {
	if m != nil {
...
func (m *OriginPoolAdvancedOptions) GetNoRequestLimitPerConnection() *schema.Empty {
	if x, ok := m.GetMaxRequestsPerConnectionChoice().(*OriginPoolAdvancedOptions_NoRequestLimitPerConnection); ok {
		return x.NoRequestLimitPerConnection
	}
	return nil
}

func (m *OriginPoolAdvancedOptions) GetMaxRequestsPerConnection() uint32 {
	if x, ok := m.GetMaxRequestsPerConnectionChoice().(*OriginPoolAdvancedOptions_MaxRequestsPerConnection); ok {
...
func (*OriginPoolAdvancedOptions) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*OriginPoolAdvancedOptions_NoRequestLimitPerConnection)(nil),
		(*OriginPoolAdvancedOptions_MaxRequestsPerConnection)(nil),
	}
}
...
type GlobalSpecType struct {
	...
	UpstreamConnPoolReuseType *schema.UpstreamConnPoolReuseType `protobuf:"bytes,16,opt,name=upstream_conn_pool_reuse_type,json=upstreamConnPoolReuseType,proto3" json:"upstream_conn_pool_reuse_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("ves.io.schema.views.origin_pool.ProtocolType", ProtocolType_name, ProtocolType_value)
	golang_proto.RegisterEnum("ves.io.schema.views.origin_pool.ProtocolType", ProtocolType_name, ProtocolType_value)
	...
	proto.RegisterType((*OriginServerCBIPService)(nil), "ves.io.schema.views.origin_pool.OriginServerCBIPService")
	golang_proto.RegisterType((*OriginServerCBIPService)(nil), "ves.io.schema.views.origin_pool.OriginServerCBIPService")
...
var fileDescriptor_6ebf2c0bbcdcb0e6 = []byte{
	...
	,
}
...
func (this *OriginServerCBIPService) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginServerCBIPService)
	if !ok {
		that2, ok := that.(OriginServerCBIPService)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginServerType_CbipService) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginServerType_CbipService)
	if !ok {
		that2, ok := that.(OriginServerType_CbipService)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginPoolAdvancedOptions_NoRequestLimitPerConnection)
	if !ok {
		that2, ok := that.(OriginPoolAdvancedOptions_NoRequestLimitPerConnection)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginPoolAdvancedOptions_MaxRequestsPerConnection) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*OriginPoolAdvancedOptions_MaxRequestsPerConnection)
	if !ok {
		that2, ok := that.(OriginPoolAdvancedOptions_MaxRequestsPerConnection)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OriginServerCBIPService) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&origin_pool.OriginServerCBIPService{")
	s = append(s, "ServiceName: "+fmt.Sprintf("%#v", this.ServiceName)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *OriginServerType_CbipService) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&origin_pool.OriginServerType_CbipService{` +
...
func (this *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&origin_pool.OriginPoolAdvancedOptions_NoRequestLimitPerConnection{` +
		`NoRequestLimitPerConnection:` + fmt.Sprintf("%#v", this.NoRequestLimitPerConnection) + `}`}, ", ")
	return s
}
func (this *OriginPoolAdvancedOptions_MaxRequestsPerConnection) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&origin_pool.OriginPoolAdvancedOptions_MaxRequestsPerConnection{` +
...
func (m *OriginServerCBIPService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OriginServerCBIPService) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OriginServerCBIPService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OriginServerType_CbipService) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OriginServerType_CbipService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *OriginPoolAdvancedOptions_MaxRequestsPerConnection) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OriginPoolAdvancedOptions_MaxRequestsPerConnection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *OriginServerCBIPService) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OriginServerType_CbipService) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OriginPoolAdvancedOptions_MaxRequestsPerConnection) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *OriginServerCBIPService) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginServerCBIPService{`,
		`ServiceName:` + fmt.Sprintf("%v", this.ServiceName) + `,`,
		`}`,
	}, "")
	return s
...
func (this *OriginServerType_CbipService) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginServerType_CbipService{`,
		`CbipService:` + strings.Replace(fmt.Sprintf("%v", this.CbipService), "OriginServerCBIPService", "OriginServerCBIPService", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *OriginPoolAdvancedOptions_MaxRequestsPerConnection) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginPoolAdvancedOptions_MaxRequestsPerConnection{`,
		`MaxRequestsPerConnection:` + fmt.Sprintf("%v", this.MaxRequestsPerConnection) + `,`,
		`}`,
	}, "")
	return s
}
func (this *OriginPoolAdvancedOptions_NoRequestLimitPerConnection) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&OriginPoolAdvancedOptions_NoRequestLimitPerConnection{`,
...
func (m *OriginServerCBIPService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OriginServerCBIPService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OriginServerCBIPService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OriginServerType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			v := &OriginServerCBIPService{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Choice = &OriginServerType_CbipService{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *OriginPoolAdvancedOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			m.MaxRequestsPerConnectionChoice = &OriginPoolAdvancedOptions_MaxRequestsPerConnection{v}
		case 30:
			if wireType != 2 {
			...
			m.MaxRequestsPerConnectionChoice = &OriginPoolAdvancedOptions_NoRequestLimitPerConnection{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
