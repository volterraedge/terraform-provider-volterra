...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_origin_pool.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_origin_pool.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_origin_pool.DBObject)
	}
	_ = f
