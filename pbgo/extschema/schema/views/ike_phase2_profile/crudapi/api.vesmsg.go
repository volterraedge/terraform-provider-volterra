...
import (
	...
	ves_io_schema_views_ike_phase2_profile "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/ike_phase2_profile"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_views_ike_phase2_profile.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_views_ike_phase2_profile.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_views_ike_phase2_profile.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_views_ike_phase2_profile.DBObject)
	}
	_ = f
