...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.dns_lb_pool.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.dns_lb_pool.crudapi")
	}
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/ves.io.schema.dns_lb_pool/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-replace"
                },
        ...
        "/ves.io.schema.dns_lb_pool/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-list"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-create"
                },
        ...
        "/ves.io.schema.dns_lb_pool/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-crudapi-api-liststream"
                },
    ...
    "definitions": {
        ...
        "dns_lb_poolGlobalSpecType": {
            ...
            "x-ves-oneof-field-pool_type_choice": "[\"a_pool\",\"aaaa_pool\",\"cname_pool\",\"mx_pool\"]",
            "x-ves-oneof-field-ttl_choice": "[\"ttl\",\"use_rrset_ttl\"]",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.GlobalSpecType",
            "properties": {
                "a_pool": {
                    "description": "Exclusive with [aaaa_pool cname_pool mx_pool]\n",
                    "title": "A Pool",
                    "$ref": "#/definitions/dns_lb_poolAPool",
                    "x-displayname": "A"
                },
                "aaaa_pool": {
                    "description": "Exclusive with [a_pool cname_pool mx_pool]\n",
                    "title": "AAAA Pool",
                    "$ref": "#/definitions/dns_lb_poolAAAAPool",
                    "x-displayname": "AAAA"
                },
                "cname_pool": {
                    "description": "Exclusive with [a_pool aaaa_pool mx_pool]\n",
                    "title": "CNAME Pool",
                ...
                "mx_pool": {
                    "description": "Exclusive with [a_pool aaaa_pool cname_pool]\n",
                    "title": "MX Pool",
