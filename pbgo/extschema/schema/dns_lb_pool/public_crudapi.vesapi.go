...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_pool.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_pool.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_pool.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_pool.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.dns_lb_pool.API.Delete", nil)
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_lb_pools": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/dns_lb_pools/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/dns_lb_pools": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-api-list"
                },
        ...
        "/public/namespaces/{namespace}/dns_lb_pools/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-dns_lb_pool-api-delete"
                },
    ...
    "definitions": {
        ...
        "dns_lb_poolGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/dns_lb_poolObject",
        ...
        "dns_lb_poolObject": {
            "type": "object",
            "description": "DNS Load Balancer Pool object",
            "title": "DNS Load Balancer Pool",
            "x-displayname": "DNS Load Balancer Pool",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
