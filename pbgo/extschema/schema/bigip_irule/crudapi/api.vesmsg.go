...
import (
	...
	ves_io_schema_bigip_irule "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/bigip_irule"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_bigip_irule.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_bigip_irule.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_bigip_irule.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_bigip_irule.DBObject)
	}
	_ = f
