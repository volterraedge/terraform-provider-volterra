...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_network_connector.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_network_connector.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) FromObject(e db.Entry) {
	f := e.DeepCopy().(*ves_io_schema_network_connector.DBObject)
	_ = f
...
func (m *ObjectCreateReq) ToObject(e db.Entry) {
	m1 := m.DeepCopy()
	_ = m1
	f := e.(*ves_io_schema_network_connector.DBObject)
	_ = f
