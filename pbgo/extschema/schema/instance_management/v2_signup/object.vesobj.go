...
const (
	ObjectDefTblName = "ves.io.schema.instance_management.v2_signup.Object.default"
	ObjectType       = "ves.io.schema.instance_management.v2_signup.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.instance_management.v2_signup.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.instance_management.v2_signup.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
