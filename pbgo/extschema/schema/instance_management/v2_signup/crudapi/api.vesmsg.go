...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_instance_management_v2_signup.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_instance_management_v2_signup.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_instance_management_v2_signup.DBObject)
	}
	_ = f
