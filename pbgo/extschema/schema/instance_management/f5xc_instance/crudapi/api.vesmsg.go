...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_instance_management_f5xc_instance.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_instance_management_f5xc_instance.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_instance_management_f5xc_instance.DBObject)
	}
	_ = f
