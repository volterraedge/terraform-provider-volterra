...
const (
	ObjectDefTblName = "ves.io.schema.instance_management.tenant_allocation.Object.default"
	ObjectType       = "ves.io.schema.instance_management.tenant_allocation.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.instance_management.tenant_allocation.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.instance_management.tenant_allocation.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
