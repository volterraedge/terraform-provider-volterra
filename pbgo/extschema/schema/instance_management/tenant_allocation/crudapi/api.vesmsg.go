...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_instance_management_tenant_allocation.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_instance_management_tenant_allocation.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_instance_management_tenant_allocation.DBObject)
	}
	_ = f
