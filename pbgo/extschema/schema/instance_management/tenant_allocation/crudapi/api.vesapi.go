...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/instance_management/tenant_allocation"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.instance_management.tenant_allocation.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.instance_management.tenant_allocation.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.instance_management.tenant_allocation.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.instance_management.tenant_allocation.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.instance_management.tenant_allocation.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.instance_management.tenant_allocation.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.instance_management.tenant_allocation.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.instance_management.tenant_allocation.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.instance_management.tenant_allocation.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/instance_management/tenant_allocation/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.instance_management.tenant_allocation/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant_allocation",
            "x-ves-object-type": "ves.io.schema.instance_management.tenant_allocation.Object",
            "x-ves-proto-service": "ves.io.schema.instance_management.tenant_allocation.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.instance_management.tenant_allocation/Objects": {
            "get": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant_allocation",
            "x-ves-object-type": "ves.io.schema.instance_management.tenant_allocation.Object",
        ...
        "/ves.io.schema.instance_management.tenant_allocation/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-instance_management-tenant_allocation-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant_allocation",
            "x-ves-object-type": "ves.io.schema.instance_management.tenant_allocation.Object",
        ...
        "/ves.io.schema.instance_management.tenant_allocation/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.instance_management.tenant_allocation/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.instance_management.tenant_allocation/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.instance_management.tenant_allocation/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.instance_management.tenant_allocation.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/tenant_allocationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/tenant_allocationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/tenant_allocationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/tenant_allocationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/tenant_allocationcrudapiErrorCode"
                },
        ...
        "tenant_allocationGlobalSpecType": {
            "type": "object",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.GlobalSpecType",
            "properties": {
                "cname": {
                    "type": "string",
                    "description": " Cname holds the cname of the tenant.\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "cname",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "Cname",
                ...
                "idx_lookup_key": {
                    "type": "string",
                    "description": " Idx Lookup Key is for indexing the tenant allocation object\n irrespective of the type of the tenant\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 512\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "idx_lookup_key",
                    "minLength": 1,
                    "maxLength": 512,
                ...
                "instance_ref": {
                    "description": " InstanceRef holds reference to the instance which is allocated for the tenant.",
                    "title": "instance_ref",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Instance Ref"
                },
                "tenant_ref": {
                    "description": " ObjectRef holds reference to the tenant.",
                    "title": "tenant_ref",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
        ...
        "tenant_allocationSpecType": {
            "type": "object",
            "description": "Shape of the tenant allocation specification",
            "title": "SpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.instance_management.tenant_allocation.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " Specification of the tenant allocation",
                    "title": "gc_spec",
                    "$ref": "#/definitions/tenant_allocationGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "tenant_allocationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.instance_management.tenant_allocation.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/instance_management/tenant_allocation/crudapi/api.proto"
}`
