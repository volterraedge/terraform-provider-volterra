...
func TestNetworkPolicyPBRRuleActionProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &NetworkPolicyPBRRuleAction{}
...
func TestNetworkPolicyPBRRuleActionMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, false)
	size := p.Size()
...
func BenchmarkNetworkPolicyPBRRuleActionProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NetworkPolicyPBRRuleAction, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedNetworkPolicyPBRRuleAction(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkNetworkPolicyPBRRuleActionProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedNetworkPolicyPBRRuleAction(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestNetworkPolicyRuleAdvancedActionProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &NetworkPolicyRuleAdvancedAction{}
	if err := proto.Unmarshal(dAtA, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(dAtA))
...
func TestNetworkPolicyRuleAdvancedActionMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	size := p.Size()
...
func BenchmarkNetworkPolicyRuleAdvancedActionProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NetworkPolicyRuleAdvancedAction, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkNetworkPolicyRuleAdvancedActionProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestNetworkPolicyPBRRuleActionJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, true)
...
func TestNetworkPolicyRuleAdvancedActionJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestNetworkPolicyPBRRuleActionProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, true)
...
func TestNetworkPolicyPBRRuleActionProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, true)
...
func TestNetworkPolicyRuleAdvancedActionProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestNetworkPolicyRuleAdvancedActionProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestNetworkPolicyPBRRuleActionGoString(t *testing.T) {
...
func TestNetworkPolicyRuleAdvancedActionGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestNetworkPolicyPBRRuleActionSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkNetworkPolicyPBRRuleActionSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NetworkPolicyPBRRuleAction, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedNetworkPolicyPBRRuleAction(popr, false)
	}
	b.ResetTimer()
...
func TestNetworkPolicyRuleAdvancedActionSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkNetworkPolicyRuleAdvancedActionSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*NetworkPolicyRuleAdvancedAction, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	}
	b.ResetTimer()
...
func TestNetworkPolicyPBRRuleActionStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNetworkPolicyPBRRuleAction(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestNetworkPolicyRuleAdvancedActionStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNetworkPolicyRuleAdvancedAction(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
