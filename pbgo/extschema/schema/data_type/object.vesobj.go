...
const (
	ObjectDefTblName = "ves.io.schema.data_type.Object.default"
	ObjectType       = "ves.io.schema.data_type.Object"

	StatusObjectDefTblName = "ves.io.schema.data_type.StatusObject.default"
	StatusObjectType       = "ves.io.schema.data_type.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.data_type.Object"
}
...
func GetObjectIndexers() store.Indexers {
	indexers := store.Indexers{
		"system_metadata.tenant": store.NewIndexInfo(store.WithSecondaryIndex(func(e store.Entry) ([]string, error) {
			obj, ok := e.(*Object)
			if !ok {
				return nil, fmt.Errorf("Index system_metadata.tenant expected *ves.io.schema.data_type.Object, got %T: %#v", e, e)
			}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.data_type.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.data_type.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.data_type.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.data_type.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "data_type.Object")
	if err != nil {
