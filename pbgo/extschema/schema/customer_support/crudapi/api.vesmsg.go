...
import (
	...
	ves_io_schema_customer_support "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/customer_support"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_customer_support.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_customer_support.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_customer_support.DBObject)
	}
	_ = f
