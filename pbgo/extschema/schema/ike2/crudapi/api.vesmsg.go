...
import (
	...
	ves_io_schema_ike2 "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/ike2"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_ike2.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_ike2.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ike2.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ike2.DBObject)
	}
	_ = f
