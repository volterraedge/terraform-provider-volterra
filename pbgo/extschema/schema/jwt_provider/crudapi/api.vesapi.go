...
import (
	...
	object "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/jwt_provider"
)
    ...
    "definitions": {
        ...
        "jwt_providerSpecType": {
            ...
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/jwt_providerGlobalSpecType",
