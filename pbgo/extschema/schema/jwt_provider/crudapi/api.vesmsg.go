...
import (
	...
	ves_io_schema_jwt_provider "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/jwt_provider"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_jwt_provider.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_jwt_provider.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_jwt_provider.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_jwt_provider.DBObject)
	}
	_ = f
