...
func (c *CustomDataAPIGrpcClient) doRPCEnhancedFirewallPolicyHits(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &EnhancedFirewallPolicyHitsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.enhanced_firewall_policy.EnhancedFirewallPolicyHitsRequest", yamlReq)
	}
	rsp, err := c.grpcClient.EnhancedFirewallPolicyHits(ctx, req, opts...)
	return rsp, err
}
...
func (c *CustomDataAPIRestClient) doRPCEnhancedFirewallPolicyHits(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
	...
	req := &EnhancedFirewallPolicyHitsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.enhanced_firewall_policy.EnhancedFirewallPolicyHitsRequest: %s", yamlReq, err)
	}
...
func (s *customDataAPISrv) EnhancedFirewallPolicyHits(ctx context.Context, in *EnhancedFirewallPolicyHitsRequest) (*EnhancedFirewallPolicyHitsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.enhanced_firewall_policy.CustomDataAPI")
	...
	var (
		rsp *EnhancedFirewallPolicyHitsResponse
		err error
	)

	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.enhanced_firewall_policy.EnhancedFirewallPolicyHitsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomDataAPI.EnhancedFirewallPolicyHits' operation on 'enhanced_firewall_policy'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.CustomDataAPI.EnhancedFirewallPolicyHits"); rvFn != nil {
	...
	rsp, err = cah.EnhancedFirewallPolicyHits(ctx, in)
	if err != nil {
...
var CustomDataAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Monitoring APIs for Enhanced Firewall Policy",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/enhanced_firewall_policy/hits": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyHitsResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyHitsRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Enhanced Firewall Policy Monitoring APIs",
    ...
    "definitions": {
        "enhanced_firewall_policyEnhancedFirewallPolicyHits": {
            ...
            "properties": {
                "id": {
                    ...
                    "title": "ID",
                    "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyHitsId",
                    "x-displayname": "ID"
                },
                "metric": {
                    "type": "array",
        ...
        "enhanced_firewall_policyEnhancedFirewallPolicyHitsRequest": {
            ...
            "properties": {
                ...
                "group_by": {
                    ...
                    "title": "Group by",
                    "items": {
                        "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyMetricLabel"
                    },
                ...
                "label_filter": {
                    ...
                    "title": "Label Filter",
                    "items": {
                        "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyMetricLabelFilter"
                    },
        ...
        "enhanced_firewall_policyEnhancedFirewallPolicyHitsResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "title": "Enhanced Firewall Policy Hits",
                    "items": {
                        "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyHits"
                    },
                    "x-displayname": "Enhanced Firewall Policy Hits"
                },
                "step": {
        ...
        "enhanced_firewall_policyEnhancedFirewallPolicyMetricLabelFilter": {
            ...
            "properties": {
                "label": {
                    "description": " Label associated with Enhanced Firewall Policy hits",
                    "title": "Label",
                    "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyMetricLabel",
                    "x-displayname": "Label"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/enhanced_firewall_policy/public_custom_data_api.proto"
}`
