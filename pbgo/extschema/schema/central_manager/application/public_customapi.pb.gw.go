...
var (
	filter_CustomAPI_List_0 = &utilities.DoubleArray{Encoding: map[string]int{"cm_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_CustomAPI_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "applications", "cm_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "central_manager", "applications", "cm_id", "application_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
