...
func request_CustomAPI_UpdateStatus_0(ctx context.Context, marshaler runtime.Marshaler, client CustomAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateStatusReq
...
func local_request_CustomAPI_UpdateStatus_0(ctx context.Context, marshaler runtime.Marshaler, server CustomAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateStatusReq
	var metadata runtime.ServerMetadata
...
var (
	filter_CustomAPI_List_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterCustomAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomAPIServer) error {
	...
	mux.Handle("PUT", pattern_CustomAPI_UpdateStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomAPI_UpdateStatus_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CustomAPI_UpdateStatus_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCustomAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomAPIClient) error {
	...
	mux.Handle("PUT", pattern_CustomAPI_UpdateStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CustomAPI_UpdateStatus_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CustomAPI_UpdateStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "registrations", "cm_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"public", "central_manager", "registrations"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "registrations", "cm_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "registrations", "cm_id"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_CustomAPI_UpdateStatus_0 = runtime.ForwardResponseMessage
