...
func request_CustomAPI_Get_0(ctx context.Context, marshaler runtime.Marshaler, client CustomAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["reg_token"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "reg_token")
	}

	protoReq.RegToken, err = runtime.String(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "reg_token", err)
	}
...
var (
	pattern_CustomAPI_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"public", "central_manager", "tokens"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"public", "central_manager", "tokens"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "tokens", "reg_token"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomAPI_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"public", "central_manager", "tokens", "reg_token"}, "", runtime.AssumeColonVerbOpt(false)))
)
