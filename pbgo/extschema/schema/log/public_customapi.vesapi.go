...
func (c *CustomAPIGrpcClient) doRPCConsoleLoginEventsAggregationQuery(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &ConsoleLoginEventsAggregationRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.log.ConsoleLoginEventsAggregationRequest", yamlReq)
	}
	rsp, err := c.grpcClient.ConsoleLoginEventsAggregationQuery(ctx, req, opts...)
	return rsp, err
}

func (c *CustomAPIGrpcClient) doRPCConsoleLoginEventsQuery(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &ConsoleLoginEventsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.log.ConsoleLoginEventsRequest", yamlReq)
	}
	rsp, err := c.grpcClient.ConsoleLoginEventsQuery(ctx, req, opts...)
	return rsp, err
}

func (c *CustomAPIGrpcClient) doRPCConsoleLoginEventsScrollQuery(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &LogScrollRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.log.LogScrollRequest", yamlReq)
	}
	rsp, err := c.grpcClient.ConsoleLoginEventsScrollQuery(ctx, req, opts...)
	return rsp, err
}
...
func NewCustomAPIGrpcClient(cc *grpc.ClientConn) server.CustomClient {
	...
	rpcFns["ConsoleLoginEventsAggregationQuery"] = ccl.doRPCConsoleLoginEventsAggregationQuery

	rpcFns["ConsoleLoginEventsQuery"] = ccl.doRPCConsoleLoginEventsQuery

	rpcFns["ConsoleLoginEventsScrollQuery"] = ccl.doRPCConsoleLoginEventsScrollQuery
...
func (c *CustomAPIRestClient) doRPCConsoleLoginEventsAggregationQuery(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
		return nil, fmt.Errorf("Error, URI should be specified, got empty")
	}
	url := fmt.Sprintf("%s%s", c.baseURL, callOpts.URI)
	...
	req := &ConsoleLoginEventsAggregationRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.log.ConsoleLoginEventsAggregationRequest: %s", yamlReq, err)
	}
...
func (c *CustomAPIRestClient) doRPCConsoleLoginEventsQuery(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
		return nil, fmt.Errorf("Error, URI should be specified, got empty")
	}
	url := fmt.Sprintf("%s%s", c.baseURL, callOpts.URI)
	...
	req := &ConsoleLoginEventsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.log.ConsoleLoginEventsRequest: %s", yamlReq, err)
	}
...
func (c *CustomAPIRestClient) doRPCConsoleLoginEventsScrollQuery(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
		return nil, fmt.Errorf("Error, URI should be specified, got empty")
	}
	url := fmt.Sprintf("%s%s", c.baseURL, callOpts.URI)
...
func (c *CustomAPIInprocClient) ConsoleLoginEventsAggregationQuery(ctx context.Context, in *ConsoleLoginEventsAggregationRequest, opts ...grpc.CallOption) (*LogAggregationResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.log.CustomAPI")
	cah, ok := ah.(CustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *CustomAPISrv", ah)
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.log.ConsoleLoginEventsAggregationRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.ConsoleLoginEventsAggregationQuery' operation on 'log'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if c.svc.Config().EnableAPIValidation {
		if rvFn := c.svc.GetRPCValidator("ves.io.schema.log.CustomAPI.ConsoleLoginEventsAggregationQuery"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rsp, err = cah.ConsoleLoginEventsAggregationQuery(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
...
func (c *CustomAPIInprocClient) ConsoleLoginEventsQuery(ctx context.Context, in *ConsoleLoginEventsRequest, opts ...grpc.CallOption) (*LogResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.log.CustomAPI")
	cah, ok := ah.(CustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *CustomAPISrv", ah)
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.log.ConsoleLoginEventsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.ConsoleLoginEventsQuery' operation on 'log'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if c.svc.Config().EnableAPIValidation {
		if rvFn := c.svc.GetRPCValidator("ves.io.schema.log.CustomAPI.ConsoleLoginEventsQuery"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rsp, err = cah.ConsoleLoginEventsQuery(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
...
func (c *CustomAPIInprocClient) ConsoleLoginEventsScrollQuery(ctx context.Context, in *LogScrollRequest, opts ...grpc.CallOption) (*LogResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.log.CustomAPI")
	cah, ok := ah.(CustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *CustomAPISrv", ah)
	...
	defer func() {
		...
		userMsg := "The 'CustomAPI.ConsoleLoginEventsScrollQuery' operation on 'log'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if c.svc.Config().EnableAPIValidation {
		if rvFn := c.svc.GetRPCValidator("ves.io.schema.log.CustomAPI.ConsoleLoginEventsScrollQuery"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rsp, err = cah.ConsoleLoginEventsScrollQuery(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
...
var CustomAPISwaggerJSON string = `{
    ...
    "paths": {
        ...
        "/public/namespaces/{namespace}/console_login_events": {
            "post": {
                "summary": "Console Login Events Query",
                "description": "Request to get Volterra console login events.",
                "operationId": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsQuery",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/logConsoleLoginEventsRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-log-CustomAPI-ConsoleLoginEventsQuery"
                },
                "x-ves-proto-rpc": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsQuery"
            },
            "x-displayname": "Log",
            "x-ves-proto-service": "ves.io.schema.log.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/{namespace}/console_login_events/aggregation": {
            "post": {
                "summary": "Console Login Events Aggregation Query",
                "description": "Request to get summary/analytics data for the console login events that matches the query in request.",
                "operationId": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsAggregationQuery",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/logConsoleLoginEventsAggregationRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-log-CustomAPI-ConsoleLoginEventsAggregationQuery"
                },
                "x-ves-proto-rpc": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsAggregationQuery"
            },
            "x-displayname": "Log",
            "x-ves-proto-service": "ves.io.schema.log.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/{namespace}/console_login_events/scroll": {
            "get": {
                "summary": "Console Login Events Scroll Query",
                "description": "The response for console login events query contain no more than 500 records.\nScroll request is used scroll through more than 500 records or all records that matched the criteria in the\nquery in multiple batches. EOF is indicated by empty scroll_id in the response.",
                "operationId": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsScrollQuery",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-log-CustomAPI-ConsoleLoginEventsScrollQuery"
                },
                "x-ves-proto-rpc": "ves.io.schema.log.CustomAPI.ConsoleLoginEventsScrollQuery"
            },
            "x-displayname": "Log",
            "x-ves-proto-service": "ves.io.schema.log.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
    ...
    "definitions": {
        ...
        "logConsoleLoginEventsAggregationRequest": {
            "type": "object",
            "description": "Request to get only aggregation data for console login events",
            "title": "ConsoleLoginEventsAggregationRequest",
            "x-displayname": "Console Login Events Aggregation Request",
            "x-ves-proto-message": "ves.io.schema.log.ConsoleLoginEventsAggregationRequest",
            "properties": {
                "aggs": {
                    "type": "object",
                    "description": " Aggregations provide summary/analytics data over the log response. If the number of logs that matched the query\n is large and cannot be returned in a single response message, user can get helpful insights/summary using aggregations.\n The aggregations are key'ed by user-defined aggregation name. The response will be key'ed with the same name.\n Optional",
                ...
                "end_time": {
                    "type": "string",
                    "description": " fetch console login events whose timestamp \u003c= end_time\n format: unix_timestamp|rfc 3339\n\n Optional: If not specified, then the end_time will be evaluated to start_time+10m\n           If start_time is not specified, then the end_time will be evaluated to \u003ccurrent time\u003e\n\nExample: - \"2019-09-24T12:30:11.733Z\"-",
                    "title": "end time",
                    "x-displayname": "End Time",
                    "x-ves-example": "2019-09-24T12:30:11.733Z"
                },
        ...
        "logConsoleLoginEventsRequest": {
            "type": "object",
            "description": "Request to fetch Console login events.",
            "title": "ConsoleLoginEventsRequest",
            "x-displayname": "Console Login Events Request",
            "x-ves-proto-message": "ves.io.schema.log.ConsoleLoginEventsRequest",
            "properties": {
                "aggs": {
                    "type": "object",
                    "description": " Aggregations provide summary/analytics data over the log response. If the number of logs that matched the query\n is large and cannot be returned in a single response message, user can get helpful insights/summary using aggregations.\n The aggregations are key'ed by user-defined aggregation name. The response will be key'ed with the same name.\n Optional",
        ...
        "logconsole_login_eventsAggregationRequest": {
            "type": "object",
            "description": "x-displayName: \"Aggregation Request\"\nAggregation request to provide analytics data over the log response",
            "title": "Aggregation Request",
            "properties": {
                "date_aggregation": {
                    "description": "x-displayName: \"Date Aggregation\"\nAggregate based on timestamp in the log",
                    "title": "Date Aggregation",
                    "$ref": "#/definitions/logconsole_login_eventsDateAggregation"
                }
            }
        },
        "logconsole_login_eventsDateAggregation": {
            "type": "object",
