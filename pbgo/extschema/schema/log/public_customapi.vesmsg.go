...
func (m *ConsoleLoginEventsAggregationRequest) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *ConsoleLoginEventsAggregationRequest) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *ConsoleLoginEventsAggregationRequest) DeepCopy() *ConsoleLoginEventsAggregationRequest {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
	...
	c := &ConsoleLoginEventsAggregationRequest{}
	err = c.Unmarshal(ser)
	if err != nil {
		return nil
	}
...
func (m *ConsoleLoginEventsAggregationRequest) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *ConsoleLoginEventsAggregationRequest) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return ConsoleLoginEventsAggregationRequestValidator().Validate(ctx, m, opts...)
}

type ValidateConsoleLoginEventsAggregationRequest struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateConsoleLoginEventsAggregationRequest) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*ConsoleLoginEventsAggregationRequest)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *ConsoleLoginEventsAggregationRequest got type %s", t)
		}
	}
	if m == nil {
		return nil
...
// Well-known symbol for default validator implementation
var DefaultConsoleLoginEventsAggregationRequestValidator = func() *ValidateConsoleLoginEventsAggregationRequest {
	v := &ValidateConsoleLoginEventsAggregationRequest{FldValidators: map[string]db.ValidatorFunc{}}

	v.FldValidators["aggs"] = ves_io_schema_log_console_login_events.AggregationRequestValidator().Validate

	return v
}()

func ConsoleLoginEventsAggregationRequestValidator() db.Validator {
	return DefaultConsoleLoginEventsAggregationRequestValidator
}

// augmented methods on protoc/std generated struct

func (m *ConsoleLoginEventsRequest) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *ConsoleLoginEventsRequest) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *ConsoleLoginEventsRequest) DeepCopy() *ConsoleLoginEventsRequest {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *ConsoleLoginEventsRequest) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *ConsoleLoginEventsRequest) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return ConsoleLoginEventsRequestValidator().Validate(ctx, m, opts...)
}

type ValidateConsoleLoginEventsRequest struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateConsoleLoginEventsRequest) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*ConsoleLoginEventsRequest)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *ConsoleLoginEventsRequest got type %s", t)
		}
	}
	if m == nil {
		return nil
...
// Well-known symbol for default validator implementation
var DefaultConsoleLoginEventsRequestValidator = func() *ValidateConsoleLoginEventsRequest {
	v := &ValidateConsoleLoginEventsRequest{FldValidators: map[string]db.ValidatorFunc{}}
...
func ConsoleLoginEventsRequestValidator() db.Validator {
	return DefaultConsoleLoginEventsRequestValidator
}
