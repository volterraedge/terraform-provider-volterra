...
// Create MobileIntegratorCustomAPI GRPC Client satisfying server.CustomClient
type MobileIntegratorCustomAPIGrpcClient struct {
	conn       *grpc.ClientConn
	grpcClient MobileIntegratorCustomAPIClient
	// map of rpc name to its invocation
	rpcFns map[string]func(context.Context, string, ...grpc.CallOption) (proto.Message, error)
}

func (c *MobileIntegratorCustomAPIGrpcClient) doRPCGetMobileIntegrator(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &GetObjectRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.stored_object.GetObjectRequest", yamlReq)
	}
	rsp, err := c.grpcClient.GetMobileIntegrator(ctx, req, opts...)
	return rsp, err
}

func (c *MobileIntegratorCustomAPIGrpcClient) doRPCListMobileIntegrators(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &ListObjectsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.stored_object.ListObjectsRequest", yamlReq)
	}
	rsp, err := c.grpcClient.ListMobileIntegrators(ctx, req, opts...)
	return rsp, err
}

func (c *MobileIntegratorCustomAPIGrpcClient) DoRPC(ctx context.Context, rpc string, opts ...server.CustomCallOpt) (proto.Message, error) {
...
func NewMobileIntegratorCustomAPIGrpcClient(cc *grpc.ClientConn) server.CustomClient {
	ccl := &MobileIntegratorCustomAPIGrpcClient{
		conn:       cc,
		grpcClient: NewMobileIntegratorCustomAPIClient(cc),
	}
	rpcFns := make(map[string]func(context.Context, string, ...grpc.CallOption) (proto.Message, error))
	rpcFns["GetMobileIntegrator"] = ccl.doRPCGetMobileIntegrator

	rpcFns["ListMobileIntegrators"] = ccl.doRPCListMobileIntegrators
...
// Create MobileIntegratorCustomAPI REST Client satisfying server.CustomClient
type MobileIntegratorCustomAPIRestClient struct {
	baseURL string
	client  http.Client
	// map of rpc name to its invocation
...
func (c *MobileIntegratorCustomAPIRestClient) doRPCGetMobileIntegrator(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
...
func (c *MobileIntegratorCustomAPIRestClient) doRPCListMobileIntegrators(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
		return nil, fmt.Errorf("Error, URI should be specified, got empty")
	}
	url := fmt.Sprintf("%s%s", c.baseURL, callOpts.URI)
...
func (c *MobileIntegratorCustomAPIRestClient) DoRPC(ctx context.Context, rpc string, opts ...server.CustomCallOpt) (proto.Message, error) {
	rpcFn, exists := c.rpcFns[rpc]
	if !exists {
		return nil, fmt.Errorf("Error, no such rpc %s", rpc)
	}
...
func NewMobileIntegratorCustomAPIRestClient(baseURL string, hc http.Client) server.CustomClient {
	ccl := &MobileIntegratorCustomAPIRestClient{
		baseURL: baseURL,
		client:  hc,
	}
...
// Create mobileIntegratorCustomAPIInprocClient

// INPROC Client (satisfying MobileIntegratorCustomAPIClient interface)
type mobileIntegratorCustomAPIInprocClient struct {
	MobileIntegratorCustomAPIServer
}
...
func (c *mobileIntegratorCustomAPIInprocClient) GetMobileIntegrator(ctx context.Context, in *GetObjectRequest, opts ...grpc.CallOption) (*GetObjectResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.MobileIntegratorCustomAPI.GetMobileIntegrator")
...
func (c *mobileIntegratorCustomAPIInprocClient) ListMobileIntegrators(ctx context.Context, in *ListObjectsRequest, opts ...grpc.CallOption) (*ListObjectsResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.MobileIntegratorCustomAPI.ListMobileIntegrators")
	return c.MobileIntegratorCustomAPIServer.ListMobileIntegrators(ctx, in)
}

func NewMobileIntegratorCustomAPIInprocClient(svc svcfw.Service) MobileIntegratorCustomAPIClient {
	return &mobileIntegratorCustomAPIInprocClient{MobileIntegratorCustomAPIServer: NewMobileIntegratorCustomAPIServer(svc)}
}

// RegisterGwMobileIntegratorCustomAPIHandler registers with grpc-gw with an inproc-client backing so that
// rest to grpc happens without a grpc.Dial (thus avoiding additional certs for mTLS)
func RegisterGwMobileIntegratorCustomAPIHandler(ctx context.Context, mux *runtime.ServeMux, svc interface{}) error {
	s, ok := svc.(svcfw.Service)
	if !ok {
		return fmt.Errorf("svc is not svcfw.Service")
	}
	return RegisterMobileIntegratorCustomAPIHandlerClient(ctx, mux, NewMobileIntegratorCustomAPIInprocClient(s))
}

// Create mobileIntegratorCustomAPISrv

// SERVER (satisfying MobileIntegratorCustomAPIServer interface)
type mobileIntegratorCustomAPISrv struct {
	svc svcfw.Service
}

func (s *mobileIntegratorCustomAPISrv) GetMobileIntegrator(ctx context.Context, in *GetObjectRequest) (*GetObjectResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.stored_object.MobileIntegratorCustomAPI")
	cah, ok := ah.(MobileIntegratorCustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *MobileIntegratorCustomAPIServer", ah)
	}
	...
	defer func() {
		...
		userMsg := "The 'MobileIntegratorCustomAPI.GetMobileIntegrator' operation on 'stored_object'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.stored_object.MobileIntegratorCustomAPI.GetMobileIntegrator"); rvFn != nil {
	...
	rsp, err = cah.GetMobileIntegrator(ctx, in)
	if err != nil {
...
func (s *mobileIntegratorCustomAPISrv) ListMobileIntegrators(ctx context.Context, in *ListObjectsRequest) (*ListObjectsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.stored_object.MobileIntegratorCustomAPI")
	cah, ok := ah.(MobileIntegratorCustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *MobileIntegratorCustomAPIServer", ah)
	...
	defer func() {
		...
		userMsg := "The 'MobileIntegratorCustomAPI.ListMobileIntegrators' operation on 'stored_object'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.stored_object.MobileIntegratorCustomAPI.ListMobileIntegrators"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rsp, err = cah.ListMobileIntegrators(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
...
func NewMobileIntegratorCustomAPIServer(svc svcfw.Service) MobileIntegratorCustomAPIServer {
	return &mobileIntegratorCustomAPISrv{svc: svc}
}

var MobileIntegratorCustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Mobile Integrator APIs",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/stored_objects/mobile-integrator": {
            "get": {
            ...
            "x-displayname": "Mobile Integrator Custom API",
            "x-ves-proto-service": "ves.io.schema.stored_object.MobileIntegratorCustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/{namespace}/stored_objects/mobile-integrator/{name}/{version}": {
            "get": {
    ...
    "x-ves-proto-file": "ves.io/schema/stored_object/public_customapi_mobile_integrator.proto"
}`
