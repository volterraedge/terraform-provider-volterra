...
// Create MobileSdkSelfServeCustomAPI GRPC Client satisfying server.CustomClient
type MobileSdkSelfServeCustomAPIGrpcClient struct {
	conn       *grpc.ClientConn
	grpcClient MobileSdkSelfServeCustomAPIClient
	// map of rpc name to its invocation
	rpcFns map[string]func(context.Context, string, ...grpc.CallOption) (proto.Message, error)
}

func (c *MobileSdkSelfServeCustomAPIGrpcClient) doRPCGetMobileSDKSelfServe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &GetObjectRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.stored_object.GetObjectRequest", yamlReq)
	}
	rsp, err := c.grpcClient.GetMobileSDKSelfServe(ctx, req, opts...)
	return rsp, err
}
func (c *MobileSdkSelfServeCustomAPIGrpcClient) doRPCListMobileSDKSelfServe(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &ListObjectsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.stored_object.ListObjectsRequest", yamlReq)
	}
	rsp, err := c.grpcClient.ListMobileSDKSelfServe(ctx, req, opts...)
	return rsp, err
}

func (c *MobileSdkSelfServeCustomAPIGrpcClient) DoRPC(ctx context.Context, rpc string, opts ...server.CustomCallOpt) (proto.Message, error) {
...
func NewMobileSdkSelfServeCustomAPIGrpcClient(cc *grpc.ClientConn) server.CustomClient {
	ccl := &MobileSdkSelfServeCustomAPIGrpcClient{
		conn:       cc,
		grpcClient: NewMobileSdkSelfServeCustomAPIClient(cc),
	}
	rpcFns := make(map[string]func(context.Context, string, ...grpc.CallOption) (proto.Message, error))
	rpcFns["GetMobileSDKSelfServe"] = ccl.doRPCGetMobileSDKSelfServe
	rpcFns["ListMobileSDKSelfServe"] = ccl.doRPCListMobileSDKSelfServe
	ccl.rpcFns = rpcFns
	return ccl
}

// Create MobileSdkSelfServeCustomAPI REST Client satisfying server.CustomClient
type MobileSdkSelfServeCustomAPIRestClient struct {
	baseURL string
	client  http.Client
	// map of rpc name to its invocation
...
func (c *MobileSdkSelfServeCustomAPIRestClient) doRPCGetMobileSDKSelfServe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
...
func (c *MobileSdkSelfServeCustomAPIRestClient) doRPCListMobileSDKSelfServe(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
		return nil, fmt.Errorf("Error, URI should be specified, got empty")
	}
	url := fmt.Sprintf("%s%s", c.baseURL, callOpts.URI)
...
func (c *MobileSdkSelfServeCustomAPIRestClient) DoRPC(ctx context.Context, rpc string, opts ...server.CustomCallOpt) (proto.Message, error) {
	rpcFn, exists := c.rpcFns[rpc]
	if !exists {
		return nil, fmt.Errorf("Error, no such rpc %s", rpc)
	}
...
func NewMobileSdkSelfServeCustomAPIRestClient(baseURL string, hc http.Client) server.CustomClient {
	ccl := &MobileSdkSelfServeCustomAPIRestClient{
		baseURL: baseURL,
		client:  hc,
	}
...
// Create mobileSdkSelfServeCustomAPIInprocClient

// INPROC Client (satisfying MobileSdkSelfServeCustomAPIClient interface)
type mobileSdkSelfServeCustomAPIInprocClient struct {
	MobileSdkSelfServeCustomAPIServer
}

func (c *mobileSdkSelfServeCustomAPIInprocClient) GetMobileSDKSelfServe(ctx context.Context, in *GetObjectRequest, opts ...grpc.CallOption) (*GetObjectResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI.GetMobileSDKSelfServe")
	return c.MobileSdkSelfServeCustomAPIServer.GetMobileSDKSelfServe(ctx, in)
}
func (c *mobileSdkSelfServeCustomAPIInprocClient) ListMobileSDKSelfServe(ctx context.Context, in *ListObjectsRequest, opts ...grpc.CallOption) (*ListObjectsResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI.ListMobileSDKSelfServe")
	return c.MobileSdkSelfServeCustomAPIServer.ListMobileSDKSelfServe(ctx, in)
}

func NewMobileSdkSelfServeCustomAPIInprocClient(svc svcfw.Service) MobileSdkSelfServeCustomAPIClient {
	return &mobileSdkSelfServeCustomAPIInprocClient{MobileSdkSelfServeCustomAPIServer: NewMobileSdkSelfServeCustomAPIServer(svc)}
}

// RegisterGwMobileSdkSelfServeCustomAPIHandler registers with grpc-gw with an inproc-client backing so that
// rest to grpc happens without a grpc.Dial (thus avoiding additional certs for mTLS)
func RegisterGwMobileSdkSelfServeCustomAPIHandler(ctx context.Context, mux *runtime.ServeMux, svc interface{}) error {
	s, ok := svc.(svcfw.Service)
	if !ok {
		return fmt.Errorf("svc is not svcfw.Service")
	}
	return RegisterMobileSdkSelfServeCustomAPIHandlerClient(ctx, mux, NewMobileSdkSelfServeCustomAPIInprocClient(s))
}

// Create mobileSdkSelfServeCustomAPISrv

// SERVER (satisfying MobileSdkSelfServeCustomAPIServer interface)
type mobileSdkSelfServeCustomAPISrv struct {
	svc svcfw.Service
}

func (s *mobileSdkSelfServeCustomAPISrv) GetMobileSDKSelfServe(ctx context.Context, in *GetObjectRequest) (*GetObjectResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI")
	cah, ok := ah.(MobileSdkSelfServeCustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *MobileSdkSelfServeCustomAPIServer", ah)
	}
	...
	defer func() {
		...
		userMsg := "The 'MobileSdkSelfServeCustomAPI.GetMobileSDKSelfServe' operation on 'stored_object'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI.GetMobileSDKSelfServe"); rvFn != nil {
	...
	rsp, err = cah.GetMobileSDKSelfServe(ctx, in)
	if err != nil {
...
func (s *mobileSdkSelfServeCustomAPISrv) ListMobileSDKSelfServe(ctx context.Context, in *ListObjectsRequest) (*ListObjectsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI")
	cah, ok := ah.(MobileSdkSelfServeCustomAPIServer)
	if !ok {
		return nil, fmt.Errorf("ah %v is not of type *MobileSdkSelfServeCustomAPIServer", ah)
	...
	defer func() {
		...
		userMsg := "The 'MobileSdkSelfServeCustomAPI.ListMobileSDKSelfServe' operation on 'stored_object'"
		if err == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI.ListMobileSDKSelfServe"); rvFn != nil {
			if verr := rvFn(ctx, in); verr != nil {
				err = server.MaybePublicRestError(ctx, errors.Wrapf(verr, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rsp, err = cah.ListMobileSDKSelfServe(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
...
func NewMobileSdkSelfServeCustomAPIServer(svc svcfw.Service) MobileSdkSelfServeCustomAPIServer {
	return &mobileSdkSelfServeCustomAPISrv{svc: svc}
}

var MobileSdkSelfServeCustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Mobile SDK APIs for self serve",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/stored_objects/mobile-sdk-self-serve": {
            "get": {
            ...
            "x-displayname": "Mobile SDK Self serve Custom API",
            "x-ves-proto-service": "ves.io.schema.stored_object.MobileSdkSelfServeCustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        },
        "/public/namespaces/{namespace}/stored_objects/mobile-sdk-self-serve/{name}/{version}": {
            "get": {
    ...
    "x-ves-proto-file": "ves.io/schema/stored_object/public_customapi_mobile_sdk_self_serve.proto"
}`
