...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.stored_object.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.stored_object.crudapi")
	}
    ...
    "definitions": {
        ...
        "stored_objectGlobalSpecType": {
            ...
            "properties": {
                ...
                "content_hash": {
                    "type": "string",
                    "description": " Hash value of the stored_object\n\nExample: - \"value\"-\nRequired: YES",
                    "title": "hash",
                    "x-displayname": "Hash",
                    "x-ves-example": "value",
                    "x-ves-required": "true"
