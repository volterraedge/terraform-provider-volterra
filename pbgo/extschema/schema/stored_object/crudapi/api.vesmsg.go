...
import (
	...
	ves_io_schema_stored_object "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/stored_object"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_stored_object.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_stored_object.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_stored_object.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_stored_object.DBObject)
	}
	_ = f
