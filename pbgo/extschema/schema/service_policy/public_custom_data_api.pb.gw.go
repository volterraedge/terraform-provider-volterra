...
func local_request_CustomDataAPI_ServicePolicyHits_0(ctx context.Context, marshaler runtime.Marshaler, server CustomDataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ServicePolicyHitsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ServicePolicyHits(ctx, &protoReq)
	return msg, metadata, err
...
func local_request_CustomDataAPI_ServicePolicyHitsLatency_0(ctx context.Context, marshaler runtime.Marshaler, server CustomDataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ServicePolicyHitsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ServicePolicyHitsLatency(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCustomDataAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomDataAPIServer) error {
	...
	mux.Handle("POST", pattern_CustomDataAPI_ServicePolicyHits_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomDataAPI_ServicePolicyHits_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_CustomDataAPI_ServicePolicyHitsLatency_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomDataAPI_ServicePolicyHitsLatency_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CustomDataAPI_ServicePolicyHits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"public", "namespaces", "namespace", "service_policy", "hits"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_CustomDataAPI_ServicePolicyHitsLatency_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"public", "namespaces", "namespace", "service_policy", "latency"}, "", runtime.AssumeColonVerbOpt(false)))
)
