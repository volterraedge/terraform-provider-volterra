...
func TestSimpleRuleProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, false)
...
func TestSimpleRuleMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, false)
	size := p.Size()
...
func BenchmarkSimpleRuleProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SimpleRule, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSimpleRule(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkSimpleRuleProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedSimpleRule(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSourceListProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestSourceListMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, false)
	size := p.Size()
...
func BenchmarkSourceListProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SourceList, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSourceList(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkSourceListProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedSourceList(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkRuleProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*Rule, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedRule(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkRuleProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedRule(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRuleListProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestRuleListMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, false)
	size := p.Size()
...
func BenchmarkRuleListProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*RuleList, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedRuleList(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkRuleListProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedRuleList(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestLegacyRuleListProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestLegacyRuleListMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, false)
	size := p.Size()
...
func BenchmarkLegacyRuleListProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*LegacyRuleList, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedLegacyRuleList(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkLegacyRuleListProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedLegacyRuleList(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSimpleRuleJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, true)
...
func TestSourceListJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestRuleListJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestLegacyRuleListJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestSimpleRuleProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, true)
...
func TestSimpleRuleProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, true)
...
func TestSourceListProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestSourceListProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestRuleListProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestRuleListProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestLegacyRuleListProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestLegacyRuleListProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestSimpleRuleGoString(t *testing.T) {
...
func TestSourceListGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSourceList(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestRuleGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRule(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestRuleListGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRuleList(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestLegacyRuleListGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedLegacyRuleList(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestSimpleRuleSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSimpleRule(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkSimpleRuleSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SimpleRule, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSimpleRule(popr, false)
	}
	b.ResetTimer()
...
func TestSourceListSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSourceList(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkSourceListSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SourceList, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSourceList(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkRuleSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*Rule, 1000)
	for i := 0; i < 1000; i++ {
...
func TestRuleListSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRuleList(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkRuleListSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*RuleList, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedRuleList(popr, false)
	}
	b.ResetTimer()
...
func TestLegacyRuleListSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedLegacyRuleList(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkLegacyRuleListSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*LegacyRuleList, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedLegacyRuleList(popr, false)
	}
	b.ResetTimer()
...
func TestSimpleRuleStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSimpleRule(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestSourceListStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSourceList(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestRuleListStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRuleList(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestLegacyRuleListStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedLegacyRuleList(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
