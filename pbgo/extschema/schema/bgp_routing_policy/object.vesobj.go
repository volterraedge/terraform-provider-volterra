...
const (
	ObjectDefTblName = "ves.io.schema.bgp_routing_policy.Object.default"
	ObjectType       = "ves.io.schema.bgp_routing_policy.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.bgp_routing_policy.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.bgp_routing_policy.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
