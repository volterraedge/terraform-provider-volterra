...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_known_label.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_known_label.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_known_label.DBObject)
	}
	_ = f
