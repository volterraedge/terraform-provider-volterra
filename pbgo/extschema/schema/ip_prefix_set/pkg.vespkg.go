...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.ip_prefix_set.GetRequest"] = GetRequestValidator()
	vr["ves.io.schema.ip_prefix_set.GetResponse"] = GetResponseValidator()
	vr["ves.io.schema.ip_prefix_set.ListRequest"] = ListRequestValidator()
	vr["ves.io.schema.ip_prefix_set.ListResponse"] = ListResponseValidator()
...
func initializeEntryRegistry(mdr *svcfw.MDRegistry) {
	mdr.EntryFactory["ves.io.schema.ip_prefix_set.Object"] = NewEntryObject
	mdr.EntryStoreMap["ves.io.schema.ip_prefix_set.Object"] = store.InMemory
	mdr.EntryRegistry["ves.io.schema.ip_prefix_set.Object"] = reflect.TypeOf(&DBObject{})
	mdr.EntryIndexers["ves.io.schema.ip_prefix_set.Object"] = GetObjectIndexers
	mdr.EntryFactory["ves.io.schema.ip_prefix_set.StatusObject"] = NewEntryStatusObject
