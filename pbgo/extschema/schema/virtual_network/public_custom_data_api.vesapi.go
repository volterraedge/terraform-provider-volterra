...
func (c *CustomDataAPIGrpcClient) doRPCSIDCounters(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &SIDCounterRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.virtual_network.SIDCounterRequest", yamlReq)
	}
	rsp, err := c.grpcClient.SIDCounters(ctx, req, opts...)
	return rsp, err
}
...
func (c *CustomDataAPIRestClient) doRPCSIDCounters(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
	...
	req := &SIDCounterRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.virtual_network.SIDCounterRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, fmt.Errorf("JSON Response %s is not of type *ves.io.schema.virtual_network.SIDCounterResponse", body)
...
func (c *CustomDataAPIInprocClient) SIDCounters(ctx context.Context, in *SIDCounterRequest, opts ...grpc.CallOption) (*SIDCounterResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'CustomDataAPI.SIDCounters' operation on 'virtual_network'"
		if err == nil {
	...
	rsp, err = cah.SIDCounters(ctx, in)
	if err != nil {
...
var CustomDataAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "APIs to get monitoring data for Virtual Networks",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{namespace}/virtual_network/sid_counters": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/virtual_networkSIDCounterRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-virtual_network-CustomDataAPI-SIDCounters"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_network.CustomDataAPI.SIDCounters"
            },
            "x-displayname": "Virtual Network Custom Data API",
            "x-ves-proto-service": "ves.io.schema.virtual_network.CustomDataAPI",
    ...
    "definitions": {
        ...
        "virtual_networkSIDCounterData": {
            "type": "object",
            "description": "SID Counter data contains the counter type and the corresponding value",
            "title": "SID Counter Data",
            "x-displayname": "SID Counter Data",
            "x-ves-proto-message": "ves.io.schema.virtual_network.SIDCounterData",
            "properties": {
                "data": {
                    "type": "array",
                ...
                "type": {
                    "description": " SID Counter Type",
                    "title": "Type",
                    "$ref": "#/definitions/virtual_networkSIDCounterType",
                    "x-displayname": "Type"
                }
            }
        },
        "virtual_networkSIDCounterLabel": {
            "type": "string",
            "description": "Labels in SID Counter  metrics\n\nSite name\nVirtual-Network name\nSID prefix",
            "title": "SID Counter Labels",
            "enum": [
                "SITE",
                "VIRTUAL_NETWORK",
                "SID_PREFIX"
            ...
            "x-ves-proto-enum": "ves.io.schema.virtual_network.SIDCounterLabel"
        },
        "virtual_networkSIDCounterRequest": {
            "type": "object",
            "description": "Request to get the SID Counters",
            "title": "SID Counter Request",
            "x-displayname": "SID Counter Request",
            "x-ves-proto-message": "ves.io.schema.virtual_network.SIDCounterRequest",
            "properties": {
                "end_time": {
                    "type": "string",
                ...
                "group_by": {
                    "type": "array",
                    "description": " Aggregate data by zero or more labels {SITE, VIRTUAL_NETWORK, SID_PREFIX}",
                    "title": "Group by",
                    "items": {
                        "$ref": "#/definitions/virtual_networkSIDCounterLabel"
                    },
        ...
        "virtual_networkSIDCounterResponse": {
            "type": "object",
            "title": "SID Counter Response",
            "x-displayname": "SID Counter Response",
            "x-ves-proto-message": "ves.io.schema.virtual_network.SIDCounterResponse",
            "properties": {
                "data": {
                    "type": "array",
                    "description": " Data contains time-series data for SID counters",
                    "title": "Data",
                    "items": {
                        "$ref": "#/definitions/virtual_networkSIDCounterData"
                    },
                    "x-displayname": "Data"
                }
            }
        },
        "virtual_networkSIDCounterType": {
            "type": "string",
            "description": "List of SID Counter metrics\n\nx-unit: \"count\"\nx-unit: \"count\"\nx-unit: \"count\"\nx-unit: \"count\"",
            "title": "SID Counter Type",
            "enum": [
            ...
            "default": "SID_COUNTER_IN_BYTES",
            "x-displayname": "SID Counter Type",
            "x-ves-proto-enum": "ves.io.schema.virtual_network.SIDCounterType"
        },
        "virtual_networkSIDCounterTypeData": {
            "type": "object",
            "description": "SID Counter Type Data contains key/value pairs that uniquely identifies the group_by labels specified in the request.",
            "title": "SID Counter Type Data",
            "x-displayname": "SID Counter Type Data",
            "x-ves-proto-message": "ves.io.schema.virtual_network.SIDCounterTypeData",
            "properties": {
                "key": {
                    "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/virtual_network/public_custom_data_api.proto"
}`
