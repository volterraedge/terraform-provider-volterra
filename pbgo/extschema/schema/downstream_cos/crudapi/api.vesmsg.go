...
import (
	...
	ves_io_schema_downstream_cos "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/downstream_cos"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_downstream_cos.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_downstream_cos.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_downstream_cos.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_downstream_cos.DBObject)
	}
	_ = f
