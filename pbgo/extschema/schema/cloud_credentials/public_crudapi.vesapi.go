...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.cloud_credentials.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.cloud_credentials.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.cloud_credentials.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.cloud_credentials.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.cloud_credentials.API.Delete", nil)
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "cloud_credentialsObject": {
            "type": "object",
            "description": "Cloud Credentials object",
            "title": "Cloud Credentials object",
            "x-displayname": "Cloud Credentials",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
