...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.cloud_credentials.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.cloud_credentials.crudapi")
	}
    ...
    "paths": {
        "/ves.io.schema.cloud_credentials/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-Delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-Replace"
                },
        ...
        "/ves.io.schema.cloud_credentials/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-List"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-Create"
                },
        ...
        "/ves.io.schema.cloud_credentials/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-cloud_credentials-crudapi-API-ListStream"
                },
