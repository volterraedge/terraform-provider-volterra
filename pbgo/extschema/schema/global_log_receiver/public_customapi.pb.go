...
// Enumerates Status of Global Log Receiver Test Connection
type TestConnectionStatus int32

const (
	// UNKNOWN
	// x-displayName: "Unknown"
	// Unknown status of the test connection.
	UNKNOWN TestConnectionStatus = 0
	// Running
	// x-displayName: "Running"
	// The test connection is incomplete/running.
	RUNNING TestConnectionStatus = 1
	// Success
	// x-displayName: "Success"
	// The test connection is Successful.
	SUCCESS TestConnectionStatus = 2
	// Failed
	// x-displayName: "Failed"
	// The test connection is failed.
	FAILED TestConnectionStatus = 3
)

var TestConnectionStatus_name = map[int32]string{
	0: "UNKNOWN",
	1: "RUNNING",
	2: "SUCCESS",
	3: "FAILED",
...
var TestConnectionStatus_value = map[string]int32{
	"UNKNOWN": 0,
	"RUNNING": 1,
	"SUCCESS": 2,
	"FAILED":  3,
...
func (TestConnectionStatus) EnumDescriptor() ([]byte, []int) {
...
type TestGlobalLogReceiverResponse struct {
	...
	// x-displayName: "Status"
	// Status
	Status TestConnectionStatus `protobuf:"varint,1,opt,name=status,proto3,enum=ves.io.schema.global_log_receiver.TestConnectionStatus" json:"status,omitempty"`
}
...
func (m *TestGlobalLogReceiverResponse) GetStatus() TestConnectionStatus {
	if m != nil {
		return m.Status
	}
	return UNKNOWN
...
func init() {
	proto.RegisterEnum("ves.io.schema.global_log_receiver.TestConnectionStatus", TestConnectionStatus_name, TestConnectionStatus_value)
	golang_proto.RegisterEnum("ves.io.schema.global_log_receiver.TestConnectionStatus", TestConnectionStatus_name, TestConnectionStatus_value)
...
var fileDescriptor_0c4bdaebe7e79181 = []byte{
	...
	,
}

func (x TestConnectionStatus) String() string {
	s, ok := TestConnectionStatus_name[int32(x)]
	if ok {
		return s
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= TestConnectionStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
