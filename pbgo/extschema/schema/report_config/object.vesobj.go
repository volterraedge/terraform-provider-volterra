...
const (
	ObjectDefTblName = "ves.io.schema.report_config.Object.default"
	ObjectType       = "ves.io.schema.report_config.Object"

	StatusObjectDefTblName = "ves.io.schema.report_config.StatusObject.default"
	StatusObjectType       = "ves.io.schema.report_config.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.report_config.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.report_config.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.report_config.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.report_config.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetObjectRefsDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			dri := &fdrInfos[i]
			// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
			dri.DRField = "ves.io.schema.report_config.StatusObject." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
	...
	if fdrInfos, err := e.GetReportsDRefInfo(); err != nil {
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "report_config.Object")
	if err != nil {
...
func (e *DBStatusObject) GetReportsDRefInfo() ([]db.DRefInfo, error) {
	refrUID, err := e.Key()
	if err != nil {
		return nil, errors.Wrap(err, "GetDRefInfo, error in key")
	}
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("StatusObject.reports[%d] has a nil value", i)
		}
		// resolve kind to type if needed at DBObject.GetDRefInfo()
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "report.Object",
			RefdUID:    ref.Uid,
			RefdTenant: ref.Tenant,
			RefdNS:     ref.Namespace,
			RefdName:   ref.Name,
...
// GetReportsDBEntries returns the db.Entry corresponding to the ObjRefType from the default Table
func (e *DBStatusObject) GetReportsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	var entries []db.Entry
	refrUID, err := e.Key()
	if err != nil {
		return nil, errors.Wrap(err, "Get<fld>DBEntries, error in key")
	}
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "report.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: report")
	}
	tblName := db.DefaultTableName(refdType)
	if intTbl, err := d.GetTable(ctx, db.InternalTableName(refdType)); err == nil {
		tblName = intTbl.Name()
	}
	for _, ref := range e.GetReports() {
		e, exist, err := d.FindEntry(ctx, tblName, ref.Uid)
		if err != nil {
			return nil, errors.Wrap(err, fmt.Sprintf("Tbl: %s, Key: %s", tblName, ref.Uid))
		}
...
func (v *ValidateStatusObject) ObjectRefsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
...
func (v *ValidateStatusObject) ReportsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	repValFn, err := db.NewRepeatedValidationRuleHandler(rules)
	if err != nil {
		return nil, errors.Wrap(err, "Repeated ValidationRuleHandler for reports")
	}
	...
	validatorFn := func(ctx context.Context, val interface{}, opts ...db.ValidateOpt) error {
		...
		if err := repValFn(ctx, l, opts...); err != nil {
			return errors.Wrap(err, "repeated reports")
		}
		if err := itemsValidatorFn(ctx, elems, opts...); err != nil {
			return errors.Wrap(err, "items reports")
		}
		return nil
	}
...
func (v *ValidateStatusObject) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	if fv, exists := v.FldValidators["object_refs"]; exists {
		...
		if err := fv(ctx, e.GetObjectRefs(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["report_delivery_status"]; exists {
		...
		if err := fv(ctx, e.GetReportDeliveryStatus(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["report_generation_status"]; exists {
		...
		if err := fv(ctx, e.GetReportGenerationStatus(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["reports"]; exists {
		...
		if err := fv(ctx, e.GetReports(), vOpts...); err != nil {
			return err
		}
	...
	if fv, exists := v.FldValidators["sent_time"]; exists {
		...
		if err := fv(ctx, e.GetSentTime(), vOpts...); err != nil {
			return err
		}
...
var DefaultStatusObjectValidator = func() *ValidateStatusObject {
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for StatusObject.object_refs: %s", err)
		panic(errMsg)
	}
	v.FldValidators["object_refs"] = vFn

	vrhReports := v.ReportsValidationRuleHandler
	rulesReports := map[string]string{
		"ves.io.schema.rules.repeated.unique": "true",
	}
	vFn, err = vrhReports(rulesReports)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for StatusObject.reports: %s", err)
		panic(errMsg)
	}
	v.FldValidators["reports"] = vFn

	v.FldValidators["conditions"] = ves_io_schema.ConditionTypeValidator().Validate

	v.FldValidators["report_generation_status"] = ves_io_schema_report.ReportGenerationStatusValidator().Validate

	v.FldValidators["report_delivery_status"] = ves_io_schema_report.ReportDeliveryStatusValidator().Validate
