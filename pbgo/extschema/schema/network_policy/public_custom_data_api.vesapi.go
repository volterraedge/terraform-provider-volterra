...
func (c *CustomDataAPIGrpcClient) doRPCNetworkPolicyHits(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.network_policy.NetworkPolicyHitsRequest", yamlReq)
	}
...
func (c *CustomDataAPIRestClient) doRPCNetworkPolicyHits(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &NetworkPolicyHitsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.network_policy.NetworkPolicyHitsRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.network_policy.NetworkPolicyHitsResponse", body)
...
func (c *customDataAPIInprocClient) NetworkPolicyHits(ctx context.Context, in *NetworkPolicyHitsRequest, opts ...grpc.CallOption) (*NetworkPolicyHitsResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.CustomDataAPI.NetworkPolicyHits")
...
func (s *customDataAPISrv) NetworkPolicyHits(ctx context.Context, in *NetworkPolicyHitsRequest) (*NetworkPolicyHitsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.network_policy.CustomDataAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.network_policy.NetworkPolicyHitsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomDataAPI.NetworkPolicyHits' operation on 'network_policy'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.network_policy.CustomDataAPI.NetworkPolicyHits"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.network_policy.NetworkPolicyHitsResponse", rsp)...)
...
var CustomDataAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Monitoring APIs for Network Policy",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/network_policy/hits": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/network_policyNetworkPolicyHitsRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy-customdataapi-networkpolicyhits"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy.CustomDataAPI.NetworkPolicyHits"
            },
            "x-displayname": "Network Policy Monitoring APIs",
        ...
        "network_policyNetworkPolicyHits": {
            ...
            "properties": {
                "id": {
                    ...
                    "title": "ID",
                    "$ref": "#/definitions/network_policyNetworkPolicyHitsId",
                    "x-displayname": "ID"
                },
                "metric": {
                    "type": "array",
        ...
        "network_policyNetworkPolicyHitsRequest": {
            ...
            "properties": {
                ...
                "group_by": {
                    ...
                    "title": "Group by",
                    "items": {
                        "$ref": "#/definitions/network_policyNetworkPolicyMetricLabel"
                    },
                ...
                "label_filter": {
                    ...
                    "title": "Label Filter",
                    "items": {
                        "$ref": "#/definitions/network_policyNetworkPolicyMetricLabelFilter"
                    },
        ...
        "network_policyNetworkPolicyHitsResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "title": "Network policy Hits",
                    "items": {
                        "$ref": "#/definitions/network_policyNetworkPolicyHits"
                    },
                    "x-displayname": "Network Policy Hits"
                },
                "step": {
    ...
    "x-ves-proto-file": "ves.io/schema/network_policy/public_custom_data_api.proto"
}`
