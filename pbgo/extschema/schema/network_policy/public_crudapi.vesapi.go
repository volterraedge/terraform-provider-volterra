    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/network_policys": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-network_policy-API-Create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/network_policys/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-network_policy-API-Replace"
                },
        ...
        "/public/namespaces/{namespace}/network_policys": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-network_policy-API-List"
                },
        ...
        "/public/namespaces/{namespace}/network_policys/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-network_policy-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-network_policy-API-Delete"
                },
    ...
    "definitions": {
        ...
        "network_policyCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/network_policyCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "network_policyCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the network policy",
                    "title": "spec",
                    "$ref": "#/definitions/network_policyGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "network_policyReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the network policy",
                    "title": "spec",
                    "$ref": "#/definitions/network_policyReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        ...
        "network_policySpecType": {
            ...
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/network_policyGlobalSpecType",
