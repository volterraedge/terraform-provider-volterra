...
import (
	...
	ves_io_schema_usage "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/usage"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_usage.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_usage.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_usage.DBObject)
	}
	_ = f
