...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.app_firewall.crudapi.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.app_firewall.crudapi.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.app_firewall.crudapi.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.app_firewall.crudapi.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.app_firewall.crudapi.API.Delete", nil)
    ...
    "paths": {
        "/ves.io.schema.app_firewall/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-replace"
                },
        ...
        "/ves.io.schema.app_firewall/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-list"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-create"
                },
        ...
        "/ves.io.schema.app_firewall/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-liststream"
                },
