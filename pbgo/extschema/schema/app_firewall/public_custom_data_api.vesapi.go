...
func (c *CustomDataAPIRestClient) doRPCMetrics(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, fmt.Errorf("JSON Response %s is not of type *ves.io.schema.app_firewall.MetricsResponse", body)
...
func (c *CustomDataAPIInprocClient) Metrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.app_firewall.CustomDataAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, c.svc, "ves.io.schema.app_firewall.MetricsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, c.svc, "ves.io.schema.app_firewall.MetricsResponse", rsp)...)
        ...
        "app_firewallMetricData": {
            ...
            "properties": {
                "data": {
                    ...
                    "title": "Data",
                    "items": {
                        "$ref": "#/definitions/app_firewallMetricTypeData"
                    },
                    "x-displayname": "Data"
                },
                "type": {
