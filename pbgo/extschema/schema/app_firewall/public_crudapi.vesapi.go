...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.app_firewall.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.app_firewall")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.app_firewall")
	}
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "app_firewallCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/schemaapp_firewallCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "app_firewallCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the WAF instance",
                    "title": "spec",
                    "$ref": "#/definitions/schemaapp_firewallGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "app_firewallReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the WAF instance",
                    "title": "spec",
                    "$ref": "#/definitions/schemaapp_firewallReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        ...
        "schemaapp_firewallCreateSpecType": {
            "type": "object",
            "description": "Create Application Firewall",
        ...
        "schemaapp_firewallReplaceSpecType": {
            "type": "object",
            "description": "Replace Application Firewall",
