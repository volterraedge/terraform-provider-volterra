...
import (
	...
	ves_io_schema_data_privacy_geo_config "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/data_privacy/geo_config"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_data_privacy_geo_config.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_data_privacy_geo_config.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_data_privacy_geo_config.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_data_privacy_geo_config.DBObject)
	}
	_ = f
