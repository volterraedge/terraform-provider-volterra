...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/address_allocators", c.baseURL, namespace)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/address_allocators/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/address_allocators", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.address_allocator.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.address_allocator")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.address_allocator.API.Create", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.address_allocator.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.address_allocator.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.address_allocator.API.Delete", nil)
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.address_allocator.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.address_allocator.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.address_allocator.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.address_allocator.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	rspMsgFQN := "ves.io.schema.address_allocator.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.address_allocator.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.address_allocator.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/address_allocators": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/address_allocatorCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/address_allocatorCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.API.Create"
            },
            "x-displayname": "Address Allocator",
            "x-ves-proto-service": "ves.io.schema.address_allocator.API",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/address_allocatorListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.API.List"
            },
            "x-displayname": "Address Allocator",
            "x-ves-proto-service": "ves.io.schema.address_allocator.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/address_allocators/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/address_allocatorGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/address_allocatorDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.API.Delete"
            },
            "x-displayname": "Address Allocator",
            "x-ves-proto-service": "ves.io.schema.address_allocator.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "address_allocatorCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of address_allocator",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of address allocator",
                    "title": "spec",
                    "$ref": "#/definitions/address_allocatorCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "address_allocatorCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of address allocator",
                    "title": "spec",
                    "$ref": "#/definitions/address_allocatorGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "address_allocatorCreateSpecType": {
            "type": "object",
            "description": "Create Address Allocator will create an address allocator object in 'system' namespace of the user",
            "title": "Create Address Allocator",
        ...
        "address_allocatorDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a address_allocator",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.address_allocator.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "address_allocatorGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read address_allocator",
        ...
        "address_allocatorGetResponseFormatCode": {
            "type": "string",
        ...
        "address_allocatorGetSpecType": {
            "type": "object",
            "description": "Get Address Allocator will get address allocator object from system namespace",
            "title": "Get Address Allocator",
        ...
        "address_allocatorListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of address_allocator",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.address_allocator.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/address_allocatorListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "address_allocatorListResponseItem": {
            "type": "object",
            "description": "By default a summary of address_allocator is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of address_allocator",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.address_allocator.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this address_allocator",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this address_allocator",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates address_allocator is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this address_allocator",
                    "title": "labels",
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this address_allocator\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "address_allocatorObject": {
            "type": "object",
            "description": "Address Allocator Object",
            "title": "Address Allocator",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.address_allocator.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
    ...
    "x-displayname": "Address Allocator",
    "x-ves-proto-file": "ves.io/schema/address_allocator/public_crudapi.proto"
}`
