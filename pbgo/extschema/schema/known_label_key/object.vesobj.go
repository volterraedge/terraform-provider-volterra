...
const (
	ObjectDefTblName = "ves.io.schema.known_label_key.Object.default"
	ObjectType       = "ves.io.schema.known_label_key.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.known_label_key.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.known_label_key.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
