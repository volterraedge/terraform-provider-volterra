...
import (
	...
	ves_io_schema_virtual_k8s_quota "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s_quota"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_virtual_k8s_quota.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_virtual_k8s_quota.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_virtual_k8s_quota.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_virtual_k8s_quota.DBObject)
	}
	_ = f
