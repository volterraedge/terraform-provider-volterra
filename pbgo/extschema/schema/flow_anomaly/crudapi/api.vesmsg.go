...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_flow_anomaly.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_flow_anomaly.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_flow_anomaly.DBObject)
	}
	_ = f
