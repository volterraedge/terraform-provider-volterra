...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/flow_exporter"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.flow_exporter.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.flow_exporter.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.flow_exporter.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.flow_exporter.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.flow_exporter.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.flow_exporter.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.flow_exporter.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.flow_exporter.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.flow_exporter.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.flow_exporter.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.flow_exporter.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.flow_exporter.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.flow_exporter.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.flow_exporter.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.flow_exporter.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.flow_exporter.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.flow_exporter.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.flow_exporter.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/flow_exporter/crudapi/api.proto",
    ...
    "paths": {
        "/ves.io.schema.flow_exporter/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "flow_exporter",
            "x-ves-object-type": "ves.io.schema.flow_exporter.Object",
            "x-ves-proto-service": "ves.io.schema.flow_exporter.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.flow_exporter/Objects": {
            "get": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "flow_exporter",
            "x-ves-object-type": "ves.io.schema.flow_exporter.Object",
        ...
        "/ves.io.schema.flow_exporter/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-flow_exporter-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.flow_exporter.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "flow_exporter",
            "x-ves-object-type": "ves.io.schema.flow_exporter.Object",
        ...
        "/ves.io.schema.flow_exporter/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.flow_exporter/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.flow_exporter/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.flow_exporter/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.flow_exporter.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/flow_exporterSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/flow_exportercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/flow_exportercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/flow_exporterStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/flow_exportercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/flow_exportercrudapiErrorCode"
                },
        ...
        "flow_exporterCollectorType": {
            "type": "string",
            "description": "Type of the collector. As of now, only IPFIX collectors\nare supported\n\n - COLLECTOR_TYPE_IPFIX: IPFIX Collector Type\n\nCollector supports IPFIX protocol",
            "title": "Collector Type",
            "enum": [
                "COLLECTOR_TYPE_IPFIX"
            ],
            "default": "COLLECTOR_TYPE_IPFIX",
            "x-displayname": "Collector Type",
            "x-ves-proto-enum": "ves.io.schema.flow_exporter.CollectorType"
        },
        "flow_exporterFlowCollector": {
            "type": "object",
            "description": "Collector Server Information",
            "title": "FlowCollector",
            "x-displayname": "Flow Collector",
            "x-ves-oneof-field-collector_type_parameters": "[\"ipfix_collector_parameters\"]",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.FlowCollector",
            "properties": {
                "collector_end_point": {
                    "description": " Reachability information for the collector",
                    "title": "Collector End Point Information",
                    "$ref": "#/definitions/flow_exporterFlowCollectorEndPoint",
                    "x-displayname": "Collector Endpoint Information"
                },
                "collector_type": {
                    "description": " Type of the collector",
                    "title": "Collector Type",
                    "$ref": "#/definitions/flow_exporterCollectorType",
                    "x-displayname": "Collector Type"
                },
                "ipfix_collector_parameters": {
                    "description": "Exclusive with []\n IPFIX parameters for the collector",
                    "title": "IPFIX parameters",
                    "$ref": "#/definitions/flow_exporterIpfixParameters",
                    "x-displayname": "IPFIX Collector Parameters"
                }
            }
        },
        "flow_exporterFlowCollectorEndPoint": {
            "type": "object",
            "description": "Collector Reachability Information",
            ...
            "properties": {
                "collector_ip": {
                    "description": "Exclusive with [collector_service_name]\n Address in which the collector resides",
                    "title": "Collector IP",
        ...
        "flow_exporterFlowExportTimeout": {
            "type": "object",
            "description": "Flow Export Timeout",
            "title": "FlowExportTimeout",
            "x-displayname": "FlowExportTimeout",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.FlowExportTimeout",
            "properties": {
                "timeout_packets": {
                    "type": "integer",
        ...
        "flow_exporterFlowSampler": {
            "type": "object",
            "description": "Flow Sampler",
            "title": "FlowSampler",
            "x-displayname": "FlowSampler",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.FlowSampler",
            "properties": {
                "sampler_rate": {
                    "type": "integer",
        ...
        "flow_exporterGlobalSpecType": {
            "type": "object",
            "description": "Flow exporter configuration",
            "title": "Flow Exporter",
            "x-displayname": "Flow Exporter",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.GlobalSpecType",
            "properties": {
                "flow_active_timeout": {
                    "type": "integer",
                    "description": " Time in seconds after which a long running flow is considered\n for exporting\n\nExample: - \"60\"-",
                    "title": "Active Flow Timeout",
                    "format": "int64",
                ...
                "flow_sampler": {
                    ...
                    "$ref": "#/definitions/flow_exporterFlowSampler",
                    "x-displayname": "Sampling Specification"
                }
            }
        },
        "flow_exporterIpfixParameters": {
            "type": "object",
            "description": "Parameters for ipfix",
            "title": "IPFIX parameters",
            "x-displayname": "IPFIX Parameters",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.IpfixParameters",
            "properties": {
                "ipfix_template_refresh_time": {
                    "description": " Time interval after which templates are sent to the collector",
                    "title": "Template refresh time",
                    "$ref": "#/definitions/flow_exporterFlowExportTimeout",
                    "x-displayname": "Template Refresh Time"
                }
            }
        },
        "flow_exporterSpecType": {
            "type": "object",
            "description": "Shape of Flow Exporter",
            "title": "Specification",
            "x-displayname": "Specification",
            "x-ves-displayorder": "2",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/flow_exporterGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "flow_exporterStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status Object",
            "x-ves-displayorder": "1,2,3",
            "x-ves-proto-message": "ves.io.schema.flow_exporter.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "flow_exportercrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.flow_exporter.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/flow_exporter/crudapi/api.proto"
}`
