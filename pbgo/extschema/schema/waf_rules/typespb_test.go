...
func TestRulesProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRules(popr, false)
...
func TestRulesMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRules(popr, false)
	size := p.Size()
...
func BenchmarkRulesProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*Rules, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedRules(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkRulesProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedRules(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRulesProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRules(popr, true)
...
func TestRulesProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedRules(popr, true)
...
func TestRulesGoString(t *testing.T) {
...
func BenchmarkRulesSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*Rules, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedRules(popr, false)
	}
	b.ResetTimer()
