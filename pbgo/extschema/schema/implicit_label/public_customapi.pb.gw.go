...
/*
Package implicit_label is a reverse proxy.
...
var (
	filter_CustomAPI_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_CustomAPI_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"public", "namespaces", "system", "implicit_labels"}, "", runtime.AssumeColonVerbOpt(false)))
)
