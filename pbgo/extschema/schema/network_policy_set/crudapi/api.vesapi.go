...
import (
	...
	object "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/network_policy_set"
)
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.network_policy_set.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.network_policy_set.crudapi")
	}
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/ves.io.schema.network_policy_set/Object/{object_uid}": {
            "get": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-Delete"
                },
            ...
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-Replace"
                },
        ...
        "/ves.io.schema.network_policy_set/Objects": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-List"
                },
            ...
            "post": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-Create"
                },
        ...
        "/ves.io.schema.network_policy_set/Objects/stream": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-crudapi-API-ListStream"
                },
    ...
    "definitions": {
        ...
        "network_policy_setGlobalSpecType": {
            ...
            "properties": {
                "nps_type": {
                    "description": " Network policy set type lets VER know what this policy set is used for.",
                    "title": "Network Policy Set Type",
                    "$ref": "#/definitions/network_policy_setNetworkPolicySetType",
        ...
        "network_policy_setNetworkPolicySetType": {
            ...
            "x-displayname": "Network Policy Set Type",
            "x-ves-proto-enum": "ves.io.schema.network_policy_set.NetworkPolicySetType"
        },
