...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/network_policy_sets", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/network_policy_sets/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/network_policy_sets/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/network_policy_sets", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/network_policy_sets/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.network_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.network_policy_set")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.network_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.network_policy_set")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.network_policy_set")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.network_policy_set.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.network_policy_set.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_set.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_set.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.network_policy_set.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.network_policy_set.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.network_policy_set.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_set.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_set.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.network_policy_set.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.network_policy_set.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_set.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.network_policy_set.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_set.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_set.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_set.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.network_policy_set.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.network_policy_set.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Network Policy Set Object",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{metadata.namespace}/network_policy_sets": {
            "post": {
                "summary": "Create Network Policy Set",
                "description": "Create Network Policy Set in a given namespace. If one already exist it will give a error.",
                "operationId": "ves.io.schema.network_policy_set.API.Create",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/network_policy_setCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/network_policy_setCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_set.API.Create"
            },
        ...
        "/public/namespaces/{metadata.namespace}/network_policy_sets/{metadata.name}": {
            "put": {
                "summary": "Replace Network Policy Set",
                "description": "Replace Network Policy Set in a given namespace.",
                "operationId": "ves.io.schema.network_policy_set.API.Replace",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/network_policy_setReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/network_policy_setReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_set.API.Replace"
            },
            "x-displayname": "Network Policy Set",
            "x-ves-proto-service": "ves.io.schema.network_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/network_policy_sets": {
            "get": {
                "summary": "List",
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/network_policy_setListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/network_policy_sets/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/network_policy_setGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                "summary": "Delete",
                "description": "Delete the specified network_policy_set",
                "operationId": "ves.io.schema.network_policy_set.API.Delete",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/network_policy_setDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-network_policy_set-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_set.API.Delete"
            },
            "x-displayname": "Network Policy Set",
            "x-ves-proto-service": "ves.io.schema.network_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "network_policy_setCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of network_policy_set",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the network policy set",
                    "title": "spec",
                    "$ref": "#/definitions/network_policy_setCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "network_policy_setCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the network policy set",
                    "title": "spec",
                    "$ref": "#/definitions/network_policy_setGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "network_policy_setCreateSpecType": {
            "type": "object",
            "description": "Create Network Policy Set in a given namespace. If one already exist it will give a error.",
            "title": "Create Network Policy Set",
            "x-displayname": "Create Network Policy Set",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.CreateSpecType",
            "properties": {
                "policies": {
                    "type": "array",
        ...
        "network_policy_setDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a network_policy_set",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "network_policy_setGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/network_policy_setObject",
        ...
        "network_policy_setListResponse": {
            ...
            "properties": {
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/network_policy_setListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "network_policy_setObject": {
            "type": "object",
            "description": "Network Policy Set object",
            "title": "Network Policy Set",
            "x-displayname": "Network Policy Set",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "network_policy_setReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a network_policy_set",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the network policy set",
                    "title": "spec",
                    "$ref": "#/definitions/network_policy_setReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "network_policy_setReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.ReplaceResponse"
        },
        "network_policy_setReplaceSpecType": {
            "type": "object",
            "description": "Replace Network Policy Set in a given namespace.",
            "title": "Replace Network Policy Set",
            "x-displayname": "Replace Network Policy Set",
            "x-ves-proto-message": "ves.io.schema.network_policy_set.ReplaceSpecType",
            "properties": {
                "policies": {
                    "type": "array",
                    "description": " Ordered list of references to the network policy that make up this Network policy set.",
    ...
    "x-displayname": "Network Policy Set",
    "x-ves-proto-file": "ves.io/schema/network_policy_set/public_crudapi.proto"
}`
