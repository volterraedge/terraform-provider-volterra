...
// source: ves.io/schema/secret_management_access/object.proto
...
//
// x-displayName: "SMA"
// Secret Management Access object
type Object struct {
	// metadata
	//
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c9fc4eee8eb1199, []int{0}
}
...
// Specification for secret managmenet object
//
// x-displayName: "Specification"
// Shape of the secret management host specification
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c9fc4eee8eb1199, []int{1}
}
...
// Status for secret managment access
//
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c9fc4eee8eb1199, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.secret_management_access.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.secret_management_access.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.secret_management_access.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.secret_management_access.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.secret_management_access.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.secret_management_access.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/secret_management_access/object.proto", fileDescriptor_0c9fc4eee8eb1199)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/secret_management_access/object.proto", fileDescriptor_0c9fc4eee8eb1199)
}

var fileDescriptor_0c9fc4eee8eb1199 = []byte{
	// 598 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&secret_management_access.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&secret_management_access.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&secret_management_access.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
