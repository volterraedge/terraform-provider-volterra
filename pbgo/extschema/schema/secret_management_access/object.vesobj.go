...
const (
	ObjectDefTblName = "ves.io.schema.secret_management_access.Object.default"
	ObjectType       = "ves.io.schema.secret_management_access.Object"

	StatusObjectDefTblName = "ves.io.schema.secret_management_access.StatusObject.default"
	StatusObjectType       = "ves.io.schema.secret_management_access.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.secret_management_access.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.secret_management_access.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.secret_management_access.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.secret_management_access.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.secret_management_access.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		...
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "secret_management_access.Object",
			RefdUID:    ref.Uid,
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "secret_management_access.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: secret_management_access")
	}
