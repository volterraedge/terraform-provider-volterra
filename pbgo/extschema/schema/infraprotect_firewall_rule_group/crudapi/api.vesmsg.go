...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_infraprotect_firewall_rule_group.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_infraprotect_firewall_rule_group.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_infraprotect_firewall_rule_group.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_infraprotect_firewall_rule_group.DBObject)
	}
	_ = f
