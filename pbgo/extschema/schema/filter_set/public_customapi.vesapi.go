...
func (c *CustomAPIGrpcClient) doRPCFindFilterSets(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	req := &FindFilterSetsReq{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.filter_set.FindFilterSetsReq", yamlReq)
	}
	rsp, err := c.grpcClient.FindFilterSets(ctx, req, opts...)
	return rsp, err
}
...
func NewCustomAPIGrpcClient(cc *grpc.ClientConn) server.CustomClient {
	...
	rpcFns["FindFilterSets"] = ccl.doRPCFindFilterSets
...
func (c *CustomAPIRestClient) doRPCFindFilterSets(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	if callOpts.URI == "" {
	...
	req := &FindFilterSetsReq{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.filter_set.FindFilterSetsReq: %s", yamlReq, err)
	}
	...
	case "get":
		...
		q := hReq.URL.Query()
		_ = q
		for _, item := range req.ContextKeys {
			q.Add("context_keys", fmt.Sprintf("%v", item))
		}
	...
	pbRsp := &FindFilterSetsRsp{}
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.filter_set.FindFilterSetsRsp", body)
...
func (c *customAPIInprocClient) FindFilterSets(ctx context.Context, in *FindFilterSetsReq, opts ...grpc.CallOption) (*FindFilterSetsRsp, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.filter_set.CustomAPI.FindFilterSets")
	return c.CustomAPIServer.FindFilterSets(ctx, in)
}
...
func (s *customAPISrv) FindFilterSets(ctx context.Context, in *FindFilterSetsReq) (*FindFilterSetsRsp, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.filter_set.CustomAPI")
	...
	var (
		rsp *FindFilterSetsRsp
		err error
	)

	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.filter_set.FindFilterSetsReq", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.FindFilterSets' operation on 'filter_set'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.filter_set.CustomAPI.FindFilterSets"); rvFn != nil {
	...
	rsp, err = cah.FindFilterSets(ctx, in)
	if err != nil {
		return rsp, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.filter_set.FindFilterSetsRsp", rsp)...)
...
var CustomAPISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/filter_sets/find": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/filter_setFindFilterSetsRsp"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/filter_setFindFilterSetsReq"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "filter_setFindFilterSetsReq": {
            ...
            "properties": {
                "context_keys": {
                    "type": "array",
                    "description": " context key(s) that idenfify one or more console pages/views where filters of the same field/values can be applied\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "context_keys",
                    "minItems": 1,
                    "items": {
                        "type": "string"
        ...
        "filter_setFindFilterSetsRsp": {
            ...
            "properties": {
                "filter_sets": {
                    ...
                    "title": "filter_sets",
                    "items": {
                        "$ref": "#/definitions/filter_setObject"
                    },
        ...
        "filter_setObject": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Filter Set",
                    "title": "spec",
    ...
    "x-displayname": "Filter Set",
    "x-ves-proto-file": "ves.io/schema/filter_set/public_customapi.proto"
}`
