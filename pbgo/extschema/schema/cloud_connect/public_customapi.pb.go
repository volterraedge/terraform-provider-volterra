...
// Enumerates Status of CloudConnect
type Status int32
...
type FieldData struct {
	...
	// x-displayName: "Status"
	// Status
	Status Status `protobuf:"varint,3,opt,name=status,proto3,enum=ves.io.schema.cloud_connect.Status" json:"status,omitempty"`
}
...
func (m *FieldData) GetStatus() Status {
	if m != nil {
		return m.Status
	}
...
func init() {
	proto.RegisterEnum("ves.io.schema.cloud_connect.Status", Status_name, Status_value)
	golang_proto.RegisterEnum("ves.io.schema.cloud_connect.Status", Status_name, Status_value)
...
var fileDescriptor_f06559f2a0429fbd = []byte{
	...
	,
}
