...
const (
	ObjectDefTblName = "ves.io.schema.tunnel.Object.default"
	ObjectType       = "ves.io.schema.tunnel.Object"

	StatusObjectDefTblName = "ves.io.schema.tunnel.StatusObject.default"
	StatusObjectType       = "ves.io.schema.tunnel.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.tunnel.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		...
		dri.DRField = "ves.io.schema.tunnel.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.tunnel.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.tunnel.StatusObject"
}
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "tunnel.Object")
	if err != nil {
