...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_40c0b9a2b459d6d9, []int{0}
}
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_40c0b9a2b459d6d9, []int{1}
}
...
type StatusObject struct {
	...
	TunnelStatus []*site.TunnelConnectionStatus `protobuf:"bytes,4,rep,name=tunnel_status,json=tunnelStatus,proto3" json:"tunnel_status,omitempty"`
}

func (m *StatusObject) Reset()      { *m = StatusObject{} }
func (*StatusObject) ProtoMessage() {}
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_40c0b9a2b459d6d9, []int{2}
}
...
func (m *StatusObject) GetTunnelStatus() []*site.TunnelConnectionStatus {
	if m != nil {
...
func init() { proto.RegisterFile("ves.io/schema/tunnel/object.proto", fileDescriptor_40c0b9a2b459d6d9) }
func init() {
	golang_proto.RegisterFile("ves.io/schema/tunnel/object.proto", fileDescriptor_40c0b9a2b459d6d9)
}

var fileDescriptor_40c0b9a2b459d6d9 = []byte{
	// 634 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *StatusObject) Equal(that interface{}) bool {
	...
	if len(this.TunnelStatus) != len(that1.TunnelStatus) {
		return false
	}
	for i := range this.TunnelStatus {
		if !this.TunnelStatus[i].Equal(that1.TunnelStatus[i]) {
			return false
		}
	}
	return true
...
func (this *StatusObject) GoString() string {
	...
	if this.TunnelStatus != nil {
		s = append(s, "TunnelStatus: "+fmt.Sprintf("%#v", this.TunnelStatus)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *StatusObject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TunnelStatus) > 0 {
		for iNdEx := len(m.TunnelStatus) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TunnelStatus[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (this *StatusObject) String() string {
	...
	repeatedStringForTunnelStatus := "[]*TunnelConnectionStatus{"
	for _, f := range this.TunnelStatus {
		repeatedStringForTunnelStatus += strings.Replace(fmt.Sprintf("%v", f), "TunnelConnectionStatus", "site.TunnelConnectionStatus", 1) + ","
	}
	repeatedStringForTunnelStatus += "}"
	s := strings.Join([]string{`&StatusObject{`,
		...
		`TunnelStatus:` + repeatedStringForTunnelStatus + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StatusObject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TunnelStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TunnelStatus = append(m.TunnelStatus, &site.TunnelConnectionStatus{})
			if err := m.TunnelStatus[len(m.TunnelStatus)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
