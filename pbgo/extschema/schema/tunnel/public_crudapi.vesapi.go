...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.tunnel.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.tunnel.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.tunnel.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.tunnel.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.tunnel.API.Delete", nil)
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "tunnelCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/tunnelCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "tunnelCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Tunnel",
                    "title": "spec",
                    "$ref": "#/definitions/tunnelGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "tunnelObject": {
            ...
            "title": "Tunnel",
            "x-displayname": "Tunnel",
            "x-ves-proto-message": "ves.io.schema.tunnel.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "tunnelReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Tunnel",
                    "title": "spec",
                    "$ref": "#/definitions/tunnelReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
