...
type AllocateIPRequest struct {
	...
	// This is the global ip allocator context from which ip allocation will happen
	// x-example: "app-vip-pool-1"
...
func (m *AllocateIPRequest) GetContext() string {
	if m != nil {
		return m.Context
	}
	return ""
...
type DeallocateIPRequest struct {
	...
	//
	// x-displayName: "Context"
	// This is the global ip allocator context from which ip deallocation will happen
	// x-example: "app-vip-pool-1"
...
func (m *DeallocateIPRequest) GetContext() string {
	if m != nil {
		return m.Context
	}
	return ""
...
var fileDescriptor_1329530397cf8606 = []byte{
	...
	,
}
...
func (m *AllocateIPRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		...
		i = encodeVarintPublicCustomapi(dAtA, i, uint64(len(m.Context)))
		i--
		dAtA[i] = 0x12
	}
	if m.UseV6Range {
