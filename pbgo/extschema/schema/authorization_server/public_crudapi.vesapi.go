...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/authorization_servers", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/authorization_servers/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/authorization_servers/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/authorization_servers", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/authorization_servers/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.authorization_server.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.authorization_server")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.authorization_server.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.authorization_server.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.authorization_server.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.authorization_server.API.Create' operation on 'authorization_server'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.authorization_server.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.authorization_server.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.authorization_server.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.authorization_server.API.Replace' operation on 'authorization_server'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.authorization_server.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.authorization_server.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.authorization_server.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.authorization_server.API.Delete' operation on 'authorization_server'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.authorization_server.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Authorization Server Object",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/authorization_servers": {
            "post": {
                "summary": "Create Authorization Server",
                "description": "Create authorization_server creates a new object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.authorization_server.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/authorization_serverCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authorization_serverCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.authorization_server.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/authorization_servers/{metadata.name}": {
            "put": {
                "summary": "Replace Authorization Server",
                "description": "Replace authorization_server replaces an existing object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.authorization_server.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/authorization_serverReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authorization_serverReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/authorization_servers": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/authorization_serverListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/authorization_servers/{name}": {
            "get": {
                "summary": "Get Authorization Server",
                "description": "Get authorization_server reads a given object from storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.authorization_server.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/authorization_serverGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authorization_serverDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "authorization_serverCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of authorization_server",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the authorization_server",
                    "title": "spec",
                    "$ref": "#/definitions/authorization_serverCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "authorization_serverCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the authorization_server",
                    "title": "spec",
                    "$ref": "#/definitions/authorization_serverGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "authorization_serverCreateSpecType": {
            "type": "object",
            "description": "Create authorization_server creates a new object in the storage backend for metadata.namespace.",
            "title": "Create authorization server",
            "x-displayname": "Create Authorization Server",
            "x-ves-proto-message": "ves.io.schema.authorization_server.CreateSpecType",
            "properties": {
                "jwks_uri": {
                    "type": "string",
        ...
        "authorization_serverDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a authorization_server",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.authorization_server.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "authorization_serverGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read authorization_server",
        ...
        "authorization_serverGetResponseFormatCode": {
            "type": "string",
        ...
        "authorization_serverGetSpecType": {
            "type": "object",
            "description": "Get authorization_server reads a given object from storage backend for metadata.namespace.",
            "title": "Get authorization server",
            "x-displayname": "Get Authorization Server",
            "x-ves-proto-message": "ves.io.schema.authorization_server.GetSpecType",
            "properties": {
                "jwks_uri": {
                    "type": "string",
                    "description": " x-textBlockContent:\n Automatic fetching of JWKS will happen once daily. You can also do it manually from the list of Authorization Servers at any time.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.uri: true\n",
        ...
        "authorization_serverListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of authorization_server",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.authorization_server.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/authorization_serverListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "authorization_serverListResponseItem": {
            "type": "object",
            "description": "By default a summary of authorization_server is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of authorization_server",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.authorization_server.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this authorization_server",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this authorization_server",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates authorization_server is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this authorization_server",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this authorization_server\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this authorization_server\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "authorization_serverReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a authorization_server",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the authorization_server",
                    "title": "spec",
                    "$ref": "#/definitions/authorization_serverReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "authorization_serverReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.ReplaceResponse"
        },
        "authorization_serverReplaceSpecType": {
            "type": "object",
            "description": "Replace authorization_server replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace authorization server",
            "x-displayname": "Replace Authorization Server",
            "x-ves-proto-message": "ves.io.schema.authorization_server.ReplaceSpecType",
            "properties": {
                "jwks_uri": {
                    "type": "string",
                    "description": " x-textBlockContent:\n Automatic fetching of JWKS will happen once daily. You can also do it manually from the list of Authorization Servers at any time.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.uri: true\n",
    ...
    "x-displayname": "Authorization Server",
    "x-ves-proto-file": "ves.io/schema/authorization_server/public_crudapi.proto"
}`
