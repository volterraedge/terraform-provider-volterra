...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/alert_receivers", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
    ...
    "definitions": {
        ...
        "alert_receiverGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/alert_receiverObject",
        ...
        "alert_receiverObject": {
            "type": "object",
            "description": "Alert Receiver Object to configure Alert notifiers",
            "title": "Alert Receiver Object",
            "x-displayname": "Alert Receiver Object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
