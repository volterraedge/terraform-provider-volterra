...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/waf_rule_list"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.waf_rule_list.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.waf_rule_list.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf_rule_list.crudapi")
	}
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.waf_rule_list.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf_rule_list.crudapi")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.waf_rule_list.crudapi")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.waf_rule_list.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.waf_rule_list.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_rule_list.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_rule_list.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_rule_list.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_rule_list.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_rule_list.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_rule_list.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_rule_list.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_rule_list.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/waf_rule_list/crudapi/api.proto",
    ...
    "tags": null,
    "paths": {
        "/ves.io.schema.waf_rule_list/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Get",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_rule_list",
            "x-ves-object-type": "ves.io.schema.waf_rule_list.Object",
            "x-ves-proto-service": "ves.io.schema.waf_rule_list.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.waf_rule_list/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_rule_list",
            "x-ves-object-type": "ves.io.schema.waf_rule_list.Object",
        ...
        "/ves.io.schema.waf_rule_list/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-waf_rule_list-crudapi-API-ListStream"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_rule_list.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_rule_list",
            "x-ves-object-type": "ves.io.schema.waf_rule_list.Object",
        ...
        "/ves.io.schema.waf_rule_list/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_rule_list/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_rule_list/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_rule_list/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.waf_rule_list.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.waf_rule_list.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_rule_list.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
    ...
    "x-displayname": "",
    "x-ves-proto-file": "ves.io/schema/waf_rule_list/crudapi/api.proto"
}`
