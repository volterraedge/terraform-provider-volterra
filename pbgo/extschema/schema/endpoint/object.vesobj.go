...
const (
	ObjectDefTblName = "ves.io.schema.endpoint.Object.default"
	ObjectType       = "ves.io.schema.endpoint.Object"

	StatusObjectDefTblName = "ves.io.schema.endpoint.StatusObject.default"
	StatusObjectType       = "ves.io.schema.endpoint.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.endpoint.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.endpoint.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.endpoint.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (v *ValidateObject) MetadataValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {

	validatorFn := ves_io_schema.ObjectMetaTypeValidator().Validate

	return validatorFn, nil
}

func (v *ValidateObject) SpecValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {

	validatorFn := SpecTypeValidator().Validate
...
var DefaultObjectValidator = func() *ValidateObject {
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for Object.metadata: %s", err)
		panic(errMsg)
	}
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for Object.spec: %s", err)
		panic(errMsg)
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.endpoint.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.endpoint.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "endpoint.Object")
	if err != nil {
