...
type GlobalSpecType struct {
	...
	// Endpoint Type
	//
	// x-displayName: "Endpoint Type"
	// Endpoint Type - internal config to handle TMM pool members
	//
	// Types that are valid to be assigned to EndpointType:
	//	*GlobalSpecType_DefaultEndpoint
	//	*GlobalSpecType_TmmPoolMemberEndpoint
	EndpointType isGlobalSpecType_EndpointType `protobuf_oneof:"endpoint_type"`
}
...
type isGlobalSpecType_EndpointType interface {
	isGlobalSpecType_EndpointType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GlobalSpecType_DefaultEndpoint struct {
	DefaultEndpoint *schema.Empty `protobuf:"bytes,19,opt,name=default_endpoint,json=defaultEndpoint,proto3,oneof" json:"default_endpoint,omitempty"`
}
type GlobalSpecType_TmmPoolMemberEndpoint struct {
	TmmPoolMemberEndpoint *TMMPoolMemberType `protobuf:"bytes,20,opt,name=tmm_pool_member_endpoint,json=tmmPoolMemberEndpoint,proto3,oneof" json:"tmm_pool_member_endpoint,omitempty"`
}
...
func (*GlobalSpecType_DefaultEndpoint) isGlobalSpecType_EndpointType()          {}
func (*GlobalSpecType_TmmPoolMemberEndpoint) isGlobalSpecType_EndpointType()    {}
...
func (m *GlobalSpecType) GetEndpointType() isGlobalSpecType_EndpointType {
	if m != nil {
...
func (m *GlobalSpecType) GetDefaultEndpoint() *schema.Empty {
	if x, ok := m.GetEndpointType().(*GlobalSpecType_DefaultEndpoint); ok {
		return x.DefaultEndpoint
	}
	return nil
}

func (m *GlobalSpecType) GetTmmPoolMemberEndpoint() *TMMPoolMemberType {
	if x, ok := m.GetEndpointType().(*GlobalSpecType_TmmPoolMemberEndpoint); ok {
		return x.TmmPoolMemberEndpoint
	}
	return nil
}
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_DefaultEndpoint)(nil),
		(*GlobalSpecType_TmmPoolMemberEndpoint)(nil),
	}
}
...
type TMMPoolMemberType struct {
	// State
	//
	// x-displayName: "State"
	// Displays the current status of the pool member.
	State *schema.TMMMemberStateType `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	// PoolMemberSelectionType
	//
	// x-displayName: "Pool Member Selection"
	MemberSelection *schema.TMMPoolMemberSelectionType `protobuf:"bytes,2,opt,name=member_selection,json=memberSelection,proto3" json:"member_selection,omitempty"`
}

func (m *TMMPoolMemberType) Reset()      { *m = TMMPoolMemberType{} }
func (*TMMPoolMemberType) ProtoMessage() {}
func (*TMMPoolMemberType) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c4b1d0fcf1d7e4b, []int{3}
}
func (m *TMMPoolMemberType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TMMPoolMemberType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *TMMPoolMemberType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TMMPoolMemberType.Merge(m, src)
}
func (m *TMMPoolMemberType) XXX_Size() int {
	return m.Size()
}
func (m *TMMPoolMemberType) XXX_DiscardUnknown() {
	xxx_messageInfo_TMMPoolMemberType.DiscardUnknown(m)
}

var xxx_messageInfo_TMMPoolMemberType proto.InternalMessageInfo

func (m *TMMPoolMemberType) GetState() *schema.TMMMemberStateType {
	if m != nil {
		return m.State
	}
	return nil
...
func (m *TMMPoolMemberType) GetMemberSelection() *schema.TMMPoolMemberSelectionType {
	if m != nil {
...
func (*VerStatusType) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c4b1d0fcf1d7e4b, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*TMMPoolMemberType)(nil), "ves.io.schema.endpoint.TMMPoolMemberType")
	golang_proto.RegisterType((*TMMPoolMemberType)(nil), "ves.io.schema.endpoint.TMMPoolMemberType")
...
var fileDescriptor_3c4b1d0fcf1d7e4b = []byte{
	...
	,
}
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if that1.EndpointType == nil {
		if this.EndpointType != nil {
			return false
		}
	} else if this.EndpointType == nil {
		return false
	} else if !this.EndpointType.Equal(that1.EndpointType) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_DefaultEndpoint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_DefaultEndpoint)
	if !ok {
		that2, ok := that.(GlobalSpecType_DefaultEndpoint)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultEndpoint.Equal(that1.DefaultEndpoint) {
		return false
	}
	return true
}
func (this *GlobalSpecType_TmmPoolMemberEndpoint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_TmmPoolMemberEndpoint)
	if !ok {
		that2, ok := that.(GlobalSpecType_TmmPoolMemberEndpoint)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.TmmPoolMemberEndpoint.Equal(that1.TmmPoolMemberEndpoint) {
		return false
	}
	return true
}
func (this *TMMPoolMemberType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TMMPoolMemberType)
	if !ok {
		that2, ok := that.(TMMPoolMemberType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType_DefaultEndpoint) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&endpoint.GlobalSpecType_DefaultEndpoint{` +
		`DefaultEndpoint:` + fmt.Sprintf("%#v", this.DefaultEndpoint) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_TmmPoolMemberEndpoint) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&endpoint.GlobalSpecType_TmmPoolMemberEndpoint{` +
		`TmmPoolMemberEndpoint:` + fmt.Sprintf("%#v", this.TmmPoolMemberEndpoint) + `}`}, ", ")
	return s
}
func (this *TMMPoolMemberType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&endpoint.TMMPoolMemberType{")
	if this.State != nil {
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EndpointType != nil {
		{
			size := m.EndpointType.Size()
			i -= size
			if _, err := m.EndpointType.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *GlobalSpecType_DefaultEndpoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_DefaultEndpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultEndpoint != nil {
		{
			size, err := m.DefaultEndpoint.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_TmmPoolMemberEndpoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_TmmPoolMemberEndpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TmmPoolMemberEndpoint != nil {
		{
			size, err := m.TmmPoolMemberEndpoint.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TMMPoolMemberType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TMMPoolMemberType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TMMPoolMemberType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GlobalSpecType_DefaultEndpoint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DefaultEndpoint != nil {
		l = m.DefaultEndpoint.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_TmmPoolMemberEndpoint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.TmmPoolMemberEndpoint != nil {
		l = m.TmmPoolMemberEndpoint.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *TMMPoolMemberType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType_DefaultEndpoint) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_DefaultEndpoint{`,
		`DefaultEndpoint:` + strings.Replace(fmt.Sprintf("%v", this.DefaultEndpoint), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_TmmPoolMemberEndpoint) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_TmmPoolMemberEndpoint{`,
		`TmmPoolMemberEndpoint:` + strings.Replace(fmt.Sprintf("%v", this.TmmPoolMemberEndpoint), "TMMPoolMemberType", "TMMPoolMemberType", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TMMPoolMemberType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TMMPoolMemberType{`,
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			...
			m.EndpointType = &GlobalSpecType_DefaultEndpoint{v}
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TmmPoolMemberEndpoint", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EndpointType = &GlobalSpecType_TmmPoolMemberEndpoint{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *TMMPoolMemberType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TMMPoolMemberType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TMMPoolMemberType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
