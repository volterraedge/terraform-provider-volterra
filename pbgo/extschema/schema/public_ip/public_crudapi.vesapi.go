    ...
    "definitions": {
        ...
        "public_ipGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/public_ipObject",
        ...
        "public_ipGetSpecType": {
            ...
            "properties": {
                ...
                "virtual_sites": {
                    "type": "array",
                    "description": " List of references to virtual_site objects where this pubic IP will be available.",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "public_ipGlobalSpecType": {
            ...
            "properties": {
                ...
                "is_shared": {
                    "type": "boolean",
                    "description": " Is this public ip a shared vip\n\nExample: - \"true\"-",
                    "title": "is_shared",
                    "format": "boolean",
                ...
                "node_selector": {
                    "description": " this expression is used if ver node should own this vip or not\n\nExample: - \"vipSelector in (subset2)\"-",
                    "title": "Label expression to select Node",
                    "$ref": "#/definitions/schemaLabelSelectorType",
                    "x-displayname": "Node Label Expression",
                    "x-ves-example": "vipSelector in (subset2)"
                },
                "virtual_sites": {
                    "type": "array",
                    "description": " List of references to virtual_site objects where this pubic IP will be available.",
        ...
        "public_ipObject": {
            ...
            "title": "Public IP Object",
            "x-displayname": "Public IP",
            "x-ves-proto-message": "ves.io.schema.public_ip.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
