...
type AWSType struct {
	...
	// TGW CIDR
	//
	// x-displayName: "Allocated TGW CIDR"
	// Allocated TGW CIDR by config service
	TgwCidrIpv4 string `protobuf:"bytes,13,opt,name=tgw_cidr_ipv4,json=tgwCidrIpv4,proto3" json:"tgw_cidr_ipv4,omitempty"`
	// Service VPC Info
	//
...
func (m *AWSType) GetTgwCidrIpv4() string {
	if m != nil {
		return m.TgwCidrIpv4
	}
	return ""
}
...
var fileDescriptor_e797e7039fdd1cb5 = []byte{
	...
	,
}
...
func (this *AWSType) Equal(that interface{}) bool {
	...
	if this.TgwCidrIpv4 != that1.TgwCidrIpv4 {
		return false
	}
...
func (this *AWSType) GoString() string {
	...
	s = append(s, "TgwCidrIpv4: "+fmt.Sprintf("%#v", this.TgwCidrIpv4)+",\n")
...
func (m *AWSType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TgwCidrIpv4) > 0 {
		i -= len(m.TgwCidrIpv4)
		copy(dAtA[i:], m.TgwCidrIpv4)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.TgwCidrIpv4)))
		i--
		dAtA[i] = 0x6a
	}
	if m.ServiceVpc != nil {
...
func (this *AWSType) String() string {
	...
	s := strings.Join([]string{`&AWSType{`,
		...
		`TgwCidrIpv4:` + fmt.Sprintf("%v", this.TgwCidrIpv4) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *AWSType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TgwCidrIpv4", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TgwCidrIpv4 = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
