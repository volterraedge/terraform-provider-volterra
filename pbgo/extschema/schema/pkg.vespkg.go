...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.SegementRefType"] = SegementRefTypeValidator()
	...
	vr["ves.io.schema.SiteSegmentRefType"] = SiteSegmentRefTypeValidator()
	...
	vr["ves.io.schema.VSiteSegmentRefType"] = VSiteSegmentRefTypeValidator()
