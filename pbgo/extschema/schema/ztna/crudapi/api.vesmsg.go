...
import (
	...
	ves_io_schema_ztna "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/ztna"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_ztna.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_ztna.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_ztna.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_ztna.DBObject)
	}
	_ = f
