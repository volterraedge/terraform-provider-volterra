...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_virtual_host_dns_info.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_virtual_host_dns_info.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_virtual_host_dns_info.DBObject)
	}
	_ = f
