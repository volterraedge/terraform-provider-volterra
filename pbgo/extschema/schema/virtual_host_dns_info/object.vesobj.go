...
const (
	ObjectDefTblName = "ves.io.schema.virtual_host_dns_info.Object.default"
	ObjectType       = "ves.io.schema.virtual_host_dns_info.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.virtual_host_dns_info.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for _, dri := range fdrInfos {
		...
		dri.DRField = "ves.io.schema.virtual_host_dns_info.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
