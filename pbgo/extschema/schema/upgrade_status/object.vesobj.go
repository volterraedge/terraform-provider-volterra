...
const (
	ObjectDefTblName = "ves.io.schema.upgrade_status.Object.default"
	ObjectType       = "ves.io.schema.upgrade_status.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.upgrade_status.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.upgrade_status.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
