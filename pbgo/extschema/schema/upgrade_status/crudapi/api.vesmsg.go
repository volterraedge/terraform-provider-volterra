...
import (
	...
	ves_io_schema_upgrade_status "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/upgrade_status"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_upgrade_status.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_upgrade_status.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_upgrade_status.DBObject)
	}
	_ = f
