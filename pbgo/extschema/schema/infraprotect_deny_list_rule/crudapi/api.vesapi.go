...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/infraprotect_deny_list_rule"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.infraprotect_deny_list_rule.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.infraprotect_deny_list_rule.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.infraprotect_deny_list_rule.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.infraprotect_deny_list_rule.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.infraprotect_deny_list_rule.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/infraprotect_deny_list_rule/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.infraprotect_deny_list_rule/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_deny_list_rule",
            "x-ves-object-type": "ves.io.schema.infraprotect_deny_list_rule.Object",
            "x-ves-proto-service": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.infraprotect_deny_list_rule/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_deny_list_rule",
            "x-ves-object-type": "ves.io.schema.infraprotect_deny_list_rule.Object",
        ...
        "/ves.io.schema.infraprotect_deny_list_rule/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_deny_list_rule",
            "x-ves-object-type": "ves.io.schema.infraprotect_deny_list_rule.Object",
        ...
        "/ves.io.schema.infraprotect_deny_list_rule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_deny_list_rule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_deny_list_rule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_deny_list_rule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.infraprotect_deny_list_rule.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_deny_list_rulecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_deny_list_rulecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_deny_list_rulecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_deny_list_rulecrudapiErrorCode"
                },
        ...
        "infraprotect_deny_list_rulecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.infraprotect_deny_list_rule.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/infraprotect_deny_list_rule/crudapi/api.proto"
}`
