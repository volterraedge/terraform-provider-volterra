...
const (
	...
	CreateRequestFQN = "ves.io.schema.infraprotect_deny_list_rule.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.infraprotect_deny_list_rule.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.infraprotect_deny_list_rule.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.infraprotect_deny_list_rule.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.infraprotect_deny_list_rule.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.infraprotect_deny_list_rule.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.infraprotect_deny_list_rule.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.infraprotect_deny_list_rule.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.infraprotect_deny_list_rule.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.infraprotect_deny_list_rule.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_deny_list_rules", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_deny_list_rules/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_deny_list_rules/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_deny_list_rules", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_deny_list_rules/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.infraprotect_deny_list_rule.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.infraprotect_deny_list_rule")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_deny_list_rule.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_deny_list_rule.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_deny_list_rule.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_deny_list_rule.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_deny_list_rule.API.Delete", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.infraprotect_deny_list_rule.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.infraprotect_deny_list_rule.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.infraprotect_deny_list_rule.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.infraprotect_deny_list_rule.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_deny_list_rule.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_deny_list_rule.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_deny_list_rule.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.infraprotect_deny_list_rule.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_deny_list_rule.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_deny_list_rule.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_deny_list_rule.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.infraprotect_deny_list_rule.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/infraprotect_deny_list_rules": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/infraprotect_deny_list_rules/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/infraprotect_deny_list_rules": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-api-list"
                },
        ...
        "/public/namespaces/{namespace}/infraprotect_deny_list_rules/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-api-get"
                },
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_deny_list_ruleDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_deny_list_rule-api-delete"
                },
    ...
    "definitions": {
        "infraprotect_deny_list_ruleCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Deny List Rule",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "infraprotect_deny_list_ruleCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Deny List Rule",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "infraprotect_deny_list_ruleCreateSpecType": {
            ...
            "properties": {
                "expiration_never": {
                    "description": "Exclusive with [expiration_timestamp one_day one_hour one_month one_year]\n This deny list rule will never expire",
                ...
                "one_day": {
                    "description": "Exclusive with [expiration_never expiration_timestamp one_hour one_month one_year]\n This deny list rule will expire in one day",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "One Day"
                },
                "one_hour": {
                    "description": "Exclusive with [expiration_never expiration_timestamp one_day one_month one_year]\n This deny list rule will expire in one hour",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "One Hour"
                },
                "one_month": {
                    "description": "Exclusive with [expiration_never expiration_timestamp one_day one_hour one_year]\n This deny list rule will expire in one month",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "One Month"
                },
                "one_year": {
                    "description": "Exclusive with [expiration_never expiration_timestamp one_day one_hour one_month]\n This deny list rule will expire in one year",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "One Year"
                },
                "prefix": {
                    "type": "string",
                    "description": " Prefix\n\nExample: - \"12.13.14.0/24 or 12.13.14.15/32\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.ip_prefix_globally_routable: true\n",
                    "x-displayname": "Prefix",
                    "x-ves-example": "12.13.14.0/24 or 12.13.14.15/32",
                    "x-ves-required": "true",
        ...
        "infraprotect_deny_list_ruleGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleObject",
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/infraprotect_deny_list_ruleStatusObject"
                    },
        ...
        "infraprotect_deny_list_ruleGetResponseFormatCode": {
            "type": "string",
        ...
        "infraprotect_deny_list_ruleGetSpecType": {
            ...
            "properties": {
                "expiration_never": {
                    "description": "Exclusive with [expiration_timestamp]\n This deny list rule will never expire",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Never"
                },
                "expiration_timestamp": {
        ...
        "infraprotect_deny_list_ruleGlobalSpecType": {
            "type": "object",
            "description": "DDos Transit Deny List Rule spec",
            "title": "GlobalSpecType",
            "x-displayname": "DDos Transit Deny List Rule",
            "x-ves-oneof-field-expiration": "[\"expiration_never\",\"expiration_timestamp\",\"one_day\",\"one_hour\",\"one_month\",\"one_year\"]",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.GlobalSpecType",
            "properties": {
                "expiration_never": {
                    "description": "Exclusive with [expiration_timestamp one_day one_hour one_month one_year]\n This deny list rule will never expire",
        ...
        "infraprotect_deny_list_ruleListResponse": {
            ...
            "properties": {
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/infraprotect_deny_list_ruleListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "infraprotect_deny_list_ruleObject": {
            "type": "object",
            "description": "Deny List Rule Object",
            "title": "Deny List Rule Object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Deny List Rule",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
                    "description": " System generated object's metadata",
        ...
        "infraprotect_deny_list_ruleReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Deny List Rule",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        ...
        "infraprotect_deny_list_ruleSpecType": {
            "type": "object",
            "description": "Infraprotect Deny List Rule Object",
            "title": "Infraprotect Deny List Rule Specification",
            "x-displayname": "Deny List Rule Specification",
            "x-ves-proto-message": "ves.io.schema.infraprotect_deny_list_rule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/infraprotect_deny_list_ruleGlobalSpecType",
    ...
    "x-displayname": "Infraprotect Deny List Rule",
    "x-ves-proto-file": "ves.io/schema/infraprotect_deny_list_rule/public_crudapi.proto"
}`
