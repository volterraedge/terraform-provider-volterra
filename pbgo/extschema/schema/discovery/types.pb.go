...
func (*ConsulHttpBasicAuthInfoType) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{6} }
...
func (*ConsulVipDiscoveryInfoType) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{12} }
...
func NewPopulatedVerStatusType(r randyTypes, easy bool) *VerStatusType {
	...
	this.Type = ves_io_schema4.DiscoveryType([]int32{0, 1, 2}[r.Intn(3)])
	if r.Intn(10) != 0 {
		v1 := r.Intn(5)
		this.Services = make([]*DiscoveredServiceType, v1)
		for i := 0; i < v1; i++ {
			this.Services[i] = NewPopulatedDiscoveredServiceType(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedPodInfoType(r randyTypes, easy bool) *PodInfoType {
	this := &PodInfoType{}
	this.PodName = string(randStringTypes(r))
...
func NewPopulatedDiscoveredServiceType(r randyTypes, easy bool) *DiscoveredServiceType {
	this := &DiscoveredServiceType{}
	this.ServiceName = string(randStringTypes(r))
	this.Namespace = string(randStringTypes(r))
	this.ServiceType = string(randStringTypes(r))
	...
	if r.Intn(10) != 0 {
		v3 := r.Intn(5)
		this.Pods = make([]*PodInfoType, v3)
		for i := 0; i < v3; i++ {
			this.Pods[i] = NewPopulatedPodInfoType(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v4 := r.Intn(10)
		this.PortMap = make(map[uint32]uint32)
		for i := 0; i < v4; i++ {
			v5 := uint32(r.Uint32())
			this.PortMap[v5] = uint32(r.Uint32())
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedTLSClientConfigType(r randyTypes, easy bool) *TLSClientConfigType {
	this := &TLSClientConfigType{}
	this.ServerName = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.CertificateUrl = ves_io_schema4.NewPopulatedSecretType(r, easy)
	}
	if r.Intn(10) != 0 {
		this.KeyUrl = ves_io_schema4.NewPopulatedSecretType(r, easy)
	}
	if r.Intn(10) != 0 {
		this.CaCertificateUrl = ves_io_schema4.NewPopulatedSecretType(r, easy)
	}
	this.Certificate = string(randStringTypes(r))
...
func NewPopulatedRestConfigType(r randyTypes, easy bool) *RestConfigType {
	this := &RestConfigType{}
	this.ApiServer = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.TlsInfo = NewPopulatedTLSClientConfigType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedK8SAccessInfo(r randyTypes, easy bool) *K8SAccessInfo {
	this := &K8SAccessInfo{}
	oneofNumber_ConfigType := []int32{1, 2, 3}[r.Intn(3)]
	switch oneofNumber_ConfigType {
	case 1:
		this.ConfigType = NewPopulatedK8SAccessInfo_KubeconfigUrl(r, easy)
	case 2:
		this.ConfigType = NewPopulatedK8SAccessInfo_ConnectionInfo(r, easy)
	case 3:
		this.ConfigType = NewPopulatedK8SAccessInfo_InCluster(r, easy)
	}
	oneofNumber_K8SPodNetworkChoice := []int32{4, 5}[r.Intn(2)]
	switch oneofNumber_K8SPodNetworkChoice {
	case 4:
		this.K8SPodNetworkChoice = NewPopulatedK8SAccessInfo_Isolated(r, easy)
	case 5:
		this.K8SPodNetworkChoice = NewPopulatedK8SAccessInfo_Reachable(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedK8SAccessInfo_KubeconfigUrl(r randyTypes, easy bool) *K8SAccessInfo_KubeconfigUrl {
	this := &K8SAccessInfo_KubeconfigUrl{}
	this.KubeconfigUrl = ves_io_schema4.NewPopulatedSecretType(r, easy)
	return this
}
func NewPopulatedK8SAccessInfo_ConnectionInfo(r randyTypes, easy bool) *K8SAccessInfo_ConnectionInfo {
	this := &K8SAccessInfo_ConnectionInfo{}
	this.ConnectionInfo = NewPopulatedRestConfigType(r, easy)
	return this
}
func NewPopulatedK8SAccessInfo_InCluster(r randyTypes, easy bool) *K8SAccessInfo_InCluster {
	this := &K8SAccessInfo_InCluster{}
	this.InCluster = bool(bool(r.Intn(2) == 0))
	return this
}
func NewPopulatedK8SAccessInfo_Isolated(r randyTypes, easy bool) *K8SAccessInfo_Isolated {
	this := &K8SAccessInfo_Isolated{}
	this.Isolated = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedK8SAccessInfo_Reachable(r randyTypes, easy bool) *K8SAccessInfo_Reachable {
	this := &K8SAccessInfo_Reachable{}
	this.Reachable = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedConsulHttpBasicAuthInfoType(r randyTypes, easy bool) *ConsulHttpBasicAuthInfoType {
	this := &ConsulHttpBasicAuthInfoType{}
	this.UserName = string(randStringTypes(r))
	if r.Intn(10) != 0 {
		this.PasswdUrl = ves_io_schema4.NewPopulatedSecretType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedConsulAccessInfo(r randyTypes, easy bool) *ConsulAccessInfo {
	this := &ConsulAccessInfo{}
	if r.Intn(10) != 0 {
		this.ConnectionInfo = NewPopulatedRestConfigType(r, easy)
	}
	this.Scheme = SchemeType([]int32{0, 1}[r.Intn(2)])
	if r.Intn(10) != 0 {
		this.HttpBasicAuthInfo = NewPopulatedConsulHttpBasicAuthInfoType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedVipDiscoveryInfoType(r randyTypes, easy bool) *VipDiscoveryInfoType {
	this := &VipDiscoveryInfoType{}
	this.PublishVirtualIp = bool(bool(r.Intn(2) == 0))
	this.Type = VirtualIPDiscoveryType([]int32{0, 1}[r.Intn(2)])
	this.Subdomain = string(randStringTypes(r))
	this.DnsMode = K8SDNSMode([]int32{0, 1}[r.Intn(2)])
	this.Namespace = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedK8SPublishType(r randyTypes, easy bool) *K8SPublishType {
	this := &K8SPublishType{}
	this.Namespace = string(randStringTypes(r))
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedK8SDelegationType(r randyTypes, easy bool) *K8SDelegationType {
	this := &K8SDelegationType{}
	this.Subdomain = string(randStringTypes(r))
	this.DnsMode = K8SDNSMode([]int32{0, 1}[r.Intn(2)])
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedK8SVipDiscoveryInfoType(r randyTypes, easy bool) *K8SVipDiscoveryInfoType {
	this := &K8SVipDiscoveryInfoType{}
	oneofNumber_PublishChoice := []int32{2, 3, 4, 5}[r.Intn(4)]
	switch oneofNumber_PublishChoice {
	case 2:
		this.PublishChoice = NewPopulatedK8SVipDiscoveryInfoType_Disable(r, easy)
	case 3:
		this.PublishChoice = NewPopulatedK8SVipDiscoveryInfoType_Publish(r, easy)
	case 4:
		this.PublishChoice = NewPopulatedK8SVipDiscoveryInfoType_PublishFqdns(r, easy)
	case 5:
		this.PublishChoice = NewPopulatedK8SVipDiscoveryInfoType_DnsDelegation(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedK8SVipDiscoveryInfoType_Disable(r randyTypes, easy bool) *K8SVipDiscoveryInfoType_Disable {
	this := &K8SVipDiscoveryInfoType_Disable{}
	this.Disable = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedK8SVipDiscoveryInfoType_Publish(r randyTypes, easy bool) *K8SVipDiscoveryInfoType_Publish {
	this := &K8SVipDiscoveryInfoType_Publish{}
	this.Publish = NewPopulatedK8SPublishType(r, easy)
	return this
}
func NewPopulatedK8SVipDiscoveryInfoType_PublishFqdns(r randyTypes, easy bool) *K8SVipDiscoveryInfoType_PublishFqdns {
	this := &K8SVipDiscoveryInfoType_PublishFqdns{}
	this.PublishFqdns = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedK8SVipDiscoveryInfoType_DnsDelegation(r randyTypes, easy bool) *K8SVipDiscoveryInfoType_DnsDelegation {
	this := &K8SVipDiscoveryInfoType_DnsDelegation{}
	this.DnsDelegation = NewPopulatedK8SDelegationType(r, easy)
	return this
}
func NewPopulatedConsulVipDiscoveryInfoType(r randyTypes, easy bool) *ConsulVipDiscoveryInfoType {
	this := &ConsulVipDiscoveryInfoType{}
	oneofNumber_PublishChoice := []int32{2, 3}[r.Intn(2)]
	switch oneofNumber_PublishChoice {
	case 2:
		this.PublishChoice = NewPopulatedConsulVipDiscoveryInfoType_Disable(r, easy)
	case 3:
		this.PublishChoice = NewPopulatedConsulVipDiscoveryInfoType_Publish(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedConsulVipDiscoveryInfoType_Disable(r randyTypes, easy bool) *ConsulVipDiscoveryInfoType_Disable {
	this := &ConsulVipDiscoveryInfoType_Disable{}
	this.Disable = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedConsulVipDiscoveryInfoType_Publish(r randyTypes, easy bool) *ConsulVipDiscoveryInfoType_Publish {
	this := &ConsulVipDiscoveryInfoType_Publish{}
	this.Publish = ves_io_schema4.NewPopulatedEmpty(r, easy)
	return this
}
func NewPopulatedK8SDiscoveryType(r randyTypes, easy bool) *K8SDiscoveryType {
	this := &K8SDiscoveryType{}
	if r.Intn(10) != 0 {
		this.AccessInfo = NewPopulatedK8SAccessInfo(r, easy)
	}
	if r.Intn(10) != 0 {
		this.PublishInfo = NewPopulatedK8SVipDiscoveryInfoType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedConsulDiscoveryType(r randyTypes, easy bool) *ConsulDiscoveryType {
	this := &ConsulDiscoveryType{}
	if r.Intn(10) != 0 {
		this.AccessInfo = NewPopulatedConsulAccessInfo(r, easy)
	}
	if r.Intn(10) != 0 {
		this.PublishInfo = NewPopulatedConsulVipDiscoveryInfoType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGlobalSpecType(r randyTypes, easy bool) *GlobalSpecType {
	...
	this.Type = ves_io_schema4.DiscoveryType([]int32{0, 1, 2}[r.Intn(3)])
	if r.Intn(10) != 0 {
		this.PublishVip = NewPopulatedVipDiscoveryInfoType(r, easy)
	}
	oneofNumber_AccessInfo := []int32{4, 5}[r.Intn(2)]
	switch oneofNumber_AccessInfo {
	case 4:
		this.AccessInfo = NewPopulatedGlobalSpecType_K8S(r, easy)
	case 5:
		this.AccessInfo = NewPopulatedGlobalSpecType_Consul(r, easy)
	}
	oneofNumber_DiscoveryChoice := []int32{8, 9}[r.Intn(2)]
	switch oneofNumber_DiscoveryChoice {
	case 8:
		this.DiscoveryChoice = NewPopulatedGlobalSpecType_DiscoveryK8S(r, easy)
	case 9:
		this.DiscoveryChoice = NewPopulatedGlobalSpecType_DiscoveryConsul(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGlobalSpecType_K8S(r randyTypes, easy bool) *GlobalSpecType_K8S {
	this := &GlobalSpecType_K8S{}
	this.K8S = NewPopulatedK8SAccessInfo(r, easy)
	return this
}
func NewPopulatedGlobalSpecType_Consul(r randyTypes, easy bool) *GlobalSpecType_Consul {
	this := &GlobalSpecType_Consul{}
	this.Consul = NewPopulatedConsulAccessInfo(r, easy)
	return this
}
func NewPopulatedGlobalSpecType_DiscoveryK8S(r randyTypes, easy bool) *GlobalSpecType_DiscoveryK8S {
	this := &GlobalSpecType_DiscoveryK8S{}
	this.DiscoveryK8S = NewPopulatedK8SDiscoveryType(r, easy)
	return this
}
func NewPopulatedGlobalSpecType_DiscoveryConsul(r randyTypes, easy bool) *GlobalSpecType_DiscoveryConsul {
	this := &GlobalSpecType_DiscoveryConsul{}
	this.DiscoveryConsul = NewPopulatedConsulDiscoveryType(r, easy)
	return this
}
func NewPopulatedCreateSpecType(r randyTypes, easy bool) *CreateSpecType {
	...
	switch oneofNumber_DiscoveryChoice {
	case 8:
		this.DiscoveryChoice = NewPopulatedCreateSpecType_DiscoveryK8S(r, easy)
	case 9:
		this.DiscoveryChoice = NewPopulatedCreateSpecType_DiscoveryConsul(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedCreateSpecType_DiscoveryK8S(r randyTypes, easy bool) *CreateSpecType_DiscoveryK8S {
	this := &CreateSpecType_DiscoveryK8S{}
	this.DiscoveryK8S = NewPopulatedK8SDiscoveryType(r, easy)
	return this
}
func NewPopulatedCreateSpecType_DiscoveryConsul(r randyTypes, easy bool) *CreateSpecType_DiscoveryConsul {
	this := &CreateSpecType_DiscoveryConsul{}
	this.DiscoveryConsul = NewPopulatedConsulDiscoveryType(r, easy)
	return this
}
func NewPopulatedReplaceSpecType(r randyTypes, easy bool) *ReplaceSpecType {
	...
	switch oneofNumber_DiscoveryChoice {
	case 8:
		this.DiscoveryChoice = NewPopulatedReplaceSpecType_DiscoveryK8S(r, easy)
	case 9:
		this.DiscoveryChoice = NewPopulatedReplaceSpecType_DiscoveryConsul(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedReplaceSpecType_DiscoveryK8S(r randyTypes, easy bool) *ReplaceSpecType_DiscoveryK8S {
	this := &ReplaceSpecType_DiscoveryK8S{}
	this.DiscoveryK8S = NewPopulatedK8SDiscoveryType(r, easy)
	return this
}
func NewPopulatedReplaceSpecType_DiscoveryConsul(r randyTypes, easy bool) *ReplaceSpecType_DiscoveryConsul {
	this := &ReplaceSpecType_DiscoveryConsul{}
	this.DiscoveryConsul = NewPopulatedConsulDiscoveryType(r, easy)
	return this
}
func NewPopulatedGetSpecType(r randyTypes, easy bool) *GetSpecType {
	...
	switch oneofNumber_DiscoveryChoice {
	case 8:
		this.DiscoveryChoice = NewPopulatedGetSpecType_DiscoveryK8S(r, easy)
	case 9:
		this.DiscoveryChoice = NewPopulatedGetSpecType_DiscoveryConsul(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGetSpecType_DiscoveryK8S(r randyTypes, easy bool) *GetSpecType_DiscoveryK8S {
	this := &GetSpecType_DiscoveryK8S{}
	this.DiscoveryK8S = NewPopulatedK8SDiscoveryType(r, easy)
	return this
}
func NewPopulatedGetSpecType_DiscoveryConsul(r randyTypes, easy bool) *GetSpecType_DiscoveryConsul {
	this := &GetSpecType_DiscoveryConsul{}
	this.DiscoveryConsul = NewPopulatedConsulDiscoveryType(r, easy)
	return this
}
...
var fileDescriptorTypes = []byte{
	...
	,
}
