...
// Status indicates status of a tenant, like active, to be deleted, disabled and so on
type TenantStatus int32

const (
	// x-displayName: "Active"
	// tenant is active
	TENANT_STATUS_ACTIVE TenantStatus = 0
	// x-displayName: "Disabled"
	// tenant is disabled
	TENANT_STATUS_DISABLED TenantStatus = 1
	// x-displayName: "To be deleted"
	// tenant is about to be deleted
	TENANT_STATUS_TO_BE_DELETED TenantStatus = 2
	// x-displayName: "Inactive"
	// any other status then active
	TENANT_STATUS_INACTIVE TenantStatus = 3
)

var TenantStatus_name = map[int32]string{
	0: "TENANT_STATUS_ACTIVE",
	1: "TENANT_STATUS_DISABLED",
	2: "TENANT_STATUS_TO_BE_DELETED",
	3: "TENANT_STATUS_INACTIVE",
}

var TenantStatus_value = map[string]int32{
	"TENANT_STATUS_ACTIVE":        0,
	"TENANT_STATUS_DISABLED":      1,
	"TENANT_STATUS_TO_BE_DELETED": 2,
...
type AccessInfo struct {
	...
	// Status indicates status of a tenant, like active, to be deleted, disabled and so on
	TenantStatus TenantStatus `protobuf:"varint,4,opt,name=tenant_status,json=tenantStatus,proto3,enum=ves.io.schema.tenant_management.managed_tenant.TenantStatus" json:"tenant_status,omitempty"`
}
...
func (m *AccessInfo) GetTenantStatus() TenantStatus {
	if m != nil {
...
func init() {
	proto.RegisterEnum("ves.io.schema.tenant_management.managed_tenant.TenantStatus", TenantStatus_name, TenantStatus_value)
	golang_proto.RegisterEnum("ves.io.schema.tenant_management.managed_tenant.TenantStatus", TenantStatus_name, TenantStatus_value)
...
var fileDescriptor_e85f277aa02575c0 = []byte{
	...
	,
}

func (x TenantStatus) String() string {
	s, ok := TenantStatus_name[int32(x)]
	if ok {
		return s
	}
...
func (m *AccessInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TenantStatus != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.TenantStatus))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Groups) > 0 {
...
func (m *AccessInfo) Size() (n int) {
	...
	if m.TenantStatus != 0 {
		n += 1 + sovTypes(uint64(m.TenantStatus))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TenantStatus |= TenantStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
