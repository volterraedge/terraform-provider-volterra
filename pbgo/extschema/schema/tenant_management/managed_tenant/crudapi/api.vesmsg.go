...
import (
	...
	ves_io_schema_tenant_management_managed_tenant "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/tenant_management/managed_tenant"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_tenant_management_managed_tenant.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_tenant_management_managed_tenant.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_tenant_management_managed_tenant.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_tenant_management_managed_tenant.DBObject)
	}
	_ = f
