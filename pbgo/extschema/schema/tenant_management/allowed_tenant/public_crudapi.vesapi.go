...
const (
	...
	CreateRequestFQN = "ves.io.schema.tenant_management.allowed_tenant.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.tenant_management.allowed_tenant.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.tenant_management.allowed_tenant.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.tenant_management.allowed_tenant.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.tenant_management.allowed_tenant.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.tenant_management.allowed_tenant.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.tenant_management.allowed_tenant.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.tenant_management.allowed_tenant.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.tenant_management.allowed_tenant.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.tenant_management.allowed_tenant.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.tenant_management.allowed_tenant.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.tenant_management.allowed_tenant.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.tenant_management.allowed_tenant.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.tenant_management.allowed_tenant.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.tenant_management.allowed_tenant.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.tenant_management.allowed_tenant.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.tenant_management.allowed_tenant.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.tenant_management.allowed_tenant.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.tenant_management.allowed_tenant.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.tenant_management.allowed_tenant.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.tenant_management.allowed_tenant.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.tenant_management.allowed_tenant.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/allowed_tenants": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.API.Create"
            },
            "x-displayname": "Allowed Tenant",
            "x-ves-proto-service": "ves.io.schema.tenant_management.allowed_tenant.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/allowed_tenants/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/allowed_tenants": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-api-list"
                },
        ...
        "/public/namespaces/{namespace}/allowed_tenants/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-api-get"
                },
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/allowed_tenantDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-api-delete"
                },
    ...
    "definitions": {
        "allowed_tenantAllowedAccessConfig": {
            ...
            "properties": {
                "disable": {
                    "type": "boolean",
                    "description": "x-displayName: \"Pause Access\"\nTemporarily revoke access to this tenant.",
                    "title": "Disable",
                    "format": "boolean"
                },
                "read_only": {
                    "description": "x-displayName: \"Read Only All\"\nAllow read operations in all namespaces in this tenant.",
                    "title": "read_only",
                    "$ref": "#/definitions/ioschemaEmpty"
                },
                "read_write_all": {
                    "description": "x-displayName: \"Read Write All\"\nAllow read and write operations in all namespaces in this tenant.",
                    "title": "read_write_all",
                    "$ref": "#/definitions/ioschemaEmpty"
                },
                "read_write_ns": {
                    "description": "x-displayName: \"Read Write Specific Namespaces\"\nAllow read and write operations only in specified namespaces in this tenant",
                    "title": "read_write_ns",
                    "$ref": "#/definitions/allowed_tenantNsReadWriteAccess"
                }
            }
        },
        "allowed_tenantCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of allowed_tenant",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the allowed_tenant",
                    "title": "spec",
                    "$ref": "#/definitions/allowed_tenantCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "allowed_tenantCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the allowed_tenant",
                    "title": "spec",
                    "$ref": "#/definitions/allowed_tenantGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "allowed_tenantDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a allowed_tenant",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "allowed_tenantGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read allowed_tenant",
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/allowed_tenantObject",
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/allowed_tenantStatusObject"
                    },
        ...
        "allowed_tenantGetResponseFormatCode": {
            "type": "string",
        ...
        "allowed_tenantGlobalSpecType": {
            "type": "object",
            "description": "Shape of allowed_tenant in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-oneof-field-internal_config": "[]",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.GlobalSpecType",
            "properties": {
                "allowed_groups": {
                    "type": "array",
                    "description": " List of references to allowed user_group objects for access in to tenant.\n Admin can use this to control API access by users from from original tenant into an allowed tenant.\n User access from original tenant into an allowed tenant will be associated to underlying roles in this user_group.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "allowed_groups",
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/schemaviewsObjectRefType"
                    },
        ...
        "allowed_tenantListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of allowed_tenant",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/allowed_tenantListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "allowed_tenantListResponseItem": {
            "type": "object",
            "description": "By default a summary of allowed_tenant is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of allowed_tenant",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this allowed_tenant",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this allowed_tenant",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates allowed_tenant is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this allowed_tenant",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this allowed_tenant\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this allowed_tenant\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "allowed_tenantNsReadWriteAccess": {
            "type": "object",
            "description": "x-displayName: \"Namespaces Read Write Access\"\nshape of read write access control for namespaces",
        ...
        "allowed_tenantObject": {
            "type": "object",
            "description": "Allowed Tenant object",
            "title": "Allowed Tenant Object",
            "x-displayname": "Allowed Tenant",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the allowed_tenant",
                    "title": "spec",
                    "$ref": "#/definitions/allowed_tenantSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
                    "description": " System generated object's metadata",
        ...
        "allowed_tenantReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a allowed_tenant",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the allowed_tenant",
                    "title": "spec",
                    "$ref": "#/definitions/allowed_tenantReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "allowed_tenantReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.ReplaceResponse"
        },
        "allowed_tenantReplaceSpecType": {
            "type": "object",
            "description": "Replaces attributes of a allowed_tenant instance including its metadata like labels, description etc.",
            "title": "Replace Allowed Tenant",
            "x-displayname": "Replace Allowed Tenant",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.ReplaceSpecType",
            "properties": {
                "allowed_groups": {
                    "type": "array",
                    "description": " List of references to allowed user_group objects for access in to tenant.\n Admin can use this to control API access by users from from original tenant into an allowed tenant.\n User access from original tenant into an allowed tenant will be associated to underlying roles in this user_group.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "allowed_tenantSpecType": {
            "type": "object",
            "description": "Shape of the allowed_tenant specification",
            "title": "Specification for Allowed Tenant",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/allowed_tenantGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "allowed_tenantStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Allowed Tenant",
            "x-displayname": "Allowed Tenant",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "Allowed Tenant",
    "x-ves-proto-file": "ves.io/schema/tenant_management/allowed_tenant/public_crudapi.proto"
}`
