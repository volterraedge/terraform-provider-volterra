...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/allowed_tenants", c.baseURL, req.Metadata.GetNamespace())
    ...
    "definitions": {
        ...
        "allowed_tenantGlobalSpecType": {
            ...
            "properties": {
                ...
                "support_tenant": {
                    "description": "x-displayName: \"Support Tenant access config\"\nsupport related tenant access configuration.",
                    "title": "support_tenant",
        ...
        "allowed_tenantListResponseItem": {
            ...
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": "x-displayName: \"Annotations\"\nThe set of annotations present on this allowed_tenant",
                    "title": "annotations"
                },
                "description": {
                    "type": "string",
                    "description": "x-displayName: \"Description\"\nThe description set for this allowed_tenant",
                    "title": "description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": "x-displayName: \"Disabled\"\nA value of true indicates allowed_tenant is administratively disabled",
                    "title": "disabled",
                    "format": "boolean"
                },
                "get_spec": {
                ...
                "labels": {
                    "type": "object",
                    "description": "x-displayName: \"Labels\"\nThe set of labels present on this allowed_tenant",
                    "title": "labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": "x-displayName: \"Name\"\nx-example: \"name\"\nThe name of this allowed_tenant",
                    "title": "name"
                },
                "namespace": {
                    "type": "string",
        ...
        "allowed_tenantObject": {
            "type": "object",
            "description": "x-displayName: \"Allowed Tenant\"\nAllowed Tenant object",
            "title": "Allowed Tenant Object",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": "x-displayName: \"Spec\"\nSpecification of the desired behavior of the allowed_tenant",
                    "title": "spec",
        ...
        "allowed_tenantSpecType": {
            "type": "object",
            "description": "x-displayName: \"Specification\"\nShape of the allowed_tenant specification",
