...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/tenant_management/allowed_tenant"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.tenant_management.allowed_tenant.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.tenant_management.allowed_tenant.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant.crudapi")
	}
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.tenant_management.allowed_tenant.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant.crudapi")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.tenant_management.allowed_tenant.crudapi")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.tenant_management.allowed_tenant.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.tenant_management.allowed_tenant.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/tenant_management/allowed_tenant/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.tenant_management.allowed_tenant/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "allowed_tenant",
            "x-ves-object-type": "ves.io.schema.tenant_management.allowed_tenant.Object",
            "x-ves-proto-service": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.tenant_management.allowed_tenant/Objects": {
            "get": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "allowed_tenant",
            "x-ves-object-type": "ves.io.schema.tenant_management.allowed_tenant.Object",
        ...
        "/ves.io.schema.tenant_management.allowed_tenant/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-tenant_management-allowed_tenant-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "allowed_tenant",
            "x-ves-object-type": "ves.io.schema.tenant_management.allowed_tenant.Object",
        ...
        "/ves.io.schema.tenant_management.allowed_tenant/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant_management.allowed_tenant/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant_management.allowed_tenant/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant_management.allowed_tenant/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.tenant_management.allowed_tenant.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant_management.allowed_tenant.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/tenant_management/allowed_tenant/crudapi/api.proto"
}`
