...
import (
	...
	ves_io_schema_protocol_inspection "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/protocol_inspection"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_protocol_inspection.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_protocol_inspection.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_protocol_inspection.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_protocol_inspection.DBObject)
	}
	_ = f
