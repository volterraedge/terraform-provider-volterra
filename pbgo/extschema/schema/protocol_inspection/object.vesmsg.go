...
func (m *ProtocolInspectionStatus) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *ProtocolInspectionStatus) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *ProtocolInspectionStatus) DeepCopy() *ProtocolInspectionStatus {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *ProtocolInspectionStatus) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *ProtocolInspectionStatus) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return ProtocolInspectionStatusValidator().Validate(ctx, m, opts...)
}

type ValidateProtocolInspectionStatus struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateProtocolInspectionStatus) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*ProtocolInspectionStatus)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *ProtocolInspectionStatus got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultProtocolInspectionStatusValidator = func() *ValidateProtocolInspectionStatus {
	v := &ValidateProtocolInspectionStatus{FldValidators: map[string]db.ValidatorFunc{}}

	return v
}()

func ProtocolInspectionStatusValidator() db.Validator {
	return DefaultProtocolInspectionStatusValidator
}
