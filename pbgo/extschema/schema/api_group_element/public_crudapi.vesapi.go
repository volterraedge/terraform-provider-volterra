...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/api_group_elements/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/api_group_elements", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_group_element.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.api_group_element")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.api_group_element.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.api_group_element.API.List", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_group_element.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_group_element.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.api_group_element.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.api_group_element.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "api group element object",
    ...
    "paths": {
        "/public/namespaces/{namespace}/api_group_elements": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api_group_elementListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.api_group_element.API",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/api_group_elementGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        "api_group_elementGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read api_group_element",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.api_group_element.GetResponse",
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/api_group_elementObject",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the api_group_element",
                    "title": "spec",
                    "$ref": "#/definitions/api_group_elementGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "api_group_elementGetResponseFormatCode": {
            "type": "string",
        ...
        "api_group_elementGetSpecType": {
            "type": "object",
            "description": "Get api_group_element reads a given object from storage backend for metadata.namespace.",
            "title": "Get api group element",
            "x-displayname": "Get API Group Element",
            "x-ves-proto-message": "ves.io.schema.api_group_element.GetSpecType",
            "properties": {
                "methods": {
                    "type": "array",
        ...
        "api_group_elementListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of api_group_element",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.api_group_element.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/api_group_elementListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "api_group_elementListResponseItem": {
            "type": "object",
            "description": "By default a summary of api_group_element is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of api_group_element",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.api_group_element.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this api_group_element",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this api_group_element",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates api_group_element is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this api_group_element",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this api_group_element\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this api_group_element\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "api_group_elementObject": {
            "type": "object",
            "title": "API Group Element object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
    ...
    "x-displayname": "API Group Element",
    "x-ves-proto-file": "ves.io/schema/api_group_element/public_crudapi.proto"
}`
