...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/service_policy_sets", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/service_policy_sets/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/service_policy_sets/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/service_policy_sets", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/service_policy_sets/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.service_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.service_policy_set")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.service_policy_set.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.service_policy_set")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.service_policy_set")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.service_policy_set.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.service_policy_set.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_policy_set.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_policy_set.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.service_policy_set.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.service_policy_set.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.service_policy_set.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_policy_set.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_policy_set.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.service_policy_set.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.service_policy_set.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_policy_set.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.service_policy_set.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_policy_set.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.service_policy_set.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.service_policy_set.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.service_policy_set.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.service_policy_set.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "service policy set object",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{metadata.namespace}/service_policy_sets": {
            "post": {
                "summary": "Create service policy",
                "description": "Create service_policy_set creates a new object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.service_policy_set.API.Create",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/service_policy_setCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service_policy_setCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-service_policy_set-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_policy_set.API.Create"
            },
        ...
        "/public/namespaces/{metadata.namespace}/service_policy_sets/{metadata.name}": {
            "put": {
                "summary": "Replace service policy",
                "description": "Replace service_policy_set replaces an existing object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.service_policy_set.API.Replace",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/service_policy_setReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service_policy_setReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-service_policy_set-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_policy_set.API.Replace"
            },
            "x-displayname": "Service Policy Set",
            "x-ves-proto-service": "ves.io.schema.service_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/service_policy_sets": {
            "get": {
                "summary": "List",
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/service_policy_setListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-service_policy_set-API-List"
                },
        ...
        "/public/namespaces/{namespace}/service_policy_sets/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/service_policy_setGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-service_policy_set-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_policy_set.API.Get"
            },
            "delete": {
                "summary": "Delete",
                "description": "Delete the specified service_policy_set",
                "operationId": "ves.io.schema.service_policy_set.API.Delete",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service_policy_setDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-service_policy_set-API-Delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.service_policy_set.API.Delete"
            },
            "x-displayname": "Service Policy Set",
            "x-ves-proto-service": "ves.io.schema.service_policy_set.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "policyPolicySetType": {
            ...
            "x-ves-proto-enum": "ves.io.schema.policy.PolicySetType"
        },
        "policyRuleAction": {
            "type": "string",
        ...
        "schemaservice_policy_setCreateSpecType": {
            "type": "object",
            "description": "Create service_policy_set creates a new object in the storage backend for metadata.namespace.",
            "title": "Create service policy",
            "x-displayname": "Create Service Policy Set",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.CreateSpecType",
            "properties": {
                "default_action": {
                    "description": " Default action for the service_policy_set. This is used when the request does not match any policy in the policy set.\n It is marked hidden since it defaults to DENY for user-configured policy sets. It will be set to NEXT_POLICY_SET only for system generated rate limiting\n policy sets for the time being.",
                    "$ref": "#/definitions/policyRuleAction",
                    "x-displayname": "Default Action"
                },
                "deny_info": {
                    "description": " Detailed information including HTTP response code and error message to be sent when the policy set default action is used and that action is DENY.",
        ...
        "schemaservice_policy_setReplaceSpecType": {
            "type": "object",
            "description": "Replace service_policy_set replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace service policy",
            "x-displayname": "Replace Service Policy Set",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.ReplaceSpecType",
            "properties": {
                "default_action": {
                    "description": " Default action for the service_policy_set. This is used when the request does not match any policy in the policy set.\n It is marked hidden since it defaults to DENY for user-configured policy sets. It will be set to NEXT_POLICY_SET only for system generated rate limiting\n policy sets for the time being.",
                    "$ref": "#/definitions/policyRuleAction",
        ...
        "service_policy_setCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of service_policy_set",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the service_policy_set ",
                    "title": "spec",
                    "$ref": "#/definitions/schemaservice_policy_setCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "service_policy_setCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the service_policy_set ",
                    "title": "spec",
                    "$ref": "#/definitions/schemaservice_policy_setGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "service_policy_setDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a service_policy_set",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "service_policy_setGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/service_policy_setObject",
        ...
        "service_policy_setGetResponseFormatCode": {
            "type": "string",
        ...
        "service_policy_setListResponse": {
            ...
            "properties": {
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/service_policy_setListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "service_policy_setObject": {
            "type": "object",
            "description": "Service Policy set object",
            "title": "Service Policy Set object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "service_policy_setReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a service_policy_set",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the service_policy_set ",
                    "title": "spec",
                    "$ref": "#/definitions/schemaservice_policy_setReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "service_policy_setReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.service_policy_set.ReplaceResponse"
        },
    ...
    "x-displayname": "Service Policy Set",
    "x-ves-proto-file": "ves.io/schema/service_policy_set/public_crudapi.proto"
}`
