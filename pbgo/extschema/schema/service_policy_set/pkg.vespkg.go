...
func initializeEntryRegistry(mdr *svcfw.MDRegistry) {
	mdr.EntryFactory["ves.io.schema.service_policy_set.Object"] = NewEntryObject
	mdr.EntryStoreMap["ves.io.schema.service_policy_set.Object"] = store.InMemory
	mdr.EntryRegistry["ves.io.schema.service_policy_set.Object"] = reflect.TypeOf(&DBObject{})
	mdr.EntryIndexers["ves.io.schema.service_policy_set.Object"] = GetObjectIndexers
	mdr.EntryFactory["ves.io.schema.service_policy_set.StatusObject"] = NewEntryStatusObject
...
func initializeCRUDServiceRegistry(mdr *svcfw.MDRegistry, isExternal bool) {
	...
	func() {
		...
		csr.CRUDGrpcClientRegistry["ves.io.schema.service_policy_set.Object"] = NewCRUDAPIGrpcClient
		csr.CRUDRestClientRegistry["ves.io.schema.service_policy_set.Object"] = NewCRUDAPIRestClient
		csr.CRUDInprocClientRegistry["ves.io.schema.service_policy_set.Object"] = NewCRUDAPIInprocClient
		if isExternal {
			return
		}
