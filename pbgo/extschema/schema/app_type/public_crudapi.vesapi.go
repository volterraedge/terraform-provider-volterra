...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/app_types", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.app_type.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.app_type")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.app_type")
	}
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/app_types": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "http://some-url-here/ves-io-schema-app_type-API-Create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/app_types/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-app_type-API-Replace"
                },
        ...
        "/public/namespaces/{namespace}/app_types": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-app_type-API-List"
                },
        ...
        "/public/namespaces/{namespace}/app_types/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-app_type-API-Get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "http://some-url-here/ves-io-schema-app_type-API-Delete"
                },
    ...
    "definitions": {
        ...
        "app_typeGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/app_typeObject",
        ...
        "app_typeObject": {
            "type": "object",
            "description": "app_type Object to configure Data Services across namespaces.",
            "title": "App Type object",
            "x-displayname": "AppType Object",
            "x-ves-proto-message": "ves.io.schema.app_type.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
