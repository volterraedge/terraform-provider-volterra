...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_cdn_cache_rule.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_cdn_cache_rule.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_cdn_cache_rule.DBObject)
	}
	_ = f
