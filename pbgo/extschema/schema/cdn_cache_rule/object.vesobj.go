...
const (
	ObjectDefTblName = "ves.io.schema.cdn_cache_rule.Object.default"
	ObjectType       = "ves.io.schema.cdn_cache_rule.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.cdn_cache_rule.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.cdn_cache_rule.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
