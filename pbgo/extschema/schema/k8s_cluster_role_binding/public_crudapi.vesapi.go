...
const (
	...
	CreateRequestFQN = "ves.io.schema.k8s_cluster_role_binding.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.k8s_cluster_role_binding.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.k8s_cluster_role_binding.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.k8s_cluster_role_binding.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.k8s_cluster_role_binding.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.k8s_cluster_role_binding.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.k8s_cluster_role_binding.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.k8s_cluster_role_binding.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.k8s_cluster_role_binding.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.k8s_cluster_role_binding.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_role_bindings", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_role_bindings/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_role_bindings/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_role_bindings", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/k8s_cluster_role_bindings/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.k8s_cluster_role_binding.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role_binding")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.k8s_cluster_role_binding.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.k8s_cluster_role_binding.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.k8s_cluster_role_binding.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.k8s_cluster_role_binding.API.Create' operation on 'k8s_cluster_role_binding'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.k8s_cluster_role_binding.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.k8s_cluster_role_binding.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.k8s_cluster_role_binding.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.k8s_cluster_role_binding.API.Replace' operation on 'k8s_cluster_role_binding'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.k8s_cluster_role_binding.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.k8s_cluster_role_binding.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.k8s_cluster_role_binding.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.k8s_cluster_role_binding.API.Delete' operation on 'k8s_cluster_role_binding'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.k8s_cluster_role_binding.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "K8s Cluster Role Binding object",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingReplaceRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s_cluster_role_bindingDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "k8s_cluster_role_bindingCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of k8s_cluster_role_binding",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the k8s_cluster_role_binding",
                    "title": "spec",
                    "$ref": "#/definitions/k8s_cluster_role_bindingCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "k8s_cluster_role_bindingCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the k8s_cluster_role_binding",
                    "title": "spec",
                    "$ref": "#/definitions/k8s_cluster_role_bindingGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "k8s_cluster_role_bindingCreateSpecType": {
            "type": "object",
            "description": "Create k8s_cluster_role_binding will create the object in the storage backend for namespace metadata.namespace",
            "title": "Create k8s_cluster_role_binding",
        ...
        "k8s_cluster_role_bindingDeleteRequest": {
            ...
            "title": "DeleteRequest is used to delete a k8s_cluster_role_binding",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "k8s_cluster_role_bindingGetResponse": {
            ...
            "title": "GetResponse is the shape of a read k8s_cluster_role_binding",
        ...
        "k8s_cluster_role_bindingGetResponseFormatCode": {
            "type": "string",
        ...
        "k8s_cluster_role_bindingGetSpecType": {
            "type": "object",
            "description": "Get k8s_cluster_role_binding will get the object from the storage backend for namespace metadata.namespace",
            "title": "Get k8s_cluster_role_binding",
        ...
        "k8s_cluster_role_bindingListResponse": {
            ...
            "title": "ListResponse is the collection of k8s_cluster_role_binding",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/k8s_cluster_role_bindingListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "k8s_cluster_role_bindingListResponseItem": {
            "type": "object",
            "description": "By default a summary of k8s_cluster_role_binding is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of k8s_cluster_role_binding",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates k8s_cluster_role_binding is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this k8s_cluster_role_binding\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this k8s_cluster_role_binding\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "k8s_cluster_role_bindingReplaceRequest": {
            ...
            "title": "ReplaceRequest is used to replace contents of a k8s_cluster_role_binding",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the k8s_cluster_role_binding",
                    "title": "spec",
                    "$ref": "#/definitions/k8s_cluster_role_bindingReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "k8s_cluster_role_bindingReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.ReplaceResponse"
        },
    ...
    "x-displayname": "K8s Cluster Role Binding",
    "x-ves-proto-file": "ves.io/schema/k8s_cluster_role_binding/public_crudapi.proto"
}`
