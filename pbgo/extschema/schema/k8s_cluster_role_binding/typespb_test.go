...
func TestServiceAccountTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &ServiceAccountType{}
...
func TestServiceAccountTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, false)
	size := p.Size()
...
func BenchmarkServiceAccountTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*ServiceAccountType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedServiceAccountType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkServiceAccountTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedServiceAccountType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSubjectTypeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestSubjectTypeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, false)
	size := p.Size()
...
func BenchmarkSubjectTypeProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SubjectType, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSubjectType(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkSubjectTypeProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedSubjectType(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestServiceAccountTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, true)
...
func TestSubjectTypeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestServiceAccountTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, true)
...
func TestServiceAccountTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, true)
...
func TestSubjectTypeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestSubjectTypeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestServiceAccountTypeGoString(t *testing.T) {
...
func TestSubjectTypeGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSubjectType(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestServiceAccountTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedServiceAccountType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkServiceAccountTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*ServiceAccountType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedServiceAccountType(popr, false)
	}
	b.ResetTimer()
...
func TestSubjectTypeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSubjectType(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkSubjectTypeSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SubjectType, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSubjectType(popr, false)
	}
	b.ResetTimer()
...
func TestServiceAccountTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedServiceAccountType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestSubjectTypeStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSubjectType(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
