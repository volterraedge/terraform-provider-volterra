...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.k8s_cluster_role_binding.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role_binding.crudapi")
	}
    ...
    "definitions": {
        ...
        "k8s_cluster_role_bindingGlobalSpecType": {
            ...
            "properties": {
                ...
                "subjects": {
                    "type": "array",
                    "description": " List of subjects (user, group or service account) to which this role is bonded\nRequired: YES",
                    "title": "Subjects",
                    "items": {
