...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_k8s_cluster_role_binding.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_k8s_cluster_role_binding.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_k8s_cluster_role_binding.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_k8s_cluster_role_binding.DBObject)
	}
	_ = f
