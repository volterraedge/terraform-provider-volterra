...
// source: ves.io/schema/signup/object.proto
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b71a1de86800486, []int{0}
}
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b71a1de86800486, []int{1}
}
...
type StatusObject struct {
	...
	// Tenant reference
	Tenant []*schema.ObjectRefType `protobuf:"bytes,3,rep,name=tenant,proto3" json:"tenant,omitempty"`
	// User reference
	User []*schema.ObjectRefType `protobuf:"bytes,4,rep,name=user,proto3" json:"user,omitempty"`
	// Billing account reference
	BillingAccount []*schema.ObjectRefType `protobuf:"bytes,5,rep,name=billingAccount,proto3" json:"billingAccount,omitempty"`
	// conditions
	//
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b71a1de86800486, []int{2}
}
...
func (m *StatusObject) GetTenant() []*schema.ObjectRefType {
	if m != nil {
		return m.Tenant
	}
	return nil
...
func (m *StatusObject) GetUser() []*schema.ObjectRefType {
	if m != nil {
		return m.User
	}
	return nil
...
func (m *StatusObject) GetBillingAccount() []*schema.ObjectRefType {
	if m != nil {
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.signup.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.signup.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.signup.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.signup.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.signup.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.signup.StatusObject")
}

func init() { proto.RegisterFile("ves.io/schema/signup/object.proto", fileDescriptor_7b71a1de86800486) }
func init() {
	golang_proto.RegisterFile("ves.io/schema/signup/object.proto", fileDescriptor_7b71a1de86800486)
}

var fileDescriptor_7b71a1de86800486 = []byte{
	// 538 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *StatusObject) Equal(that interface{}) bool {
	...
	if len(this.BillingAccount) != len(that1.BillingAccount) {
		return false
	}
	for i := range this.BillingAccount {
		if !this.BillingAccount[i].Equal(that1.BillingAccount[i]) {
			return false
		}
	}
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 10)
	s = append(s, "&signup.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
	...
	if this.BillingAccount != nil {
		s = append(s, "BillingAccount: "+fmt.Sprintf("%#v", this.BillingAccount)+",\n")
	}
...
func (m *StatusObject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BillingAccount) > 0 {
		for iNdEx := len(m.BillingAccount) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BillingAccount[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *StatusObject) Size() (n int) {
	...
	if len(m.BillingAccount) > 0 {
		for _, e := range m.BillingAccount {
			l = e.Size()
			n += 1 + l + sovObject(uint64(l))
		}
	}
...
func (this *StatusObject) String() string {
	...
	repeatedStringForBillingAccount := "[]*ObjectRefType{"
	for _, f := range this.BillingAccount {
		repeatedStringForBillingAccount += strings.Replace(fmt.Sprintf("%v", f), "ObjectRefType", "schema.ObjectRefType", 1) + ","
	}
	repeatedStringForBillingAccount += "}"
	...
	s := strings.Join([]string{`&StatusObject{`,
		...
		`BillingAccount:` + repeatedStringForBillingAccount + `,`,
...
func (m *StatusObject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BillingAccount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BillingAccount = append(m.BillingAccount, &schema.ObjectRefType{})
			if err := m.BillingAccount[len(m.BillingAccount)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
