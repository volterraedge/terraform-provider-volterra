...
func (m *ConnectToLayer2) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *ConnectToLayer2) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *ConnectToLayer2) DeepCopy() *ConnectToLayer2 {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *ConnectToLayer2) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *ConnectToLayer2) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return ConnectToLayer2Validator().Validate(ctx, m, opts...)
}

func (m *ConnectToLayer2) GetDRefInfo() ([]db.DRefInfo, error) {
	if m == nil {
		return nil, nil
	}

	var drInfos []db.DRefInfo
	if fdrInfos, err := m.GetLayer2IntfInternalRefDRefInfo(); err != nil {
		return nil, errors.Wrap(err, "GetLayer2IntfInternalRefDRefInfo() FAILED")
	} else {
...
func (m *ConnectToLayer2) GetLayer2IntfInternalRefDRefInfo() ([]db.DRefInfo, error) {
	refs := m.GetLayer2IntfInternalRef()
	if len(refs) == 0 {
		return nil, nil
	}
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("ConnectToLayer2.layer2_intf_internal_ref[%d] has a nil value", i)
		}
		...
		drInfos = append(drInfos, db.DRefInfo{
			...
			RefdName:   ref.Name,
			DRField:    "layer2_intf_internal_ref",
			Ref:        ref,
		})
	}
	return drInfos, nil
...
func (m *ConnectToLayer2) GetLayer2IntfInternalRefDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	for _, ref := range m.GetLayer2IntfInternalRef() {
...
func (m *ConnectToLayer2) GetLayer2IntfRefDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	var entries []db.Entry
	refdType, err := d.TypeForEntryKind("", "", "network_interface.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: network_interface")
...
type ValidateConnectToLayer2 struct {
...
func (v *ValidateConnectToLayer2) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*ConnectToLayer2)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *ConnectToLayer2 got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultConnectToLayer2Validator = func() *ValidateConnectToLayer2 {
	...
	vrhLayer2IntfRef := v.Layer2IntfRefValidationRuleHandler
	rulesLayer2IntfRef := map[string]string{
		"ves.io.schema.rules.message.required": "true",
	}
	vFn, err = vrhLayer2IntfRef(rulesLayer2IntfRef)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for ConnectToLayer2.layer2_intf_ref: %s", err)
		panic(errMsg)
	}
	v.FldValidators["layer2_intf_ref"] = vFn

	return v
}()

func ConnectToLayer2Validator() db.Validator {
	return DefaultConnectToLayer2Validator
}
...
func (m *CreateSpecType) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := m.GetConnectionChoiceDRefInfo(); err != nil {
		return nil, errors.Wrap(err, "GetConnectionChoiceDRefInfo() FAILED")
	} else {
		drInfos = append(drInfos, fdrInfos...)
	}
...
func (m *CreateSpecType) GetConnectionChoiceDRefInfo() ([]db.DRefInfo, error) {
...
func (v *ValidateCreateSpecType) SiteSubnetParamsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for site_subnet_params")
	}
...
func (v *ValidateCreateSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *CreateSpecType_ConnectToLayer2:
		if fv, exists := v.FldValidators["connection_choice.connect_to_layer2"]; exists {
			val := m.GetConnectionChoice().(*CreateSpecType_ConnectToLayer2).ConnectToLayer2
			vOpts := append(opts,
				db.WithValidateField("connection_choice"),
				db.WithValidateField("connect_to_layer2"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
...
func (v *ValidateDHCPNetworkType) NetworkPrefixChoiceNetworkPrefixIpv6ValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "ValidationRuleHandler for network_prefix_ipv6")
	}
	return oValidatorFn_NetworkPrefixIpv6, nil
}
...
func (v *ValidateDHCPNetworkType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *DHCPNetworkType_NetworkPrefixIpv6:
		if fv, exists := v.FldValidators["network_prefix_choice.network_prefix_ipv6"]; exists {
			val := m.GetNetworkPrefixChoice().(*DHCPNetworkType_NetworkPrefixIpv6).NetworkPrefixIpv6
			vOpts := append(opts,
				db.WithValidateField("network_prefix_choice"),
				db.WithValidateField("network_prefix_ipv6"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
...
var DefaultDHCPNetworkTypeValidator = func() *ValidateDHCPNetworkType {
	...
	vrhNetworkPrefixChoiceNetworkPrefixIpv6 := v.NetworkPrefixChoiceNetworkPrefixIpv6ValidationRuleHandler
	rulesNetworkPrefixChoiceNetworkPrefixIpv6 := map[string]string{
		"ves.io.schema.rules.string.ipv6_prefix": "true",
	}
	vFnMap["network_prefix_choice.network_prefix_ipv6"], err = vrhNetworkPrefixChoiceNetworkPrefixIpv6(rulesNetworkPrefixChoiceNetworkPrefixIpv6)
	if err != nil {
...
// GetDRefInfo for the field's type
func (m *GetSpecType) GetConnectionChoiceDRefInfo() ([]db.DRefInfo, error) {
	if m.GetConnectionChoice() == nil {
		return nil, nil
	}
	switch m.GetConnectionChoice().(type) {
...
func (v *ValidateGetSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *GetSpecType_ConnectToLayer2:
		if fv, exists := v.FldValidators["connection_choice.connect_to_layer2"]; exists {
			val := m.GetConnectionChoice().(*GetSpecType_ConnectToLayer2).ConnectToLayer2
			vOpts := append(opts,
				db.WithValidateField("connection_choice"),
				db.WithValidateField("connect_to_layer2"),
			)
...
// GetDRefInfo for the field's type
func (m *GlobalSpecType) GetConnectionChoiceDRefInfo() ([]db.DRefInfo, error) {
	if m.GetConnectionChoice() == nil {
		return nil, nil
	}
	switch m.GetConnectionChoice().(type) {
...
func (v *ValidateGlobalSpecType) SiteDhcpServerParamsInternalValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for site_dhcp_server_params_internal")
	}
...
func (v *ValidateGlobalSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *GlobalSpecType_ConnectToLayer2:
		if fv, exists := v.FldValidators["connection_choice.connect_to_layer2"]; exists {
			val := m.GetConnectionChoice().(*GlobalSpecType_ConnectToLayer2).ConnectToLayer2
			vOpts := append(opts,
				db.WithValidateField("connection_choice"),
				db.WithValidateField("connect_to_layer2"),
			)
...
// GetDRefInfo for the field's type
func (m *ReplaceSpecType) GetConnectionChoiceDRefInfo() ([]db.DRefInfo, error) {
	if m.GetConnectionChoice() == nil {
		return nil, nil
	}
	switch m.GetConnectionChoice().(type) {
...
func (v *ValidateReplaceSpecType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *ReplaceSpecType_ConnectToLayer2:
		if fv, exists := v.FldValidators["connection_choice.connect_to_layer2"]; exists {
			val := m.GetConnectionChoice().(*ReplaceSpecType_ConnectToLayer2).ConnectToLayer2
			vOpts := append(opts,
				db.WithValidateField("connection_choice"),
				db.WithValidateField("connect_to_layer2"),
			)
...
func (v *ValidateSiteSubnetParametersType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *SiteSubnetParametersType_Dhcp:
		if fv, exists := v.FldValidators["address_choice.dhcp"]; exists {
			val := m.GetAddressChoice().(*SiteSubnetParametersType_Dhcp).Dhcp
			vOpts := append(opts,
				db.WithValidateField("address_choice"),
				db.WithValidateField("dhcp"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
		}
	case *SiteSubnetParametersType_StaticIp:
		if fv, exists := v.FldValidators["address_choice.static_ip"]; exists {
			val := m.GetAddressChoice().(*SiteSubnetParametersType_StaticIp).StaticIp
			vOpts := append(opts,
				db.WithValidateField("address_choice"),
...
var DefaultSiteSubnetParametersTypeValidator = func() *ValidateSiteSubnetParametersType {
	...
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for SiteSubnetParametersType.site: %s", err)
		panic(errMsg)
	}
...
func (m *SubnetDHCPServerParametersType) GetSiteDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("SubnetDHCPServerParametersType.site[%d] has a nil value", i)
		}
		// resolve kind to type if needed at DBObject.GetDRefInfo()
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "site.Object",
...
func (r *CreateSpecType) SetConnectionChoiceToGlobalSpecType(o *GlobalSpecType) error {
	...
	case *CreateSpecType_ConnectToLayer2:
		o.ConnectionChoice = &GlobalSpecType_ConnectToLayer2{ConnectToLayer2: of.ConnectToLayer2}
...
func (r *CreateSpecType) GetConnectionChoiceFromGlobalSpecType(o *GlobalSpecType) error {
	...
	case *GlobalSpecType_ConnectToLayer2:
		r.ConnectionChoice = &CreateSpecType_ConnectToLayer2{ConnectToLayer2: of.ConnectToLayer2}
...
func (r *GetSpecType) GetConnectionChoiceFromGlobalSpecType(o *GlobalSpecType) error {
	...
	case *GlobalSpecType_ConnectToLayer2:
		r.ConnectionChoice = &GetSpecType_ConnectToLayer2{ConnectToLayer2: of.ConnectToLayer2}
...
func (r *ReplaceSpecType) GetConnectionChoiceFromGlobalSpecType(o *GlobalSpecType) error {
	...
	case *GlobalSpecType_ConnectToLayer2:
		r.ConnectionChoice = &ReplaceSpecType_ConnectToLayer2{ConnectToLayer2: of.ConnectToLayer2}
