...
type GetUserRoleResponse struct {
	...
	// Addon Service Access
	//
	// x-displayName: "Addon Service Access"
	// Addon service status and access for the user.
	AddonServiceAccess map[string]*AddonServiceAccess `protobuf:"bytes,27,rep,name=addon_service_access,json=addonServiceAccess,proto3" json:"addon_service_access,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Tile Access
	//
...
func (m *GetUserRoleResponse) GetAddonServiceAccess() map[string]*AddonServiceAccess {
	if m != nil {
		return m.AddonServiceAccess
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*AddonServiceAccess)(nil), "ves.io.schema.user.GetUserRoleResponse.AddonServiceAccessEntry")
	golang_proto.RegisterMapType((map[string]*AddonServiceAccess)(nil), "ves.io.schema.user.GetUserRoleResponse.AddonServiceAccessEntry")
...
var fileDescriptor_5ce53d51230acf0d = []byte{
	...
	,
}
...
func (this *GetUserRoleResponse) Equal(that interface{}) bool {
	...
	if len(this.AddonServiceAccess) != len(that1.AddonServiceAccess) {
		return false
	}
	for i := range this.AddonServiceAccess {
		if !this.AddonServiceAccess[i].Equal(that1.AddonServiceAccess[i]) {
			return false
		}
	}
...
func (this *GetUserRoleResponse) GoString() string {
	...
	keysForAddonServiceAccess := make([]string, 0, len(this.AddonServiceAccess))
	for k, _ := range this.AddonServiceAccess {
		keysForAddonServiceAccess = append(keysForAddonServiceAccess, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForAddonServiceAccess)
	mapStringForAddonServiceAccess := "map[string]*AddonServiceAccess{"
	for _, k := range keysForAddonServiceAccess {
		mapStringForAddonServiceAccess += fmt.Sprintf("%#v: %#v,", k, this.AddonServiceAccess[k])
	}
	mapStringForAddonServiceAccess += "}"
	if this.AddonServiceAccess != nil {
		s = append(s, "AddonServiceAccess: "+mapStringForAddonServiceAccess+",\n")
	}
...
func (m *GetUserRoleResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AddonServiceAccess) > 0 {
		for k := range m.AddonServiceAccess {
			v := m.AddonServiceAccess[k]
			baseI := i
			if v != nil {
				{
					size, err := v.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetUserRoleResponse) Size() (n int) {
	...
	if len(m.AddonServiceAccess) > 0 {
		for k, v := range m.AddonServiceAccess {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (this *GetUserRoleResponse) String() string {
	...
	s := strings.Join([]string{`&GetUserRoleResponse{`,
		...
		`AddonServiceAccess:` + mapStringForAddonServiceAccess + `,`,
...
func (m *GetUserRoleResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddonServiceAccess", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AddonServiceAccess == nil {
				m.AddonServiceAccess = make(map[string]*AddonServiceAccess)
			}
			var mapkey string
			var mapvalue *AddonServiceAccess
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.AddonServiceAccess[mapkey] = mapvalue
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
