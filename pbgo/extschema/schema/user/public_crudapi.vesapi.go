...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/users", c.baseURL, req.Metadata.GetNamespace())
	jsn, err := req.ToJSON()
	if err != nil {
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/users/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/users/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/users", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.crudCl.svc.GetAPIHandler("ves.io.schema.user.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.user")
...
func (c *crudAPIInprocClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	ah := c.svc.GetAPIHandler("ves.io.schema.user.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.user")
	}
...
func (c *crudAPIInprocClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return fmt.Errorf("No CRUD Server for ves.io.schema.user")
	}
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.user.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.user.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	reqMsgFQN := "ves.io.schema.user.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.user.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.user.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.user.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.user.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.user.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object != nil && o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.user.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "User",
        "description": "Represents user for a given tenant",
    ...
    "tags": null,
    "paths": {
        "/public/namespaces/{metadata.namespace}/users": {
            "post": {
                "summary": "CreateSpecType",
                "operationId": "ves.io.schema.user.API.Create",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-user-API-Create"
                },
                "x-ves-proto-rpc": "ves.io.schema.user.API.Create"
            },
            "x-displayname": "User",
            "x-ves-proto-service": "ves.io.schema.user.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/users/{metadata.name}": {
            "put": {
                "summary": "ReplaceSpecType",
                "operationId": "ves.io.schema.user.API.Replace",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                            "$ref": "#/definitions/userReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-user-API-Replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.user.API.Replace"
            },
            "x-displayname": "User",
            "x-ves-proto-service": "ves.io.schema.user.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/users": {
            "get": {
                "summary": "List",
                "description": "List the set of user in a namespace",
                "operationId": "ves.io.schema.user.API.List",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-user-API-List"
                },
                "x-ves-proto-rpc": "ves.io.schema.user.API.List"
            },
            "x-displayname": "User",
            "x-ves-proto-service": "ves.io.schema.user.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/users/{name}": {
            "get": {
                "summary": "GetSpecType",
                "operationId": "ves.io.schema.user.API.Get",
                "responses": {
                    "200": {
                        "description": "",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-user-API-Get"
                },
                "x-ves-proto-rpc": "ves.io.schema.user.API.Get"
            },
            "x-displayname": "User",
            "x-ves-proto-service": "ves.io.schema.user.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "userCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of user",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.user.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/userCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "userCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.user.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the user",
                    "title": "spec",
                    "$ref": "#/definitions/userGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "userGetResponse": {
            ...
            "title": "GetResponse is the shape of a read user",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.user.GetResponse",
            "properties": {
                "create_form": {
        ...
        "userListResponse": {
            ...
            "title": "ListResponse is the collection of user",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.user.ListResponse",
            "properties": {
                "items": {
                    "type": "array",
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/userListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "userListResponseItem": {
            "type": "object",
            "description": "By default a summary of user is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of user",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.user.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this user",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this user",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates user is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this user",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
        ...
        "userReplaceRequest": {
            ...
            "title": "ReplaceRequest is used to replace contents of a user",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.user.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the user",
                    "title": "spec",
                    "$ref": "#/definitions/userReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "userReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.user.ReplaceResponse"
        },
        "userReplaceSpecType": {
            "type": "object",
        ...
        "userUserState": {
            "type": "string",
            "description": "UserState defines the state of the user\n\n - NEW: User was created(request for creating user was received and object created)\n - REMOVED: User is removed",
            "title": "UserState",
            "enum": [
                "NEW",
                "REMOVED"
    ...
    "x-displayname": "User",
    "x-ves-proto-file": "ves.io/schema/user/public_crudapi.proto"
}`
