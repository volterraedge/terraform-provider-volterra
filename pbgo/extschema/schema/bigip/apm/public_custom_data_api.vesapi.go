...
func (c *CustomDataAPIGrpcClient) doRPCMetrics(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.bigip.apm.MetricsRequest", yamlReq)
	}
...
func (c *CustomDataAPIRestClient) doRPCMetrics(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &MetricsRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.bigip.apm.MetricsRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.bigip.apm.MetricsResponse", body)
...
func (c *customDataAPIInprocClient) Metrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip.apm.CustomDataAPI.Metrics")
...
func (s *customDataAPISrv) Metrics(ctx context.Context, in *MetricsRequest) (*MetricsResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.bigip.apm.CustomDataAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.bigip.apm.MetricsRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomDataAPI.Metrics' operation on 'apm'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.bigip.apm.CustomDataAPI.Metrics"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.bigip.apm.MetricsResponse", rsp)...)
...
var CustomDataAPISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "APIs to get metrics for BIG-IP APM services",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/bigip/apm/metrics": {
            "post": {
                "summary": "Metrics",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/apmMetricsResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apmMetricsRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-bigip-apm-customdataapi-metrics"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip.apm.CustomDataAPI.Metrics"
            },
            "x-displayname": "BIG-IP APM Custom Data API",
            "x-ves-proto-service": "ves.io.schema.bigip.apm.CustomDataAPI",
    ...
    "definitions": {
        "apmMetricData": {
            ...
            "x-ves-proto-message": "ves.io.schema.bigip.apm.MetricData",
            "properties": {
                "data": {
                    "type": "array",
                    ...
                    "title": "Data",
                    "items": {
                        "$ref": "#/definitions/bigipapmMetricTypeData"
                    },
                    "x-displayname": "Data"
                },
                "type": {
                    ...
                    "title": "Type",
                    "$ref": "#/definitions/bigipapmMetricType",
                    "x-displayname": "Type"
                }
            }
        },
        "apmMetricLabel": {
            "type": "string",
            "description": "Labels in BIG-IP APM Service Metrics\n",
            "title": "Metric Label",
            "enum": [
                "SITE",
                "SERVICE",
            ...
            "x-ves-proto-enum": "ves.io.schema.bigip.apm.MetricLabel"
        },
        "apmMetricsRequest": {
            "type": "object",
            "description": "Request to get the metrics for BIG-IP APM services",
            "title": "Metrics Request",
            "x-displayname": "Metrics Request",
            "x-ves-proto-message": "ves.io.schema.bigip.apm.MetricsRequest",
            "properties": {
                "end_time": {
                    "type": "string",
                ...
                "group_by": {
                    ...
                    "title": "Group by",
                    "items": {
                        "$ref": "#/definitions/apmMetricLabel"
                    },
        ...
        "apmMetricsResponse": {
            "type": "object",
            "description": "Metrics for BIG-IP APM Services",
            "title": "Metrics Response",
            "x-displayname": "Metrics Response",
            "x-ves-proto-message": "ves.io.schema.bigip.apm.MetricsResponse",
            "properties": {
                "data": {
                    "type": "array",
                    "description": " Data contains time-series metric data for BIG-IP APM services",
                    "title": "Data",
                    "items": {
                        "$ref": "#/definitions/apmMetricData"
                    },
                    "x-displayname": "Data"
                },
                "step": {
        ...
        "bigipapmMetricType": {
            ...
            "enum": [
                ...
                "RX_THROUGHPUT_BYTES",
                "RX_TRANSFERRED_BYTES",
                "CONNECTIONS_RATE",
                "CONNECTIONS_TOTAL",
                "MAX_ACCESS_SESSIONS_COUNT",
                "HEALTHSCORE"
            ],
        ...
        "bigipapmMetricTypeData": {
            ...
            "x-ves-proto-message": "ves.io.schema.bigip.apm.MetricTypeData",
            "properties": {
                "key": {
                    "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/bigip/apm/public_custom_data_api.proto"
}`
