...
/*
Package apm is a reverse proxy.
...
var (
	pattern_CustomDataAPI_Metrics_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4, 2, 5}, []string{"public", "namespaces", "namespace", "bigip", "apm", "metrics"}, "", runtime.AssumeColonVerbOpt(false)))
)
