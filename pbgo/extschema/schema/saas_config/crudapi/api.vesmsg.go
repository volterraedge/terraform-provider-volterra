...
import (
	...
	ves_io_schema_saas_config "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/saas_config"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_saas_config.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_saas_config.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_saas_config.DBObject)
	}
	_ = f
