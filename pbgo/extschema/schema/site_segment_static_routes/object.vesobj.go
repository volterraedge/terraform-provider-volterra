...
const (
	ObjectDefTblName = "ves.io.schema.site_segment_static_routes.Object.default"
	ObjectType       = "ves.io.schema.site_segment_static_routes.Object"

	StatusObjectDefTblName = "ves.io.schema.site_segment_static_routes.StatusObject.default"
	StatusObjectType       = "ves.io.schema.site_segment_static_routes.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.site_segment_static_routes.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.site_segment_static_routes.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.site_segment_static_routes.StatusObject"
}
