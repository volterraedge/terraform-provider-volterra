...
// source: ves.io/schema/infraprotect_firewall_rule/object.proto
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6eb24da55d2fe7f, []int{0}
}
...
// Infraprotect Firewall Rule Specification
//
// x-displayName: "Firewall Rule Specification"
// Infraprotect Firewall Rule Object
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6eb24da55d2fe7f, []int{1}
}
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6eb24da55d2fe7f, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.infraprotect_firewall_rule.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.infraprotect_firewall_rule.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.infraprotect_firewall_rule.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.infraprotect_firewall_rule.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.infraprotect_firewall_rule.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.infraprotect_firewall_rule.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/infraprotect_firewall_rule/object.proto", fileDescriptor_f6eb24da55d2fe7f)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/infraprotect_firewall_rule/object.proto", fileDescriptor_f6eb24da55d2fe7f)
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&infraprotect_firewall_rule.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&infraprotect_firewall_rule.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&infraprotect_firewall_rule.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
