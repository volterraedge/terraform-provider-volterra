...
const (
	...
	CreateRequestFQN = "ves.io.schema.infraprotect_firewall_rule.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.infraprotect_firewall_rule.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.infraprotect_firewall_rule.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.infraprotect_firewall_rule.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.infraprotect_firewall_rule.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.infraprotect_firewall_rule.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.infraprotect_firewall_rule.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.infraprotect_firewall_rule.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.infraprotect_firewall_rule.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.infraprotect_firewall_rule.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_firewall_rules", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_firewall_rules/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_firewall_rules/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_firewall_rules", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/infraprotect_firewall_rules/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.infraprotect_firewall_rule.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.infraprotect_firewall_rule")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_firewall_rule.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_firewall_rule.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_firewall_rule.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_firewall_rule.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.infraprotect_firewall_rule.API.Delete", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.infraprotect_firewall_rule.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.infraprotect_firewall_rule.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_firewall_rule.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_firewall_rule.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.infraprotect_firewall_rule.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.infraprotect_firewall_rule.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_firewall_rule.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_firewall_rule.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_firewall_rule.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_firewall_rule.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_firewall_rule.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_firewall_rule.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.infraprotect_firewall_rule.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_firewall_rule.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_firewall_rule.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_firewall_rule.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.infraprotect_firewall_rule.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.infraprotect_firewall_rule.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/infraprotect_firewall_rules": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_firewall_rule-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/infraprotect_firewall_rules/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_firewall_rule-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/infraprotect_firewall_rules": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_firewall_rule-api-list"
                },
        ...
        "/public/namespaces/{namespace}/infraprotect_firewall_rules/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_firewall_rule-api-get"
                },
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/infraprotect_firewall_ruleDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://www.volterra.io/docs/reference/api-ref/ves-io-schema-infraprotect_firewall_rule-api-delete"
                },
    ...
    "definitions": {
        "infraprotect_firewall_ruleCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_firewall_ruleCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "infraprotect_firewall_ruleCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the firewall rules",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_firewall_ruleGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "infraprotect_firewall_ruleCreateSpecType": {
            ...
            "properties": {
                "action_allow": {
                    "description": "Exclusive with [action_deny]\n Allow",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Allow"
                },
                "action_deny": {
                    "description": "Exclusive with [action_allow]\n Deny",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Deny"
                },
                "destination_prefix_all": {
                    "description": "Exclusive with [destination_prefix_single]\n All Prefixes",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All Prefixes"
                },
                ...
                "fragments_allow": {
                    "description": "Exclusive with [fragments_deny]\n Allow",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Allow"
                },
                "fragments_deny": {
                    "description": "Exclusive with [fragments_allow]\n Deny",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Deny"
                },
                "protocol_ah": {
                    "description": "Exclusive with [protocol_all protocol_esp protocol_gre protocol_icmp protocol_icmp6 protocol_ipv6 protocol_tcp protocol_udp]\n AH",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "AH"
                },
                "protocol_all": {
                    "description": "Exclusive with [protocol_ah protocol_esp protocol_gre protocol_icmp protocol_icmp6 protocol_ipv6 protocol_tcp protocol_udp]\n All Protocols",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All Protocols"
                },
                "protocol_esp": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_gre protocol_icmp protocol_icmp6 protocol_ipv6 protocol_tcp protocol_udp]\n ESP",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "ESP"
                },
                "protocol_gre": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_icmp protocol_icmp6 protocol_ipv6 protocol_tcp protocol_udp]\n GRE",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "GRE"
                },
                "protocol_icmp": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_gre protocol_icmp6 protocol_ipv6 protocol_tcp protocol_udp]\n ICMP",
                    "$ref": "#/definitions/infraprotect_firewall_ruleICMPProtocol",
                    "x-displayname": "ICMP"
                },
                "protocol_icmp6": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_gre protocol_icmp protocol_ipv6 protocol_tcp protocol_udp]\n ICMP6",
                    "$ref": "#/definitions/infraprotect_firewall_ruleICMP6Protocol",
                    "x-displayname": "ICMP6"
                },
                "protocol_ipv6": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_gre protocol_icmp protocol_icmp6 protocol_tcp protocol_udp]\n IPV6",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "IPV6"
                },
                "protocol_tcp": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_gre protocol_icmp protocol_icmp6 protocol_ipv6 protocol_udp]\n TCP",
                    "$ref": "#/definitions/infraprotect_firewall_ruleTCPProtocol",
                    "x-displayname": "TCP"
                },
                "protocol_udp": {
                    "description": "Exclusive with [protocol_ah protocol_all protocol_esp protocol_gre protocol_icmp protocol_icmp6 protocol_ipv6 protocol_tcp]\n UDP",
                    "$ref": "#/definitions/infraprotect_firewall_ruleUDPProtocol",
                    "x-displayname": "UDP"
                },
                "source_prefix_all": {
                    "description": "Exclusive with [source_prefix_single]\n All Prefixes",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All Prefixes"
                },
                ...
                "state_off": {
                    "description": "Exclusive with [state_on]\n Off",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Off"
                },
                "state_on": {
                    "description": "Exclusive with [state_off]\n On",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "On"
                },
                "version_ipv4": {
        ...
        "infraprotect_firewall_ruleGetResponse": {
            ...
            "properties": {
                ...
                "object": {
                    "title": "object",
                    "$ref": "#/definitions/infraprotect_firewall_ruleObject",
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/infraprotect_firewall_ruleStatusObject"
                    },
        ...
        "infraprotect_firewall_ruleGetResponseFormatCode": {
            "type": "string",
        ...
        "infraprotect_firewall_ruleGlobalSpecType": {
            "type": "object",
            "description": "DDos Transit Firewall Rule spec",
            ...
            "x-ves-oneof-field-state": "[\"state_off\",\"state_on\"]",
            "x-ves-oneof-field-version": "[\"version_ipv4\",\"version_ipv6\"]",
            "x-ves-proto-message": "ves.io.schema.infraprotect_firewall_rule.GlobalSpecType",
            "properties": {
                "action_allow": {
                    "description": "Exclusive with [action_deny]\n Allow",
                    "title": "Allow",
        ...
        "infraprotect_firewall_ruleListResponse": {
            ...
            "properties": {
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/infraprotect_firewall_ruleListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "infraprotect_firewall_ruleObject": {
            "type": "object",
            "description": "Firewall Rule Object",
            "title": "Firewall Rule Object",
            "x-displayname": "Object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_firewall_rule.Object",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the firewall rules",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_firewall_ruleSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
                    "description": " System generated object's metadata",
        ...
        "infraprotect_firewall_ruleReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the firewall rules",
                    "title": "spec",
                    "$ref": "#/definitions/infraprotect_firewall_ruleReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        ...
        "infraprotect_firewall_ruleSpecType": {
            "type": "object",
            "description": "Infraprotect Firewall Rule Object",
            "title": "Infraprotect Firewall Rule Specification",
            "x-displayname": "Firewall Rule Specification",
            "x-ves-proto-message": "ves.io.schema.infraprotect_firewall_rule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/infraprotect_firewall_ruleGlobalSpecType",
        ...
        "infraprotect_firewall_ruleTCPProtocol": {
            ...
            "properties": {
                ...
                "destination_port_all": {
                    "description": "Exclusive with [destination_port_range]\n All",
                    "title": "All",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All"
                },
                ...
                "source_port_all": {
                    "description": "Exclusive with [source_port_range]\n All",
                    "title": "All",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "All"
                },
    ...
    "x-displayname": "Infraprotect Firewall Rule",
    "x-ves-proto-file": "ves.io/schema/infraprotect_firewall_rule/public_crudapi.proto"
}`
