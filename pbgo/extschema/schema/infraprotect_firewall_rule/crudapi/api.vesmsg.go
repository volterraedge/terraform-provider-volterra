...
import (
	...
	ves_io_schema_infraprotect_firewall_rule "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/infraprotect_firewall_rule"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_infraprotect_firewall_rule.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_infraprotect_firewall_rule.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_infraprotect_firewall_rule.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_infraprotect_firewall_rule.DBObject)
	}
	_ = f
