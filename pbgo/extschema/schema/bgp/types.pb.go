...
// Indicates the state of BFD session
type BfdPeerState int32

const (
	// x-displayName: "Unknown"
	// BFD session state is unknown
	BFD_PEER_UNKNOWN BfdPeerState = 0
	// x-displayName: "Down"
	// BFD session is Down
	BFD_PEER_DOWN BfdPeerState = 1
	// x-displayName: "Up"
	// BFD session is Up
	BFD_PEER_UP BfdPeerState = 2
	// x-displayName: "Admin Down"
	// BFD session is administratively down
	BFD_PEER_ADMIN_DOWN BfdPeerState = 3
	// x-displayName: "Init"
	// BFD session is initializing
	BFD_PEER_INIT BfdPeerState = 4
)

var BfdPeerState_name = map[int32]string{
	0: "BFD_PEER_UNKNOWN",
	1: "BFD_PEER_DOWN",
	2: "BFD_PEER_UP",
	3: "BFD_PEER_ADMIN_DOWN",
	4: "BFD_PEER_INIT",
}

var BfdPeerState_value = map[string]int32{
	"BFD_PEER_UNKNOWN":    0,
	"BFD_PEER_DOWN":       1,
	"BFD_PEER_UP":         2,
	"BFD_PEER_ADMIN_DOWN": 3,
	"BFD_PEER_INIT":       4,
}
...
type FamilyInet_Enable struct {
	Enable *UnicastIPv4 `protobuf:"bytes,2,opt,name=enable,proto3,oneof" json:"enable,omitempty"`
}
...
func (m *FamilyInet) GetEnable() *UnicastIPv4 {
...
type FamilyInet6_Enable struct {
	Enable *UnicastIPv6 `protobuf:"bytes,2,opt,name=enable,proto3,oneof" json:"enable,omitempty"`
}
...
func (m *FamilyInet6) GetEnable() *UnicastIPv6 {
...
type UnicastIPv4 struct {
	...
	Aggregation []*AggregationIPv4 `protobuf:"bytes,1,rep,name=aggregation,proto3" json:"aggregation,omitempty"`
}

func (m *UnicastIPv4) Reset()      { *m = UnicastIPv4{} }
func (*UnicastIPv4) ProtoMessage() {}
func (*UnicastIPv4) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{8}
}
func (m *UnicastIPv4) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnicastIPv4) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *UnicastIPv4) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnicastIPv4.Merge(m, src)
}
func (m *UnicastIPv4) XXX_Size() int {
	return m.Size()
}
func (m *UnicastIPv4) XXX_DiscardUnknown() {
	xxx_messageInfo_UnicastIPv4.DiscardUnknown(m)
}

var xxx_messageInfo_UnicastIPv4 proto.InternalMessageInfo

func (m *UnicastIPv4) GetAggregation() []*AggregationIPv4 {
	if m != nil {
...
// IPv6 Unicast
type UnicastIPv6 struct {
	// aggregation
	//
	// x-displayName: "Aggregation"
	// BGP aggregation prefixes are shared among all peers, aggregation configured under any peer will take effect on all peers. Aggregation in BGP occurs only when more specific routes exist in the routing table and applies to outbound advertisements.
	Aggregation []*AggregationIPv6 `protobuf:"bytes,1,rep,name=aggregation,proto3" json:"aggregation,omitempty"`
}

func (m *UnicastIPv6) Reset()      { *m = UnicastIPv6{} }
func (*UnicastIPv6) ProtoMessage() {}
func (*UnicastIPv6) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{9}
}
func (m *UnicastIPv6) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnicastIPv6) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *UnicastIPv6) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnicastIPv6.Merge(m, src)
}
func (m *UnicastIPv6) XXX_Size() int {
	return m.Size()
}
func (m *UnicastIPv6) XXX_DiscardUnknown() {
	xxx_messageInfo_UnicastIPv6.DiscardUnknown(m)
}

var xxx_messageInfo_UnicastIPv6 proto.InternalMessageInfo

func (m *UnicastIPv6) GetAggregation() []*AggregationIPv6 {
	if m != nil {
		return m.Aggregation
	}
	return nil
...
type AggregationIPv4 struct {
	...
	Options []*AggregationOption `protobuf:"bytes,3,rep,name=options,proto3" json:"options,omitempty"`
}

func (m *AggregationIPv4) Reset()      { *m = AggregationIPv4{} }
func (*AggregationIPv4) ProtoMessage() {}
func (*AggregationIPv4) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{10}
}
func (m *AggregationIPv4) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AggregationIPv4) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AggregationIPv4) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AggregationIPv4.Merge(m, src)
}
func (m *AggregationIPv4) XXX_Size() int {
	return m.Size()
}
func (m *AggregationIPv4) XXX_DiscardUnknown() {
	xxx_messageInfo_AggregationIPv4.DiscardUnknown(m)
}

var xxx_messageInfo_AggregationIPv4 proto.InternalMessageInfo

func (m *AggregationIPv4) GetIpPrefix() string {
	if m != nil {
		return m.IpPrefix
	}
	return ""
...
func (m *AggregationIPv4) GetOptions() []*AggregationOption {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *AggregationIPv6) Reset()      { *m = AggregationIPv6{} }
func (*AggregationIPv6) ProtoMessage() {}
func (*AggregationIPv6) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{11}
}
func (m *AggregationIPv6) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AggregationIPv6) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AggregationIPv6) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AggregationIPv6.Merge(m, src)
}
func (m *AggregationIPv6) XXX_Size() int {
	return m.Size()
}
func (m *AggregationIPv6) XXX_DiscardUnknown() {
	xxx_messageInfo_AggregationIPv6.DiscardUnknown(m)
}

var xxx_messageInfo_AggregationIPv6 proto.InternalMessageInfo

func (m *AggregationIPv6) GetIpPrefix() string {
	if m != nil {
		return m.IpPrefix
	}
	return ""
...
func (m *AggregationIPv6) GetOptions() []*AggregationOption {
	if m != nil {
		return m.Options
	}
	return nil
...
type AggregationOption struct {
	// aggregation_choice
	//
	// x-displayName: "Select Aggregation Options"
	// x-required
	//
	// Types that are valid to be assigned to AggregationChoice:
	//	*AggregationOption_SummaryOnly
	AggregationChoice isAggregationOption_AggregationChoice `protobuf_oneof:"aggregation_choice"`
}

func (m *AggregationOption) Reset()      { *m = AggregationOption{} }
...
func (m *AggregationOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AggregationOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AggregationOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AggregationOption.Merge(m, src)
}
func (m *AggregationOption) XXX_Size() int {
	return m.Size()
}
func (m *AggregationOption) XXX_DiscardUnknown() {
	xxx_messageInfo_AggregationOption.DiscardUnknown(m)
}

var xxx_messageInfo_AggregationOption proto.InternalMessageInfo

type isAggregationOption_AggregationChoice interface {
	isAggregationOption_AggregationChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type AggregationOption_SummaryOnly struct {
	SummaryOnly *schema.Empty `protobuf:"bytes,3,opt,name=summary_only,json=summaryOnly,proto3,oneof" json:"summary_only,omitempty"`
}

func (*AggregationOption_SummaryOnly) isAggregationOption_AggregationChoice() {}

func (m *AggregationOption) GetAggregationChoice() isAggregationOption_AggregationChoice {
	if m != nil {
		return m.AggregationChoice
	}
	return nil
}

func (m *AggregationOption) GetSummaryOnly() *schema.Empty {
	if x, ok := m.GetAggregationChoice().(*AggregationOption_SummaryOnly); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*AggregationOption) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AggregationOption_SummaryOnly)(nil),
	}
}
...
type PeerFamilyParameters struct {
	...
	// x-displayName: "Unicast IPv4"
	// IPv4 Unicast.
	UnicastIpv4 *UnicastIPv4 `protobuf:"bytes,4,opt,name=unicast_ipv4,json=unicastIpv4,proto3" json:"unicast_ipv4,omitempty"`
	// unicast_ipv6
	//
	// x-displayName: "Unicast IPv6"
	// IPv6 Unicast.
	UnicastIpv6 *UnicastIPv6 `protobuf:"bytes,6,opt,name=unicast_ipv6,json=unicastIpv6,proto3" json:"unicast_ipv6,omitempty"`
}
...
func (m *PeerFamilyParameters) GetUnicastIpv4() *UnicastIPv4 {
	if m != nil {
		return m.UnicastIpv4
	}
	return nil
}

func (m *PeerFamilyParameters) GetUnicastIpv6() *UnicastIPv6 {
	if m != nil {
		return m.UnicastIpv6
	}
	return nil
}
...
func (*ReplaceSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{24}
}
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{25}
}
...
// Status of BFD session for this BGP peer
type BfdPeerStatusType struct {
	// State
	//
	// x-displayName: "State"
	// Current state of the BFD session
	State BfdPeerState `protobuf:"varint,1,opt,name=state,proto3,enum=ves.io.schema.bgp.BfdPeerState" json:"state,omitempty"`
	// State Change Timestamp
	//
	// x-displayName: "State Change Timestamp"
	// Timestamp at which last BFD state change happened
	StateChangeTimestamp *types.Timestamp `protobuf:"bytes,2,opt,name=state_change_timestamp,json=stateChangeTimestamp,proto3" json:"state_change_timestamp,omitempty"`
}

func (m *BfdPeerStatusType) Reset()      { *m = BfdPeerStatusType{} }
func (*BfdPeerStatusType) ProtoMessage() {}
func (*BfdPeerStatusType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{26}
}
func (m *BfdPeerStatusType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BfdPeerStatusType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BfdPeerStatusType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BfdPeerStatusType.Merge(m, src)
}
func (m *BfdPeerStatusType) XXX_Size() int {
	return m.Size()
}
func (m *BfdPeerStatusType) XXX_DiscardUnknown() {
	xxx_messageInfo_BfdPeerStatusType.DiscardUnknown(m)
}

var xxx_messageInfo_BfdPeerStatusType proto.InternalMessageInfo

func (m *BfdPeerStatusType) GetState() BfdPeerState {
	if m != nil {
		return m.State
	}
	return BFD_PEER_UNKNOWN
}

func (m *BfdPeerStatusType) GetStateChangeTimestamp() *types.Timestamp {
	if m != nil {
...
type BgpPeerStatusType struct {
	...
	// Status of BFD session for this peer. Only present when BFD is enabled for the peer.
	BfdStatus *BfdPeerStatusType `protobuf:"bytes,14,opt,name=bfd_status,json=bfdStatus,proto3" json:"bfd_status,omitempty"`
}
...
func (*BgpPeerStatusType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{27}
}
...
func (m *BgpPeerStatusType) GetBfdStatus() *BfdPeerStatusType {
	if m != nil {
		return m.BfdStatus
	}
	return nil
...
func (*BgpStatusType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{28}
}
...
func (*BFD) Descriptor() ([]byte, []int) {
	return fileDescriptor_cad0df24d7dab112, []int{29}
}
...
func init() {
	...
	proto.RegisterEnum("ves.io.schema.bgp.BfdPeerState", BfdPeerState_name, BfdPeerState_value)
	golang_proto.RegisterEnum("ves.io.schema.bgp.BfdPeerState", BfdPeerState_name, BfdPeerState_value)
	...
	proto.RegisterType((*UnicastIPv4)(nil), "ves.io.schema.bgp.UnicastIPv4")
	golang_proto.RegisterType((*UnicastIPv4)(nil), "ves.io.schema.bgp.UnicastIPv4")
	proto.RegisterType((*UnicastIPv6)(nil), "ves.io.schema.bgp.UnicastIPv6")
	golang_proto.RegisterType((*UnicastIPv6)(nil), "ves.io.schema.bgp.UnicastIPv6")
	proto.RegisterType((*AggregationIPv4)(nil), "ves.io.schema.bgp.AggregationIPv4")
	golang_proto.RegisterType((*AggregationIPv4)(nil), "ves.io.schema.bgp.AggregationIPv4")
	proto.RegisterType((*AggregationIPv6)(nil), "ves.io.schema.bgp.AggregationIPv6")
	golang_proto.RegisterType((*AggregationIPv6)(nil), "ves.io.schema.bgp.AggregationIPv6")
	proto.RegisterType((*AggregationOption)(nil), "ves.io.schema.bgp.AggregationOption")
	golang_proto.RegisterType((*AggregationOption)(nil), "ves.io.schema.bgp.AggregationOption")
	...
	proto.RegisterType((*BfdPeerStatusType)(nil), "ves.io.schema.bgp.BfdPeerStatusType")
	golang_proto.RegisterType((*BfdPeerStatusType)(nil), "ves.io.schema.bgp.BfdPeerStatusType")
...
var fileDescriptor_cad0df24d7dab112 = []byte{
	...
	,
}
...
func (x BfdPeerState) String() string {
	s, ok := BfdPeerState_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *UnicastIPv4) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UnicastIPv4)
	if !ok {
		that2, ok := that.(UnicastIPv4)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.Aggregation) != len(that1.Aggregation) {
		return false
	}
	for i := range this.Aggregation {
		if !this.Aggregation[i].Equal(that1.Aggregation[i]) {
			return false
		}
	}
	return true
}
func (this *UnicastIPv6) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UnicastIPv6)
	if !ok {
		that2, ok := that.(UnicastIPv6)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AggregationIPv4) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AggregationIPv4)
	if !ok {
		that2, ok := that.(AggregationIPv4)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AggregationIPv6) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AggregationIPv6)
	if !ok {
		that2, ok := that.(AggregationIPv6)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AggregationOption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AggregationOption)
	if !ok {
		that2, ok := that.(AggregationOption)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.AggregationChoice == nil {
		if this.AggregationChoice != nil {
			return false
		}
	} else if this.AggregationChoice == nil {
		return false
	} else if !this.AggregationChoice.Equal(that1.AggregationChoice) {
		return false
	}
	return true
}
func (this *AggregationOption_SummaryOnly) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AggregationOption_SummaryOnly)
	if !ok {
		that2, ok := that.(AggregationOption_SummaryOnly)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.SummaryOnly.Equal(that1.SummaryOnly) {
		return false
	}
	return true
}
...
func (this *PeerFamilyParameters) Equal(that interface{}) bool {
	...
	if !this.UnicastIpv4.Equal(that1.UnicastIpv4) {
		return false
	}
	if !this.UnicastIpv6.Equal(that1.UnicastIpv6) {
		return false
	}
	return true
}
...
func (this *BfdPeerStatusType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BfdPeerStatusType)
	if !ok {
		that2, ok := that.(BfdPeerStatusType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *BgpPeerStatusType) Equal(that interface{}) bool {
	...
	if !this.BfdStatus.Equal(that1.BfdStatus) {
		return false
	}
	return true
}
...
func (this *UnicastIPv4) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&bgp.UnicastIPv4{")
...
func (this *UnicastIPv6) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&bgp.UnicastIPv6{")
	if this.Aggregation != nil {
		s = append(s, "Aggregation: "+fmt.Sprintf("%#v", this.Aggregation)+",\n")
	}
	s = append(s, "}")
...
func (this *AggregationIPv4) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&bgp.AggregationIPv4{")
...
func (this *AggregationIPv6) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&bgp.AggregationIPv6{")
	s = append(s, "IpPrefix: "+fmt.Sprintf("%#v", this.IpPrefix)+",\n")
	if this.Options != nil {
		s = append(s, "Options: "+fmt.Sprintf("%#v", this.Options)+",\n")
	}
...
func (this *AggregationOption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&bgp.AggregationOption{")
	if this.AggregationChoice != nil {
		s = append(s, "AggregationChoice: "+fmt.Sprintf("%#v", this.AggregationChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *AggregationOption_SummaryOnly) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&bgp.AggregationOption_SummaryOnly{` +
...
func (this *PeerFamilyParameters) GoString() string {
	...
	if this.UnicastIpv4 != nil {
		s = append(s, "UnicastIpv4: "+fmt.Sprintf("%#v", this.UnicastIpv4)+",\n")
	}
	if this.UnicastIpv6 != nil {
		s = append(s, "UnicastIpv6: "+fmt.Sprintf("%#v", this.UnicastIpv6)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *BfdPeerStatusType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&bgp.BfdPeerStatusType{")
...
func (this *BgpPeerStatusType) GoString() string {
	...
	if this.BfdStatus != nil {
		s = append(s, "BfdStatus: "+fmt.Sprintf("%#v", this.BfdStatus)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *UnicastIPv4) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UnicastIPv4) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UnicastIPv4) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Aggregation) > 0 {
		for iNdEx := len(m.Aggregation) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Aggregation[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *UnicastIPv6) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UnicastIPv6) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UnicastIPv6) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AggregationIPv4) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AggregationIPv4) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AggregationIPv4) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AggregationIPv6) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AggregationIPv6) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AggregationIPv6) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AggregationOption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AggregationOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AggregationOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.AggregationChoice != nil {
		{
			size := m.AggregationChoice.Size()
			i -= size
			if _, err := m.AggregationChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *AggregationOption_SummaryOnly) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AggregationOption_SummaryOnly) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SummaryOnly != nil {
		{
			size, err := m.SummaryOnly.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PeerFamilyParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.UnicastIpv6 != nil {
		{
			size, err := m.UnicastIpv6.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UnicastIpv4 != nil {
		{
			size, err := m.UnicastIpv4.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BfdPeerStatusType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BfdPeerStatusType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BfdPeerStatusType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BgpPeerStatusType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BfdStatus != nil {
		{
			size, err := m.BfdStatus.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AggregationIPv4) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AggregationIPv6) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AggregationOption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AggregationChoice != nil {
		n += m.AggregationChoice.Size()
	}
	return n
}

func (m *AggregationOption_SummaryOnly) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PeerFamilyParameters) Size() (n int) {
	...
	if m.UnicastIpv4 != nil {
		l = m.UnicastIpv4.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.UnicastIpv6 != nil {
		l = m.UnicastIpv6.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *BfdPeerStatusType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *FamilyInet_Enable) String() string {
	...
	s := strings.Join([]string{`&FamilyInet_Enable{`,
		`Enable:` + strings.Replace(fmt.Sprintf("%v", this.Enable), "UnicastIPv4", "UnicastIPv4", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *FamilyInet6_Enable) String() string {
	...
	s := strings.Join([]string{`&FamilyInet6_Enable{`,
		`Enable:` + strings.Replace(fmt.Sprintf("%v", this.Enable), "UnicastIPv6", "UnicastIPv6", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *UnicastIPv4) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAggregation := "[]*AggregationIPv4{"
	for _, f := range this.Aggregation {
		repeatedStringForAggregation += strings.Replace(f.String(), "AggregationIPv4", "AggregationIPv4", 1) + ","
	}
	repeatedStringForAggregation += "}"
	s := strings.Join([]string{`&UnicastIPv4{`,
		`Aggregation:` + repeatedStringForAggregation + `,`,
		`}`,
	}, "")
	return s
}
func (this *UnicastIPv6) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAggregation := "[]*AggregationIPv6{"
	for _, f := range this.Aggregation {
		repeatedStringForAggregation += strings.Replace(f.String(), "AggregationIPv6", "AggregationIPv6", 1) + ","
	}
	repeatedStringForAggregation += "}"
	s := strings.Join([]string{`&UnicastIPv6{`,
		`Aggregation:` + repeatedStringForAggregation + `,`,
		`}`,
	}, "")
	return s
}
func (this *AggregationIPv4) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForOptions := "[]*AggregationOption{"
	for _, f := range this.Options {
		repeatedStringForOptions += strings.Replace(f.String(), "AggregationOption", "AggregationOption", 1) + ","
	}
	repeatedStringForOptions += "}"
	s := strings.Join([]string{`&AggregationIPv4{`,
...
func (this *AggregationIPv6) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForOptions := "[]*AggregationOption{"
	...
	repeatedStringForOptions += "}"
	s := strings.Join([]string{`&AggregationIPv6{`,
		`IpPrefix:` + fmt.Sprintf("%v", this.IpPrefix) + `,`,
		`Options:` + repeatedStringForOptions + `,`,
		`}`,
	}, "")
...
func (this *AggregationOption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AggregationOption{`,
		`AggregationChoice:` + fmt.Sprintf("%v", this.AggregationChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AggregationOption_SummaryOnly) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AggregationOption_SummaryOnly{`,
		`SummaryOnly:` + strings.Replace(fmt.Sprintf("%v", this.SummaryOnly), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PeerFamilyParameters) String() string {
	...
	s := strings.Join([]string{`&PeerFamilyParameters{`,
		...
		`UnicastIpv4:` + strings.Replace(this.UnicastIpv4.String(), "UnicastIPv4", "UnicastIPv4", 1) + `,`,
		`UnicastIpv6:` + strings.Replace(this.UnicastIpv6.String(), "UnicastIPv6", "UnicastIPv6", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *BfdPeerStatusType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BfdPeerStatusType{`,
...
func (this *BgpPeerStatusType) String() string {
	...
	s := strings.Join([]string{`&BgpPeerStatusType{`,
		...
		`BfdStatus:` + strings.Replace(this.BfdStatus.String(), "BfdPeerStatusType", "BfdPeerStatusType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UnicastIPv4) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnicastIPv4: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnicastIPv4: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Aggregation = append(m.Aggregation, &AggregationIPv4{})
			if err := m.Aggregation[len(m.Aggregation)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *UnicastIPv6) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnicastIPv6: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnicastIPv6: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Aggregation = append(m.Aggregation, &AggregationIPv6{})
			if err := m.Aggregation[len(m.Aggregation)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *AggregationIPv4) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AggregationIPv4: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AggregationIPv4: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.Options = append(m.Options, &AggregationOption{})
...
func (m *AggregationIPv6) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AggregationIPv6: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AggregationIPv6: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AggregationOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AggregationOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AggregationOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 2 {
			...
			m.AggregationChoice = &AggregationOption_SummaryOnly{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *PeerFamilyParameters) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnicastIpv4", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnicastIpv4 == nil {
				m.UnicastIpv4 = &UnicastIPv4{}
			}
			if err := m.UnicastIpv4.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnicastIpv6", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnicastIpv6 == nil {
				m.UnicastIpv6 = &UnicastIPv6{}
			}
			if err := m.UnicastIpv6.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *BfdPeerStatusType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BfdPeerStatusType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BfdPeerStatusType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= BfdPeerState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BgpPeerStatusType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BfdStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BfdStatus == nil {
				m.BfdStatus = &BfdPeerStatusType{}
			}
			if err := m.BfdStatus.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
