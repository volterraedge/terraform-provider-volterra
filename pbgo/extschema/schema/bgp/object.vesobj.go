...
const (
	ObjectDefTblName = "ves.io.schema.bgp.Object.default"
	ObjectType       = "ves.io.schema.bgp.Object"

	StatusObjectDefTblName = "ves.io.schema.bgp.StatusObject.default"
	StatusObjectType       = "ves.io.schema.bgp.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.bgp.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.bgp.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.bgp.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.bgp.StatusObject"
}
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "bgp.Object")
	if err != nil {
...
func (v *ValidateStatusObject) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	if fv, exists := v.FldValidators["bgp_status"]; exists {
		...
		if err := fv(ctx, e.GetBgpStatus(), vOpts...); err != nil {
			return err
		}
...
var DefaultStatusObjectValidator = func() *ValidateStatusObject {
	...
	v.FldValidators["bgp_status"] = BgpStatusTypeValidator().Validate
