...
type StatusObject struct {
	...
	BgpStatus *BgpStatusType `protobuf:"bytes,5,opt,name=bgp_status,json=bgpStatus" json:"bgp_status,omitempty"`
}
...
func (m *StatusObject) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BgpStatus != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintObject(dAtA, i, uint64(m.BgpStatus.Size()))
		n6, err := m.BgpStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func NewPopulatedStatusObject(r randyObject, easy bool) *StatusObject {
	...
	if r.Intn(10) != 0 {
		this.BgpStatus = NewPopulatedBgpStatusType(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func init() { proto.RegisterFile("ves.io/schema/bgp/object.proto", fileDescriptorObject) }
func init() { golang_proto.RegisterFile("ves.io/schema/bgp/object.proto", fileDescriptorObject) }

var fileDescriptorObject = []byte{
	// 528 bytes of a gzipped FileDescriptorProto
	,
}
