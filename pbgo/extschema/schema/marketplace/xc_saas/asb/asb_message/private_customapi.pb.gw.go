...
/*
Package asb_message is a reverse proxy.
...
func request_CustomPrivateAPI_RegisterXCSaaS_0(ctx context.Context, marshaler runtime.Marshaler, client CustomPrivateAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RegisterXCSaaSRequest
	...
	msg, err := client.RegisterXCSaaS(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_CustomPrivateAPI_RegisterXCSaaS_0(ctx context.Context, marshaler runtime.Marshaler, server CustomPrivateAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RegisterXCSaaSRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RegisterXCSaaS(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCustomPrivateAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomPrivateAPIServer) error {
	...
	mux.Handle("POST", pattern_CustomPrivateAPI_RegisterXCSaaS_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CustomPrivateAPI_RegisterXCSaaS_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CustomPrivateAPI_RegisterXCSaaS_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCustomPrivateAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomPrivateAPIClient) error {
	...
	mux.Handle("POST", pattern_CustomPrivateAPI_RegisterXCSaaS_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CustomPrivateAPI_RegisterXCSaaS_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CustomPrivateAPI_RegisterXCSaaS_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ves.io.schema.marketplace.xc_saas.asb.asb_message", "register"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_CustomPrivateAPI_RegisterXCSaaS_0 = runtime.ForwardResponseMessage
)
