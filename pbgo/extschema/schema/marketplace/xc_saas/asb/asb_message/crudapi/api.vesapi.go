...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/marketplace/xc_saas/asb/asb_message"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/marketplace/xc_saas/asb/asb_message/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "asb_message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object",
            "x-ves-proto-service": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "asb_message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object",
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-asb_message-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "asb_message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object",
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.asb_message/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "asb_messageASBResponseMessage": {
            "type": "object",
            "description": "\nThe response message sent to the ASB sender topic contains information about the tenant and its provisioning status",
            "title": "ASBResponseMessage",
            "x-displayname": "ASB Response Message",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.ASBResponseMessage",
            "properties": {
                "document_type": {
                    "description": " Identifies the type of response document\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "DocumentType",
                    "$ref": "#/definitions/asb_messageResponseDocumentType",
                ...
                "notification": {
                    "description": " Information about the specific notification sent\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Notification",
                    "$ref": "#/definitions/asb_messageProvisioningNotification",
        ...
        "asb_messageASBTenantStatus": {
            ...
            "x-ves-proto-enum": "ves.io.schema.marketplace.xc_saas.asb.asb_message.ASBTenantStatus"
        },
        ...
        "asb_messageProvisioningNotification": {
            "type": "object",
            "description": "\nInformation about the provisioning notification sent",
            "title": "ProvisioningNotification",
            "x-displayname": "Provisioning Notification",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.ProvisioningNotification",
            "properties": {
                "activity_date": {
                    "type": "string",
                    "description": " Date of the provisioning action\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "ActivityDate",
                    "format": "date-time",
                ...
                "entitlement_id": {
                    "type": "string",
                    "description": " The entitlement identifier of the purchased service\n\nExample: - \"e5712007-0560-4fcc-b8c9-f4ffbeaf3e4e\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "EntitlementID",
                    "minLength": 1,
                    "maxLength": 256,
                ...
                "order_number": {
                    "type": "string",
                    "description": " The salesforce order number that triggered the service order\n\nExample: - \"O-00040342\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "OrderNumber",
                    "minLength": 1,
                    "maxLength": 256,
                    "x-displayname": "Order Number",
                    "x-ves-example": "O-00040342",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_len": "256",
                ...
                "service": {
                    "description": " Identifies the service that provisioned the order\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.enum.defined_only: true\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Service",
                ...
                "status_details": {
                    "type": "string",
                    "description": " Provisioning status details sent to the ASB(return bus)",
                    "title": "StatusDetails",
                ...
                "status_type": {
                    ...
                    "$ref": "#/definitions/asb_messageASBTenantStatus",
                    "x-displayname": "Status Type",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "tenant_ids": {
                    "type": "array",
                    "description": " List of tenant IDs provisioned\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_len: 256\n  ves.io.schema.rules.repeated.items.string.min_len: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "TenantIDs",
                    "items": {
                        "type": "string",
                        "minLength": 1,
        ...
        "asb_messageResponseDocumentType": {
            "type": "string",
            "description": "Identifies the type of ASB sender message document\n\nDocument type for the ASB sender topic setup by TEEM",
            "title": "ResponseDocumentType",
            "enum": [
                "TEEM_SERVICE_NOTIFICATION"
            ],
            "default": "TEEM_SERVICE_NOTIFICATION",
            "x-displayname": "Response Document Type",
            "x-ves-proto-enum": "ves.io.schema.marketplace.xc_saas.asb.asb_message.ResponseDocumentType"
        },
        ...
        "asb_messageSignupRegistrationMessage": {
            "type": "object",
            "description": "The signup registration message holds customer information and other related provisioning information needed to\nfulfill the tenant registration for further processing in the signup process.",
            "title": "SignupRegistrationMessage",
            "x-displayname": "Signup Registration Message",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.SignupRegistrationMessage",
            "properties": {
                "account_details": {
        ...
        "asb_messageSpecType": {
            "type": "object",
            "description": "Shape of the ASB message specification",
            "title": "ASB Message specification",
            "x-displayname": "ASB Message object specification",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/asbasb_messageGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "asb_messagecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ErrorCode"
        },
        "asbasb_messageGlobalSpecType": {
            "type": "object",
            "description": "Shape of ASB message in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-oneof-field-parsed_type": "[\"none\",\"registration_message\"]",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.GlobalSpecType",
            "properties": {
                "none": {
                    "description": "Exclusive with [registration_message]\n Raw message handling failed or unsupported.",
                    "title": "None",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "No Parsed Message"
                },
                "raw_json": {
                    "type": "object",
                    "description": " Raw JSON message string that holds metadata and payload related to provisioning\n\nExample: - \"{\"documentType\":\"teem-service-order\",\"documentVersion\":\"1.0\",\"serviceOrderType\":\"provisioning\"}\"-",
                    "title": "Raw JSON",
                    "x-displayname": "Raw JSON",
                    "x-ves-example": "{\"documentType\":\"teem-service-order\",\"documentVersion\":\"1.0\",\"serviceOrderType\":\"provisioning\"}"
                },
                "registration_message": {
                    ...
                    "title": "SignupRegistrationMessage",
                    "$ref": "#/definitions/asb_messageSignupRegistrationMessage",
                    "x-displayname": "Signup Registration Message"
                },
                "response_message": {
                    "description": " The response message sent to the ASB sender topic contains information about the tenant and its provisioning status",
                    "title": "ResponseMessage",
                    "$ref": "#/definitions/asb_messageASBResponseMessage",
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/asb_messageSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/asb_messagecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/asb_messagecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/asb_messagecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.asb_message.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/asb_messagecrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/marketplace/xc_saas/asb/asb_message/crudapi/api.proto"
}`
