...
const (
	ObjectDefTblName = "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object.default"
	ObjectType       = "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.marketplace.xc_saas.asb.asb_message.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
