...
const (
	ObjectDefTblName = "ves.io.schema.marketplace.xc_saas.asb.message.Object.default"
	ObjectType       = "ves.io.schema.marketplace.xc_saas.asb.message.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.marketplace.xc_saas.asb.message.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.marketplace.xc_saas.asb.message.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
