...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/marketplace/xc_saas/asb/message"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.marketplace.xc_saas.asb.message.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.marketplace.xc_saas.asb.message.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/marketplace/xc_saas/asb/message/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.marketplace.xc_saas.asb.message/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.message.Object",
            "x-ves-proto-service": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.marketplace.xc_saas.asb.message/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.message.Object",
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.message/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-marketplace-xc_saas-asb-message-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "message",
            "x-ves-object-type": "ves.io.schema.marketplace.xc_saas.asb.message.Object",
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.message/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.message/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.message/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.xc_saas.asb.message/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "asbmessageGlobalSpecType": {
            "type": "object",
            "description": "Shape of message in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-oneof-field-parsed_type": "[\"none\",\"signup_message\"]",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.GlobalSpecType",
            "properties": {
                "none": {
                    "description": "Exclusive with [signup_message]\n Raw message handling failed or unsupported.",
                    "title": "None",
                ...
                "signup_message": {
                    ...
                    "$ref": "#/definitions/messageSignupMessage",
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/messageSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/messagecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/messagecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/messagecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/messagecrudapiErrorCode"
                },
        ...
        "messageActionType": {
            ...
            "x-ves-proto-enum": "ves.io.schema.marketplace.xc_saas.asb.message.ActionType"
        },
        "messageSignupMessage": {
            "type": "object",
            "description": "Signup message holds customer information and other related provisioning information needed to sign up the\ncustomer for F5XC services.",
            "title": "Signup Message",
            "x-displayname": "Signup Message",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.SignupMessage",
            "properties": {
                "account_details": {
        ...
        "messageSpecType": {
            "type": "object",
            "description": "Shape of the message specification",
            "title": "Message specification",
            "x-displayname": "Message object specification",
            "x-ves-proto-message": "ves.io.schema.marketplace.xc_saas.asb.message.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/asbmessageGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "messagecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.marketplace.xc_saas.asb.message.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/marketplace/xc_saas/asb/message/crudapi/api.proto"
}`
