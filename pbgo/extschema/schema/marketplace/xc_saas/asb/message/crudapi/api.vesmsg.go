...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_marketplace_xc_saas_asb_message.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_marketplace_xc_saas_asb_message.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_marketplace_xc_saas_asb_message.DBObject)
	}
	_ = f
