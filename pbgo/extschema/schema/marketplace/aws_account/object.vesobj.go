...
const (
	ObjectDefTblName = "ves.io.schema.marketplace.aws_account.Object.default"
	ObjectType       = "ves.io.schema.marketplace.aws_account.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.marketplace.aws_account.Object"
}
...
func GetObjectIndexers() store.Indexers {
	indexers := store.Indexers{
		"spec.gc_spec.customer_identifier": store.NewIndexInfo(store.WithSecondaryIndex(func(e store.Entry) ([]string, error) {
			obj, ok := e.(*Object)
			if !ok {
				return nil, fmt.Errorf("Index spec.gc_spec.customer_identifier expected *ves.io.schema.marketplace.aws_account.Object, got %T: %#v", e, e)
			}
			return []string{obj.GetSpec().GetGcSpec().GetCustomerIdentifier()}, nil
		})),
	}
	return indexers
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.marketplace.aws_account.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
