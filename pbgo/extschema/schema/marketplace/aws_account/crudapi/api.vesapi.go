...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/marketplace/aws_account"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.marketplace.aws_account.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.marketplace.aws_account.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.marketplace.aws_account.crudapi")
	}

	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.marketplace.aws_account.crudapi.API.Create", nil)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.marketplace.aws_account.crudapi.API.Replace", nil)
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.marketplace.aws_account.crudapi.API.Get", nil)
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.marketplace.aws_account.crudapi.API.List", nil)
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextFromInprocReq(ctx, "ves.io.schema.marketplace.aws_account.crudapi.API.Delete", nil)
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.marketplace.aws_account.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.marketplace.aws_account.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.aws_account.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.aws_account.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.aws_account.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.aws_account.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.aws_account.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.aws_account.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.marketplace.aws_account.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.marketplace.aws_account.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/marketplace/aws_account/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.marketplace.aws_account/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "aws_account",
            "x-ves-object-type": "ves.io.schema.marketplace.aws_account.Object",
            "x-ves-proto-service": "ves.io.schema.marketplace.aws_account.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.marketplace.aws_account/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.marketplace.aws_account/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.aws_account/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.aws_account/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.aws_account/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.marketplace.aws_account/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.marketplace.aws_account.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "aws_accountAWSSubscriptionStatus": {
            ...
            "default": "SUBSCRIBE_SUCCESS",
            "x-displayname": "AWS Customer Subscription Status",
            "x-ves-proto-enum": "ves.io.schema.marketplace.aws_account.AWSSubscriptionStatus"
        },
        "aws_accountGlobalSpecType": {
            "type": "object",
            "description": "Shape of aws_account in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.GlobalSpecType",
            "properties": {
                "aws_account_id": {
                    "type": "string",
                    "description": " AWS account ID associated with the customer identifier\n\nExample: - \"516023652278\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 255\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "aws_account_id",
                    "minLength": 1,
                    "maxLength": 255,
                    "x-displayname": "AWS Account ID",
                    "x-ves-example": "516023652278",
                ...
                "customer_identifier": {
                    "type": "string",
                    "description": " Customer identifier is a unique account(tenant) identifier provided by AWS\n\nExample: - \"HHhd4MFcSzM\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 255\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "customer_identifier",
                    "minLength": 1,
                    "maxLength": 255,
                    "x-displayname": "Customer Identifier",
                    "x-ves-example": "HHhd4MFcSzM",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.max_len": "255",
                        "ves.io.schema.rules.string.min_len": "1"
                    }
                ...
                "product_code": {
                    "type": "string",
                    "description": " Product code provided by AWS for the product listed in AWS Marketplace\n\nExample: - \"a1sz43x6uizq7oxocvxvovrxo\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 255\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "product_code",
                    "minLength": 1,
                    "maxLength": 255,
                    "x-displayname": "Product Code",
                    "x-ves-example": "a1sz43x6uizq7oxocvxvovrxo",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.max_len": "255",
                        "ves.io.schema.rules.string.min_len": "1"
                    }
        ...
        "aws_accountSpecType": {
            "type": "object",
            "description": "Shape of the aws_account specification",
            "title": "AWS Account specification",
            "x-displayname": "AWS Account object specification",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/aws_accountGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "aws_accountcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.marketplace.aws_account.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/aws_accountSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/aws_accountcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/aws_accountcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/aws_accountcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.marketplace.aws_account.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/aws_accountcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/marketplace/aws_account/crudapi/api.proto"
}`
