...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_marketplace_aws_account.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_marketplace_aws_account.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_marketplace_aws_account.DBObject)
	}
	_ = f
