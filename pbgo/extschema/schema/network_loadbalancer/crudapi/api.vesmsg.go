...
import (
	...
	ves_io_schema_network_loadbalancer "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/network_loadbalancer"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_network_loadbalancer.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_network_loadbalancer.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_network_loadbalancer.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_network_loadbalancer.DBObject)
	}
	_ = f
