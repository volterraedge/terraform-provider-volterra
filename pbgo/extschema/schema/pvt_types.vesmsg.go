...
func (m *StatusServerParamsType) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *StatusServerParamsType) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *StatusServerParamsType) DeepCopy() *StatusServerParamsType {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *StatusServerParamsType) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *StatusServerParamsType) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return StatusServerParamsTypeValidator().Validate(ctx, m, opts...)
}

type ValidateStatusServerParamsType struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateStatusServerParamsType) StatusServerListValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "Repeated ValidationRuleHandler for status_server_list")
	}
	...
	validatorFn := func(ctx context.Context, val interface{}, opts ...db.ValidateOpt) error {
		...
		if err := repValFn(ctx, l, opts...); err != nil {
			return errors.Wrap(err, "repeated status_server_list")
		}
		if err := itemsValidatorFn(ctx, elems, opts...); err != nil {
			return errors.Wrap(err, "items status_server_list")
		}
		return nil
	}
...
func (v *ValidateStatusServerParamsType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*StatusServerParamsType)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *StatusServerParamsType got type %s", t)
		}
	}
	if m == nil {
		return nil
	...
	if fv, exists := v.FldValidators["status_server_list"]; exists {
		vOpts := append(opts, db.WithValidateField("status_server_list"))
		if err := fv(ctx, m.GetStatusServerList(), vOpts...); err != nil {
			return err
		}
...
// Well-known symbol for default validator implementation
var DefaultStatusServerParamsTypeValidator = func() *ValidateStatusServerParamsType {
	v := &ValidateStatusServerParamsType{FldValidators: map[string]db.ValidatorFunc{}}
	...
	vrhStatusServerList := v.StatusServerListValidationRuleHandler
	rulesStatusServerList := map[string]string{
		"ves.io.schema.rules.message.required":   "true",
		"ves.io.schema.rules.repeated.max_items": "2",
		"ves.io.schema.rules.repeated.min_items": "2",
		"ves.io.schema.rules.repeated.unique":    "true",
	}
	vFn, err = vrhStatusServerList(rulesStatusServerList)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for StatusServerParamsType.status_server_list: %s", err)
		panic(errMsg)
	}
	v.FldValidators["status_server_list"] = vFn

	return v
}()

func StatusServerParamsTypeValidator() db.Validator {
	return DefaultStatusServerParamsTypeValidator
}
