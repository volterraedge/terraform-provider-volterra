...
// source: ves.io/schema/waf_suppression_rule/object.proto
...
// WAF Suppression Rule Object
//
// x-displayName: "WAF Suppression Rule Object"
// This object allows user to define false positive rule
// Each rule is combined by several attributes,
// part of the attributes are being used for matching, like contexts and detections,
// those should help to determine whether the 'examined' detection should be considered as false positive.
// The state attribute is used to determine the detection's desired state (Enabled, Disabled, Auto Suppressed...).
// For a detection to be considered as false positive,
// all matching attributes must match the detection's compatible property.
// For example, the examined detection's context should match one of the rule's contexts list.
// If a rule's matching attribute is not initialized, it should be ignored in the matching process.
// For example, If the rule's contexts list was not initialized (or empty), and violations list is not empty,
// the 'examined' detection will be determined as false positive only by its violation ID.
// If a match is found, the detection's state should be set to what is configured in the Rule's state.
type Object struct {
	// metadata
	//
	...
	//
	// x-displayName: "Spec"
	// Specification of the desired behavior of the WAF suppression rule instance
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_565a5a16aa23a643, []int{0}
}
...
// WAF Suppression Rule Object Specification
//
// x-displayName: "WAF Suppression Rule Object Specification"
// Shape of the WAF Suppression Rule Object specification
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_565a5a16aa23a643, []int{1}
}
...
// WAF Suppression Rule Status
//
// x-displayName: "WAF Suppression Rule Object"
// WAF Suppression Rule Object to configure false positive rule.
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_565a5a16aa23a643, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.waf_suppression_rule.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.waf_suppression_rule.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.waf_suppression_rule.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.waf_suppression_rule.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.waf_suppression_rule.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.waf_suppression_rule.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/waf_suppression_rule/object.proto", fileDescriptor_565a5a16aa23a643)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/waf_suppression_rule/object.proto", fileDescriptor_565a5a16aa23a643)
}

var fileDescriptor_565a5a16aa23a643 = []byte{
	// 499 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&waf_suppression_rule.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&waf_suppression_rule.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&waf_suppression_rule.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
