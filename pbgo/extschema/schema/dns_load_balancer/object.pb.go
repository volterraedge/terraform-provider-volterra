...
// source: ves.io/schema/dns_load_balancer/object.proto
...
// DNS Load Balanced Record
//
// x-displayName: "DNS Load Balanced Record"
// DNS Load Balanced Record object
type Object struct {
	// metadata
	//
	...
	//
	// x-displayName: "Spec"
	// Specification of the desired behavior of the DNS Load Balanced Record
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b0067946d30a063, []int{0}
}
...
// DNS Load Balanced Record specification
//
// x-displayName: "Specification"
// Shape of the DNS Load Balanced Record specification
...
func (*SpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b0067946d30a063, []int{1}
}
...
// DNS Load Balancer Status Object
//
...
func (*StatusObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b0067946d30a063, []int{2}
}
...
func init() {
	proto.RegisterType((*Object)(nil), "ves.io.schema.dns_load_balancer.Object")
	golang_proto.RegisterType((*Object)(nil), "ves.io.schema.dns_load_balancer.Object")
	proto.RegisterType((*SpecType)(nil), "ves.io.schema.dns_load_balancer.SpecType")
	golang_proto.RegisterType((*SpecType)(nil), "ves.io.schema.dns_load_balancer.SpecType")
	proto.RegisterType((*StatusObject)(nil), "ves.io.schema.dns_load_balancer.StatusObject")
	golang_proto.RegisterType((*StatusObject)(nil), "ves.io.schema.dns_load_balancer.StatusObject")
}

func init() {
	proto.RegisterFile("ves.io/schema/dns_load_balancer/object.proto", fileDescriptor_1b0067946d30a063)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/dns_load_balancer/object.proto", fileDescriptor_1b0067946d30a063)
}

var fileDescriptor_1b0067946d30a063 = []byte{
	// 626 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Object) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&dns_load_balancer.Object{")
...
func (this *SpecType) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&dns_load_balancer.SpecType{")
	if this.GcSpec != nil {
...
func (this *StatusObject) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&dns_load_balancer.StatusObject{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
