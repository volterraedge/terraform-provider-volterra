...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/cloud_elastic_ips", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/cloud_elastic_ips/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/cloud_elastic_ips/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/cloud_elastic_ips", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/cloud_elastic_ips/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.cloud_elastic_ip.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.cloud_elastic_ip")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.cloud_elastic_ip.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.cloud_elastic_ip.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.cloud_elastic_ip.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.cloud_elastic_ip.API.Create' operation on 'cloud_elastic_ip'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.cloud_elastic_ip.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.cloud_elastic_ip.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.cloud_elastic_ip.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.cloud_elastic_ip.API.Replace' operation on 'cloud_elastic_ip'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.cloud_elastic_ip.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.cloud_elastic_ip.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.cloud_elastic_ip.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.cloud_elastic_ip.API.Delete' operation on 'cloud_elastic_ip'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.cloud_elastic_ip.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/cloud_elastic_ips": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.cloud_elastic_ip.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/cloud_elastic_ips/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/cloud_elastic_ips": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/cloud_elastic_ips/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cloud_elastic_ipDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "cloud_elastic_ipCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of cloud_elastic_ip",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the cloud elastic IP",
                    "title": "spec",
                    "$ref": "#/definitions/cloud_elastic_ipCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "cloud_elastic_ipCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the cloud elastic IP",
                    "title": "spec",
                    "$ref": "#/definitions/cloud_elastic_ipGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "cloud_elastic_ipCreateSpecType": {
            "type": "object",
            "description": "Create Cloud Elastic IP creates Cloud Elastic IP object\nObject is attached to a site",
            "title": "Create Cloud Elastic IP",
            "x-displayname": "Create Cloud Elastic IP",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.CreateSpecType",
            "properties": {
                "count": {
                    "type": "integer",
        ...
        "cloud_elastic_ipDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a cloud_elastic_ip",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "cloud_elastic_ipGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read cloud_elastic_ip",
        ...
        "cloud_elastic_ipGetResponseFormatCode": {
            "type": "string",
        ...
        "cloud_elastic_ipGetSpecType": {
            "type": "object",
            "description": "Get cloud elastic ip will get the object from the storage backend for namespace metadata.namespace",
            "title": "Get cloud elastic ip",
            "x-displayname": "Get Cloud Elastic IP",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.GetSpecType",
            "properties": {
                "count": {
                    "type": "integer",
                    "description": " number of Elastic Ips / Public Ips associated with this object per Node\n\nExample: - \"3\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 8\n",
        ...
        "cloud_elastic_ipListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of cloud_elastic_ip",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/cloud_elastic_ipListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "cloud_elastic_ipListResponseItem": {
            "type": "object",
            "description": "By default a summary of cloud_elastic_ip is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of cloud_elastic_ip",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this cloud_elastic_ip",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this cloud_elastic_ip",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates cloud_elastic_ip is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this cloud_elastic_ip",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this cloud_elastic_ip\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this cloud_elastic_ip\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "cloud_elastic_ipReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a cloud_elastic_ip",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the cloud elastic IP",
                    "title": "spec",
                    "$ref": "#/definitions/cloud_elastic_ipReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "cloud_elastic_ipReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ReplaceResponse"
        },
        "cloud_elastic_ipReplaceSpecType": {
            "type": "object",
            "description": "Replace cloud elastic ip will replace cloud elastic ip object with new object",
            "title": "Replace Cloud Elastic IP",
            "x-displayname": "Replace Cloud Elastic IP",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ReplaceSpecType",
            "properties": {
                "count": {
                    "type": "integer",
                    "description": " number of Elastic Ips / Public Ips associated with this object per Node\n\nExample: - \"3\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 8\n",
    ...
    "x-displayname": "Cloud Elastic IP",
    "x-ves-proto-file": "ves.io/schema/cloud_elastic_ip/public_crudapi.proto"
}`
