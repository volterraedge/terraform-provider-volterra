...
const (
	...
	CreateRequestFQN = "ves.io.schema.uztna.uztna_origin_pool.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.uztna.uztna_origin_pool.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.uztna.uztna_origin_pool.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.uztna.uztna_origin_pool.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.uztna.uztna_origin_pool.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.uztna.uztna_origin_pool.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.uztna.uztna_origin_pool.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.uztna.uztna_origin_pool.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.uztna.uztna_origin_pool.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.uztna.uztna_origin_pool.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_origin_pools", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_origin_pools/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_origin_pools/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_origin_pools", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_origin_pools/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_origin_pool.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_origin_pool")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.uztna_origin_pool.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.uztna_origin_pool.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.uztna.uztna_origin_pool.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.uztna.uztna_origin_pool.API.Create' operation on 'uztna_origin_pool'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_origin_pool.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_origin_pool.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_origin_pool.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.uztna_origin_pool.API.Replace' operation on 'uztna_origin_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_origin_pool.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_origin_pool.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_origin_pool.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.uztna_origin_pool.API.Delete' operation on 'uztna_origin_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.uztna.uztna_origin_pool.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/uztna_origin_pools": {
            "post": {
                "summary": "Create Origin Pool",
                "description": "Shape of the origin pool create specification",
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_origin_pool-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_origin_pool.API.Create"
            },
            "x-displayname": "Origin Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_origin_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/uztna_origin_pools/{metadata.name}": {
            "put": {
                "summary": "Replace Origin Pool",
                "description": "Shape of the origin pool replace specification",
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_origin_pool-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_origin_pool.API.Replace"
            },
            "x-displayname": "Origin Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_origin_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_origin_pools": {
            "get": {
                "summary": "List Origin Pool",
                "description": "List the set of uztna_origin_pool in a namespace",
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of uztna_origin_pool",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_origin_pool-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_origin_pool.API.List"
            },
            "x-displayname": "Origin Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_origin_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_origin_pools/{name}": {
            "get": {
                "summary": "Get Origin Pool",
                "description": "Shape of the origin pool get specification",
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_origin_pool-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_origin_pool.API.Get"
            },
            "delete": {
                "summary": "Delete Origin Pool",
                "description": "Delete the specified uztna_origin_pool",
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_origin_poolDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_origin_pool-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_origin_pool.API.Delete"
            },
            "x-displayname": "Origin Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_origin_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "uztna_origin_poolCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of uztna_origin_pool",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/uztnauztna_origin_poolCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_origin_poolCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/uztnauztna_origin_poolGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "uztna_origin_poolDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a uztna_origin_pool",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "uztna_origin_poolGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read uztna_origin_pool",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.GetResponse",
            "properties": {
                "create_form": {
        ...
        "uztna_origin_poolGetResponseFormatCode": {
            "type": "string",
        ...
        "uztna_origin_poolListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of uztna_origin_pool",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/uztna_origin_poolListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "uztna_origin_poolListResponseItem": {
            "type": "object",
            "description": "By default a summary of uztna_origin_pool is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of uztna_origin_pool",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this uztna_origin_pool",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this uztna_origin_pool",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates uztna_origin_pool is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this uztna_origin_pool",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this uztna_origin_pool\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this uztna_origin_pool\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "uztna_origin_poolReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a uztna_origin_pool",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/uztnauztna_origin_poolReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_origin_poolReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.ReplaceResponse"
        },
        ...
        "uztnauztna_origin_poolCreateSpecType": {
            "type": "object",
            "description": "Shape of the origin pool create specification",
            "title": "CreateSpecType",
            "x-displayname": "Create Origin Pool",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.CreateSpecType",
            "properties": {
        ...
        "uztnauztna_origin_poolGetSpecType": {
            "type": "object",
            "description": "Shape of the origin pool get specification",
            "title": "GetSpecType",
            "x-displayname": "Get Origin Pool",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.GetSpecType",
            "properties": {
                "loadbalancer_algorithm": {
                    "description": " When a connection to a endpoint in an upstream cluster is required, the loadbalancer uses\n loadbalancer_algorithm to determine which host is selected.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/uztnauztna_origin_poolLoadbalancerAlgorithm",
        ...
        "uztnauztna_origin_poolReplaceSpecType": {
            "type": "object",
            "description": "Shape of the origin pool replace specification",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace Origin Pool",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.ReplaceSpecType",
            "properties": {
                "loadbalancer_algorithm": {
                    "description": " When a connection to a endpoint in an upstream cluster is required, the loadbalancer uses\n loadbalancer_algorithm to determine which host is selected.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/uztnauztna_origin_poolLoadbalancerAlgorithm",
    ...
    "x-displayname": "Origin Pool",
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_origin_pool/public_crudapi.proto"
}`
