...
import (
	...
	ves_io_schema_uztna_views_uztna_domain_view "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/views/uztna_domain_view"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_views_uztna_domain_view.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_views_uztna_domain_view.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_views_uztna_domain_view.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_views_uztna_domain_view.DBObject)
	}
	_ = f
