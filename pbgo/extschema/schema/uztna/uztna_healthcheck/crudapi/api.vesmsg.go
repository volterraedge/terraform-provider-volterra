...
import (
	...
	ves_io_schema_uztna_uztna_healthcheck "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_healthcheck"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_uztna_healthcheck.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_uztna_healthcheck.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_uztna_healthcheck.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_uztna_healthcheck.DBObject)
	}
	_ = f
