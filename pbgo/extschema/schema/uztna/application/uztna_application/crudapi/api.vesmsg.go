...
import (
	...
	ves_io_schema_uztna_application_uztna_application "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/application/uztna_application"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_application_uztna_application.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_application_uztna_application.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_application_uztna_application.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_application_uztna_application.DBObject)
	}
	_ = f
