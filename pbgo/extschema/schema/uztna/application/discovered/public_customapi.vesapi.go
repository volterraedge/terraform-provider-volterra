...
func (c *CustomAPIGrpcClient) doRPCList(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.uztna.application.discovered.ListRequest", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCList(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &ListRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.uztna.application.discovered.ListRequest: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.uztna.application.discovered.ListResponse", body)
...
func (c *customAPIInprocClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.discovered.CustomAPI.List")
...
func (s *customAPISrv) List(ctx context.Context, in *ListRequest) (*ListResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.uztna.application.discovered.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.uztna.application.discovered.ListRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.List' operation on 'discovered'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.uztna.application.discovered.CustomAPI.List"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.uztna.application.discovered.ListResponse", rsp)...)
...
var CustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Discovered CM Application Object",
        "description": "Discovered CM Application Object. It contains info about\na Discovered App Managed by a BIP-IP Central Manager (CM).",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/uztna/applications/discovered": {
            "get": {
                "summary": "List",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/discoveredListResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    {
                        "name": "label_filter",
                        "description": "x-example: \"site-name in (cm01-eastern-us, cm01-western-us)\"\nA LabelSelectorType expression that every item in list response will satisfy",
                        "in": "query",
                        "required": false,
                        "type": "string",
            ...
            "x-displayname": "Discovered CM Application Custom API",
        ...
        "discoveredListResponse": {
            ...
            "properties": {
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/discoveredGetSpecType"
                    },
                    "x-displayname": "Items"
                }
            }
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/application/discovered/public_customapi.proto"
}`
