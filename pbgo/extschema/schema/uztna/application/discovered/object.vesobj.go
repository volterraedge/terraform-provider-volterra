...
const (
	ObjectDefTblName = "ves.io.schema.uztna.application.discovered.Object.default"
	ObjectType       = "ves.io.schema.uztna.application.discovered.Object"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.uztna.application.discovered.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		...
		dri.DRField = "ves.io.schema.uztna.application.discovered.Object." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
