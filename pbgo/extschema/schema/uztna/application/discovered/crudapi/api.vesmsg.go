...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_application_discovered.SpecTypeValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_application_discovered.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_application_discovered.DBObject)
	}
	_ = f
