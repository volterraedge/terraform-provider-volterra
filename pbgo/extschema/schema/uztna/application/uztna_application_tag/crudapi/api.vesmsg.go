...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_application_uztna_application_tag.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_application_uztna_application_tag.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_application_uztna_application_tag.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_application_uztna_application_tag.DBObject)
	}
	_ = f
