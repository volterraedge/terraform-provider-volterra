...
const (
	...
	CreateRequestFQN = "ves.io.schema.uztna.application.uztna_application_tag.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.uztna.application.uztna_application_tag.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.uztna.application.uztna_application_tag.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.uztna.application.uztna_application_tag.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.uztna.application.uztna_application_tag.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.uztna.application.uztna_application_tag.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.uztna.application.uztna_application_tag.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.uztna.application.uztna_application_tag.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.uztna.application.uztna_application_tag.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.uztna.application.uztna_application_tag.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_application_tags", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_application_tags/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_application_tags/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_application_tags", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_application_tags/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.uztna_application_tag.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.uztna_application_tag")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.uztna_application_tag.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.uztna_application_tag.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.uztna.application.uztna_application_tag.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.uztna.application.uztna_application_tag.API.Create' operation on 'uztna_application_tag'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.uztna.application.uztna_application_tag.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_application_tag.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_application_tag.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.application.uztna_application_tag.API.Replace' operation on 'uztna_application_tag'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_application_tag.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.uztna.application.uztna_application_tag.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.application.uztna_application_tag.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.application.uztna_application_tag.API.Delete' operation on 'uztna_application_tag'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.uztna.application.uztna_application_tag.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "UZTNA  Application Tag",
        "description": "ZTNA Application tag for managing access to ZTNA applications",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/uztna_application_tags": {
            "post": {
                "summary": "Create Specification",
                "description": "Shape of the UZTNA Application Tag",
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.API.Create"
            },
            "x-displayname": "UZTNA Application Tag",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application_tag.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/uztna_application_tags/{metadata.name}": {
            "put": {
                "summary": "Replace Specification",
                "description": "Shape of the UZTNA Application Tag",
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.API.Replace"
            },
            "x-displayname": "UZTNA Application Tag",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application_tag.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_application_tags": {
            "get": {
                "summary": "List UZTNA Application Tag",
                "description": "List the set of uztna_application_tag in a namespace",
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.API.List"
            },
            "x-displayname": "UZTNA Application Tag",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application_tag.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_application_tags/{name}": {
            "get": {
                "summary": "Get Specification",
                "description": "Shape of the UZTNA Application Tag",
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.API.Get"
            },
            "delete": {
                "summary": "Delete UZTNA Application Tag",
                "description": "Delete the specified uztna_application_tag",
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_application_tagDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.API.Delete"
            },
            "x-displayname": "UZTNA Application Tag",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application_tag.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "uztna_application_tagCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of uztna_application_tag",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the application tag",
                    "title": "spec",
                    "$ref": "#/definitions/uztna_application_tagCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_application_tagCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the application tag",
                    "title": "spec",
                    "$ref": "#/definitions/uztna_application_tagGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "uztna_application_tagCreateSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA Application Tag",
            "title": "CreateSpecType",
            "x-displayname": "Create Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.CreateSpecType",
            "properties": {
                "tag": {
                    "type": "string",
        ...
        "uztna_application_tagDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a uztna_application_tag",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "uztna_application_tagGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read uztna_application_tag",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.GetResponse",
            "properties": {
                "create_form": {
        ...
        "uztna_application_tagGetResponseFormatCode": {
            "type": "string",
        ...
        "uztna_application_tagGetSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA Application Tag",
            "title": "GetSpecType",
            "x-displayname": "Get Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.GetSpecType",
            "properties": {
                "tag": {
                    "type": "string",
                    "description": " This field is used to create a tag that will be attached to the application.\n\nExample: - \"APPGRP-MKTG\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 1024\n  ves.io.schema.rules.string.min_bytes: 1\n",
        ...
        "uztna_application_tagListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of uztna_application_tag",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/uztna_application_tagListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "uztna_application_tagListResponseItem": {
            "type": "object",
            "description": "By default a summary of uztna_application_tag is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of uztna_application_tag",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this uztna_application_tag",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this uztna_application_tag",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates uztna_application_tag is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this uztna_application_tag",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this uztna_application_tag\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this uztna_application_tag\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "uztna_application_tagReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a uztna_application_tag",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the application tag",
                    "title": "spec",
                    "$ref": "#/definitions/uztna_application_tagReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_application_tagReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.ReplaceResponse"
        },
        "uztna_application_tagReplaceSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA Application Tag",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.ReplaceSpecType",
            "properties": {
                "tag": {
                    "type": "string",
                    "description": " This field is used to create a tag that will be attached to the application.\n\nExample: - \"APPGRP-MKTG\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 1024\n  ves.io.schema.rules.string.min_bytes: 1\n",
    ...
    "x-displayname": "UZTNA Application Tag",
    "x-ves-proto-file": "ves.io/schema/uztna/application/uztna_application_tag/public_crudapi.proto"
}`
