...
import (
	...
	ves_io_schema_uztna_uztna_gateway "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_gateway"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_uztna_gateway.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_uztna_gateway.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_uztna_gateway.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_uztna_gateway.DBObject)
	}
	_ = f
