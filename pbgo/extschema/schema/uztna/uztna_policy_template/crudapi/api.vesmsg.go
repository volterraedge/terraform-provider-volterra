...
import (
	...
	ves_io_schema_uztna_uztna_policy_template "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_policy_template"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_uztna_policy_template.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_uztna_policy_template.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_uztna_policy_template.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_uztna_policy_template.DBObject)
	}
	_ = f
