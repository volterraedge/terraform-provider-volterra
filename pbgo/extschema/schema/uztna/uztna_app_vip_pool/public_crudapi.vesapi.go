...
const (
	...
	CreateRequestFQN = "ves.io.schema.uztna.uztna_app_vip_pool.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.uztna.uztna_app_vip_pool.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.uztna.uztna_app_vip_pool.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.uztna.uztna_app_vip_pool.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.uztna.uztna_app_vip_pool.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.uztna.uztna_app_vip_pool.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.uztna.uztna_app_vip_pool.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.uztna.uztna_app_vip_pool.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.uztna.uztna_app_vip_pool.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.uztna.uztna_app_vip_pool.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_app_vip_pools", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_app_vip_pools/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_app_vip_pools/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_app_vip_pools", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_app_vip_pool.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_app_vip_pool")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_app_vip_pool.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_app_vip_pool.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_app_vip_pool.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_app_vip_pool.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_app_vip_pool.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.uztna_app_vip_pool.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.uztna_app_vip_pool.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_app_vip_pool.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_app_vip_pool.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.uztna.uztna_app_vip_pool.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.uztna.uztna_app_vip_pool.API.Create' operation on 'uztna_app_vip_pool'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_app_vip_pool.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_app_vip_pool.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_app_vip_pool.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_app_vip_pool.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_app_vip_pool.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.uztna_app_vip_pool.API.Replace' operation on 'uztna_app_vip_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_app_vip_pool.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_app_vip_pool.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_app_vip_pool.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_app_vip_pool.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_app_vip_pool.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_app_vip_pool.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_app_vip_pool.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.uztna.uztna_app_vip_pool.API.Delete' operation on 'uztna_app_vip_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.uztna.uztna_app_vip_pool.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Pool of IP addresses to auto-assign Virtual IP’s to Application during the \nZTNA Application configuration",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/uztna_app_vip_pools": {
            "post": {
                "summary": "Create Specification",
                "description": "\nShape of the UZTNA Tenant",
                "operationId": "ves.io.schema.uztna.uztna_app_vip_pool.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_app_vip_poolCreateResponse"
                        }
                    },
                    "401": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_app_vip_pool-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_app_vip_pool.API.Create"
            },
            "x-displayname": "Application VIP Pool",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_app_vip_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/uztna_app_vip_pools/{metadata.name}": {
            "put": {
                "summary": "Replace Specification",
                "description": "\nShape of the UZTNA Tenant",
                "operationId": "ves.io.schema.uztna.uztna_app_vip_pool.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_app_vip_poolReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_app_vip_pool-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/uztna_app_vip_pools": {
            "get": {
                "summary": "List Application VIP Pool",
                "description": "List the set of uztna_app_vip_pool in a namespace",
                "operationId": "ves.io.schema.uztna.uztna_app_vip_pool.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_app_vip_poolListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_app_vip_pool-api-list"
                },
        ...
        "/public/namespaces/{namespace}/uztna_app_vip_pools/{name}": {
            "get": {
                "summary": "Get Tenant schema",
                "description": "\nGet a new gateways object.",
                "operationId": "ves.io.schema.uztna.uztna_app_vip_pool.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_app_vip_poolGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_app_vip_pool-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_app_vip_pool.API.Get"
            },
            "delete": {
                "summary": "Delete Application VIP Pool",
                "description": "Delete the specified uztna_app_vip_pool",
                "operationId": "ves.io.schema.uztna.uztna_app_vip_pool.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_app_vip_poolDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_app_vip_pool-api-delete"
                },
    ...
    "definitions": {
        ...
        "uztna_app_vip_poolCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of uztna_app_vip_pool",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.CreateRequest",
            "properties": {
                "metadata": {
        ...
        "uztna_app_vip_poolListResponseItem": {
            ...
            "properties": {
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this uztna_app_vip_pool",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this uztna_app_vip_pool\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this uztna_app_vip_pool\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "uztna_app_vip_poolReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a uztna_app_vip_pool",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna app vip pool",
                    "title": "spec",
                    "$ref": "#/definitions/uztnauztna_app_vip_poolReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_app_vip_poolReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.ReplaceResponse"
        },
        ...
        "uztnauztna_app_vip_poolCreateSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA Tenant",
            "title": "CreateSpecType",
            "x-displayname": "Create Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.CreateSpecType",
            "properties": {
                "ip_version": {
        ...
        "uztnauztna_app_vip_poolGetSpecType": {
            "type": "object",
            "description": "\nGet a new gateways object.",
            "title": "Get Tenant Schema",
            "x-displayname": "Get Tenant schema",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.GetSpecType",
            "properties": {
                "ip_version": {
                    "description": " IP address ranges for the Application VIP Pool Range \n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/uztna_app_vip_poolIPVersion",
        ...
        "uztnauztna_app_vip_poolReplaceSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA Tenant",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_app_vip_pool.ReplaceSpecType",
            "properties": {
                "ip_version": {
                    "description": " IP address ranges for the Application VIP Pool Range \n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/uztna_app_vip_poolIPVersion",
    ...
    "x-displayname": "Application VIP Pool",
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_app_vip_pool/public_crudapi.proto"
}`
