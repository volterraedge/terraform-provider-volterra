...
import (
	...
	ves_io_schema_uztna_uztna_app_vip_pool "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_app_vip_pool"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_uztna_uztna_app_vip_pool.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_uztna_uztna_app_vip_pool.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_uztna_uztna_app_vip_pool.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_uztna_uztna_app_vip_pool.DBObject)
	}
	_ = f
