...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_domains", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_domains/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_domains/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_domains", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/uztna_domains/%s", c.baseURL, dReq.Namespace, dReq.Name)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_domain.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_domain")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.uztna_domain.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.uztna_domain.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.uztna.uztna_domain.CreateRequest"
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_domain.CreateResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
	}
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_domain.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_domain.API.ReplaceRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_domain.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.uztna.uztna_domain.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.uztna.uztna_domain.API.DeleteRequest", req)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.uztna.uztna_domain.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/uztna_domains": {
            "post": {
                "summary": "Create Specification",
                "description": "Shape of the UZTNA ZeroTrust Domain",
                "operationId": "ves.io.schema.uztna.uztna_domain.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_domainCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_domainCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_domain-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_domain.API.Create"
            },
            "x-displayname": "ZeroTrust Info",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/uztna_domains/{metadata.name}": {
            "put": {
                "summary": "Replace Specification",
                "description": "Shape of the UZTNA ZeroTrust Domain",
                "operationId": "ves.io.schema.uztna.uztna_domain.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_domainReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_domainReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_domain-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_domain.API.Replace"
            },
            "x-displayname": "ZeroTrust Info",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_domains": {
            "get": {
                "summary": "List ZeroTrust Info",
                "description": "List the set of uztna_domain in a namespace",
                "operationId": "ves.io.schema.uztna.uztna_domain.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_domainListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_domain-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_domain.API.List"
            },
            "x-displayname": "ZeroTrust Info",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/uztna_domains/{name}": {
            "get": {
                "summary": "Get Specification",
                "description": "Shape of the UZTNA ZeroTrust Domain",
                "operationId": "ves.io.schema.uztna.uztna_domain.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/uztna_domainGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_domain-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_domain.API.Get"
            },
            "delete": {
                "summary": "Delete ZeroTrust Info",
                "description": "Delete the specified uztna_domain",
                "operationId": "ves.io.schema.uztna.uztna_domain.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/uztna_domainDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-uztna_domain-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.uztna.uztna_domain.API.Delete"
            },
            "x-displayname": "ZeroTrust Info",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "uztna_domainCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of uztna_domain",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/uztna_domainCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_domainCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna gateway",
                    "title": "spec",
                    "$ref": "#/definitions/uztna_domainGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "uztna_domainCreateSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA ZeroTrust Domain",
            "title": "CreateSpecType",
            "x-displayname": "Create Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.CreateSpecType",
            "properties": {
                "access_url": {
                    "type": "string",
                ...
                "lease_pool": {
                    "description": " This is List of LeasePool Object created.From the List we can assign one LeasePool to one ZeroTrust Domain. \n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "profile_name": {
                    "type": "string",
                    "description": " Ztna Profile Name used to refer the ZTNA profile\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 1024\n",
                    "maxLength": 1024,
        ...
        "uztna_domainDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a uztna_domain",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "uztna_domainDomainPerimeterRE": {
            "type": "object",
            "description": "\nSelected Perimeter RE Sites",
            "title": "Perimeter RE Site",
            "x-displayname": "Perimeter RE Site",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.DomainPerimeterRE",
            "properties": {
                "perimeter_re_site": {
                    "type": "array",
        ...
        "uztna_domainDomainSites": {
            "type": "object",
            "description": "Selected BigIP CE.",
            "title": "BigIP CE",
            "x-displayname": "BigIP CE",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.DomainSites",
            "properties": {
                "uztna_gateway": {
                    "type": "array",
                    "description": " List of All avaliable Big IP CE List",
                    "title": "Available Big Ip Access List",
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                    },
        ...
        "uztna_domainGateways": {
            ...
            "properties": {
                "bigip_ce": {
                    ...
                    "title": "BigIP CE List",
                    "$ref": "#/definitions/uztna_domainDomainSites",
                ...
                "perimeter_re": {
                    ...
                    "$ref": "#/definitions/uztna_domainPerimeterREAdvertisement",
                    "x-displayname": "Perimeter RE"
                }
            }
        },
        "uztna_domainGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read uztna_domain",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.GetResponse",
            "properties": {
                "create_form": {
        ...
        "uztna_domainGetResponseFormatCode": {
            "type": "string",
        ...
        "uztna_domainGetSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA ZeroTrust Domain",
            "title": "GetSpecType",
            "x-displayname": "Get Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.GetSpecType",
            "properties": {
                "access_url": {
                    "type": "string",
                    "description": " x-example: \"/not-found\"\n Url to access the gateways\n\nExample: - \"https://example.com/landing/page\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 1024\n  ves.io.schema.rules.string.url_or_uri_ref: true\n",
        ...
        "uztna_domainLeasePoolList": {
            ...
            "properties": {
                "uztna_lpool": {
                    "type": "array",
                    "description": " Lease Pool for UZTNA Domain\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "LeasePool",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
        ...
        "uztna_domainListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of uztna_domain",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/uztna_domainListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "uztna_domainListResponseItem": {
            "type": "object",
            "description": "By default a summary of uztna_domain is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of uztna_domain",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this uztna_domain",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this uztna_domain",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates uztna_domain is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this uztna_domain",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this uztna_domain\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this uztna_domain\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "uztna_domainPerimeterREAdvertisement": {
            "type": "object",
            "description": "Advertise on all perimeter RE or Some Selected\nPerimter RE list",
            "title": "PerimeterREAdvertisement",
            "x-displayname": "PerimeterREAdvertisement",
            "x-ves-oneof-field-perimter_re_choice": "[\"all_perimeter\",\"domain_re_sites\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.PerimeterREAdvertisement",
            "properties": {
                "all_perimeter": {
                    "description": "Exclusive with [domain_re_sites]\n This option will allow to advertise on all available perimeter RE sites",
                    "title": "All",
                ...
                "domain_re_sites": {
                    ...
                    "title": "Specific",
                    "$ref": "#/definitions/uztna_domainDomainPerimeterRE",
                    "x-displayname": "Advertise on specific Perimeter RE site"
                }
            }
        },
        "uztna_domainReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a uztna_domain",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the uztna gateway",
                    "title": "spec",
                    "$ref": "#/definitions/uztna_domainReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "uztna_domainReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.ReplaceResponse"
        },
        "uztna_domainReplaceSpecType": {
            "type": "object",
            "description": "Shape of the UZTNA ZeroTrust Domain",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.ReplaceSpecType",
            "properties": {
                "access_url": {
                    "type": "string",
                    "description": " x-example: \"/not-found\"\n Url to access the gateways\n\nExample: - \"https://example.com/landing/page\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 1024\n  ves.io.schema.rules.string.url_or_uri_ref: true\n",
    ...
    "x-displayname": "ZeroTrust Info",
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_domain/public_crudapi.proto"
}`
