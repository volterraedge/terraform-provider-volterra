...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/unified_policy_groups", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/unified_policy_groups/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/unified_policy_groups/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/unified_policy_groups", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/unified_policy_groups/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.unified_policy_group.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.unified_policy_group")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.unified_policy_group.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.unified_policy_group.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.unified_policy_group.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.unified_policy_group.API.Create' operation on 'unified_policy_group'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.unified_policy_group.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.unified_policy_group.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.unified_policy_group.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.unified_policy_group.API.Replace' operation on 'unified_policy_group'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.unified_policy_group.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.unified_policy_group.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.unified_policy_group.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.unified_policy_group.API.Delete' operation on 'unified_policy_group'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.unified_policy_group.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "unified policy group object",
        "description": "A unified_policy_group object consists of a collection of network and security policies that can be applied together universally to all segments.\nIt will contain the following types of policies:\n   - enhanced firewall policy\n   - east west unified policy group\n   - forward proxy policy",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/unified_policy_groups": {
            "post": {
                "summary": "Create unified policy group",
                "description": "Create unified_policy_group creates a new object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.unified_policy_group.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.API.Create"
            },
            "x-displayname": "unified policy group",
            "x-ves-proto-service": "ves.io.schema.unified_policy_group.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/unified_policy_groups/{metadata.name}": {
            "put": {
                "summary": "Replace unified policy group",
                "description": "Replace unified_policy_group replaces an existing object in the storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.unified_policy_group.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.API.Replace"
            },
            "x-displayname": "unified policy group",
            "x-ves-proto-service": "ves.io.schema.unified_policy_group.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/unified_policy_groups": {
            "get": {
                "summary": "List unified policy group",
                "description": "List the set of unified_policy_group in a namespace",
                "operationId": "ves.io.schema.unified_policy_group.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.API.List"
            },
            "x-displayname": "unified policy group",
            "x-ves-proto-service": "ves.io.schema.unified_policy_group.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/unified_policy_groups/{name}": {
            "get": {
                "summary": "Get unified policy group",
                "description": "Get unified_policy_group reads a given object from storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.unified_policy_group.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.API.Get"
            },
            "delete": {
                "summary": "Delete unified policy group",
                "description": "Delete the specified unified_policy_group",
                "operationId": "ves.io.schema.unified_policy_group.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/unified_policy_groupDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.API.Delete"
            },
            "x-displayname": "unified policy group",
            "x-ves-proto-service": "ves.io.schema.unified_policy_group.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "schemaunified_policy_groupCreateSpecType": {
            "type": "object",
            "description": "Create unified_policy_group creates a new object in the storage backend for metadata.namespace.",
            "title": "Create unified policy group",
            "x-displayname": "Create unified policy group",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.CreateSpecType",
            "properties": {
                "east_west_policy": {
        ...
        "schemaunified_policy_groupGetSpecType": {
            "type": "object",
            "description": "Get unified_policy_group reads a given object from storage backend for metadata.namespace.",
            "title": "Get unified policy group",
            "x-displayname": "Get unified policy group",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.GetSpecType",
            "properties": {
                "east_west_policy": {
                    "description": " Manage policies for inter and intra segment traffic",
                    "$ref": "#/definitions/unified_policy_groupEastWestPolicyType",
        ...
        "schemaunified_policy_groupReplaceSpecType": {
            "type": "object",
            "description": "Replace unified_policy_group replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace unified policy group",
            "x-displayname": "Replace unified policy group",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.ReplaceSpecType",
            "properties": {
                "east_west_policy": {
                    "description": " Manage policies for inter and intra segment traffic",
                    "$ref": "#/definitions/unified_policy_groupEastWestPolicyType",
        ...
        "unified_policy_groupCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of unified_policy_group",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the unified_policy_group",
                    "title": "spec",
                    "$ref": "#/definitions/schemaunified_policy_groupCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "unified_policy_groupCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the unified_policy_group",
                    "title": "spec",
                    "$ref": "#/definitions/schemaunified_policy_groupGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "unified_policy_groupDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a unified_policy_group",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "unified_policy_groupGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read unified_policy_group",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.GetResponse",
            "properties": {
                "create_form": {
        ...
        "unified_policy_groupGetResponseFormatCode": {
            "type": "string",
        ...
        "unified_policy_groupListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of unified_policy_group",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/unified_policy_groupListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "unified_policy_groupListResponseItem": {
            "type": "object",
            "description": "By default a summary of unified_policy_group is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of unified_policy_group",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this unified_policy_group",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this unified_policy_group",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates unified_policy_group is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this unified_policy_group",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this unified_policy_group\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this unified_policy_group\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "unified_policy_groupReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a unified_policy_group",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the unified_policy_group",
                    "title": "spec",
                    "$ref": "#/definitions/schemaunified_policy_groupReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "unified_policy_groupReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.ReplaceResponse"
        },
    ...
    "x-displayname": "unified policy group",
    "x-ves-proto-file": "ves.io/schema/unified_policy_group/public_crudapi.proto"
}`
