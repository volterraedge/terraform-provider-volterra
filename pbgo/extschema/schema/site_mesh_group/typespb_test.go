...
func TestSiteMeshGroupStatusProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &SiteMeshGroupStatus{}
	if err := proto.Unmarshal(dAtA, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(dAtA))
...
func TestSiteMeshGroupStatusMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, false)
	size := p.Size()
...
func BenchmarkSiteMeshGroupStatusProtoMarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SiteMeshGroupStatus, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSiteMeshGroupStatus(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := proto.Marshal(pops[i%10000])
...
func BenchmarkSiteMeshGroupStatusProtoUnmarshal(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedSiteMeshGroupStatus(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSiteMeshGroupStatusJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestSiteMeshGroupStatusProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestSiteMeshGroupStatusProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestSiteMeshGroupStatusGoString(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSiteMeshGroupStatus(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestSiteMeshGroupStatusSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedSiteMeshGroupStatus(popr, true)
	size2 := proto.Size(p)
...
func BenchmarkSiteMeshGroupStatusSize(b *testing.B) {
	popr := rand.New(rand.NewSource(616))
	total := 0
	pops := make([]*SiteMeshGroupStatus, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSiteMeshGroupStatus(popr, false)
	}
	b.ResetTimer()
...
func TestSiteMeshGroupStatusStringer(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSiteMeshGroupStatus(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
