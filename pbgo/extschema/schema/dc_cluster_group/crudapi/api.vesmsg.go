...
import (
	...
	ves_io_schema_dc_cluster_group "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/dc_cluster_group"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_dc_cluster_group.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_dc_cluster_group.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_dc_cluster_group.DBObject)
	}
	_ = f
