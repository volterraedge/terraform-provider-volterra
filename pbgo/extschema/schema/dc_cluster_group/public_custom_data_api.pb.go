...
// APIs to get monitoring data for DC Cluster Group
...
func (MetricType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2307ac15b290439f, []int{0}
}
...
func (MetricLabel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2307ac15b290439f, []int{1}
}
...
type MetricsRequest struct {
	...
	GroupBy []MetricLabel `protobuf:"varint,3,rep,packed,name=group_by,json=groupBy,proto3,enum=ves.io.schema.dc_cluster_group.MetricLabel" json:"group_by,omitempty"`
	// Field Selector
	//
	...
	FieldSelector []MetricType `protobuf:"varint,4,rep,packed,name=field_selector,json=fieldSelector,proto3,enum=ves.io.schema.dc_cluster_group.MetricType" json:"field_selector,omitempty"`
	// Start time
	//
...
func (*MetricTypeData) Descriptor() ([]byte, []int) {
	return fileDescriptor_2307ac15b290439f, []int{2}
}
...
func (*MetricData) Descriptor() ([]byte, []int) {
	return fileDescriptor_2307ac15b290439f, []int{3}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.dc_cluster_group.MetricTypeData.KeyEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.dc_cluster_group.MetricTypeData.KeyEntry")
...
func init() {
	proto.RegisterFile("ves.io/schema/dc_cluster_group/public_custom_data_api.proto", fileDescriptor_2307ac15b290439f)
}
func init() {
	golang_proto.RegisterFile("ves.io/schema/dc_cluster_group/public_custom_data_api.proto", fileDescriptor_2307ac15b290439f)
}

var fileDescriptor_2307ac15b290439f = []byte{
	...
	,
}
...
func (c *customDataAPIClient) Metrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ves.io.schema.dc_cluster_group.CustomDataAPI/Metrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
