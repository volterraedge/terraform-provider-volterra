...
import (
	...
	ves_io_schema_terraform_container_version "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/terraform_container_version"
)
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_terraform_container_version.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_terraform_container_version.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_terraform_container_version.DBObject)
	}
	_ = f
