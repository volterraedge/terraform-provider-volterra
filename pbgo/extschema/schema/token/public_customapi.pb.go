...
//
// x-displayName: "Get cloud-init config Request"
...
type GetCloudInitConfigReq struct {
	...
	// Management Network choice
	//
	// x-displayName: "Management Network choice"
	// management network choice for this cloud-init config
	EnableManagementNetwork bool `protobuf:"varint,3,opt,name=enable_management_network,json=enableManagementNetwork,proto3" json:"enable_management_network,omitempty"`
}
...
func (m *GetCloudInitConfigReq) GetEnableManagementNetwork() bool {
	if m != nil {
		return m.EnableManagementNetwork
	}
	return false
}
...
var fileDescriptor_1daf03efacb073ee = []byte{
	...
	,
}
...
func (this *GetCloudInitConfigReq) Equal(that interface{}) bool {
	...
	if this.EnableManagementNetwork != that1.EnableManagementNetwork {
		return false
	}
	return true
}
...
func (this *GetCloudInitConfigReq) GoString() string {
	...
	s = append(s, "EnableManagementNetwork: "+fmt.Sprintf("%#v", this.EnableManagementNetwork)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *GetCloudInitConfigReq) String() string {
	...
	s := strings.Join([]string{`&GetCloudInitConfigReq{`,
		...
		`EnableManagementNetwork:` + fmt.Sprintf("%v", this.EnableManagementNetwork) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *GetCloudInitConfigReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableManagementNetwork", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableManagementNetwork = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipPublicCustomapi(dAtA[iNdEx:])
			if err != nil {
