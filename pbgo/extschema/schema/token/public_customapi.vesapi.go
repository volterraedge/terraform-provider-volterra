...
func (s *customAPISrv) TokenState(ctx context.Context, in *StateReq) (*ObjectChangeResp, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.token.StateReq", in)
	defer func() {
		if len(bodyFields) > 0 {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.token.CustomAPI.TokenState"); rvFn != nil {
