...
type GlobalSpecType struct {
	...
	// x-required
	// Select pod security policies for this k8s cluster, removed in k8s version 1.25. Use pod security admission.
	//
	...
	// x-required
	// Select pod security admission configuration for this k8s cluster, available from k8s version 1.25
	//
	// Types that are valid to be assigned to PodSecurityAdmissionChoice:
	//	*GlobalSpecType_UseDefaultPodSecurityAdmission
	//	*GlobalSpecType_UseCustomPodSecurityAdmission
	PodSecurityAdmissionChoice isGlobalSpecType_PodSecurityAdmissionChoice `protobuf_oneof:"pod_security_admission_choice"`
	// view_internal
	//
	...
	// Internal Pod Security Admission
	//
	// x-displayName: "Internal Pod Security Admission"
	// Internal Pod Security Admission is default or custom
	FinalPodSecurityAdmission *views.ObjectRefType `protobuf:"bytes,1004,opt,name=final_pod_security_admission,json=finalPodSecurityAdmission,proto3" json:"final_pod_security_admission,omitempty"`
}
...
type isGlobalSpecType_PodSecurityAdmissionChoice interface {
	isGlobalSpecType_PodSecurityAdmissionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GlobalSpecType_UseDefaultPodSecurityAdmission struct {
	UseDefaultPodSecurityAdmission *schema.Empty `protobuf:"bytes,29,opt,name=use_default_pod_security_admission,json=useDefaultPodSecurityAdmission,proto3,oneof" json:"use_default_pod_security_admission,omitempty"`
}
type GlobalSpecType_UseCustomPodSecurityAdmission struct {
	UseCustomPodSecurityAdmission *views.ObjectRefType `protobuf:"bytes,30,opt,name=use_custom_pod_security_admission,json=useCustomPodSecurityAdmission,proto3,oneof" json:"use_custom_pod_security_admission,omitempty"`
}
...
func (*GlobalSpecType_UseDefaultPodSecurityAdmission) isGlobalSpecType_PodSecurityAdmissionChoice() {}
func (*GlobalSpecType_UseCustomPodSecurityAdmission) isGlobalSpecType_PodSecurityAdmissionChoice()  {}
...
func (m *GlobalSpecType) GetPodSecurityAdmissionChoice() isGlobalSpecType_PodSecurityAdmissionChoice {
	if m != nil {
		return m.PodSecurityAdmissionChoice
	}
	return nil
}
...
func (m *GlobalSpecType) GetUseDefaultPodSecurityAdmission() *schema.Empty {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*GlobalSpecType_UseDefaultPodSecurityAdmission); ok {
		return x.UseDefaultPodSecurityAdmission
	}
	return nil
}

func (m *GlobalSpecType) GetUseCustomPodSecurityAdmission() *views.ObjectRefType {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*GlobalSpecType_UseCustomPodSecurityAdmission); ok {
		return x.UseCustomPodSecurityAdmission
	}
	return nil
}
...
func (m *GlobalSpecType) GetFinalPodSecurityAdmission() *views.ObjectRefType {
	if m != nil {
		return m.FinalPodSecurityAdmission
	}
	return nil
}
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_UseDefaultPodSecurityAdmission)(nil),
		(*GlobalSpecType_UseCustomPodSecurityAdmission)(nil),
	}
}
...
type CreateSpecType struct {
	...
	// Types that are valid to be assigned to Vk8SNamespaceAccessChoice:
	//	*CreateSpecType_Vk8SNamespaceAccessDeny
	//	*CreateSpecType_Vk8SNamespaceAccessPermit
	Vk8SNamespaceAccessChoice isCreateSpecType_Vk8SNamespaceAccessChoice `protobuf_oneof:"vk8s_namespace_access_choice"`
	// Types that are valid to be assigned to PodSecurityAdmissionChoice:
	//	*CreateSpecType_UseDefaultPodSecurityAdmission
	//	*CreateSpecType_UseCustomPodSecurityAdmission
	PodSecurityAdmissionChoice isCreateSpecType_PodSecurityAdmissionChoice `protobuf_oneof:"pod_security_admission_choice"`
}
...
type isCreateSpecType_Vk8SNamespaceAccessChoice interface {
	isCreateSpecType_Vk8SNamespaceAccessChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
type isCreateSpecType_PodSecurityAdmissionChoice interface {
	isCreateSpecType_PodSecurityAdmissionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type CreateSpecType_Vk8SNamespaceAccessDeny struct {
	Vk8SNamespaceAccessDeny *schema.Empty `protobuf:"bytes,26,opt,name=vk8s_namespace_access_deny,json=vk8sNamespaceAccessDeny,proto3,oneof" json:"vk8s_namespace_access_deny,omitempty"`
}
type CreateSpecType_Vk8SNamespaceAccessPermit struct {
	Vk8SNamespaceAccessPermit *schema.Empty `protobuf:"bytes,27,opt,name=vk8s_namespace_access_permit,json=vk8sNamespaceAccessPermit,proto3,oneof" json:"vk8s_namespace_access_permit,omitempty"`
}
type CreateSpecType_UseDefaultPodSecurityAdmission struct {
	UseDefaultPodSecurityAdmission *schema.Empty `protobuf:"bytes,29,opt,name=use_default_pod_security_admission,json=useDefaultPodSecurityAdmission,proto3,oneof" json:"use_default_pod_security_admission,omitempty"`
}
type CreateSpecType_UseCustomPodSecurityAdmission struct {
	UseCustomPodSecurityAdmission *views.ObjectRefType `protobuf:"bytes,30,opt,name=use_custom_pod_security_admission,json=useCustomPodSecurityAdmission,proto3,oneof" json:"use_custom_pod_security_admission,omitempty"`
}
...
func (*CreateSpecType_Vk8SNamespaceAccessDeny) isCreateSpecType_Vk8SNamespaceAccessChoice()         {}
func (*CreateSpecType_Vk8SNamespaceAccessPermit) isCreateSpecType_Vk8SNamespaceAccessChoice()       {}
func (*CreateSpecType_UseDefaultPodSecurityAdmission) isCreateSpecType_PodSecurityAdmissionChoice() {}
func (*CreateSpecType_UseCustomPodSecurityAdmission) isCreateSpecType_PodSecurityAdmissionChoice()  {}
...
func (m *CreateSpecType) GetVk8SNamespaceAccessChoice() isCreateSpecType_Vk8SNamespaceAccessChoice {
	if m != nil {
		return m.Vk8SNamespaceAccessChoice
	}
	return nil
}
func (m *CreateSpecType) GetPodSecurityAdmissionChoice() isCreateSpecType_PodSecurityAdmissionChoice {
	if m != nil {
		return m.PodSecurityAdmissionChoice
	}
	return nil
...
func (m *CreateSpecType) GetVk8SNamespaceAccessDeny() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*CreateSpecType_Vk8SNamespaceAccessDeny); ok {
		return x.Vk8SNamespaceAccessDeny
	}
	return nil
}

func (m *CreateSpecType) GetVk8SNamespaceAccessPermit() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*CreateSpecType_Vk8SNamespaceAccessPermit); ok {
		return x.Vk8SNamespaceAccessPermit
	}
	return nil
}

func (m *CreateSpecType) GetUseDefaultPodSecurityAdmission() *schema.Empty {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*CreateSpecType_UseDefaultPodSecurityAdmission); ok {
		return x.UseDefaultPodSecurityAdmission
	}
	return nil
}

func (m *CreateSpecType) GetUseCustomPodSecurityAdmission() *views.ObjectRefType {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*CreateSpecType_UseCustomPodSecurityAdmission); ok {
		return x.UseCustomPodSecurityAdmission
	}
	return nil
}
...
func (*CreateSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*CreateSpecType_Vk8SNamespaceAccessDeny)(nil),
		(*CreateSpecType_Vk8SNamespaceAccessPermit)(nil),
		(*CreateSpecType_UseDefaultPodSecurityAdmission)(nil),
		(*CreateSpecType_UseCustomPodSecurityAdmission)(nil),
	}
}
...
type ReplaceSpecType struct {
	...
	// Types that are valid to be assigned to Vk8SNamespaceAccessChoice:
	//	*ReplaceSpecType_Vk8SNamespaceAccessDeny
	//	*ReplaceSpecType_Vk8SNamespaceAccessPermit
	Vk8SNamespaceAccessChoice isReplaceSpecType_Vk8SNamespaceAccessChoice `protobuf_oneof:"vk8s_namespace_access_choice"`
	// Types that are valid to be assigned to PodSecurityAdmissionChoice:
	//	*ReplaceSpecType_UseDefaultPodSecurityAdmission
	//	*ReplaceSpecType_UseCustomPodSecurityAdmission
	PodSecurityAdmissionChoice isReplaceSpecType_PodSecurityAdmissionChoice `protobuf_oneof:"pod_security_admission_choice"`
}
...
type isReplaceSpecType_Vk8SNamespaceAccessChoice interface {
	isReplaceSpecType_Vk8SNamespaceAccessChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
type isReplaceSpecType_PodSecurityAdmissionChoice interface {
	isReplaceSpecType_PodSecurityAdmissionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type ReplaceSpecType_Vk8SNamespaceAccessDeny struct {
	Vk8SNamespaceAccessDeny *schema.Empty `protobuf:"bytes,26,opt,name=vk8s_namespace_access_deny,json=vk8sNamespaceAccessDeny,proto3,oneof" json:"vk8s_namespace_access_deny,omitempty"`
}
type ReplaceSpecType_Vk8SNamespaceAccessPermit struct {
	Vk8SNamespaceAccessPermit *schema.Empty `protobuf:"bytes,27,opt,name=vk8s_namespace_access_permit,json=vk8sNamespaceAccessPermit,proto3,oneof" json:"vk8s_namespace_access_permit,omitempty"`
}
type ReplaceSpecType_UseDefaultPodSecurityAdmission struct {
	UseDefaultPodSecurityAdmission *schema.Empty `protobuf:"bytes,29,opt,name=use_default_pod_security_admission,json=useDefaultPodSecurityAdmission,proto3,oneof" json:"use_default_pod_security_admission,omitempty"`
}
type ReplaceSpecType_UseCustomPodSecurityAdmission struct {
	UseCustomPodSecurityAdmission *views.ObjectRefType `protobuf:"bytes,30,opt,name=use_custom_pod_security_admission,json=useCustomPodSecurityAdmission,proto3,oneof" json:"use_custom_pod_security_admission,omitempty"`
}
...
func (*ReplaceSpecType_Vk8SNamespaceAccessDeny) isReplaceSpecType_Vk8SNamespaceAccessChoice()   {}
func (*ReplaceSpecType_Vk8SNamespaceAccessPermit) isReplaceSpecType_Vk8SNamespaceAccessChoice() {}
func (*ReplaceSpecType_UseDefaultPodSecurityAdmission) isReplaceSpecType_PodSecurityAdmissionChoice() {
}
func (*ReplaceSpecType_UseCustomPodSecurityAdmission) isReplaceSpecType_PodSecurityAdmissionChoice() {
}
...
func (m *ReplaceSpecType) GetVk8SNamespaceAccessChoice() isReplaceSpecType_Vk8SNamespaceAccessChoice {
	if m != nil {
		return m.Vk8SNamespaceAccessChoice
	}
	return nil
}
func (m *ReplaceSpecType) GetPodSecurityAdmissionChoice() isReplaceSpecType_PodSecurityAdmissionChoice {
	if m != nil {
		return m.PodSecurityAdmissionChoice
	}
	return nil
...
func (m *ReplaceSpecType) GetVk8SNamespaceAccessDeny() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*ReplaceSpecType_Vk8SNamespaceAccessDeny); ok {
		return x.Vk8SNamespaceAccessDeny
	}
	return nil
}

func (m *ReplaceSpecType) GetVk8SNamespaceAccessPermit() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*ReplaceSpecType_Vk8SNamespaceAccessPermit); ok {
		return x.Vk8SNamespaceAccessPermit
	}
	return nil
}

func (m *ReplaceSpecType) GetUseDefaultPodSecurityAdmission() *schema.Empty {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*ReplaceSpecType_UseDefaultPodSecurityAdmission); ok {
		return x.UseDefaultPodSecurityAdmission
	}
	return nil
}

func (m *ReplaceSpecType) GetUseCustomPodSecurityAdmission() *views.ObjectRefType {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*ReplaceSpecType_UseCustomPodSecurityAdmission); ok {
		return x.UseCustomPodSecurityAdmission
	}
	return nil
}
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_Vk8SNamespaceAccessDeny)(nil),
		(*ReplaceSpecType_Vk8SNamespaceAccessPermit)(nil),
		(*ReplaceSpecType_UseDefaultPodSecurityAdmission)(nil),
		(*ReplaceSpecType_UseCustomPodSecurityAdmission)(nil),
	}
}
...
type GetSpecType struct {
	...
	// Types that are valid to be assigned to Vk8SNamespaceAccessChoice:
	//	*GetSpecType_Vk8SNamespaceAccessDeny
	//	*GetSpecType_Vk8SNamespaceAccessPermit
	Vk8SNamespaceAccessChoice isGetSpecType_Vk8SNamespaceAccessChoice `protobuf_oneof:"vk8s_namespace_access_choice"`
	// Types that are valid to be assigned to PodSecurityAdmissionChoice:
	//	*GetSpecType_UseDefaultPodSecurityAdmission
	//	*GetSpecType_UseCustomPodSecurityAdmission
	PodSecurityAdmissionChoice isGetSpecType_PodSecurityAdmissionChoice `protobuf_oneof:"pod_security_admission_choice"`
}
...
type isGetSpecType_Vk8SNamespaceAccessChoice interface {
	isGetSpecType_Vk8SNamespaceAccessChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
type isGetSpecType_PodSecurityAdmissionChoice interface {
	isGetSpecType_PodSecurityAdmissionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GetSpecType_Vk8SNamespaceAccessDeny struct {
	Vk8SNamespaceAccessDeny *schema.Empty `protobuf:"bytes,26,opt,name=vk8s_namespace_access_deny,json=vk8sNamespaceAccessDeny,proto3,oneof" json:"vk8s_namespace_access_deny,omitempty"`
}
type GetSpecType_Vk8SNamespaceAccessPermit struct {
	Vk8SNamespaceAccessPermit *schema.Empty `protobuf:"bytes,27,opt,name=vk8s_namespace_access_permit,json=vk8sNamespaceAccessPermit,proto3,oneof" json:"vk8s_namespace_access_permit,omitempty"`
}
type GetSpecType_UseDefaultPodSecurityAdmission struct {
	UseDefaultPodSecurityAdmission *schema.Empty `protobuf:"bytes,29,opt,name=use_default_pod_security_admission,json=useDefaultPodSecurityAdmission,proto3,oneof" json:"use_default_pod_security_admission,omitempty"`
}
type GetSpecType_UseCustomPodSecurityAdmission struct {
	UseCustomPodSecurityAdmission *views.ObjectRefType `protobuf:"bytes,30,opt,name=use_custom_pod_security_admission,json=useCustomPodSecurityAdmission,proto3,oneof" json:"use_custom_pod_security_admission,omitempty"`
}
...
func (*GetSpecType_Vk8SNamespaceAccessDeny) isGetSpecType_Vk8SNamespaceAccessChoice()           {}
func (*GetSpecType_Vk8SNamespaceAccessPermit) isGetSpecType_Vk8SNamespaceAccessChoice()         {}
func (*GetSpecType_UseDefaultPodSecurityAdmission) isGetSpecType_PodSecurityAdmissionChoice()   {}
func (*GetSpecType_UseCustomPodSecurityAdmission) isGetSpecType_PodSecurityAdmissionChoice()    {}
...
func (m *GetSpecType) GetVk8SNamespaceAccessChoice() isGetSpecType_Vk8SNamespaceAccessChoice {
	if m != nil {
		return m.Vk8SNamespaceAccessChoice
	}
	return nil
}
func (m *GetSpecType) GetPodSecurityAdmissionChoice() isGetSpecType_PodSecurityAdmissionChoice {
	if m != nil {
		return m.PodSecurityAdmissionChoice
	}
	return nil
...
func (m *GetSpecType) GetVk8SNamespaceAccessDeny() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*GetSpecType_Vk8SNamespaceAccessDeny); ok {
		return x.Vk8SNamespaceAccessDeny
	}
	return nil
}

func (m *GetSpecType) GetVk8SNamespaceAccessPermit() *schema.Empty {
	if x, ok := m.GetVk8SNamespaceAccessChoice().(*GetSpecType_Vk8SNamespaceAccessPermit); ok {
		return x.Vk8SNamespaceAccessPermit
	}
	return nil
}

func (m *GetSpecType) GetUseDefaultPodSecurityAdmission() *schema.Empty {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*GetSpecType_UseDefaultPodSecurityAdmission); ok {
		return x.UseDefaultPodSecurityAdmission
	}
	return nil
}

func (m *GetSpecType) GetUseCustomPodSecurityAdmission() *views.ObjectRefType {
	if x, ok := m.GetPodSecurityAdmissionChoice().(*GetSpecType_UseCustomPodSecurityAdmission); ok {
		return x.UseCustomPodSecurityAdmission
	}
	return nil
}
...
func (*GetSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GetSpecType_Vk8SNamespaceAccessDeny)(nil),
		(*GetSpecType_Vk8SNamespaceAccessPermit)(nil),
		(*GetSpecType_UseDefaultPodSecurityAdmission)(nil),
		(*GetSpecType_UseCustomPodSecurityAdmission)(nil),
	}
}
...
var fileDescriptor_c55b4fdc7e1bea1d = []byte{
	...
	,
}
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if that1.PodSecurityAdmissionChoice == nil {
		if this.PodSecurityAdmissionChoice != nil {
			return false
		}
	} else if this.PodSecurityAdmissionChoice == nil {
		return false
	} else if !this.PodSecurityAdmissionChoice.Equal(that1.PodSecurityAdmissionChoice) {
		return false
	}
	...
	if !this.FinalPodSecurityAdmission.Equal(that1.FinalPodSecurityAdmission) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_UseDefaultPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_UseDefaultPodSecurityAdmission)
	if !ok {
		that2, ok := that.(GlobalSpecType_UseDefaultPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.UseDefaultPodSecurityAdmission.Equal(that1.UseDefaultPodSecurityAdmission) {
		return false
	}
	return true
}
func (this *GlobalSpecType_UseCustomPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_UseCustomPodSecurityAdmission)
	if !ok {
		that2, ok := that.(GlobalSpecType_UseCustomPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.UseCustomPodSecurityAdmission.Equal(that1.UseCustomPodSecurityAdmission) {
		return false
	}
	return true
}
...
func (this *CreateSpecType_Vk8SNamespaceAccessDeny) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_Vk8SNamespaceAccessDeny)
	if !ok {
		that2, ok := that.(CreateSpecType_Vk8SNamespaceAccessDeny)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_Vk8SNamespaceAccessPermit) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_Vk8SNamespaceAccessPermit)
	if !ok {
		that2, ok := that.(CreateSpecType_Vk8SNamespaceAccessPermit)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_UseDefaultPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_UseDefaultPodSecurityAdmission)
	if !ok {
		that2, ok := that.(CreateSpecType_UseDefaultPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_UseCustomPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_UseCustomPodSecurityAdmission)
	if !ok {
		that2, ok := that.(CreateSpecType_UseCustomPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_Vk8SNamespaceAccessDeny) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_Vk8SNamespaceAccessDeny)
	if !ok {
		that2, ok := that.(ReplaceSpecType_Vk8SNamespaceAccessDeny)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_Vk8SNamespaceAccessPermit) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_Vk8SNamespaceAccessPermit)
	if !ok {
		that2, ok := that.(ReplaceSpecType_Vk8SNamespaceAccessPermit)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_UseDefaultPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_UseDefaultPodSecurityAdmission)
	if !ok {
		that2, ok := that.(ReplaceSpecType_UseDefaultPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_UseCustomPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_UseCustomPodSecurityAdmission)
	if !ok {
		that2, ok := that.(ReplaceSpecType_UseCustomPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_Vk8SNamespaceAccessDeny) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_Vk8SNamespaceAccessDeny)
	if !ok {
		that2, ok := that.(GetSpecType_Vk8SNamespaceAccessDeny)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_Vk8SNamespaceAccessPermit) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_Vk8SNamespaceAccessPermit)
	if !ok {
		that2, ok := that.(GetSpecType_Vk8SNamespaceAccessPermit)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_UseDefaultPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_UseDefaultPodSecurityAdmission)
	if !ok {
		that2, ok := that.(GetSpecType_UseDefaultPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_UseCustomPodSecurityAdmission) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_UseCustomPodSecurityAdmission)
	if !ok {
		that2, ok := that.(GetSpecType_UseCustomPodSecurityAdmission)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType) GoString() string {
	...
	if this.PodSecurityAdmissionChoice != nil {
		s = append(s, "PodSecurityAdmissionChoice: "+fmt.Sprintf("%#v", this.PodSecurityAdmissionChoice)+",\n")
	}
	...
	if this.FinalPodSecurityAdmission != nil {
		s = append(s, "FinalPodSecurityAdmission: "+fmt.Sprintf("%#v", this.FinalPodSecurityAdmission)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *GlobalSpecType_UseDefaultPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GlobalSpecType_UseDefaultPodSecurityAdmission{` +
		`UseDefaultPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseDefaultPodSecurityAdmission) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_UseCustomPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GlobalSpecType_UseCustomPodSecurityAdmission{` +
		`UseCustomPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseCustomPodSecurityAdmission) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_Vk8SNamespaceAccessDeny) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.CreateSpecType_Vk8SNamespaceAccessDeny{` +
		`Vk8SNamespaceAccessDeny:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessDeny) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_Vk8SNamespaceAccessPermit) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.CreateSpecType_Vk8SNamespaceAccessPermit{` +
		`Vk8SNamespaceAccessPermit:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessPermit) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_UseDefaultPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.CreateSpecType_UseDefaultPodSecurityAdmission{` +
		`UseDefaultPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseDefaultPodSecurityAdmission) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_UseCustomPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.CreateSpecType_UseCustomPodSecurityAdmission{` +
		`UseCustomPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseCustomPodSecurityAdmission) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_Vk8SNamespaceAccessDeny) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.ReplaceSpecType_Vk8SNamespaceAccessDeny{` +
		`Vk8SNamespaceAccessDeny:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessDeny) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_Vk8SNamespaceAccessPermit) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.ReplaceSpecType_Vk8SNamespaceAccessPermit{` +
		`Vk8SNamespaceAccessPermit:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessPermit) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_UseDefaultPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.ReplaceSpecType_UseDefaultPodSecurityAdmission{` +
		`UseDefaultPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseDefaultPodSecurityAdmission) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_UseCustomPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.ReplaceSpecType_UseCustomPodSecurityAdmission{` +
		`UseCustomPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseCustomPodSecurityAdmission) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_Vk8SNamespaceAccessDeny) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GetSpecType_Vk8SNamespaceAccessDeny{` +
		`Vk8SNamespaceAccessDeny:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessDeny) + `}`}, ", ")
	return s
}
func (this *GetSpecType_Vk8SNamespaceAccessPermit) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GetSpecType_Vk8SNamespaceAccessPermit{` +
		`Vk8SNamespaceAccessPermit:` + fmt.Sprintf("%#v", this.Vk8SNamespaceAccessPermit) + `}`}, ", ")
	return s
}
func (this *GetSpecType_UseDefaultPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GetSpecType_UseDefaultPodSecurityAdmission{` +
		`UseDefaultPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseDefaultPodSecurityAdmission) + `}`}, ", ")
	return s
}
func (this *GetSpecType_UseCustomPodSecurityAdmission) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&k8s_cluster.GetSpecType_UseCustomPodSecurityAdmission{` +
		`UseCustomPodSecurityAdmission:` + fmt.Sprintf("%#v", this.UseCustomPodSecurityAdmission) + `}`}, ", ")
	return s
}
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FinalPodSecurityAdmission != nil {
		{
			size, err := m.FinalPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.PodSecurityAdmissionChoice != nil {
		{
			size := m.PodSecurityAdmissionChoice.Size()
			i -= size
			if _, err := m.PodSecurityAdmissionChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *GlobalSpecType_UseDefaultPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_UseDefaultPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseDefaultPodSecurityAdmission != nil {
		{
			size, err := m.UseDefaultPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_UseCustomPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_UseCustomPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseCustomPodSecurityAdmission != nil {
		{
			size, err := m.UseCustomPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CreateSpecType_Vk8SNamespaceAccessDeny) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_Vk8SNamespaceAccessDeny) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessDeny != nil {
		{
			size, err := m.Vk8SNamespaceAccessDeny.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_Vk8SNamespaceAccessPermit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_Vk8SNamespaceAccessPermit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessPermit != nil {
		{
			size, err := m.Vk8SNamespaceAccessPermit.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_UseDefaultPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_UseDefaultPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseDefaultPodSecurityAdmission != nil {
		{
			size, err := m.UseDefaultPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_UseCustomPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_UseCustomPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseCustomPodSecurityAdmission != nil {
		{
			size, err := m.UseCustomPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_Vk8SNamespaceAccessDeny) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_Vk8SNamespaceAccessDeny) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessDeny != nil {
		{
			size, err := m.Vk8SNamespaceAccessDeny.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_Vk8SNamespaceAccessPermit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_Vk8SNamespaceAccessPermit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessPermit != nil {
		{
			size, err := m.Vk8SNamespaceAccessPermit.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_UseDefaultPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_UseDefaultPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseDefaultPodSecurityAdmission != nil {
		{
			size, err := m.UseDefaultPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_UseCustomPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_UseCustomPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseCustomPodSecurityAdmission != nil {
		{
			size, err := m.UseCustomPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_Vk8SNamespaceAccessDeny) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_Vk8SNamespaceAccessDeny) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessDeny != nil {
		{
			size, err := m.Vk8SNamespaceAccessDeny.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_Vk8SNamespaceAccessPermit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_Vk8SNamespaceAccessPermit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vk8SNamespaceAccessPermit != nil {
		{
			size, err := m.Vk8SNamespaceAccessPermit.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_UseDefaultPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_UseDefaultPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseDefaultPodSecurityAdmission != nil {
		{
			size, err := m.UseDefaultPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_UseCustomPodSecurityAdmission) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_UseCustomPodSecurityAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UseCustomPodSecurityAdmission != nil {
		{
			size, err := m.UseCustomPodSecurityAdmission.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GlobalSpecType) Size() (n int) {
	...
	if m.PodSecurityAdmissionChoice != nil {
		n += m.PodSecurityAdmissionChoice.Size()
	}
	if m.ViewInternal != nil {
	...
	if m.FinalPodSecurityAdmission != nil {
		l = m.FinalPodSecurityAdmission.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *GlobalSpecType_UseDefaultPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UseDefaultPodSecurityAdmission != nil {
		l = m.UseDefaultPodSecurityAdmission.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_UseCustomPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UseCustomPodSecurityAdmission != nil {
		l = m.UseCustomPodSecurityAdmission.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *CreateSpecType_Vk8SNamespaceAccessDeny) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_Vk8SNamespaceAccessPermit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_UseDefaultPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_UseCustomPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_Vk8SNamespaceAccessDeny) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_Vk8SNamespaceAccessPermit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_UseDefaultPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_UseCustomPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_Vk8SNamespaceAccessDeny) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_Vk8SNamespaceAccessPermit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_UseDefaultPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_UseCustomPodSecurityAdmission) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`PodSecurityAdmissionChoice:` + fmt.Sprintf("%v", this.PodSecurityAdmissionChoice) + `,`,
		...
		`FinalPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.FinalPodSecurityAdmission), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_UseDefaultPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_UseDefaultPodSecurityAdmission{`,
		`UseDefaultPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseDefaultPodSecurityAdmission), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_UseCustomPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_UseCustomPodSecurityAdmission{`,
		`UseCustomPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseCustomPodSecurityAdmission), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CreateSpecType_Vk8SNamespaceAccessDeny) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_Vk8SNamespaceAccessDeny{`,
		`Vk8SNamespaceAccessDeny:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessDeny), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_Vk8SNamespaceAccessPermit) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_Vk8SNamespaceAccessPermit{`,
		`Vk8SNamespaceAccessPermit:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessPermit), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_UseDefaultPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_UseDefaultPodSecurityAdmission{`,
		`UseDefaultPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseDefaultPodSecurityAdmission), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_UseCustomPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_UseCustomPodSecurityAdmission{`,
		`UseCustomPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseCustomPodSecurityAdmission), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_Vk8SNamespaceAccessDeny) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_Vk8SNamespaceAccessDeny{`,
		`Vk8SNamespaceAccessDeny:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessDeny), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_Vk8SNamespaceAccessPermit) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_Vk8SNamespaceAccessPermit{`,
		`Vk8SNamespaceAccessPermit:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessPermit), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_UseDefaultPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_UseDefaultPodSecurityAdmission{`,
		`UseDefaultPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseDefaultPodSecurityAdmission), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_UseCustomPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_UseCustomPodSecurityAdmission{`,
		`UseCustomPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseCustomPodSecurityAdmission), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_Vk8SNamespaceAccessDeny) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_Vk8SNamespaceAccessDeny{`,
		`Vk8SNamespaceAccessDeny:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessDeny), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_Vk8SNamespaceAccessPermit) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_Vk8SNamespaceAccessPermit{`,
		`Vk8SNamespaceAccessPermit:` + strings.Replace(fmt.Sprintf("%v", this.Vk8SNamespaceAccessPermit), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_UseDefaultPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_UseDefaultPodSecurityAdmission{`,
		`UseDefaultPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseDefaultPodSecurityAdmission), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_UseCustomPodSecurityAdmission) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_UseCustomPodSecurityAdmission{`,
		`UseCustomPodSecurityAdmission:` + strings.Replace(fmt.Sprintf("%v", this.UseCustomPodSecurityAdmission), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDefaultPodSecurityAdmission", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PodSecurityAdmissionChoice = &GlobalSpecType_UseDefaultPodSecurityAdmission{v}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseCustomPodSecurityAdmission", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PodSecurityAdmissionChoice = &GlobalSpecType_UseCustomPodSecurityAdmission{v}
			iNdEx = postIndex
		case 1000:
			if wireType != 2 {
		...
		case 1004:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinalPodSecurityAdmission", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FinalPodSecurityAdmission == nil {
				m.FinalPodSecurityAdmission = &views.ObjectRefType{}
			}
			if err := m.FinalPodSecurityAdmission.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CreateSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			m.Vk8SNamespaceAccessChoice = &CreateSpecType_Vk8SNamespaceAccessDeny{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vk8SNamespaceAccessPermit", wireType)
			...
			m.Vk8SNamespaceAccessChoice = &CreateSpecType_Vk8SNamespaceAccessPermit{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDefaultPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &CreateSpecType_UseDefaultPodSecurityAdmission{v}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseCustomPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &CreateSpecType_UseCustomPodSecurityAdmission{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			m.Vk8SNamespaceAccessChoice = &ReplaceSpecType_Vk8SNamespaceAccessDeny{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vk8SNamespaceAccessPermit", wireType)
			...
			m.Vk8SNamespaceAccessChoice = &ReplaceSpecType_Vk8SNamespaceAccessPermit{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDefaultPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &ReplaceSpecType_UseDefaultPodSecurityAdmission{v}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseCustomPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &ReplaceSpecType_UseCustomPodSecurityAdmission{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			m.Vk8SNamespaceAccessChoice = &GetSpecType_Vk8SNamespaceAccessDeny{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vk8SNamespaceAccessPermit", wireType)
			...
			m.Vk8SNamespaceAccessChoice = &GetSpecType_Vk8SNamespaceAccessPermit{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDefaultPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &GetSpecType_UseDefaultPodSecurityAdmission{v}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseCustomPodSecurityAdmission", wireType)
			...
			m.PodSecurityAdmissionChoice = &GetSpecType_UseCustomPodSecurityAdmission{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
