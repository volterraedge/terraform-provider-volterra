...
var (
	pattern_API_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ves.io.schema.fleet", "Objects"}, ""))

	pattern_API_Create_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ves.io.schema.fleet", "introspect", "write", "Objects"}, ""))

	pattern_API_Replace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ves.io.schema.fleet", "Object", "object_uid"}, ""))

	pattern_API_Replace_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ves.io.schema.fleet", "introspect", "write", "Object", "object_uid"}, ""))

	pattern_API_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ves.io.schema.fleet", "Object", "object_uid"}, ""))

	pattern_API_Get_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ves.io.schema.fleet", "introspect", "read", "Object", "object_uid"}, ""))

	pattern_API_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ves.io.schema.fleet", "Objects"}, ""))

	pattern_API_List_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ves.io.schema.fleet", "introspect", "read", "Objects"}, ""))

	pattern_API_ListStream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ves.io.schema.fleet", "Objects", "stream"}, ""))

	pattern_API_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ves.io.schema.fleet", "Object", "object_uid"}, ""))

	pattern_API_Delete_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ves.io.schema.fleet", "introspect", "write", "Object", "object_uid"}, ""))
)
