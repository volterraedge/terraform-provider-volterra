...
type UserIdentificationRule struct {
	...
	//	*UserIdentificationRule_Ja4TlsFingerprint
	//	*UserIdentificationRule_IpAndJa4TlsFingerprint
...
type UserIdentificationRule_Ja4TlsFingerprint struct {
	Ja4TlsFingerprint *schema.Empty `protobuf:"bytes,15,opt,name=ja4_tls_fingerprint,json=ja4TlsFingerprint,proto3,oneof" json:"ja4_tls_fingerprint,omitempty"`
}
type UserIdentificationRule_IpAndJa4TlsFingerprint struct {
	IpAndJa4TlsFingerprint *schema.Empty `protobuf:"bytes,16,opt,name=ip_and_ja4_tls_fingerprint,json=ipAndJa4TlsFingerprint,proto3,oneof" json:"ip_and_ja4_tls_fingerprint,omitempty"`
}
...
func (*UserIdentificationRule_Ja4TlsFingerprint) isUserIdentificationRule_Identifier()      {}
func (*UserIdentificationRule_IpAndJa4TlsFingerprint) isUserIdentificationRule_Identifier() {}
...
func (m *UserIdentificationRule) GetJa4TlsFingerprint() *schema.Empty {
	if x, ok := m.GetIdentifier().(*UserIdentificationRule_Ja4TlsFingerprint); ok {
		return x.Ja4TlsFingerprint
	}
	return nil
}

func (m *UserIdentificationRule) GetIpAndJa4TlsFingerprint() *schema.Empty {
	if x, ok := m.GetIdentifier().(*UserIdentificationRule_IpAndJa4TlsFingerprint); ok {
		return x.IpAndJa4TlsFingerprint
	}
	return nil
}
...
func (*UserIdentificationRule) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*UserIdentificationRule_Ja4TlsFingerprint)(nil),
		(*UserIdentificationRule_IpAndJa4TlsFingerprint)(nil),
	}
}
...
var fileDescriptor_9386c30a805661f8 = []byte{
	...
	,
}
...
func (this *UserIdentificationRule_Ja4TlsFingerprint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UserIdentificationRule_Ja4TlsFingerprint)
	if !ok {
		that2, ok := that.(UserIdentificationRule_Ja4TlsFingerprint)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UserIdentificationRule_IpAndJa4TlsFingerprint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UserIdentificationRule_IpAndJa4TlsFingerprint)
	if !ok {
		that2, ok := that.(UserIdentificationRule_IpAndJa4TlsFingerprint)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.IpAndJa4TlsFingerprint.Equal(that1.IpAndJa4TlsFingerprint) {
		return false
	}
	return true
}
...
func (this *UserIdentificationRule_Ja4TlsFingerprint) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&user_identification.UserIdentificationRule_Ja4TlsFingerprint{` +
		`Ja4TlsFingerprint:` + fmt.Sprintf("%#v", this.Ja4TlsFingerprint) + `}`}, ", ")
	return s
}
func (this *UserIdentificationRule_IpAndJa4TlsFingerprint) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&user_identification.UserIdentificationRule_IpAndJa4TlsFingerprint{` +
		`IpAndJa4TlsFingerprint:` + fmt.Sprintf("%#v", this.IpAndJa4TlsFingerprint) + `}`}, ", ")
	return s
}
...
func (m *UserIdentificationRule_Ja4TlsFingerprint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UserIdentificationRule_Ja4TlsFingerprint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *UserIdentificationRule_IpAndJa4TlsFingerprint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UserIdentificationRule_IpAndJa4TlsFingerprint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.IpAndJa4TlsFingerprint != nil {
		{
			size, err := m.IpAndJa4TlsFingerprint.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *UserIdentificationRule_Ja4TlsFingerprint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UserIdentificationRule_IpAndJa4TlsFingerprint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.IpAndJa4TlsFingerprint != nil {
		l = m.IpAndJa4TlsFingerprint.Size()
...
func (this *UserIdentificationRule_Ja4TlsFingerprint) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UserIdentificationRule_Ja4TlsFingerprint{`,
		`Ja4TlsFingerprint:` + strings.Replace(fmt.Sprintf("%v", this.Ja4TlsFingerprint), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UserIdentificationRule_IpAndJa4TlsFingerprint) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UserIdentificationRule_IpAndJa4TlsFingerprint{`,
		`IpAndJa4TlsFingerprint:` + strings.Replace(fmt.Sprintf("%v", this.IpAndJa4TlsFingerprint), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UserIdentificationRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			...
			m.Identifier = &UserIdentificationRule_Ja4TlsFingerprint{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpAndJa4TlsFingerprint", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Identifier = &UserIdentificationRule_IpAndJa4TlsFingerprint{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
