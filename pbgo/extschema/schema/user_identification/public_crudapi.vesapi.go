...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/user_identifications", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/user_identifications/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/user_identifications/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/user_identifications", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/user_identifications/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.user_identification.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.user_identification")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.user_identification.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.user_identification.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.user_identification.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.user_identification.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.user_identification.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.user_identification.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.user_identification.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user_identification.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.user_identification.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.user_identification.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.user_identification.API.Create' operation on 'user_identification'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.user_identification.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.user_identification.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user_identification.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.user_identification.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.user_identification.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.user_identification.API.Replace' operation on 'user_identification'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.user_identification.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user_identification.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.user_identification.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user_identification.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.user_identification.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.user_identification.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.user_identification.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.user_identification.API.Delete' operation on 'user_identification'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.user_identification.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "user identification object",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/user_identificationCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user_identificationCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "x-ves-proto-rpc": "ves.io.schema.user_identification.API.Create"
            },
            "x-displayname": "User Identification",
            "x-ves-proto-service": "ves.io.schema.user_identification.API",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/user_identificationReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user_identificationReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "x-ves-proto-rpc": "ves.io.schema.user_identification.API.Replace"
            },
            "x-displayname": "User Identification",
            "x-ves-proto-service": "ves.io.schema.user_identification.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/user_identificationListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "x-ves-proto-rpc": "ves.io.schema.user_identification.API.List"
            },
            "x-displayname": "User Identification",
            "x-ves-proto-service": "ves.io.schema.user_identification.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/user_identificationGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user_identificationDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "x-ves-proto-rpc": "ves.io.schema.user_identification.API.Delete"
            },
            "x-displayname": "User Identification",
            "x-ves-proto-service": "ves.io.schema.user_identification.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "user_identificationCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of user_identification",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the user_identification",
                    "title": "spec",
                    "$ref": "#/definitions/user_identificationCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "user_identificationCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the user_identification",
                    "title": "spec",
                    "$ref": "#/definitions/user_identificationGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "user_identificationCreateSpecType": {
            "type": "object",
            "description": "Create user_identification creates a new object in the storage backend for metadata.namespace.",
            "title": "Create user identification",
            "x-displayname": "Create User Identification",
            "x-ves-proto-message": "ves.io.schema.user_identification.CreateSpecType",
            "properties": {
                "rules": {
                    "type": "array",
        ...
        "user_identificationDeleteRequest": {
            ...
            "title": "DeleteRequest is used to delete a user_identification",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.user_identification.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "user_identificationGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read user_identification",
        ...
        "user_identificationGetResponseFormatCode": {
            "type": "string",
        ...
        "user_identificationGetSpecType": {
            "type": "object",
            "description": "Get user_identification reads a given object from storage backend for metadata.namespace.",
            "title": "Get user identification",
            "x-displayname": "Get User Identification",
            "x-ves-proto-message": "ves.io.schema.user_identification.GetSpecType",
            "properties": {
                "rules": {
                    "type": "array",
                    "description": " An ordered list of rules that are evaluated sequentially against the input fields extracted from an API request in order to determine a user identifier.\n Evaluation of the rules is terminated once a user identifier has been extracted.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 4\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "user_identificationListResponse": {
            ...
            "title": "ListResponse is the collection of user_identification",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.user_identification.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/user_identificationListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "user_identificationListResponseItem": {
            "type": "object",
            "description": "By default a summary of user_identification is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of user_identification",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.user_identification.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this user_identification",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this user_identification",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates user_identification is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this user_identification",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this user_identification\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this user_identification\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "user_identificationReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a user_identification",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the user_identification",
                    "title": "spec",
                    "$ref": "#/definitions/user_identificationReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "user_identificationReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.user_identification.ReplaceResponse"
        },
        "user_identificationReplaceSpecType": {
            "type": "object",
            "description": "Replace user_identification replaces an existing object in the storage backend for metadata.namespace.",
            "title": "Replace user identification",
            "x-displayname": "Replace User Identification",
            "x-ves-proto-message": "ves.io.schema.user_identification.ReplaceSpecType",
            "properties": {
                "rules": {
                    "type": "array",
                    "description": " An ordered list of rules that are evaluated sequentially against the input fields extracted from an API request in order to determine a user identifier.\n Evaluation of the rules is terminated once a user identifier has been extracted.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 4\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
    ...
    "x-displayname": "User Identification",
    "x-ves-proto-file": "ves.io/schema/user_identification/public_crudapi.proto"
}`
