...
import (
	...
	ves_io_schema_user_identification "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/user_identification"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_user_identification.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_user_identification.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_user_identification.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_user_identification.DBObject)
	}
	_ = f
