...
import (
	...
	ves_io_schema_certificate_chain "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/certificate_chain"
)
...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_certificate_chain.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["status"] = ves_io_schema_certificate_chain.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_certificate_chain.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_certificate_chain.DBObject)
	}
	_ = f
