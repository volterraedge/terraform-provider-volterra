...
`sensitive_data_detection_rules` - (Optional) Manage rules to detect sensitive data in requests and/or response sections.. See [Enable Discovery Sensitive Data Detection Rules ](#enable-discovery-sensitive-data-detection-rules) below for details.
...
###### One of the arguments from this list "same_as_endpoint_port, health_check_port" can be set
...
###### One of the arguments from this list "web, mobile, web_mobile" must be set
...
###### One of the arguments from this list "disallow_additional_parameters, allow_additional_parameters" must be set
...
###### One of the arguments from this list "client_name_matcher, any_client, client_name, client_selector" can be set
...
###### One of the arguments from this list "default_subset, fail_request, any_endpoint" must be set
