...
resource "volterra_alert_policy" "example" {
  ...
  routes {
    ...
    // One of the arguments from this list "group alertname alertname_regex custom any severity" can be set
...
###### One of the arguments from this list "alertname_regex, custom, any, severity, group, alertname" can be set
