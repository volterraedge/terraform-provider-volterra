...
resource "volterra_global_log_receiver" "example" {
  ...
  // One of the arguments from this list "http_receiver splunk_receiver elastic_receiver azure_receiver aws_cloud_watch_receiver kafka_receiver sumo_logic_receiver s3_receiver datadog_receiver azure_event_hubs_receiver new_relic_receiver qradar_receiver gcp_bucket_receiver" must be set
...
###### One of the arguments from this list "auth_token, auth_none, auth_basic" must be set
