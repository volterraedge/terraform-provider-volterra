...
resource "volterra_nfv_service" "example" {
  ...
  palo_alto_fw_service {
    ...
    // One of the arguments from this list "ssh_key auto_setup" must be set
  ...
  enabled_ssh_access {
    // One of the arguments from this list "advertise_on_public_default_vip advertise_on_public advertise_on_sli advertise_on_slo advertise_on_slo_sli" can be set

    advertise_on_slo = true
