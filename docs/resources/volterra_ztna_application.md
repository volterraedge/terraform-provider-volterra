...
###### One of the arguments from this list "cloud_edge_segment, advertise_on_public, site, vk8s_service, virtual_network, site_segment, virtual_site, virtual_site_with_vip, virtual_site_segment, segment" must be set
