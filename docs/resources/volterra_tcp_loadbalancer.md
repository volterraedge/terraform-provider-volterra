...
###### One of the arguments from this list "segment, virtual_site, virtual_site_with_vip, virtual_site_segment, site_segment, cloud_edge_segment, advertise_on_public, site, vk8s_service, virtual_network" must be set
