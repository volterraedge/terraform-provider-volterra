...
###### One of the arguments from this list "namespace, label_selector, ip_prefix_set, any, prefix_list, outside_endpoints, inside_endpoints" can be set
...
###### One of the arguments from this list "prefix_list, outside_endpoints, inside_endpoints, namespace, label_selector, ip_prefix_set, any" can be set
