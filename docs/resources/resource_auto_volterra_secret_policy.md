...
`allow_volterra` - (Optional) if allow_volterra is set to true, it allows relevent volterra infrastructure services to decrypt the secret encrypted using this policy. (`Bool`).
