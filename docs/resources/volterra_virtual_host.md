...
###### One of the arguments from this list "proper_case_header_transformation, preserve_case_header_transformation, legacy_header_transformation, default_header_transformation" must be set
...
###### One of the arguments from this list "use_auth_object_config, cookie_params" can be set
...
###### One of the arguments from this list "redirect_url, redirect_dynamic" must be set
...
###### One of the arguments from this list "client_certificate_optional, no_client_certificate, client_certificate_required" must be set
