...
###### One of the arguments from this list "best_plus_payg_200mbps, best_plus_payg_1gbps" must be set

`best_plus_payg_200mbps` - (Optional) F5 Best Plus with all modules in 200Mbps flavor (`Bool`).
