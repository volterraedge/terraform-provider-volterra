...
~> **Note:** Please refer to [Ztna API docs](https://docs.cloud.f5.com/docs/api/ztna) to learn more
...
###### One of the arguments from this list "acl, web, connectivity" can be set
...
###### One of the arguments from this list "log_on, active_directory_auth, active_directory_query, resource_assign" can be set
