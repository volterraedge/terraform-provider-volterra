...
var (
	...
	apiGWServiceSlugs = map[string]string{
		...
		"ves.io.schema.views.aws_vpc_site.CustomAPI.SetCloudSiteInfo":           "config",
		...
		"ves.io.schema.views.azure_vnet_site.CustomAPI.SetCloudSiteInfo":        "config",
		"ves.io.schema.views.gcp_vpc_site.Object":                               "config",
		"ves.io.schema.views.gcp_vpc_site.CustomAPI.SetCloudSiteInfo":           "config",
