...
import (
	...
	ves_io_schema_certificate "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/certificate"
...
func resourceVolterraCertificateDelete(d *schema.ResourceData, meta interface{}) error {
	...
	return client.DeleteObject(context.Background(), ves_io_schema_certificate.ObjectType, namespace, name, opts...)
}
