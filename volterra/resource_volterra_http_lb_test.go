...
import (
	...
	ves_io_schema_uid "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/user_identification"
	ves_io_schema_views "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views"
	ves_io_schema_views_api_definition "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/api_definition"
	...
	"gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/views/origin_pool"
	...
	"gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/virtual_host"
	vh_dns_info "gopkg.volterra.us/terraform-provider-volterra/pbgo/extschema/schema/virtual_host_dns_info"
)
